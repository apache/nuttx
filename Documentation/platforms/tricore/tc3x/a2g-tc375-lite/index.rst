================================
KIT_A2G_TC375_LITE (AURIX TC375)
================================

Infineon's AURIX TC375 Lite Kit (KIT_A2G_TC375_LITE) is a low-cost
single-board evaluation platform for the TriCore TC3X (TC1.6.2P)
family.

Features
========

- Infineon AURIX TC37x (TC375) - 3 TriCore CPUs, 4 MiB PFLASH,
  96 KiB LMU.
...
::
  ...
  ./tools/configure.sh -E a2g-tc375-lite:nsh
  make -j$(nproc)
...
- After running a synchronous-trap test from NSH, the TC37x OCDS5
  debug unit can refuse a clean ``reset run``.  Recover by
  power-cycling the kit (USB unplug for 10+ seconds).  See
