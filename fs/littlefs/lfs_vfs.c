                         ...
                         FAR void **handle)
{
  ...
  fs->cfg.read_size      = fs->geo.blocksize * CONFIG_FS_LITTLEFS_BLOCK_SIZE_MULTIPLE_FACTOR;
  ...
  fs->cfg.cache_size     = fs->geo.blocksize * CONFIG_FS_LITTLEFS_BLOCK_SIZE_MULTIPLE_FACTOR;
