                         ...
                         FAR void **handle)
{
  ...
  fs->cfg.read_size      = fs->geo.blocksize * CONFIG_LFS_BLOCK_MULTIPLE_FACTOR;
  fs->cfg.prog_size      = fs->geo.blocksize;
  fs->cfg.block_size     = fs->geo.erasesize;
  fs->cfg.block_count    = fs->geo.neraseblocks;
  fs->cfg.block_cycles   = CONFIG_LFS_BLOCK_CYCLE;
  fs->cfg.cache_size     = fs->geo.blocksize * CONFIG_LFS_BLOCK_MULTIPLE_FACTOR;
