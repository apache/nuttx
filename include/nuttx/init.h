...
#define nxsched_set_initstate(s)  g_nx_initstate[this_bcpu()] = (s)
#define nxsched_get_initstate()   g_nx_initstate[this_bcpu()]
...
EXTERN volatile uint8_t g_nx_initstate[CONFIG_BMP_NCPUS];  /* See enum nx_initstate_e */
