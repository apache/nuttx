...
#define SNIOC_SET_ACC_RANGE  _SNIOC(0x1)
#define SNIOC_SET_GYRO_RANGE _SNIOC(0x2)
#define SNIOC_ENABLE_SENSOR  _SNIOC(0x3)
#define SNIOC_DISABLE_SENSOR _SNIOC(0x4)

/****************************************************************************
 * Public Types
 ****************************************************************************/

struct qmi8658_data_s
{
  int16_t accel_x;
  int16_t accel_y;
  int16_t accel_z;
...
/* Configuration and scale factor structures are defined in qmi8658_base.h
