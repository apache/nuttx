 ...
 *
 * LIN_TCF_FLAG:         TxConfirmation message frame. Lower_half use this flag
 *                       to confirm frame-transmit
 *
 * LIN_EVT_FLAG:         Event message frame. Lower_half use this flag to
 *                       report state switch event
 *
