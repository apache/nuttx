...
#  define stdc_leading_zeros_uc(x) \
    ((unsigned int)((unsigned char)(x) == 0 ? 8 : \
     __builtin_clz((unsigned)(x) << 24)))
#  define stdc_leading_zeros_us(x) \
    ((unsigned int)((unsigned short)(x) == 0 ? 16 : \
     __builtin_clz((unsigned)(x) << 16)))
#  define stdc_leading_zeros_ui(x) \
    ((unsigned int)((x) == 0 ? 32 : __builtin_clz(x)))
#  define stdc_leading_zeros_ul(x) \
    ((unsigned int)((x) == 0 ? (8*sizeof(unsigned long)) : __builtin_clzl(x)))
#  define stdc_leading_zeros_ull(x) \
    ((unsigned int)((x) == 0 ? (8*sizeof(unsigned long long)) : __builtin_clzll(x)))

#  define stdc_trailing_zeros_uc(x) \
    ((unsigned int)((unsigned char)(x) == 0 ? 8 : __builtin_ctz((unsigned)(x))))
#  define stdc_trailing_zeros_us(x) \
    ((unsigned int)((unsigned short)(x) == 0 ? 16 : __builtin_ctz((unsigned)(x))))
#  define stdc_trailing_zeros_ui(x) \
    ((unsigned int)((x) == 0 ? 32 : __builtin_ctz(x)))
#  define stdc_trailing_zeros_ul(x) \
    ((unsigned int)((x) == 0 ? (8*sizeof(unsigned long)) : __builtin_ctzl(x)))
#  define stdc_trailing_zeros_ull(x) \
    ((unsigned int)((x) == 0 ? (8*sizeof(unsigned long long)) : __builtin_ctzll(x)))
...
#  define stdc_first_leading_zero_uc(x) \
    ((unsigned int)((unsigned char)(x) == 0xFF ? 0 : stdc_leading_ones_uc(x) + 1))
#  define stdc_first_leading_zero_us(x) \
    ((unsigned int)((unsigned short)(x) == 0xFFFF ? 0 : stdc_leading_ones_us(x) + 1))
#  define stdc_first_leading_zero_ui(x) \
    ((unsigned int)((x) == ~0u ? 0 : stdc_leading_ones_ui(x) + 1))
#  define stdc_first_leading_zero_ul(x) \
    ((unsigned int)((x) == ~0ul ? 0 : stdc_leading_ones_ul(x) + 1))
#  define stdc_first_leading_zero_ull(x) \
    ((unsigned int)((x) == ~0ull ? 0 : stdc_leading_ones_ull(x) + 1))

#  define stdc_first_leading_one_uc(x) \
    ((unsigned int)((unsigned char)(x) == 0 ? 0 : stdc_leading_zeros_uc(x) + 1))
#  define stdc_first_leading_one_us(x) \
    ((unsigned int)((unsigned short)(x) == 0 ? 0 : stdc_leading_zeros_us(x) + 1))
#  define stdc_first_leading_one_ui(x) \
    ((unsigned int)((x) == 0 ? 0 : stdc_leading_zeros_ui(x) + 1))
#  define stdc_first_leading_one_ul(x) \
    ((unsigned int)((x) == 0 ? 0 : stdc_leading_zeros_ul(x) + 1))
#  define stdc_first_leading_one_ull(x) \
    ((unsigned int)((x) == 0 ? 0 : stdc_leading_zeros_ull(x) + 1))
...
#  define stdc_first_trailing_zero_uc(x) \
    ((unsigned int)((unsigned char)(x) == 0xFF ? 0 : stdc_trailing_ones_uc(x) + 1))
#  define stdc_first_trailing_zero_us(x) \
    ((unsigned int)((unsigned short)(x) == 0xFFFF ? 0 : stdc_trailing_ones_us(x) + 1))
#  define stdc_first_trailing_zero_ui(x) \
    ((unsigned int)((x) == ~0u ? 0 : stdc_trailing_ones_ui(x) + 1))
#  define stdc_first_trailing_zero_ul(x) \
    ((unsigned int)((x) == ~0ul ? 0 : stdc_trailing_ones_ul(x) + 1))
#  define stdc_first_trailing_zero_ull(x) \
    ((unsigned int)((x) == ~0ull ? 0 : stdc_trailing_ones_ull(x) + 1))

#  define stdc_first_trailing_one_uc(x) \
    ((unsigned int)((unsigned char)(x) == 0 ? 0 : stdc_trailing_zeros_uc(x) + 1))
#  define stdc_first_trailing_one_us(x) \
    ((unsigned int)((unsigned short)(x) == 0 ? 0 : stdc_trailing_zeros_us(x) + 1))
#  define stdc_first_trailing_one_ui(x) \
    ((unsigned int)((x) == 0 ? 0 : stdc_trailing_zeros_ui(x) + 1))
#  define stdc_first_trailing_one_ul(x) \
    ((unsigned int)((x) == 0 ? 0 : stdc_trailing_zeros_ul(x) + 1))
#  define stdc_first_trailing_one_ull(x) \
    ((unsigned int)((x) == 0 ? 0 : stdc_trailing_zeros_ull(x) + 1))
...
#  define stdc_count_zeros_uc(x)  ((unsigned int)(8 - stdc_count_ones_uc(x)))
#  define stdc_count_zeros_us(x)  ((unsigned int)(16 - stdc_count_ones_us(x)))
#  define stdc_count_zeros_ui(x)  ((unsigned int)(32 - stdc_count_ones_ui(x)))
...
#  define stdc_bit_width_uc(x) \
    ((unsigned int)((unsigned char)(x) == 0 ? 0 : 8 - stdc_leading_zeros_uc(x)))
#  define stdc_bit_width_us(x) \
    ((unsigned int)((unsigned short)(x) == 0 ? 0 : 16 - stdc_leading_zeros_us(x)))
#  define stdc_bit_width_ui(x)  ((unsigned int)((x) == 0 ? 0 : 32 - stdc_leading_zeros_ui(x)))
#  define stdc_bit_width_ul(x) \
    ((unsigned int)((x) == 0 ? 0 : (8*sizeof(unsigned long) - stdc_leading_zeros_ul(x))))
#  define stdc_bit_width_ull(x) \
    ((unsigned int)((x) == 0 ? 0 : (8*sizeof(unsigned long long) - stdc_leading_zeros_ull(x))))

/****************************************************************************
 * bit_floor / bit_ceil: inline functions to avoid double evaluation of x
 ****************************************************************************/

static inline unsigned char stdc_bit_floor_uc_impl(unsigned char x)
{
  return (unsigned char)(x != 0 ? 1 << (7 - stdc_leading_zeros_uc(x)) : 0);
}

static inline unsigned short stdc_bit_floor_us_impl(unsigned short x)
{
  return (unsigned short)(x != 0 ? 1 << (15 - stdc_leading_zeros_us(x)) : 0);
}

static inline unsigned int stdc_bit_floor_ui_impl(unsigned int x)
{
  return x != 0 ? 1u << (31 - stdc_leading_zeros_ui(x)) : 0u;
}

static inline unsigned long stdc_bit_floor_ul_impl(unsigned long x)
{
  return x != 0 ? (unsigned long)1 << (8*sizeof(unsigned long) - 1 -
              stdc_leading_zeros_ul(x)) : 0ul;
}

static inline unsigned long long stdc_bit_floor_ull_impl(
...
#  define stdc_bit_floor_uc(x)  stdc_bit_floor_uc_impl(x)
#  define stdc_bit_floor_us(x) stdc_bit_floor_us_impl(x)
#  define stdc_bit_floor_ui(x)  stdc_bit_floor_ui_impl(x)
#  define stdc_bit_floor_ul(x)  stdc_bit_floor_ul_impl(x)
#  define stdc_bit_floor_ull(x) stdc_bit_floor_ull_impl(x)

static inline unsigned char stdc_bit_ceil_uc_impl(unsigned char x)
{
  return (unsigned char)(x <= 1 ? 1 : (unsigned char)1 << (8 -
              stdc_leading_zeros_uc((unsigned char)(x - 1))));
}

static inline unsigned short stdc_bit_ceil_us_impl(unsigned short x)
{
  return (unsigned short)(x <= 1 ? 1 : (unsigned short)1 << (16 -
              stdc_leading_zeros_us((unsigned short)(x - 1))));
}

static inline unsigned int stdc_bit_ceil_ui_impl(unsigned int x)
{
  return x <= 1 ? 1u : 1u << (32 - stdc_leading_zeros_ui(x - 1));
}

static inline unsigned long stdc_bit_ceil_ul_impl(unsigned long x)
{
  return x <= 1 ? 1ul : 1ul << (8*sizeof(unsigned long) -
              stdc_leading_zeros_ul(x - 1));
}

static inline unsigned long long stdc_bit_ceil_ull_impl(unsigned long long x)
{
  return x <= 1 ? 1ull : 1ull << (8*sizeof(unsigned long long) -
              stdc_leading_zeros_ull(x - 1));
}

#  define stdc_bit_ceil_uc(x)  stdc_bit_ceil_uc_impl(x)
#  define stdc_bit_ceil_us(x)  stdc_bit_ceil_us_impl(x)
#  define stdc_bit_ceil_ui(x)  stdc_bit_ceil_ui_impl(x)
#  define stdc_bit_ceil_ul(x)  stdc_bit_ceil_ul_impl(x)
#  define stdc_bit_ceil_ull(x) stdc_bit_ceil_ull_impl(x)
