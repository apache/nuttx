/****************************************************************************
 * arch/xtensa/src/esp32s2/esp32s2_rtc_gpio.h
 *
...
#ifndef __ARCH_XTENSA_SRC_ESP32S2_ESP32S2_RTC_GPIO_H
#define __ARCH_XTENSA_SRC_ESP32S2_ESP32S2_RTC_GPIO_H
...
#else
#  define esp32s2_rtcioirqattach(irq, handler, arg) (-ENOSYS)
#endif
...
#else
#  define esp32s2_rtcioirqdetach(irq) (-ENOSYS)
#endif
