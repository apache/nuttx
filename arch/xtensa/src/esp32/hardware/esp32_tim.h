...
/* The value that needs to be written to TIMG_WDT_WKEY
...
/* Possible values for TIMG_WDT_CPU_RESET_LENGTH
 * and TIMG_WDT_SYS_RESET_LENGTH
 */
...
/* Description: When set timer 0 time-base counter increment.
...
/* Description: When set level type interrupt
...
/* Description: Write any value will trigger
 * a timer 0 time-base counter value update
...
/* Description: Write any value will trigger timer 0
...
/* Description: When set timer 1 time-base counter increment.
...
/* Description: When set edge type interrupt
 * will be generated during alarm.
 */
...
/* Description: When set level type interrupt will be generated
 * during alarm.
 */
...
/* Description: Write any value will trigger
 * a timer 1 time-base counter value update
...
/* Description: Stage 0 configuration.
...
/* Description: Stage 1 configuration.
 * 0: off  1: interrupt  2: reset CPU  3: reset system
 */
...
/* Description: Stage 2 configuration.
 * 0: off  1: interrupt  2: reset CPU  3: reset system
 */
...
/* Description: Stage 3 configuration.
 * 0: off  1: interrupt  2: reset CPU  3: reset system
 */
...
/* Description: length of system reset selection.
 * 0: 100ns  1: 200ns  2: 300ns  3: 400ns  4: 500ns  5: 800ns  6: 1.6us
 * 7: 3.2us
 */
...
/* Description: SWDT clock prescale value. Period = 12.5ns * value
