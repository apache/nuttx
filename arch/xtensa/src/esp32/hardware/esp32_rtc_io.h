...
#define RTC_GPIO_OUT_DATA_M       ((RTC_GPIO_OUT_DATA_V) << \
                                   (RTC_GPIO_OUT_DATA_S))
...
#define RTC_GPIO_OUT_DATA_W1TS_M  ((RTC_GPIO_OUT_DATA_W1TS_V) << \
...
#define RTC_GPIO_OUT_DATA_W1TC_M  ((RTC_GPIO_OUT_DATA_W1TC_V) << \
...
#define RTC_GPIO_ENABLE_M         ((RTC_GPIO_ENABLE_V) << \
                                   (RTC_GPIO_ENABLE_S))
...
#define RTC_GPIO_ENABLE_W1TC_M    ((RTC_GPIO_ENABLE_W1TC_V) << \
...
#define RTC_GPIO_STATUS_INT_M     ((RTC_GPIO_STATUS_INT_V) << \
...
#define RTC_GPIO_STATUS_INT_W1TS_M  ((RTC_GPIO_STATUS_INT_W1TS_V) << \
...
#define RTC_GPIO_STATUS_INT_W1TC_M  ((RTC_GPIO_STATUS_INT_W1TC_V) << \
...
#define RTC_GPIO_IN_NEXT_M        ((RTC_GPIO_IN_NEXT_V) << \
                                   (RTC_GPIO_IN_NEXT_S))
...
/* Description:
 * if set to 0: GPIO interrupt disable
...
#define RTC_GPIO_PIN0_INT_TYPE_M  ((RTC_GPIO_PIN0_INT_TYPE_V) << \
...
/* Description:
 * if set to 0: normal output
 * if set to 1: open drain
 */
...
#define RTC_GPIO_PIN1_INT_TYPE_M  ((RTC_GPIO_PIN1_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN2_INT_TYPE_M  ((RTC_GPIO_PIN2_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN3_INT_TYPE_M  ((RTC_GPIO_PIN3_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN4_INT_TYPE_M  ((RTC_GPIO_PIN4_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN5_INT_TYPE_M  ((RTC_GPIO_PIN5_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN6_INT_TYPE_M  ((RTC_GPIO_PIN6_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN7_INT_TYPE_M  ((RTC_GPIO_PIN7_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN8_INT_TYPE_M  ((RTC_GPIO_PIN8_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN9_INT_TYPE_M  ((RTC_GPIO_PIN9_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN10_INT_TYPE_M  ((RTC_GPIO_PIN10_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN11_INT_TYPE_M  ((RTC_GPIO_PIN11_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN12_INT_TYPE_M  ((RTC_GPIO_PIN12_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN13_INT_TYPE_M  ((RTC_GPIO_PIN13_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN14_INT_TYPE_M  ((RTC_GPIO_PIN14_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN15_INT_TYPE_M  ((RTC_GPIO_PIN15_INT_TYPE_V) << \
...
#define RTC_GPIO_PIN16_INT_TYPE_M  ((RTC_GPIO_PIN16_INT_TYPE_V) << \
...
#define RTC_IO_DEBUG_SEL4_M  ((RTC_IO_DEBUG_SEL4_V) << \
                              (RTC_IO_DEBUG_SEL4_S))
...
#define RTC_IO_DEBUG_SEL3_M  ((RTC_IO_DEBUG_SEL3_V) << \
                              (RTC_IO_DEBUG_SEL3_S))
...
#define RTC_IO_DEBUG_SEL2_M  ((RTC_IO_DEBUG_SEL2_V) << \
                              (RTC_IO_DEBUG_SEL2_S))
...
#define RTC_IO_DEBUG_SEL0_M        ((RTC_IO_DEBUG_SEL0_V) << \
                                    (RTC_IO_DEBUG_SEL0_S))
...
#define RTC_IO_DIG_PAD_HOLD_M  ((RTC_IO_DIG_PAD_HOLD_V) << \
...
/* Description: hold the current value of the output when setting the
 * hold to '1'
 */
...
/* Description:
 * '1' select the digital function
 * '0' select the rtc function
 */
...
#define RTC_IO_SENSE1_FUN_SEL_M  ((RTC_IO_SENSE1_FUN_SEL_V) << \
...
#define RTC_IO_SENSE2_FUN_SEL_M  ((RTC_IO_SENSE2_FUN_SEL_V) << \
...
#define RTC_IO_SENSE3_FUN_SEL_M  ((RTC_IO_SENSE3_FUN_SEL_V) << \
...
#define RTC_IO_SENSE4_FUN_SEL_M  ((RTC_IO_SENSE4_FUN_SEL_V) << \
...
#define RTC_IO_ADC1_FUN_SEL_M  ((RTC_IO_ADC1_FUN_SEL_V) << \
...
#define RTC_IO_PDAC1_DRV_M  ((RTC_IO_PDAC1_DRV_V) << \
                             (RTC_IO_PDAC1_DRV_S))
...
/* Description: Power on DAC1. Usually we need to tristate PDAC1 if we
 * power on the DAC  i.e. IE=0  OE=0  RDE=0  RUE=0
 */
...
#define RTC_IO_PDAC1_FUN_SEL_M  ((RTC_IO_PDAC1_FUN_SEL_V) << \
...
#define RTC_IO_PDAC2_DRV_M  ((RTC_IO_PDAC2_DRV_V) << \
                             (RTC_IO_PDAC2_DRV_S))
...
#define RTC_IO_PDAC2_DAC_M  ((RTC_IO_PDAC2_DAC_V) << \
                             (RTC_IO_PDAC2_DAC_S))
...
/* Description: Power on DAC2. Usually we need to tristate PDAC1 if we
 * power on the DAC  i.e. IE=0  OE=0  RDE=0  RUE=0
 */
...
#define RTC_IO_PDAC2_FUN_SEL_M  ((RTC_IO_PDAC2_FUN_SEL_V) << \
...
/* Description: Power on DAC2. Usually we need to tristate PDAC2 if we
 * power on the DAC  i.e. IE=0  OE=0  RDE=0  RUE=0
 */
...
#define RTC_IO_X32N_DRV_M  ((RTC_IO_X32N_DRV_V) << \
                            (RTC_IO_X32N_DRV_S))
...
#define RTC_IO_X32P_DRV_M  ((RTC_IO_X32P_DRV_V) << \
                            (RTC_IO_X32P_DRV_S))
...
#define RTC_IO_X32N_FUN_SEL_M  ((RTC_IO_X32N_FUN_SEL_V) << \
...
#define RTC_IO_X32P_FUN_SEL_M  ((RTC_IO_X32P_FUN_SEL_V) << \
...
#define RTC_IO_DRES_XTAL_32K_M  ((RTC_IO_DRES_XTAL_32K_V) << \
...
#define RTC_IO_DBIAS_XTAL_32K_M  ((RTC_IO_DBIAS_XTAL_32K_V) << \
...
#define RTC_IO_TOUCH_DREFH_M  ((RTC_IO_TOUCH_DREFH_V) << \
...
#define RTC_IO_TOUCH_DREFL_M  ((RTC_IO_TOUCH_DREFL_V) << \
...
#define RTC_IO_TOUCH_DRANGE_M  ((RTC_IO_TOUCH_DRANGE_V) << \
...
#define RTC_IO_TOUCH_DCUR_M  ((RTC_IO_TOUCH_DCUR_V) << \
                              (RTC_IO_TOUCH_DCUR_S))
...
#define RTC_IO_TOUCH_PAD0_DRV_M  ((RTC_IO_TOUCH_PAD0_DRV_V) << \
...
/* Description: touch sensor slope control. 3-bit for each touch panel
 * default 100.
 */
...
#define RTC_IO_TOUCH_PAD0_FUN_SEL_M  ((RTC_IO_TOUCH_PAD0_FUN_SEL_V) << \
...
/* Description: connect the rtc pad input to digital pad input '0' is
 * available GPIO4
 */
...
#define RTC_IO_TOUCH_PAD1_DRV_M  ((RTC_IO_TOUCH_PAD1_DRV_V) << \
...
#define RTC_IO_TOUCH_PAD1_DAC_M  ((RTC_IO_TOUCH_PAD1_DAC_V) << \
...
#define RTC_IO_TOUCH_PAD1_FUN_SEL_M  ((RTC_IO_TOUCH_PAD1_FUN_SEL_V) << \
...
#define RTC_IO_TOUCH_PAD2_DRV_M  ((RTC_IO_TOUCH_PAD2_DRV_V) << \
...
#define RTC_IO_TOUCH_PAD2_DAC_M  ((RTC_IO_TOUCH_PAD2_DAC_V) << \
...
#define RTC_IO_TOUCH_PAD2_FUN_SEL_M  ((RTC_IO_TOUCH_PAD2_FUN_SEL_V) << \
...
#define RTC_IO_TOUCH_PAD3_DRV_M  ((RTC_IO_TOUCH_PAD3_DRV_V) << \
...
#define RTC_IO_TOUCH_PAD3_DAC_M  ((RTC_IO_TOUCH_PAD3_DAC_V) << \
...
#define RTC_IO_TOUCH_PAD3_FUN_SEL_M  ((RTC_IO_TOUCH_PAD3_FUN_SEL_V) << \
...
#define RTC_IO_TOUCH_PAD4_DRV_M  ((RTC_IO_TOUCH_PAD4_DRV_V) << \
...
#define RTC_IO_TOUCH_PAD4_DAC_M  ((RTC_IO_TOUCH_PAD4_DAC_V) << \
...
#define RTC_IO_TOUCH_PAD4_FUN_SEL_M  ((RTC_IO_TOUCH_PAD4_FUN_SEL_V) << \
...
#define RTC_IO_TOUCH_PAD5_DRV_M  ((RTC_IO_TOUCH_PAD5_DRV_V) << \
...
#define RTC_IO_TOUCH_PAD5_DAC_M  ((RTC_IO_TOUCH_PAD5_DAC_V) << \
...
#define RTC_IO_TOUCH_PAD5_FUN_SEL_M  ((RTC_IO_TOUCH_PAD5_FUN_SEL_V) << \
...
#define RTC_IO_TOUCH_PAD6_DRV_M  ((RTC_IO_TOUCH_PAD6_DRV_V) << \
...
#define RTC_IO_TOUCH_PAD6_DAC_M  ((RTC_IO_TOUCH_PAD6_DAC_V) << \
...
#define RTC_IO_TOUCH_PAD6_FUN_SEL_M  ((RTC_IO_TOUCH_PAD6_FUN_SEL_V) << \
...
#define RTC_IO_TOUCH_PAD7_DRV_M  ((RTC_IO_TOUCH_PAD7_DRV_V) << \
...
#define RTC_IO_TOUCH_PAD7_DAC_M  ((RTC_IO_TOUCH_PAD7_DAC_V) << \
...
#define RTC_IO_TOUCH_PAD7_FUN_SEL_M  ((RTC_IO_TOUCH_PAD7_FUN_SEL_V) << \
...
#define RTC_IO_TOUCH_PAD8_DAC_M  ((RTC_IO_TOUCH_PAD8_DAC_V) << \
...
#define RTC_IO_TOUCH_PAD9_DAC_M  ((RTC_IO_TOUCH_PAD9_DAC_V) << \
...
/* Description: select the wakeup source
 * '0' select GPIO0
 * '1' select GPIO2 ... '17' select GPIO17
 */

#define RTC_IO_EXT_WAKEUP0_SEL    0x0000001f
#define RTC_IO_EXT_WAKEUP0_SEL_M  ((RTC_IO_EXT_WAKEUP0_SEL_V) << \
...
/* Description: select the external xtl power source
 * '0' select GPIO0
 * '1' select GPIO2 ... '17' select GPIO17
 */

#define RTC_IO_XTL_EXT_CTR_SEL    0x0000001f
#define RTC_IO_XTL_EXT_CTR_SEL_M  ((RTC_IO_XTL_EXT_CTR_SEL_V) << \
...
/* Description:
 * '0' using TOUCH_PAD[1] as i2c sda
 * '1' using TOUCH_PAD[3] as i2c sda
 */

#define RTC_IO_SAR_I2C_SDA_SEL    0x00000003
#define RTC_IO_SAR_I2C_SDA_SEL_M  ((RTC_IO_SAR_I2C_SDA_SEL_V) << \
...
/* Description:
 * '0' using TOUCH_PAD[0] as i2c clk
 * '1' using TOUCH_PAD[2] as i2c clk
 */

#define RTC_IO_SAR_I2C_SCL_SEL    0x00000003
#define RTC_IO_SAR_I2C_SCL_SEL_M  ((RTC_IO_SAR_I2C_SCL_SEL_V) << \
...
#define RTC_IO_SAR_DEBUG_BIT_SEL_M  ((RTC_IO_SAR_DEBUG_BIT_SEL_V) << \
