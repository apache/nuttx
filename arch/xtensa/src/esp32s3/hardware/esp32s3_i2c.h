/****************************************************************************
 * arch/xtensa/src/esp32s3/hardware/esp32s3_i2c.h
 *
...
#ifndef __ARCH_XTENSA_SRC_ESP32S3_HARDWARE_ESP32S3_I2C_H
#define __ARCH_XTENSA_SRC_ESP32S3_HARDWARE_ESP32S3_I2C_H
...
#define I2C_ADDR_BROADCASTING_EN_V  0x00000001
...
#define I2C_ADDR_10BIT_RW_CHECK_EN_V  0x00000001
...
#define I2C_TXFIFO_WADDR_V  0x0000001f
...
#define I2C_RXFIFO_RADDR_V  0x0000001f
 ...
 * The control enable bit of FIFO pointer in non-fifo access mode. This bit
 * controls the valid bits and the interrupts of tx/rx_fifo overflow,
...
#define I2C_GENERAL_CALL_INT_RAW_V  0x00000001
...
#define I2C_GENERAL_CALL_INT_CLR_V  0x00000001
...
#define I2C_GENERAL_CALL_INT_ENA_V  0x00000001
...
#define I2C_GENERAL_CALL_INT_ST_V  0x00000001
 ...
 * This register is used to configure the time to hold the data after the
 * negative
 ...
 * This register is used to configure for how long SDA is sampled, in I2C
 * module clock cycles.
 */
 ...
 * SCL high level in master mode, in I2C module clock cycles.
 */
 ...
 * of SDA and the negative edge of SCL for a START condition, in I2C module
 * clock cycles.
 */
 ...
 * edge of SCL and the negative edge of SDA for a RESTART condition, in I2C
 * module clock cycles.
 */
 ...
 * the denominator of the fractional part of the fractional divisor for i2c
 * module
 */
 ...
 * the numerator of the fractional part of the fractional divisor for i2c
 * module
 */
 ...
 * The threshold value of SCL_MAIN_FSM state unchanged period.nIt should be
 * o more than 23
 */
 ...
 * Not power down. Set reg_sda_force_out and reg_sda_pd_en to 1 to stretch
 * SDA low.
 */
 ...
 * Not power down. Set reg_scl_force_out and reg_scl_pd_en to 1 to stretch
 * SCL low.
 */
 ...
 * of pulses equals to reg_scl_rst_slv_num[4:0].
 */
...
#define I2C_SLAVE_BYTE_ACK_LVL_V  0x00000001
...
#define I2C_SLAVE_BYTE_ACK_CTL_EN_V  0x00000001
 ...
 * SCL output line will be stretched low when reg_slave_scl_stretch_en is 1
...
#endif /* __ARCH_XTENSA_SRC_ESP32S3_HARDWARE_ESP32S3_I2C_H */
