/****************************************************************************
 * arch/tricore/src/tc4xx/tc4xx_serial.c
 *
...
#if defined(CONFIG_UART0_SERIAL_CONSOLE) && defined(CONFIG_TC4XX_UART0)
