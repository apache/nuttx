/****************************************************************************
 * arch/sparc/src/bm3823/bm3823_timerisr.c
 *
...
#define TIMCTR_Enable_counter               (1 << 0)  /* Bit 0: enables the timer when set */
#define TIMCTR_Auto_Reload            	    (1 << 1)  /* Bit 1: automatically reloaded with the reload value after each underflow */
#define TIMCTR_Load_counter                 (1 << 2)  /* Bit 2: Set 1, will load the timer reload register into the timer counter register */
/****************************************************************************
 * Private Functions
 ****************************************************************************/
...
{
  EXTER_REG.ScalerLoad = (BOARD_PERIPH_CLOCK/BM3823_TIMER_CLOCK) -1;
  EXTER_REG.ScalerCnt  = (BOARD_PERIPH_CLOCK/BM3823_TIMER_CLOCK) -1;
  /* Setup timer 1 compare match A to generate a tick interrupt.
   *
   * First, setup the match value for compare match A.
   */
  EXTER_REG.TimerCnt1 = (uint32_t)MATCH1;
  EXTER_REG.TimerLoad1  = (uint32_t)MATCH1;

  EXTER_REG.TimerCtrl1 = (TIMCTR_Enable_counter | TIMCTR_Auto_Reload | TIMCTR_Load_counter);
