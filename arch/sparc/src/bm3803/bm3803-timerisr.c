/****************************************************************************
 * arch/sparc/src/bm3803/bm3803_timerisr.c
 *
...
{
  BM3803_REG.ScalerLoad = (BOARD_CPU_CLOCK/BM3803_TIMER_CLOCK) -1;
  BM3803_REG.ScalerCnt  = (BOARD_CPU_CLOCK/BM3803_TIMER_CLOCK) -1;
  /* Setup timer 1 compare match A to generate a tick interrupt.
   *
   * First, setup the match value for compare match A.
   */
  BM3803_REG.TimerCnt1 = (uint32_t)MATCH1;
  BM3803_REG.TimerLoad1  = (uint32_t)MATCH1;

  BM3803_REG.TimerCtrl1 = (TIMCTR_Enable_counter | TIMCTR_Auto_Reload | TIMCTR_Load_counter);
