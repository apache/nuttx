...
#define BM3803_REG_TIMER_CONTROL_EN    0x00000001  /* 1 = enable counting */
                                              /* 0 = hold scalar and counter */
#define BM3803_REG_TIMER_CONTROL_RL    0x00000002  /* 1 = reload at 0 */
                                              /* 0 = stop at 0 */
#define BM3803_REG_TIMER_CONTROL_LD    0x00000004  /* 1 = load counter */
                                              /* 0 = no function */
...
typedef struct {
	...
	volatile unsigned int IntPend;		 //Interrupt Pending Register register
	volatile unsigned int IntForce;
	volatile unsigned int IntClear;		 //Interrupt Clear Register register
