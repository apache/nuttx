...
static int bm3803_timer_handler(int irq, void *context, void *arg)
{
  FAR struct bm3803_lowerhalf_s *lower = (FAR struct bm3803_lowerhalf_s *) arg;
...
static int bm3803_start(FAR struct timer_lowerhalf_s *lower)
{
  FAR struct bm3803_lowerhalf_s *priv = (FAR struct bm3803_lowerhalf_s *)lower;
                             ...
                             FAR struct timer_status_s *status)
{
  ...
  status->timeleft = (timeout - BM3803_TIM_GETCOUNTER(priv->tim)) * clock_factor;
  return OK;
}
