                              ...
                              uint32_t timeout)
{
  ...
  prescaler = 0x3FF & bm3803_getreg(BM3803_TIM12PRE_BASE + BM3803_TIM_PSCLOAD_OFFSET);
...
void bm3803_wdginitialize(FAR const char *devpath)
{
  ...
  bm3803_settimeout((FAR struct watchdog_lowerhalf_s *)priv, CONFIG_BM3803_WDG_DEFTIMOUT);
