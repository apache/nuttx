...
#ifndef __ARCH_RISCV_SRC_ESP32C3_HARDWARE_ESP32C3_SPI_H
#define __ARCH_RISCV_SRC_ESP32C3_HARDWARE_ESP32C3_SPI_H
...
#define SPI_CMD_REG (DR_REG_SPI2_BASE + 0x0)
 ...
 * Set this bit to synchronize SPI registers from APB clock domain into SPI
 * module clock domain, which is only used in SPI master mode.
 */

#define SPI_UPDATE    (BIT(23))
#define SPI_UPDATE_M  (SPI_UPDATE_V << SPI_UPDATE_S)
#define SPI_UPDATE_V  0x00000001
...
#define SPI_CONF_BITLEN_V  0x0003FFFF
...
#define SPI_ADDR_REG (DR_REG_SPI2_BASE + 0x4)
 ...
 * In read-data (MISO) phase 1: LSB first 0: MSB first. Can be configured in
 * CONF state.
 */
 ...
 * Apply 4 signals during addr phase 1:enable 0: disable. Can be configured
 * in CONF state.
 */
 ...
 * Apply 2 signals during addr phase 1:enable 0: disable. Can be configured
 * in CONF state.
 */
 ...
 * This bit enable the command phase of an operation. Can be configured in
 * CONF state.
 */
 ...
 * This bit enable the address phase of an operation. Can be configured in
 * CONF state.
 */
 ...
 * seg-trans or this is not seg-trans mode. Can be configured in CONF state.
 */
...
#define SPI_CS_HOLD_TIME_V  0x0000001F
...
#define SPI_CS_SETUP_TIME_V  0x0000001F
#define SPI_CS_SETUP_TIME_S  17

/* SPI_MST_WFULL_ERR_END_EN : R/W; bitpos: [16]; default: 1;
 * 1: SPI transfer is ended when SPI RX AFIFO wfull error is valid in GP-SPI
 * master FD/HD-mode. 0: SPI transfer is not ended when SPI RX AFIFO wfull
...
#define SPI_MST_WFULL_ERR_END_EN_V  0x00000001
 ...
 * 1: SPI transfer is ended when SPI TX AFIFO read empty error is valid in
 * GP-SPI master FD/HD-mode. 0: SPI transfer is not ended when SPI TX AFIFO
 * read empty error is valid in GP-SPI master FD/HD-mode.
 */
...
#define SPI_MST_REMPTY_ERR_END_EN_V  0x00000001
 ...
 * length in master mode DMA controlled transfer or CPU controlled transfer.
 * The value is also the configured bit length in slave mode DMA RX
 * controlled transfer. The register value shall be (bit_num-1). Can be
 * configured in CONF state.
 */

#define SPI_MS_DATA_BITLEN    0x0003FFFF
#define SPI_MS_DATA_BITLEN_M  (SPI_MS_DATA_BITLEN_V << SPI_MS_DATA_BITLEN_S)
#define SPI_MS_DATA_BITLEN_V  0x0003FFFF
 ...
 * 1: spi clk out disable,  0: spi clk out enable. Can be configured in CONF
 * state.
 */
 ...
 * SPI CS$n pin enable, 1: disable CS$n, 0: spi_cs$n signal is from/to CS$n
...
#define SPI_DIN_MODE_REG (DR_REG_SPI2_BASE + 0x24)
...
#define SPI_TIMING_HCLK_ACTIVE_V  0x00000001
 ...
 * without delayed, 1: input with the posedge of clk_apb,2 input with the
 * negedge of clk_apb, 3: input with the spi_clk. Can be configured in CONF
 * state.
 */

#define SPI_DIN3_MODE    0x00000003
#define SPI_DIN3_MODE_M  (SPI_DIN3_MODE_V << SPI_DIN3_MODE_S)
#define SPI_DIN3_MODE_V  0x00000003
...
#define SPI_DIN2_MODE_V  0x00000003
...
#define SPI_DIN1_MODE_V  0x00000003
...
#define SPI_DIN0_MODE_V  0x00000003
...
#define SPI_DIN_NUM_REG (DR_REG_SPI2_BASE + 0x28)

/* SPI_DIN3_NUM : R/W; bitpos: [7:6]; default: 0;
 * the input signals are delayed by SPI module clock cycles, 0: delayed by 1
 * cycle, 1: delayed by 2 cycles,...  Can be configured in CONF state.
 */
...
#define SPI_DOUT_MODE_REG (DR_REG_SPI2_BASE + 0x2c)

/* SPI_DOUT3_MODE : R/W; bitpos: [3]; default: 0;
 * The output signal $n is delayed by the SPI module clock, 0: output
...
#define SPI_DOUT3_MODE_V  0x00000001
...
#define SPI_DOUT2_MODE_V  0x00000001
...
#define SPI_DOUT1_MODE_V  0x00000001
...
#define SPI_DOUT0_MODE_V  0x00000001
...
#define SPI_DMA_CONF_REG (DR_REG_SPI2_BASE + 0x30)

/* SPI_DMA_AFIFO_RST : WT; bitpos: [31]; default: 0;
 * Set this bit to reset DMA TX AFIFO, which is used to send data out in SPI
 * slave DMA controlled mode transfer.
 */

#define SPI_DMA_AFIFO_RST    (BIT(31))
#define SPI_DMA_AFIFO_RST_M  (SPI_DMA_AFIFO_RST_V << SPI_DMA_AFIFO_RST_S)
#define SPI_DMA_AFIFO_RST_V  0x00000001
#define SPI_DMA_AFIFO_RST_S  31

/* SPI_BUF_AFIFO_RST : WT; bitpos: [30]; default: 0;
 * Set this bit to reset BUF TX AFIFO, which is used send data out in SPI
 * slave CPU controlled mode transfer and master mode transfer.
 */

#define SPI_BUF_AFIFO_RST    (BIT(30))
#define SPI_BUF_AFIFO_RST_M  (SPI_BUF_AFIFO_RST_V << SPI_BUF_AFIFO_RST_S)
#define SPI_BUF_AFIFO_RST_V  0x00000001
#define SPI_BUF_AFIFO_RST_S  30

/* SPI_RX_AFIFO_RST : WT; bitpos: [29]; default: 0;
 * Set this bit to reset RX AFIFO, which is used to receive data in SPI
 * master and slave mode transfer.
 */

#define SPI_RX_AFIFO_RST    (BIT(29))
#define SPI_RX_AFIFO_RST_M  (SPI_RX_AFIFO_RST_V << SPI_RX_AFIFO_RST_S)
#define SPI_RX_AFIFO_RST_V  0x00000001
...
#define SPI_RX_EOF_EN_V  0x00000001
...
#define SPI_APP1_INT_ENA_V  0x00000001
...
#define SPI_APP2_INT_ENA_V  0x00000001
...
#define SPI_MST_TX_AFIFO_REMPTY_ERR_INT_ENA_V  0x00000001
...
#define SPI_MST_RX_AFIFO_WFULL_ERR_INT_ENA_V  0x00000001
...
#define SPI_SLV_CMD_ERR_INT_ENA_V  0x00000001
...
#define SPI_SLV_BUF_ADDR_ERR_INT_ENA_V  0x00000001
...
#define SPI_SEG_MAGIC_ERR_INT_ENA_V  0x00000001
...
#define SPI_DMA_SEG_TRANS_DONE_INT_ENA_V  0x00000001
...
#define SPI_TRANS_DONE_INT_ENA_V  0x00000001
...
#define SPI_SLV_WR_BUF_DONE_INT_ENA_V  0x00000001
...
#define SPI_SLV_RD_BUF_DONE_INT_ENA_V  0x00000001
...
#define SPI_SLV_WR_DMA_DONE_INT_ENA_V  0x00000001
...
#define SPI_SLV_RD_DMA_DONE_INT_ENA_V  0x00000001
...
#define SPI_SLV_CMDA_INT_ENA_V  0x00000001
...
#define SPI_SLV_CMD9_INT_ENA_V  0x00000001
...
#define SPI_SLV_CMD8_INT_ENA_V  0x00000001
...
#define SPI_SLV_CMD7_INT_ENA_V  0x00000001
...
#define SPI_SLV_EN_QPI_INT_ENA_V  0x00000001
...
#define SPI_SLV_EX_QPI_INT_ENA_V  0x00000001
...
#define SPI_DMA_OUTFIFO_EMPTY_ERR_INT_ENA_V  0x00000001
...
#define SPI_DMA_INFIFO_FULL_ERR_INT_ENA_V  0x00000001
...
#define SPI_APP1_INT_CLR_V  0x00000001
...
#define SPI_APP2_INT_CLR_V  0x00000001
...
#define SPI_MST_TX_AFIFO_REMPTY_ERR_INT_CLR_V  0x00000001
...
#define SPI_MST_RX_AFIFO_WFULL_ERR_INT_CLR_V  0x00000001
...
#define SPI_SLV_CMD_ERR_INT_CLR_V  0x00000001
...
#define SPI_SLV_BUF_ADDR_ERR_INT_CLR_V  0x00000001
...
#define SPI_SEG_MAGIC_ERR_INT_CLR_V  0x00000001
...
#define SPI_DMA_SEG_TRANS_DONE_INT_CLR_V  0x00000001
...
#define SPI_TRANS_DONE_INT_CLR_V  0x00000001
...
#define SPI_SLV_WR_BUF_DONE_INT_CLR_V  0x00000001
...
#define SPI_SLV_RD_BUF_DONE_INT_CLR_V  0x00000001
...
#define SPI_SLV_WR_DMA_DONE_INT_CLR_V  0x00000001
...
#define SPI_SLV_RD_DMA_DONE_INT_CLR_V  0x00000001
...
#define SPI_SLV_CMDA_INT_CLR_V  0x00000001
...
#define SPI_SLV_CMD9_INT_CLR_V  0x00000001
...
#define SPI_SLV_CMD8_INT_CLR_V  0x00000001
...
#define SPI_SLV_CMD7_INT_CLR_V  0x00000001
...
#define SPI_SLV_EN_QPI_INT_CLR_V  0x00000001
...
#define SPI_SLV_EX_QPI_INT_CLR_V  0x00000001
...
#define SPI_DMA_OUTFIFO_EMPTY_ERR_INT_CLR_V  0x00000001
...
#define SPI_DMA_INFIFO_FULL_ERR_INT_CLR_V  0x00000001
...
/* SPI_APP1_INT_RAW : R/W/WTC; bitpos: [20]; default: 0;
...
#define SPI_APP1_INT_RAW_V  0x00000001
#define SPI_APP1_INT_RAW_S  20

/* SPI_APP2_INT_RAW : R/W/WTC; bitpos: [19]; default: 0;
...
#define SPI_APP2_INT_RAW_V  0x00000001
#define SPI_APP2_INT_RAW_S  19

/* SPI_MST_TX_AFIFO_REMPTY_ERR_INT_RAW : R/W/WTC/SS; bitpos: [18]; default:
 * 0;
 * The raw bit for SPI_MST_TX_AFIFO_REMPTY_ERR_INT interrupt. 1: There is a
 * TX BUF AFIFO read-empty error when SPI outputs data in master mode. 0:
 * Others.
 */
...
#define SPI_MST_TX_AFIFO_REMPTY_ERR_INT_RAW_V  0x00000001
#define SPI_MST_TX_AFIFO_REMPTY_ERR_INT_RAW_S  18

/* SPI_MST_RX_AFIFO_WFULL_ERR_INT_RAW : R/W/WTC/SS; bitpos: [17]; default: 0;
 * The raw bit for SPI_MST_RX_AFIFO_WFULL_ERR_INT interrupt. 1: There is a
 * RX AFIFO write-full error when SPI inputs data in master mode. 0: Others.
 */
...
/* SPI_SLV_CMD_ERR_INT_RAW : R/W/WTC/SS; bitpos: [16]; default: 0;
 * The raw bit for SPI_SLV_CMD_ERR_INT interrupt. 1: The slave command value
 * in the current SPI slave HD mode transmission is not supported. 0: Others.
 */
...
#define SPI_SLV_CMD_ERR_INT_RAW_V  0x00000001
#define SPI_SLV_CMD_ERR_INT_RAW_S  16

/* SPI_SLV_BUF_ADDR_ERR_INT_RAW : R/W/WTC/SS; bitpos: [15]; default: 0;
...
#define SPI_SLV_BUF_ADDR_ERR_INT_RAW_V  0x00000001
#define SPI_SLV_BUF_ADDR_ERR_INT_RAW_S  15

/* SPI_SEG_MAGIC_ERR_INT_RAW : R/W/WTC/SS; bitpos: [14]; default: 0;
 * The raw bit for SPI_SEG_MAGIC_ERR_INT interrupt. 1: The magic value in
 * CONF buffer is error in the DMA seg-conf-trans. 0: others.
 */
...
#define SPI_SEG_MAGIC_ERR_INT_RAW_V  0x00000001
#define SPI_SEG_MAGIC_ERR_INT_RAW_S  14

/* SPI_DMA_SEG_TRANS_DONE_INT_RAW : R/W/WTC/SS; bitpos: [13]; default: 0;
 * The raw bit for SPI_DMA_SEG_TRANS_DONE_INT interrupt. 1:  spi master DMA
 * full-duplex/half-duplex seg-conf-trans ends or slave half-duplex
...
#define SPI_DMA_SEG_TRANS_DONE_INT_RAW_V  0x00000001
#define SPI_DMA_SEG_TRANS_DONE_INT_RAW_S  13

/* SPI_TRANS_DONE_INT_RAW : R/W/WTC/SS; bitpos: [12]; default: 0;
...
#define SPI_TRANS_DONE_INT_RAW_V  0x00000001
#define SPI_TRANS_DONE_INT_RAW_S  12

/* SPI_SLV_WR_BUF_DONE_INT_RAW : R/W/WTC/SS; bitpos: [11]; default: 0;
...
#define SPI_SLV_WR_BUF_DONE_INT_RAW_V  0x00000001
#define SPI_SLV_WR_BUF_DONE_INT_RAW_S  11

/* SPI_SLV_RD_BUF_DONE_INT_RAW : R/W/WTC/SS; bitpos: [10]; default: 0;
...
#define SPI_SLV_RD_BUF_DONE_INT_RAW_V  0x00000001
#define SPI_SLV_RD_BUF_DONE_INT_RAW_S  10

/* SPI_SLV_WR_DMA_DONE_INT_RAW : R/W/WTC/SS; bitpos: [9]; default: 0;
...
#define SPI_SLV_WR_DMA_DONE_INT_RAW_V  0x00000001
#define SPI_SLV_WR_DMA_DONE_INT_RAW_S  9

/* SPI_SLV_RD_DMA_DONE_INT_RAW : R/W/WTC/SS; bitpos: [8]; default: 0;
...
#define SPI_SLV_RD_DMA_DONE_INT_RAW_V  0x00000001
#define SPI_SLV_RD_DMA_DONE_INT_RAW_S  8

/* SPI_SLV_CMDA_INT_RAW : R/W/WTC/SS; bitpos: [7]; default: 0;
...
#define SPI_SLV_CMDA_INT_RAW_V  0x00000001
#define SPI_SLV_CMDA_INT_RAW_S  7

/* SPI_SLV_CMD9_INT_RAW : R/W/WTC/SS; bitpos: [6]; default: 0;
...
#define SPI_SLV_CMD9_INT_RAW_V  0x00000001
#define SPI_SLV_CMD9_INT_RAW_S  6

/* SPI_SLV_CMD8_INT_RAW : R/W/WTC/SS; bitpos: [5]; default: 0;
...
#define SPI_SLV_CMD8_INT_RAW_V  0x00000001
#define SPI_SLV_CMD8_INT_RAW_S  5

/* SPI_SLV_CMD7_INT_RAW : R/W/WTC/SS; bitpos: [4]; default: 0;
...
#define SPI_SLV_CMD7_INT_RAW_V  0x00000001
#define SPI_SLV_CMD7_INT_RAW_S  4

/* SPI_SLV_EN_QPI_INT_RAW : R/W/WTC/SS; bitpos: [3]; default: 0;
...
#define SPI_SLV_EN_QPI_INT_RAW_V  0x00000001
#define SPI_SLV_EN_QPI_INT_RAW_S  3

/* SPI_SLV_EX_QPI_INT_RAW : R/W/WTC/SS; bitpos: [2]; default: 0;
...
#define SPI_SLV_EX_QPI_INT_RAW_V  0x00000001
#define SPI_SLV_EX_QPI_INT_RAW_S  2

/* SPI_DMA_OUTFIFO_EMPTY_ERR_INT_RAW : R/W/WTC/SS; bitpos: [1]; default: 0;
 * 1: The current data rate of DMA TX is smaller than that of SPI. SPI will
 * stop in master mode and send out all 0 in slave mode.  0: Others.
 */
...
#define SPI_DMA_OUTFIFO_EMPTY_ERR_INT_RAW_V  0x00000001
#define SPI_DMA_OUTFIFO_EMPTY_ERR_INT_RAW_S  1

/* SPI_DMA_INFIFO_FULL_ERR_INT_RAW : R/W/WTC/SS; bitpos: [0]; default: 0;
...
#define SPI_DMA_INFIFO_FULL_ERR_INT_RAW_V  0x00000001
...
#define SPI_DMA_INT_ST_REG (DR_REG_SPI2_BASE + 0x40)
...
#define SPI_APP1_INT_ST_V  0x00000001
...
#define SPI_APP2_INT_ST_V  0x00000001
...
#define SPI_MST_TX_AFIFO_REMPTY_ERR_INT_ST_V  0x00000001
...
#define SPI_MST_RX_AFIFO_WFULL_ERR_INT_ST_V  0x00000001
...
#define SPI_SLV_CMD_ERR_INT_ST_V  0x00000001
...
#define SPI_SLV_BUF_ADDR_ERR_INT_ST_V  0x00000001
...
#define SPI_SEG_MAGIC_ERR_INT_ST_V  0x00000001
...
#define SPI_DMA_SEG_TRANS_DONE_INT_ST_V  0x00000001
...
#define SPI_TRANS_DONE_INT_ST_V  0x00000001
...
#define SPI_SLV_WR_BUF_DONE_INT_ST_V  0x00000001
...
#define SPI_SLV_RD_BUF_DONE_INT_ST_V  0x00000001
...
#define SPI_SLV_WR_DMA_DONE_INT_ST_V  0x00000001
...
#define SPI_SLV_RD_DMA_DONE_INT_ST_V  0x00000001
...
#define SPI_SLV_CMDA_INT_ST_V  0x00000001
...
#define SPI_SLV_CMD9_INT_ST_V  0x00000001
...
#define SPI_SLV_CMD8_INT_ST_V  0x00000001
...
#define SPI_SLV_CMD7_INT_ST_V  0x00000001
...
#define SPI_SLV_EN_QPI_INT_ST_V  0x00000001
...
#define SPI_SLV_EX_QPI_INT_ST_V  0x00000001
...
#define SPI_DMA_OUTFIFO_EMPTY_ERR_INT_ST_V  0x00000001
...
#define SPI_DMA_INFIFO_FULL_ERR_INT_ST_V  0x00000001
...
#define SPI_W0_REG (DR_REG_SPI2_BASE + 0x98)
...
#define SPI_W1_REG (DR_REG_SPI2_BASE + 0x9c)
...
#define SPI_W2_REG (DR_REG_SPI2_BASE + 0xa0)
...
#define SPI_W3_REG (DR_REG_SPI2_BASE + 0xa4)
...
#define SPI_W4_REG (DR_REG_SPI2_BASE + 0xa8)
...
#define SPI_W5_REG (DR_REG_SPI2_BASE + 0xac)
...
#define SPI_W6_REG (DR_REG_SPI2_BASE + 0xb0)
...
#define SPI_W7_REG (DR_REG_SPI2_BASE + 0xb4)
...
#define SPI_W8_REG (DR_REG_SPI2_BASE + 0xb8)
...
#define SPI_W9_REG (DR_REG_SPI2_BASE + 0xbc)
...
#define SPI_W10_REG (DR_REG_SPI2_BASE + 0xc0)
...
#define SPI_W11_REG (DR_REG_SPI2_BASE + 0xc4)
...
#define SPI_W12_REG (DR_REG_SPI2_BASE + 0xc8)
...
#define SPI_W13_REG (DR_REG_SPI2_BASE + 0xcc)
...
#define SPI_W14_REG (DR_REG_SPI2_BASE + 0xd0)
...
#define SPI_W15_REG (DR_REG_SPI2_BASE + 0xd4)
...
#define SPI_SLAVE_REG (DR_REG_SPI2_BASE + 0xe0)
...
#define SPI_DMA_SEG_MAGIC_VALUE_V  0x0000000F
#define SPI_DMA_SEG_MAGIC_VALUE_S  22

/* SPI_SLV_WRBUF_BITLEN_EN : R/W; bitpos: [11]; default: 0;
 * 1: SPI_SLV_DATA_BITLEN stores data bit length of master-write-to-slave
...
#define SPI_SLV_WRBUF_BITLEN_EN_V  0x00000001
#define SPI_SLV_WRBUF_BITLEN_EN_S  11

/* SPI_SLV_RDBUF_BITLEN_EN : R/W; bitpos: [10]; default: 0;
 * 1: SPI_SLV_DATA_BITLEN stores data bit length of master-read-slave data
...
#define SPI_SLV_RDBUF_BITLEN_EN_V  0x00000001
...
#define SPI_SLV_WRDMA_BITLEN_EN_V  0x00000001
...
#define SPI_SLV_RDDMA_BITLEN_EN_V  0x00000001
...
#define SPI_SLAVE1_REG (DR_REG_SPI2_BASE + 0xe4)
...
#define SPI_SLV_LAST_ADDR_V  0x0000003F
...
#define SPI_SLV_DATA_BITLEN_V  0x0003FFFF
...
#define SPI_CLK_GATE_REG (DR_REG_SPI2_BASE + 0xe8)
...
#define SPI_MST_CLK_SEL_V  0x00000001
...
#define SPI_MST_CLK_ACTIVE_V  0x00000001
...
#define SPI_CLK_EN_V  0x00000001
...
#define SPI_DATE_REG (DR_REG_SPI2_BASE + 0xf0)

/* SPI_DATE : R/W; bitpos: [27:0]; default: 33583648;
...
#endif /* __ARCH_RISCV_SRC_ESP32C3_HARDWARE_ESP32C3_SPI_H */
