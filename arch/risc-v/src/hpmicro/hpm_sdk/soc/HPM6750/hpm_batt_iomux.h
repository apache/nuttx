...
#define IOC_PZ08_FUNC_CTL_TAMP_08              IOC_PAD_FUNC_CTL_ALT_SELECT_SET(2)
#define IOC_PZ08_FUNC_CTL_SOC_PZ_08            IOC_PAD_FUNC_CTL_ALT_SELECT_SET(3)

/* IOC_PZ09_FUNC_CTL function mux definitions */
#define IOC_PZ09_FUNC_CTL_BGPIO_Z_09           IOC_PAD_FUNC_CTL_ALT_SELECT_SET(0)
#define IOC_PZ09_FUNC_CTL_TAMP_09              IOC_PAD_FUNC_CTL_ALT_SELECT_SET(2)
#define IOC_PZ09_FUNC_CTL_SOC_PZ_09            IOC_PAD_FUNC_CTL_ALT_SELECT_SET(3)

/* IOC_PZ10_FUNC_CTL function mux definitions */
#define IOC_PZ10_FUNC_CTL_BGPIO_Z_10           IOC_PAD_FUNC_CTL_ALT_SELECT_SET(0)
#define IOC_PZ10_FUNC_CTL_HIBERNATE            IOC_PAD_FUNC_CTL_ALT_SELECT_SET(1)
#define IOC_PZ10_FUNC_CTL_TAMP_10              IOC_PAD_FUNC_CTL_ALT_SELECT_SET(2)
#define IOC_PZ10_FUNC_CTL_SOC_PZ_10            IOC_PAD_FUNC_CTL_ALT_SELECT_SET(3)

/* IOC_PZ11_FUNC_CTL function mux definitions */
#define IOC_PZ11_FUNC_CTL_BGPIO_Z_11           IOC_PAD_FUNC_CTL_ALT_SELECT_SET(0)
#define IOC_PZ11_FUNC_CTL_STANDBY              IOC_PAD_FUNC_CTL_ALT_SELECT_SET(1)
#define IOC_PZ11_FUNC_CTL_TAMP_11              IOC_PAD_FUNC_CTL_ALT_SELECT_SET(2)
#define IOC_PZ11_FUNC_CTL_SOC_PZ_11            IOC_PAD_FUNC_CTL_ALT_SELECT_SET(3)
