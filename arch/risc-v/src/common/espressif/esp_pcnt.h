...
struct pcnt_dev_s *esp_pcnt_new_unit(struct esp_pcnt_unit_config_s *config);
...
int esp_pcnt_del_unit(struct pcnt_dev_s *dev);
...
int esp_pcnt_unit_add_watch_point(struct pcnt_dev_s *dev, int watch_point);
...
int esp_pcnt_unit_remove_watch_point(struct pcnt_dev_s *dev,
                                     int watch_point);
...
int esp_pcnt_new_channel(struct pcnt_dev_s *dev,
