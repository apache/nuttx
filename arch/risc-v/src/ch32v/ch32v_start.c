/****************************************************************************
 * arch/risc-v/src/ch32v/ch32v_start.c
 *
...
#define CH32V_IDLESTACK_SIZE (CONFIG_IDLETHREAD_STACKSIZE)
...
uint8_t g_idle_stack[CH32V_IDLESTACK_SIZE]
...
extern void ch32v_lowsetup(void);
extern void exception_common(void);
extern void ch32v_boardinitialize(void);
...
#endif // CONFIG_STACK_OVERFLOW_CHECK
...
//  modifyreg32(CH32V_HBN_IRQ_MODE, 0, HBN_IRQ_MODE_REG_AON_PAD_IE_SMT);
