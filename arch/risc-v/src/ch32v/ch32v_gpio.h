/****************************************************************************
 * arch/risc-v/src/ch32v/ch32v_gpio.h
 *
...
#ifndef __ARCH_RISCV_SRC_ch32v_ch32v_GPIO_H
#define __ARCH_RISCV_SRC_ch32v_ch32v_GPIO_H
...
/* Bit-encoded input to ch32v_configgpio() */
...
int ch32v_configgpio(gpio_pinset_t cfgset);

/****************************************************************************
 * Name: ch32v_gpio_deinit
 *
 * Description:
...
int ch32v_gpio_deinit(uint8_t pin);

/****************************************************************************
 * Name: ch32v_config_uart_sel
 *
 * Description:
...
int ch32v_config_uart_sel(gpio_pinset_t cfgset, uint8_t sig_sel);

/****************************************************************************
 * Name: ch32v_gpiowrite
 *
 * Description:
...
void ch32v_gpiowrite(gpio_pinset_t pinset, bool value);
...
bool ch32v_gpioread(gpio_pinset_t pinset);

/****************************************************************************
 * Name: ch32v_gpiosetevent
 *
 * Description:
...
int ch32v_gpiosetevent(gpio_pinset_t pinset,
                       bool          risingedge,
                       bool          fallingedge,
                       bool          event,
                       xcpt_t        func,
...
int ch32v_gpio_initialize(void);

/****************************************************************************
 * Function:  ch32v_dumpgpio
 *
 * Description:
...
int ch32v_dumpgpio(gpio_pinset_t pinset, const char *msg);
#else
#define ch32v_dumpgpio(p, m)
#endif
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_RISCV_SRC_ch32v_ch32v_GPIO_H */
