/****************************************************************************
 * arch/risc-v/src/rp23xx-rv/rp23xx_wdt.c
 *
...
int rp23xx_wdt_start(struct watchdog_lowerhalf_s *lower)
{
  ...
  modifyreg32(RP23XX_WATCHDOG_CTRL, 0, RP23XX_WATCHDOG_ENABLE_BITS);
...
int rp23xx_wdt_stop(struct watchdog_lowerhalf_s *lower)
{
  ...
  modifyreg32(RP23XX_WATCHDOG_CTRL, RP23XX_WATCHDOG_CTRL_ENABLE, 0);
