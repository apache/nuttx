/****************************************************************************
 * arch/risc-v/src/rp23xx-rv/rp23xx_heaps.c
 *
...
#if defined(CONFIG_RP23XX_RV_PSRAM)
 ...
 * Public Functions
 ****************************************************************************/
#if defined(CONFIG_RP23XX_RV_PSRAM_HEAP_SEPARATE)
static struct mm_heap_s *g_psramheap;
#endif

#if defined(CONFIG_RP23XX_RV_PSRAM_HEAP_SINGLE)
...
#elif defined (CONFIG_RP23XX_RV_PSRAM_HEAP_USER)
...
#elif defined (CONFIG_RP23XX_RV_PSRAM_HEAP_SEPARATE)
