/****************************************************************************
 * arch/risc-v/src/jh7100/jh7100_irq_dispatch.c
 *
...
void *jh7100_dispatch_irq(uint64_t vector, uint64_t *regs)
{
  ...
  if (JH7100_IRQ_ECALLM == irq || JH7100_IRQ_ECALLU == irq)
    {
      *mepc += 4;
    }
  ...
  if (JH7100_IRQ_PERI_START <= irq)
    {
      /* Then write PLIC_CLAIM to clear pending in PLIC */

      putreg32(irq - JH7100_IRQ_PERI_START, JH7100_PLIC_MCLAIM);
    }
