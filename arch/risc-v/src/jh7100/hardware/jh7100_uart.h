/****************************************************************************
 * arch/risc-v/src/jh7100/hardware/jh7100_uart.h
 *
...
#ifndef ARCH_RISCV_SRC_JH7100_CHIP_JH7100_UART_H
#define ARCH_RISCV_SRC_JH7100_CHIP_JH7100_UART_H

/* The JH7100 and JH7110 have a 16550-compatible UART. Refactor this away. */
...
#define CONFIG_JH7100_UART0 1

#ifdef CONFIG_JH7100_UART0
#  define JH7100_UART0_TXDATA  (JH7100_UART0_BASE + UART_TXDATA_OFFSET)
#  define JH7100_UART0_RXDATA  (JH7100_UART0_BASE + UART_RXDATA_OFFSET)
#  define JH7100_UART0_TXCTRL  (JH7100_UART0_BASE + UART_TXCTRL_OFFSET)
#  define JH7100_UART0_RXCTRL  (JH7100_UART0_BASE + UART_RXCTRL_OFFSET)
#  define JH7100_UART0_IE      (JH7100_UART0_BASE + UART_IE_OFFSET)
#  define JH7100_UART0_IP      (JH7100_UART0_BASE + UART_IP_OFFSET)
#  define JH7100_UART0_DIV     (JH7100_UART0_BASE + UART_DIV_OFFSET)
#  define JH7100_UART0_LSR     (JH7100_UART0_BASE + UART_LSR_OFFSET)
#  define JH7100_UART0_MSR     (JH7100_UART0_BASE + UART_MSR_OFFSET)
#  define JH7100_UART0_USR     (JH7100_UART0_BASE + UART_USR_OFFSET)
#endif
...
#endif /* ARCH_RISCV_SRC_JH7100_CHIP_JH7100_UART_H */
