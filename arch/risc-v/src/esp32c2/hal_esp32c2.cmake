# ##############################################################################
# arch/risc-v/src/esp32c2/hal_esp32c2.cmake
#
...
set_property(GLOBAL APPEND PROPERTY LD_SCRIPT ${_esp32c2_rom_ld_files})
...
list(
  ...
  ${ESP_HAL_3RDPARTY_REPO}/components/esp_adc/${CHIP_SERIES}/adc_cali_line_fitting.c
)
...
list(
  ...
  ${ESP_HAL_3RDPARTY_REPO}/components/efuse/src/efuse_controller/keys/without_key_purposes/one_key_block/esp_efuse_api_key.c
)
...
# Make) HAL sources (paths from hal_esp32c2.mk: esp_hal_* and hal components)
list(
  APPEND
  HAL_SRCS
...
# SOC sources (paths from hal_esp32c2.mk: esp_hal_* periph and soc)
list(
  APPEND
  HAL_SRCS
