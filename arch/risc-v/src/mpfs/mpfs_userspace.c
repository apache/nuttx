...
void mpfs_userspace(void)
{
   ...
   * access here, otherwise an exception will fire when the user space task is
   * started.
   *
   ...
   *
   * Note: do not trust the stext / etc sections to be correctly aligned here,
   * they should be but it is simpler and safer to handle the user region as a
   * whole
   *
