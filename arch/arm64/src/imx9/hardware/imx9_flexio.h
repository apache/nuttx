/****************************************************************************
 * arch/arm64/src/imx9/hardware/imx9_flexio.h
 *
...
#ifndef __ARCH_ARM64_SRC_IMX9_HARDWARE_IMX9_FLEXIO_H
#define __ARCH_ARM64_SRC_IMX9_HARDWARE_IMX9_FLEXIO_H
...
#define IMX9_FLEXIO_VERID_OFFSET         0x0000 /* Version ID Register, offset: 0x0 */
#define IMX9_FLEXIO_PARAM_OFFSET         0x0004 /* Parameter Register, offset: 0x4 */
#define IMX9_FLEXIO_CTRL_OFFSET          0x0008 /* FlexIO Control Register, offset: 0x8 */
#define IMX9_FLEXIO_PIN_OFFSET           0x000c /* Pin State Register, offset: 0xC */
#define IMX9_FLEXIO_SHIFTSTAT_OFFSET     0x0010 /* Shifter Status Register, offset: 0x10 */
#define IMX9_FLEXIO_SHIFTERR_OFFSET      0x0014 /* Shifter Error Register, offset: 0x14 */
#define IMX9_FLEXIO_TIMSTAT_OFFSET       0x0018 /* Timer Status Register, offset: 0x18 */
#define IMX9_FLEXIO_SHIFTSIEN_OFFSET     0x0020 /* Shifter Status Interrupt Enable, offset: 0x20 */
#define IMX9_FLEXIO_SHIFTEIEN_OFFSET     0x0024 /* Shifter Error Interrupt Enable, offset: 0x24 */
#define IMX9_FLEXIO_TIMIEN_OFFSET        0x0028 /* Timer Interrupt Enable Register, offset: 0x28 */
#define IMX9_FLEXIO_SHIFTSDEN_OFFSET     0x0030 /* Shifter Status DMA Enable, offset: 0x30 */
#define IMX9_FLEXIO_SHIFTSTATE_OFFSET    0x0040 /* Shifter State Register, offset: 0x40 */
#define IMX9_FLEXIO_TRGSTAT_OFFSET       0x0048 /* Trigger Status */
#define IMX9_FLEXIO_TRIGIEN_OFFSET       0x004c /* External Trigger Interrupt Enable */
#define IMX9_FLEXIO_PINSTAT_OFFSET       0x0050 /* Pin Status */
#define IMX9_FLEXIO_PINIEN_OFFSET        0x0054 /* Pin Interrupt Enable */
#define IMX9_FLEXIO_PINREN_OFFSET        0x0058 /* Pin Rising Edge Enable */
#define IMX9_FLEXIO_PINFEN_OFFSET        0x005c /* Pin Falling Edge Enable */
#define IMX9_FLEXIO_PINOUTD_OFFSET       0x0060 /* Pin Output Data */
#define IMX9_FLEXIO_PINOUTE_OFFSET       0x0064 /* Pin Output Enable */
#define IMX9_FLEXIO_PINOUTDIS_OFFSET     0x0068 /* Pin Output Disable */
#define IMX9_FLEXIO_PINOUTCLR_OFFSET     0x006c /* Pin Output Clear */
#define IMX9_FLEXIO_PINOUTSET_OFFSET     0x0070 /* Pin Output Set */
#define IMX9_FLEXIO_PINOUTTOG_OFFSET     0x0074 /* Pin Output Toggle */
#define IMX9_FLEXIO_SHIFTCTL0_OFFSET     0x0080 /* Shifter Control N Register, array offset: 0x80, array step: 0x4 */
#define IMX9_FLEXIO_SHIFTCTL1_OFFSET     0x0084
#define IMX9_FLEXIO_SHIFTCTL2_OFFSET     0x0088
#define IMX9_FLEXIO_SHIFTCTL3_OFFSET     0x008c
#define IMX9_FLEXIO_SHIFTCTL4_OFFSET     0x0090
...
#define IMX9_FLEXIO_SHIFTCFG3_OFFSET     0x010c
#define IMX9_FLEXIO_SHIFTCFG4_OFFSET     0x0110
...
#define IMX9_FLEXIO_SHIFTBUF3_OFFSET     0x020c
#define IMX9_FLEXIO_SHIFTBUF4_OFFSET     0x0210
...
#define IMX9_FLEXIO_SHIFTBUFBIS3_OFFSET  0x028c
#define IMX9_FLEXIO_SHIFTBUFBIS4_OFFSET  0x0290
...
#define IMX9_FLEXIO_SHIFTBUFBYS3_OFFSET  0x030c
#define IMX9_FLEXIO_SHIFTBUFBYS4_OFFSET  0x0310
...
#define IMX9_FLEXIO_SHIFTBUFBBS3_OFFSET  0x038c
#define IMX9_FLEXIO_SHIFTBUFBBS4_OFFSET  0x0390
...
#define IMX9_FLEXIO_TIMCTL3_OFFSET       0x040c
#define IMX9_FLEXIO_TIMCTL4_OFFSET       0x0410
#define IMX9_FLEXIO_TIMCTL5_OFFSET       0x0414
#define IMX9_FLEXIO_TIMCTL6_OFFSET       0x0418
#define IMX9_FLEXIO_TIMCTL7_OFFSET       0x041c
#define IMX9_FLEXIO_TIMCTL_OFFSET(x)     (IMX9_FLEXIO_TIMCTL0_OFFSET + (x) * 4)
#define IMX9_FLEXIO_TIMCFG0_OFFSET       0x0480 /* Timer Configuration N Register, array offset: 0x480, array step: 0x4 */
#define IMX9_FLEXIO_TIMCFG1_OFFSET       0x0484
#define IMX9_FLEXIO_TIMCFG2_OFFSET       0x0488
#define IMX9_FLEXIO_TIMCFG3_OFFSET       0x048c
#define IMX9_FLEXIO_TIMCFG4_OFFSET       0x0490
#define IMX9_FLEXIO_TIMCFG5_OFFSET       0x0494
#define IMX9_FLEXIO_TIMCFG6_OFFSET       0x0498
#define IMX9_FLEXIO_TIMCFG7_OFFSET       0x049c
#define IMX9_FLEXIO_TIMCFG_OFFSET(x)     (IMX9_FLEXIO_TIMCFG0_OFFSET + (x) * 4)
#define IMX9_FLEXIO_TIMCMP0_OFFSET       0x0500 /* Timer Compare N Register, array offset: 0x500, array step: 0x4 */
#define IMX9_FLEXIO_TIMCMP1_OFFSET       0x0504
#define IMX9_FLEXIO_TIMCMP2_OFFSET       0x0508
#define IMX9_FLEXIO_TIMCMP3_OFFSET       0x050c
#define IMX9_FLEXIO_TIMCMP4_OFFSET       0x0510
#define IMX9_FLEXIO_TIMCMP5_OFFSET       0x0514
#define IMX9_FLEXIO_TIMCMP6_OFFSET       0x0518
#define IMX9_FLEXIO_TIMCMP7_OFFSET       0x051c
#define IMX9_FLEXIO_TIMCMP_OFFSET(x)     (IMX9_FLEXIO_TIMCMP0_OFFSET + (x) * 4)
#define IMX9_FLEXIO_SHIFTBUFNBS0_OFFSET  0x0680 /* Shifter Buffer N Nibble Byte Swapped Register, array offset: 0x680, array step: 0x4 */
#define IMX9_FLEXIO_SHIFTBUFNBS1_OFFSET  0x0684
#define IMX9_FLEXIO_SHIFTBUFNBS2_OFFSET  0x0688
#define IMX9_FLEXIO_SHIFTBUFNBS3_OFFSET  0x068c
#define IMX9_FLEXIO_SHIFTBUFNBS4_OFFSET  0x0690
#define IMX9_FLEXIO_SHIFTBUFNBS5_OFFSET  0x0694
#define IMX9_FLEXIO_SHIFTBUFNBS6_OFFSET  0x0698
#define IMX9_FLEXIO_SHIFTBUFNBS7_OFFSET  0x069c
#define IMX9_FLEXIO_SHIFTBUFHWS0_OFFSET  0x0700 /* Shifter Buffer N Half Word Swapped Register, array offset: 0x700, array step: 0x4 */
#define IMX9_FLEXIO_SHIFTBUFHWS1_OFFSET  0x0704
#define IMX9_FLEXIO_SHIFTBUFHWS2_OFFSET  0x0708
#define IMX9_FLEXIO_SHIFTBUFHWS3_OFFSET  0x070c
#define IMX9_FLEXIO_SHIFTBUFHWS4_OFFSET  0x0710
#define IMX9_FLEXIO_SHIFTBUFHWS5_OFFSET  0x0714
#define IMX9_FLEXIO_SHIFTBUFHWS6_OFFSET  0x0718
#define IMX9_FLEXIO_SHIFTBUFHWS7_OFFSET  0x071c
#define IMX9_FLEXIO_SHIFTBUFNIS0_OFFSET  0x0780 /* Shifter Buffer N Nibble Swapped Register, array offset: 0x780, array step: 0x4 */
#define IMX9_FLEXIO_SHIFTBUFNIS1_OFFSET  0x0784
#define IMX9_FLEXIO_SHIFTBUFNIS2_OFFSET  0x0788
#define IMX9_FLEXIO_SHIFTBUFNIS3_OFFSET  0x078c
#define IMX9_FLEXIO_SHIFTBUFNIS4_OFFSET  0x0790
#define IMX9_FLEXIO_SHIFTBUFNIS5_OFFSET  0x0794
#define IMX9_FLEXIO_SHIFTBUFNIS6_OFFSET  0x0798
#define IMX9_FLEXIO_SHIFTBUFNIS7_OFFSET  0x079c
#define IMX9_FLEXIO_SHIFTBUFOES0_OFFSET  0x0800 /* Shifter Buffer N Odd Even Swapped, array offset: 0x800, array step: 0x4 */
#define IMX9_FLEXIO_SHIFTBUFOES1_OFFSET  0x0804
#define IMX9_FLEXIO_SHIFTBUFOES2_OFFSET  0x0808
#define IMX9_FLEXIO_SHIFTBUFOES3_OFFSET  0x080c
#define IMX9_FLEXIO_SHIFTBUFOES4_OFFSET  0x0810
#define IMX9_FLEXIO_SHIFTBUFOES5_OFFSET  0x0814
#define IMX9_FLEXIO_SHIFTBUFOES6_OFFSET  0x0818
#define IMX9_FLEXIO_SHIFTBUFOES7_OFFSET  0x081c
#define IMX9_FLEXIO_SHIFTBUFEOS0_OFFSET  0x0880 /* Shifter Buffer N Even Odd Swapped, array offset: 0x880, array step: 0x4 */
#define IMX9_FLEXIO_SHIFTBUFEOS1_OFFSET  0x0884
#define IMX9_FLEXIO_SHIFTBUFEOS2_OFFSET  0x0888
#define IMX9_FLEXIO_SHIFTBUFEOS3_OFFSET  0x088c
#define IMX9_FLEXIO_SHIFTBUFEOS4_OFFSET  0x0890
#define IMX9_FLEXIO_SHIFTBUFEOS5_OFFSET  0x0894
#define IMX9_FLEXIO_SHIFTBUFEOS6_OFFSET  0x0898
#define IMX9_FLEXIO_SHIFTBUFEOS7_OFFSET  0x089c
#define IMX9_FLEXIO_SHIFTBUFHBS0_OFFSET  0x0900 /* Shifter Buffer N Halfword Byte Swapped, array offset: 0x900, array step: 0x4 */
#define IMX9_FLEXIO_SHIFTBUFHBS1_OFFSET  0x0904
#define IMX9_FLEXIO_SHIFTBUFHBS2_OFFSET  0x0908
#define IMX9_FLEXIO_SHIFTBUFHBS3_OFFSET  0x090c
#define IMX9_FLEXIO_SHIFTBUFHBS4_OFFSET  0x0910
#define IMX9_FLEXIO_SHIFTBUFHBS5_OFFSET  0x0914
#define IMX9_FLEXIO_SHIFTBUFHBS6_OFFSET  0x0918
#define IMX9_FLEXIO_SHIFTBUFHBS7_OFFSET  0x091c
...
#define FLEXIO_TIMERSDEN_TSDE(x)                 ((((uint32_t)(x)) << FLEXIO_TIMERSDEN_TSDE_SHIFT) & FLEXIO_TIMERSDEN_TSDE_MASK)
...
#define FLEXIO_TRGSTAT_ETSF(x)                   ((((uint32_t)(x)) << FLEXIO_TRGSTAT_ETSF_SHIFT) & FLEXIO_TRGSTAT_ETSF_MASK)

/* TRIGIEN - External Trigger Interrupt Enable */

#define FLEXIO_TRIGIEN_TRIE_MASK                (0xfu)
#define FLEXIO_TRIGIEN_TRIE_SHIFT               (0u)

#define FLEXIO_TRIGIEN_TRIE(x)                  ((((uint32_t)(x)) << FLEXIO_TRIGIEN_TRIE_SHIFT) & FLEXIO_TRIGIEN_TRIE_MASK)
...
#define FLEXIO_SHIFTCFG_LATST(x)                 ((((uint32_t)(x)) << FLEXIO_SHIFTCFG_LATST_SHIFT) & FLEXIO_SHIFTCFG_LATST_MASK)
...
#define FLEXIO_SHIFTCFG_SSIZE(x)                 ((((uint32_t)(x)) << FLEXIO_SHIFTCFG_SSIZE_SHIFT) & FLEXIO_SHIFTCFG_SSIZE_MASK)
...
#endif /* __ARCH_ARM64_SRC_IMX9_HARDWARE_IMX9_FLEXIO_H */
