...
#define STM32_IRQ_TAMP_S        (STM32_IRQ_FIRST + 5)   /* 5:   Tamper secure global interrupt */
...
#define STM32_IRQ_DMAMUX1_OVR   (STM32_IRQ_FIRST + 27)  /* 27:  DMAMUX1 overRun interrupt */
#define STM32_IRQ_DMAMUX1_OVR_S (STM32_IRQ_FIRST + 28)  /* 28:  DMAMUX1 secure overRun interrupt */
#define STM32_IRQ_DMA1CH1       (STM32_IRQ_FIRST + 29)  /* 29:  DMA1 Channel 1 global interrupt */
#define STM32_IRQ_DMA1CH2       (STM32_IRQ_FIRST + 30)  /* 30:  DMA1 Channel 2 global interrupt */
#define STM32_IRQ_DMA1CH3       (STM32_IRQ_FIRST + 31)  /* 31:  DMA1 Channel 3 global interrupt */
#define STM32_IRQ_DMA1CH4       (STM32_IRQ_FIRST + 32)  /* 32:  DMA1 Channel 4 global interrupt */
#define STM32_IRQ_DMA1CH5       (STM32_IRQ_FIRST + 33)  /* 33:  DMA1 Channel 5 global interrupt */
#define STM32_IRQ_DMA1CH6       (STM32_IRQ_FIRST + 34)  /* 34:  DMA1 Channel 6 global interrupt */
#define STM32_IRQ_DMA1CH7       (STM32_IRQ_FIRST + 35)  /* 35:  DMA1 Channel 7 global interrupt */
#define STM32_IRQ_DMA1CH8       (STM32_IRQ_FIRST + 36)  /* 36:  DMA1 Channel 8 global interrupt */
#define STM32_IRQ_ADC1_2        (STM32_IRQ_FIRST + 37)  /* 37:  ADC1_2 global interrupt */
...
#define STM32_IRQ_USB_FS        (STM32_IRQ_FIRST + 73)  /* 73:  USB global interrupt */
...
#define STM32_IRQ_SDMMC1        (STM32_IRQ_FIRST + 78)  /* 78:  SDMMC1 global interrupt */
                                                        /* 79:  Reserved */
#define STM32_IRQ_DMA2CH1       (STM32_IRQ_FIRST + 80)  /* 80:  DMA2 Channel 1 global interrupt */
#define STM32_IRQ_DMA2CH2       (STM32_IRQ_FIRST + 81)  /* 81:  DMA2 Channel 2 global interrupt */
#define STM32_IRQ_DMA2CH3       (STM32_IRQ_FIRST + 82)  /* 82:  DMA2 Channel 3 global interrupt */
#define STM32_IRQ_DMA2CH4       (STM32_IRQ_FIRST + 83)  /* 83:  DMA2 Channel 4 global interrupt */
#define STM32_IRQ_DMA2CH5       (STM32_IRQ_FIRST + 84)  /* 84:  DMA2 Channel 5 global interrupt */
#define STM32_IRQ_DMA2CH6       (STM32_IRQ_FIRST + 85)  /* 85:  DMA2 Channel 6 global interrupt */
#define STM32_IRQ_DMA2CH7       (STM32_IRQ_FIRST + 86)  /* 86:  DMA2 Channel 7 global interrupt */
#define STM32_IRQ_DMA2CH8       (STM32_IRQ_FIRST + 87)  /* 87:  DMA2 Channel 8 global interrupt */
...
#define STM32_IRQ_DFSDM1_FLT0   (STM32_IRQ_FIRST + 102) /* 102: DFSDM1 filter 0 global interrupt */
#define STM32_IRQ_DFSDM1_FLT1   (STM32_IRQ_FIRST + 103) /* 103: DFSDM1 filter 1 global interrupt */
#define STM32_IRQ_DFSDM1_FLT2   (STM32_IRQ_FIRST + 104) /* 104: DFSDM1 filter 2 global interrupt */
#define STM32_IRQ_DFSDM1_FLT3   (STM32_IRQ_FIRST + 105) /* 105: DFSDM1 filter 3 global interrupt */
