/****************************************************************************
 * arch/arm/include/stm32u3/stm32u3c5xx_irq.h
 *
...
#ifndef __ARCH_ARM_INCLUDE_STM32U3_STM32U3C5XX_IRQ_H
#define __ARCH_ARM_INCLUDE_STM32U3_STM32U3C5XX_IRQ_H
...
#include <arch/stm32u3/stm32_irq.h>
 ...
 * in the file nuttx/arch/arm/include/stm32u3/stm32_irq.h, which is
 * included above.
 *
 * External interrupts (vectors >= 16)
 *
 * These interrupt vectors are based on the STM32U3C5 vector table in
 * RM0487.
 */
...
#define STM32_IRQ_TIM12         (STM32_IRQ_FIRST + 51)  /* 51:  TIM12 global interrupt */
#define STM32_IRQ_I3C1_EV       (STM32_IRQ_FIRST + 53)  /* 53:  I3C1 event interrupt */
#define STM32_IRQ_I3C1_ER       (STM32_IRQ_FIRST + 54)  /* 54:  I3C1 error interrupt */
...
#define STM32_IRQ_USB_FS        (STM32_IRQ_FIRST + 73)  /* 73:  USB FS global interrupt */
...
#define STM32_IRQ_HSP1          (STM32_IRQ_FIRST + 77)  /* 77:  HSP1 global interrupt */
...
#define STM32_IRQ_I3C2_EV       (STM32_IRQ_FIRST + 100) /* 100: I3C2 event interrupt */
#define STM32_IRQ_I3C2_ER       (STM32_IRQ_FIRST + 101) /* 101: I3C2 error interrupt */
#define STM32_IRQ_TIM8_BRK      (STM32_IRQ_FIRST + 102) /* 102: TIM8 break */
#define STM32_IRQ_TIM8_TERR     (STM32_IRQ_FIRST + 102) /* 102: TIM8 transition error */
#define STM32_IRQ_TIM8_IERR     (STM32_IRQ_FIRST + 102) /* 102: TIM8 index error */
#define STM32_IRQ_TIM8_UP       (STM32_IRQ_FIRST + 103) /* 103: TIM8 update */
#define STM32_IRQ_TIM8_TRG_COM  (STM32_IRQ_FIRST + 104) /* 104: TIM8 trigger and communication */
#define STM32_IRQ_TIM8_DIR      (STM32_IRQ_FIRST + 104) /* 104: TIM8 direction change interrupt */
#define STM32_IRQ_TIM8_IDX      (STM32_IRQ_FIRST + 104) /* 104: TIM8 index */
#define STM32_IRQ_TIM8_CC       (STM32_IRQ_FIRST + 105) /* 105: TIM8 capture compare interrupt */
...
#define STM32_IRQ_ADF1          (STM32_IRQ_FIRST + 112) /* 112: ADF1 global interrupt */
#define STM32_IRQ_ADC2          (STM32_IRQ_FIRST + 113) /* 113: ADC2 global interrupt */
#define STM32_IRQ_FDCAN2_IT0    (STM32_IRQ_FIRST + 114) /* 114: FDCAN2 interrupt 0 */
#define STM32_IRQ_FDCAN2_IT1    (STM32_IRQ_FIRST + 115) /* 115: FDCAN2 interrupt 1 */
#define STM32_IRQ_I2C4_EV       (STM32_IRQ_FIRST + 116) /* 116: I2C4 event interrupt */
#define STM32_IRQ_I2C4_ER       (STM32_IRQ_FIRST + 117) /* 117: I2C4 error interrupt */
#define STM32_IRQ_SPI4          (STM32_IRQ_FIRST + 119) /* 119: SPI4 global interrupt */
#define STM32_IRQ_PWR           (STM32_IRQ_FIRST + 123) /* 123: PWR non-secure interrupt */
#define STM32_IRQ_PWR_S         (STM32_IRQ_FIRST + 124) /* 124: PWR secure interrupt */
...
#endif /* __ARCH_ARM_INCLUDE_STM32U3_STM32U3C5XX_IRQ_H */
