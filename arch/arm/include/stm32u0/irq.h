/****************************************************************************
 * arch/arm/include/stm32u0/irq.h
 *
...
#ifndef __ARCH_ARM_INCLUDE_STM32U0_IRQ_H
#define __ARCH_ARM_INCLUDE_STM32U0_IRQ_H
 ...
 * Note that many vectors are shared by several peripherals (aliases below).
 */

#define STM32_IRQ_WWDG      (STM32_IRQ_EXTINT + 0)  /* 0: Window Watchdog */
#define STM32_IRQ_IWDG      (STM32_IRQ_EXTINT + 0)  /* 0: Independent Watchdog */
#define STM32_IRQ_PVD       (STM32_IRQ_EXTINT + 1)  /* 1: PVD through EXTI Line detection */
#define STM32_IRQ_PVM       (STM32_IRQ_EXTINT + 1)  /* 1: PVM through EXTI Line detection */
#define STM32_IRQ_RTC       (STM32_IRQ_EXTINT + 2)  /* 2: RTC */
#define STM32_IRQ_TAMP      (STM32_IRQ_EXTINT + 2)  /* 2: TAMP */
#define STM32_IRQ_FLASH     (STM32_IRQ_EXTINT + 3)  /* 3: Flash, Flash ECC */
#define STM32_IRQ_RCC       (STM32_IRQ_EXTINT + 4)  /* 4: RCC */
#define STM32_IRQ_CRS       (STM32_IRQ_EXTINT + 4)  /* 4: CRS */
...
#define STM32_IRQ_USB       (STM32_IRQ_EXTINT + 8)  /* 8: USB DRD FS */
...
#define STM32_IRQ_DMAMUX    (STM32_IRQ_EXTINT + 11) /* 11: DMAMUX overrun */
#define STM32_IRQ_ADC       (STM32_IRQ_EXTINT + 12) /* 12: ADC */
#define STM32_IRQ_COMP      (STM32_IRQ_EXTINT + 12) /* 12: COMP1, COMP2 */
...
#define STM32_IRQ_TIM15     (STM32_IRQ_EXTINT + 19) /* 19: TIM15 */
#define STM32_IRQ_LPTIM3    (STM32_IRQ_EXTINT + 19) /* 19: LPTIM3 */
#define STM32_IRQ_TIM16     (STM32_IRQ_EXTINT + 20) /* 20: TIM16 */
#define STM32_IRQ_TSC       (STM32_IRQ_EXTINT + 21) /* 21: TSC */
#define STM32_IRQ_LCD       (STM32_IRQ_EXTINT + 22) /* 22: LCD */
#define STM32_IRQ_I2C1      (STM32_IRQ_EXTINT + 23) /* 23: I2C1 */
#define STM32_IRQ_I2C2      (STM32_IRQ_EXTINT + 24) /* 24: I2C2 */
#define STM32_IRQ_I2C3      (STM32_IRQ_EXTINT + 24) /* 24: I2C3 */
#define STM32_IRQ_I2C4      (STM32_IRQ_EXTINT + 24) /* 24: I2C4 */
#define STM32_IRQ_SPI1      (STM32_IRQ_EXTINT + 25) /* 25: SPI1 */
#define STM32_IRQ_SPI2      (STM32_IRQ_EXTINT + 26) /* 26: SPI2 */
#define STM32_IRQ_SPI3      (STM32_IRQ_EXTINT + 26) /* 26: SPI3 */
#define STM32_IRQ_USART1    (STM32_IRQ_EXTINT + 27) /* 27: USART1 */
#define STM32_IRQ_USART2    (STM32_IRQ_EXTINT + 28) /* 28: USART2 */
#define STM32_IRQ_LPUART2   (STM32_IRQ_EXTINT + 28) /* 28: LPUART2 */
#define STM32_IRQ_USART3    (STM32_IRQ_EXTINT + 29) /* 29: USART3 */
#define STM32_IRQ_LPUART1   (STM32_IRQ_EXTINT + 29) /* 29: LPUART1 */
#define STM32_IRQ_USART4    (STM32_IRQ_EXTINT + 30) /* 30: USART4 */
#define STM32_IRQ_LPUART3   (STM32_IRQ_EXTINT + 30) /* 30: LPUART3 */
...
#endif /* __ARCH_ARM_INCLUDE_STM32U0_IRQ_H */
