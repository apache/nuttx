...
#define STM32_IRQ_TAMPER      (STM32_IRQ_FIRST + 2)  /* 2:  Tamper through EXTI[18] interrupts */
#define STM32_IRQ_TIMESTAMP   (STM32_IRQ_FIRST + 2)  /* 2:  Time stamp through EXTI[18] interrupts */
#define STM32_IRQ_LSECSS      (STM32_IRQ_FIRST + 2)  /* 2:  LSECSS through EXTI[18] interrupts */
...
#define STM32_IRQ_EXTI95      (STM32_IRQ_FIRST + 23) /* 23: EXTI Lines [9:5] Interrupt */
...
#define STM32_IRQ_PKA         (STM32_IRQ_FIRST + 29) /* 29: PKA Interrupt */
...
#define STM32_IRQ_PWRSOTF     (STM32_IRQ_FIRST + 43) /* 43: PWR switching on the fly interrupt */
...
#define STM32_IRQ_IPCCRX      (STM32_IRQ_FIRST + 44) /* 44: IPCC RX occupied interrupt */
#define STM32_IRQ_IPCCTX      (STM32_IRQ_FIRST + 45) /* 45: IPCC TX free interrupt */
#define STM32_IRQ_HSEM        (STM32_IRQ_FIRST + 46) /* 46: Semaphore interrupt 0 to CPU1 */
...
#define STM32_IRQ_AES2        (STM32_IRQ_FIRST + 52) /* 52: AES2 crypto global interrupt */
...
#  define STM32_IRQ_DMA2CH4   (STM32_IRQ_FIRST + 58) /* 58: DMA2 Channel 4 global interrupt */
#  define STM32_IRQ_DMA2CH5   (STM32_IRQ_FIRST + 59) /* 59: DMA2 Channel 5 global interrupt */
#  define STM32_IRQ_DMA2CH6   (STM32_IRQ_FIRST + 60) /* 60: DMA2 Channel 6 global interrupt */
#  define STM32_IRQ_DMA2CH7   (STM32_IRQ_FIRST + 61) /* 61: DMA2 Channel 7 global interrupt */
#endif

#define STM32_IRQ_DMAMUX1     (STM32_IRQ_FIRST + 62) /* 62: DMAMUX1 overrun interrupt */

#define STM32_IRQ_NEXTINTS    63
