...
#    define STM32_SRAM3_SIZE            (0*1024)    /*    No SRAM3 on AHB bus Matrix (D2) */
#    define STM32_SRAM123_SIZE          (32*1024)   /*  32Kb SRAM123 on AHB bus Matrix (D2) */
#    define STM32_SRAM4_SIZE            (16*1024)   /*  16Kb SRAM4 on AHB bus Matrix (D3) */
...
#    define STM32_SRAM1_SIZE            (128*1024)  /* 128Kb SRAM1 on AHB bus Matrix (D2) */
#    define STM32_SRAM2_SIZE            (128*1024)  /* 128Kb SRAM2 on AHB bus Matrix (D2) */
#    define STM32_SRAM3_SIZE            (32*1024)   /*  32Kb SRAM3 on AHB bus Matrix (D2) */
#    define STM32_SRAM123_SIZE          (288*1024)  /* 128Kb SRAM123 on AHB bus Matrix (D2) */
#    define STM32_SRAM4_SIZE            (64*1024)   /*  64Kb SRAM2 on AHB bus Matrix (D3) */
...
#      define STM32_ITCM_SRAM_SIZE      (64*1024)   /*  64b ITCM SRAM on TCM interface */
#  else
...
#  define STM32_NADC                    (3)         /* (3) ADC1-3*/
#  define STM32_NDAC                    (2)         /* (2) DAC1-2*/
#  define STM32_NCMP                    (2)         /* (2) ultra-low power comparators */
#  define STM32_NPGA                    (2)         /* (2) Operational amplifiers: OPAMP */
#  define STM32_NDFSDM                  (1)         /* (1) digital filters for sigma delta modulator */
#  define STM32_NUSART                  (4)         /* (4) USART1-3, 6 */
#  define STM32_NSPI                    (6)         /* (6) SPI1-6 */
#  define STM32_NI2S                    (3)         /* (3) I2S1-3 */
#  define STM32_NUART                   (4)         /* (4) UART4-5, 7-8 */
#  define STM32_NI2C                    (4)         /* (4) I2C1-4 */
...
#    define STM32_SRAM1_SIZE            (64*1024)   /*   64Kb SRAM1 on AHB bus Matrix (D2) */
#    define STM32_SRAM2_SIZE            (64*1024)   /*   64Kb SRAM2 on AHB bus Matrix (D2) */
#    define STM32_SRAM3_SIZE            (0*1024)    /*     No SRAM3 on AHB bus Matrix (D2) */
#    define STM32_SRAM123_SIZE          (128*1024)  /*  128Kb SRAM123 on AHB bus Matrix (D2) */
#    define STM32_SRAM4_SIZE            (32*1024)   /*   32Kb SRAM2 on AHB bus Matrix (D3) */
#  if defined(CONFIG_ARMV7M_HAVE_DTCM)
#      define STM32_DTCM_SRAM_SIZE      (128*1024)  /* 128Kb DTCM SRAM on TCM interface */
#  else
#      define STM32_DTCM_SRAM_SIZE      (0)         /* No DTCM SRAM on TCM interface */
