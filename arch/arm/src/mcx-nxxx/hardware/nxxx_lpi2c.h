...
#define NXXX_LPI2C_VERID_OFFSET             0x0000  /* Version ID Register offset */
#define NXXX_LPI2C_PARAM_OFFSET             0x0004  /* Parameter Register offset */
#define NXXX_LPI2C_MCR_OFFSET               0x0010  /* Master Control Register offset */
#define NXXX_LPI2C_MSR_OFFSET               0x0014  /* Master Status Register offset */
#define NXXX_LPI2C_MIER_OFFSET              0x0018  /* Master Interrupt Enable Register offset */
#define NXXX_LPI2C_MDER_OFFSET              0x001c  /* Master DMA Enable Register offset */
#define NXXX_LPI2C_MCFGR0_OFFSET            0x0020  /* Master Config Register 0 offset */
#define NXXX_LPI2C_MCFGR1_OFFSET            0x0024  /* Master Config Register 1 offset */
#define NXXX_LPI2C_MCFGR2_OFFSET            0x0028  /* Master Config Register 2 offset */
#define NXXX_LPI2C_MCFGR3_OFFSET            0x002c  /* Master Config Register 3 offset */
#define NXXX_LPI2C_MDMR_OFFSET              0x0040  /* Master Data Match Register offset */
#define NXXX_LPI2C_MCCR0_OFFSET             0x0048  /* Master Clock Configuration Register 0 offset */
#define NXXX_LPI2C_MCCR1_OFFSET             0x0050  /* Master Clock Configuration Register 1 offset */
#define NXXX_LPI2C_MFCR_OFFSET              0x0058  /* Master FIFO Control Register offset */
#define NXXX_LPI2C_MFSR_OFFSET              0x005C  /* Master FIFO Status Register offset */
#define NXXX_LPI2C_MTDR_OFFSET              0x0060  /* Master Transmit Data Register offset */
#define NXXX_LPI2C_MRDR_OFFSET              0x0070  /* Master Receive Data Register offset */
#define NXXX_LPI2C_SCR_OFFSET               0x0110  /* Slave Control Register offset */
#define NXXX_LPI2C_SSR_OFFSET               0x0114  /* Slave Status Register offset */
#define NXXX_LPI2C_SIER_OFFSET              0x0118  /* Slave Interrupt Enable Register offset */
#define NXXX_LPI2C_SDER_OFFSET              0x011c  /* Slave DMA Enable Register offset */
#define NXXX_LPI2C_SCFGR1_OFFSET            0x0124  /* Slave Config Register 1 offset */
#define NXXX_LPI2C_SCFGR2_OFFSET            0x0128  /* Slave Config Register 2 offset */
#define NXXX_LPI2C_SAMR_OFFSET              0x0140  /* Slave Address Match Register offset */
#define NXXX_LPI2C_SASR_OFFSET              0x0150  /* Slave Address Status Register offset */
#define NXXX_LPI2C_STAR_OFFSET              0x0154  /* Slave Transmit ACK Register offset */
#define NXXX_LPI2C_STDR_OFFSET              0x0160  /* Slave Transmit Data Register offset */
#define NXXX_LPI2C_SRDR_OFFSET              0x0170  /* Slave Receive Data Register offset */

/* Register addresses *******************************************************/

/* LPI2C1 Registers */

#define NXXX_LPI2C1_VERID                  (NXXX_LPI2C1_BASE + NXXX_LPI2C_VERID_OFFSET)   /* Version ID Register */
#define NXXX_LPI2C1_PARAM                  (NXXX_LPI2C1_BASE + NXXX_LPI2C_PARAM_OFFSET)   /* Parameter Register  */
#define NXXX_LPI2C1_MCR                    (NXXX_LPI2C1_BASE + NXXX_LPI2C_MCR_OFFSET)     /* Master Control Register  */
#define NXXX_LPI2C1_MSR                    (NXXX_LPI2C1_BASE + NXXX_LPI2C_MSR_OFFSET)     /* Master Status Register  */
#define NXXX_LPI2C1_MIER                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_MIER_OFFSET)    /* Master Interrupt Enable Register  */
#define NXXX_LPI2C1_MDER                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_MDER_OFFSET)    /* Master DMA Enable Register  */
#define NXXX_LPI2C1_MCFGR0                 (NXXX_LPI2C1_BASE + NXXX_LPI2C_MCFGR0_OFFSET)  /* Master Config Register 0  */
#define NXXX_LPI2C1_MCFGR1                 (NXXX_LPI2C1_BASE + NXXX_LPI2C_MCFGR1_OFFSET)  /* Master Config Register 1  */
#define NXXX_LPI2C1_MCFGR2                 (NXXX_LPI2C1_BASE + NXXX_LPI2C_MCFGR2_OFFSET)  /* Master Config Register 2  */
#define NXXX_LPI2C1_MCFGR3                 (NXXX_LPI2C1_BASE + NXXX_LPI2C_MCFGR3_OFFSET)  /* Master Config Register 3  */
#define NXXX_LPI2C1_MDMR                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_MDMR_OFFSET)    /* Master Data Match Register  */
#define NXXX_LPI2C1_MCCR0                  (NXXX_LPI2C1_BASE + NXXX_LPI2C_MCCR0_OFFSET)   /* Master Clock Configuration Register 0  */
#define NXXX_LPI2C1_MCCR1                  (NXXX_LPI2C1_BASE + NXXX_LPI2C_MCCR1_OFFSET)   /* Master Clock Configuration Register 1  */
#define NXXX_LPI2C1_MFCR                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_MFCR_OFFSET)    /* Master FIFO Control Register  */
#define NXXX_LPI2C1_MFSR                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_MFSR_OFFSET)    /* Master FIFO Status Register  */
#define NXXX_LPI2C1_MTDR                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_MTDR_OFFSET)    /* Master Transmit Data Register  */
#define NXXX_LPI2C1_MRDR                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_MRDR_OFFSET)    /* Master Receive Data Register  */
#define NXXX_LPI2C1_SCR                    (NXXX_LPI2C1_BASE + NXXX_LPI2C_SCR_OFFSET)     /* Slave Control Register  */
#define NXXX_LPI2C1_SSR                    (NXXX_LPI2C1_BASE + NXXX_LPI2C_SSR_OFFSET)     /* Slave Status Register  */
#define NXXX_LPI2C1_SIER                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_SIER_OFFSET)    /* Slave Interrupt Enable Register  */
#define NXXX_LPI2C1_SDER                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_SDER_OFFSET)    /* Slave DMA Enable Register  */
#define NXXX_LPI2C1_SCFGR1                 (NXXX_LPI2C1_BASE + NXXX_LPI2C_SCFGR1_OFFSET)  /* Slave Config Register 1  */
#define NXXX_LPI2C1_SCFGR2                 (NXXX_LPI2C1_BASE + NXXX_LPI2C_SCFGR2_OFFSET)  /* Slave Config Register 2  */
#define NXXX_LPI2C1_SAMR                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_SAMR_OFFSET)    /* Slave Address Match Register  */
#define NXXX_LPI2C1_SASR                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_SASR_OFFSET)    /* Slave Address Status Register  */
#define NXXX_LPI2C1_STAR                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_STAR_OFFSET)    /* Slave Transmit ACK Register  */
#define NXXX_LPI2C1_STDR                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_STDR_OFFSET)    /* Slave Transmit Data Register  */
#define NXXX_LPI2C1_SRDR                   (NXXX_LPI2C1_BASE + NXXX_LPI2C_SRDR_OFFSET)    /* Slave Receive Data Register  */

/* LPI2C2 Registers */

#define NXXX_LPI2C2_VERID                  (NXXX_LPI2C2_BASE + NXXX_LPI2C_VERID_OFFSET)   /* Version ID Register */
#define NXXX_LPI2C2_PARAM                  (NXXX_LPI2C2_BASE + NXXX_LPI2C_PARAM_OFFSET)   /* Parameter Register  */
#define NXXX_LPI2C2_MCR                    (NXXX_LPI2C2_BASE + NXXX_LPI2C_MCR_OFFSET)     /* Master Control Register  */
#define NXXX_LPI2C2_MSR                    (NXXX_LPI2C2_BASE + NXXX_LPI2C_MSR_OFFSET)     /* Master Status Register  */
#define NXXX_LPI2C2_MIER                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_MIER_OFFSET)    /* Master Interrupt Enable Register  */
#define NXXX_LPI2C2_MDER                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_MDER_OFFSET)    /* Master DMA Enable Register  */
#define NXXX_LPI2C2_MCFGR0                 (NXXX_LPI2C2_BASE + NXXX_LPI2C_MCFGR0_OFFSET)  /* Master Config Register 0  */
#define NXXX_LPI2C2_MCFGR1                 (NXXX_LPI2C2_BASE + NXXX_LPI2C_MCFGR1_OFFSET)  /* Master Config Register 1  */
#define NXXX_LPI2C2_MCFGR2                 (NXXX_LPI2C2_BASE + NXXX_LPI2C_MCFGR2_OFFSET)  /* Master Config Register 2  */
#define NXXX_LPI2C2_MCFGR3                 (NXXX_LPI2C2_BASE + NXXX_LPI2C_MCFGR3_OFFSET)  /* Master Config Register 3  */
#define NXXX_LPI2C2_MDMR                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_MDMR_OFFSET)    /* Master Data Match Register  */
#define NXXX_LPI2C2_MCCR0                  (NXXX_LPI2C2_BASE + NXXX_LPI2C_MCCR0_OFFSET)   /* Master Clock Configuration Register 0  */
#define NXXX_LPI2C2_MCCR1                  (NXXX_LPI2C2_BASE + NXXX_LPI2C_MCCR1_OFFSET)   /* Master Clock Configuration Register 1  */
#define NXXX_LPI2C2_MFCR                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_MFCR_OFFSET)    /* Master FIFO Control Register  */
#define NXXX_LPI2C2_MFSR                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_MFSR_OFFSET)    /* Master FIFO Status Register  */
#define NXXX_LPI2C2_MTDR                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_MTDR_OFFSET)    /* Master Transmit Data Register  */
#define NXXX_LPI2C2_MRDR                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_MRDR_OFFSET)    /* Master Receive Data Register  */
#define NXXX_LPI2C2_SCR                    (NXXX_LPI2C2_BASE + NXXX_LPI2C_SCR_OFFSET)     /* Slave Control Register  */
#define NXXX_LPI2C2_SSR                    (NXXX_LPI2C2_BASE + NXXX_LPI2C_SSR_OFFSET)     /* Slave Status Register  */
#define NXXX_LPI2C2_SIER                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_SIER_OFFSET)    /* Slave Interrupt Enable Register  */
#define NXXX_LPI2C2_SDER                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_SDER_OFFSET)    /* Slave DMA Enable Register  */
#define NXXX_LPI2C2_SCFGR1                 (NXXX_LPI2C2_BASE + NXXX_LPI2C_SCFGR1_OFFSET)  /* Slave Config Register 1  */
#define NXXX_LPI2C2_SCFGR2                 (NXXX_LPI2C2_BASE + NXXX_LPI2C_SCFGR2_OFFSET)  /* Slave Config Register 2  */
#define NXXX_LPI2C2_SAMR                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_SAMR_OFFSET)    /* Slave Address Match Register  */
#define NXXX_LPI2C2_SASR                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_SASR_OFFSET)    /* Slave Address Status Register  */
#define NXXX_LPI2C2_STAR                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_STAR_OFFSET)    /* Slave Transmit ACK Register  */
#define NXXX_LPI2C2_STDR                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_STDR_OFFSET)    /* Slave Transmit Data Register  */
#define NXXX_LPI2C2_SRDR                   (NXXX_LPI2C2_BASE + NXXX_LPI2C_SRDR_OFFSET)    /* Slave Receive Data Register  */

/* LPI2C3 Registers */

#define NXXX_LPI2C3_VERID                  (NXXX_LPI2C3_BASE + NXXX_LPI2C_VERID_OFFSET)   /* Version ID Register */
#define NXXX_LPI2C3_PARAM                  (NXXX_LPI2C3_BASE + NXXX_LPI2C_PARAM_OFFSET)   /* Parameter Register  */
#define NXXX_LPI2C3_MCR                    (NXXX_LPI2C3_BASE + NXXX_LPI2C_MCR_OFFSET)     /* Master Control Register  */
#define NXXX_LPI2C3_MSR                    (NXXX_LPI2C3_BASE + NXXX_LPI2C_MSR_OFFSET)     /* Master Status Register  */
#define NXXX_LPI2C3_MIER                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_MIER_OFFSET)    /* Master Interrupt Enable Register  */
#define NXXX_LPI2C3_MDER                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_MDER_OFFSET)    /* Master DMA Enable Register  */
#define NXXX_LPI2C3_MCFGR0                 (NXXX_LPI2C3_BASE + NXXX_LPI2C_MCFGR0_OFFSET)  /* Master Config Register 0  */
#define NXXX_LPI2C3_MCFGR1                 (NXXX_LPI2C3_BASE + NXXX_LPI2C_MCFGR1_OFFSET)  /* Master Config Register 1  */
#define NXXX_LPI2C3_MCFGR2                 (NXXX_LPI2C3_BASE + NXXX_LPI2C_MCFGR2_OFFSET)  /* Master Config Register 2  */
#define NXXX_LPI2C3_MCFGR3                 (NXXX_LPI2C3_BASE + NXXX_LPI2C_MCFGR3_OFFSET)  /* Master Config Register 3  */
#define NXXX_LPI2C3_MDMR                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_MDMR_OFFSET)    /* Master Data Match Register  */
#define NXXX_LPI2C3_MCCR0                  (NXXX_LPI2C3_BASE + NXXX_LPI2C_MCCR0_OFFSET)   /* Master Clock Configuration Register 0  */
#define NXXX_LPI2C3_MCCR1                  (NXXX_LPI2C3_BASE + NXXX_LPI2C_MCCR1_OFFSET)   /* Master Clock Configuration Register 1  */
#define NXXX_LPI2C3_MFCR                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_MFCR_OFFSET)    /* Master FIFO Control Register  */
#define NXXX_LPI2C3_MFSR                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_MFSR_OFFSET)    /* Master FIFO Status Register  */
#define NXXX_LPI2C3_MTDR                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_MTDR_OFFSET)    /* Master Transmit Data Register  */
#define NXXX_LPI2C3_MRDR                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_MRDR_OFFSET)    /* Master Receive Data Register  */
#define NXXX_LPI2C3_SCR                    (NXXX_LPI2C3_BASE + NXXX_LPI2C_SCR_OFFSET)     /* Slave Control Register  */
#define NXXX_LPI2C3_SSR                    (NXXX_LPI2C3_BASE + NXXX_LPI2C_SSR_OFFSET)     /* Slave Status Register  */
#define NXXX_LPI2C3_SIER                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_SIER_OFFSET)    /* Slave Interrupt Enable Register  */
#define NXXX_LPI2C3_SDER                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_SDER_OFFSET)    /* Slave DMA Enable Register  */
#define NXXX_LPI2C3_SCFGR1                 (NXXX_LPI2C3_BASE + NXXX_LPI2C_SCFGR1_OFFSET)  /* Slave Config Register 1  */
#define NXXX_LPI2C3_SCFGR2                 (NXXX_LPI2C3_BASE + NXXX_LPI2C_SCFGR2_OFFSET)  /* Slave Config Register 2  */
#define NXXX_LPI2C3_SAMR                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_SAMR_OFFSET)    /* Slave Address Match Register  */
#define NXXX_LPI2C3_SASR                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_SASR_OFFSET)    /* Slave Address Status Register  */
#define NXXX_LPI2C3_STAR                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_STAR_OFFSET)    /* Slave Transmit ACK Register  */
#define NXXX_LPI2C3_STDR                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_STDR_OFFSET)    /* Slave Transmit Data Register  */
#define NXXX_LPI2C3_SRDR                   (NXXX_LPI2C3_BASE + NXXX_LPI2C_SRDR_OFFSET)    /* Slave Receive Data Register  */

/* LPI2C4 Registers */

#define NXXX_LPI2C4_VERID                  (NXXX_LPI2C4_BASE + NXXX_LPI2C_VERID_OFFSET)   /* Version ID Register */
#define NXXX_LPI2C4_PARAM                  (NXXX_LPI2C4_BASE + NXXX_LPI2C_PARAM_OFFSET)   /* Parameter Register  */
#define NXXX_LPI2C4_MCR                    (NXXX_LPI2C4_BASE + NXXX_LPI2C_MCR_OFFSET)     /* Master Control Register  */
#define NXXX_LPI2C4_MSR                    (NXXX_LPI2C4_BASE + NXXX_LPI2C_MSR_OFFSET)     /* Master Status Register  */
#define NXXX_LPI2C4_MIER                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_MIER_OFFSET)    /* Master Interrupt Enable Register  */
#define NXXX_LPI2C4_MDER                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_MDER_OFFSET)    /* Master DMA Enable Register  */
#define NXXX_LPI2C4_MCFGR0                 (NXXX_LPI2C4_BASE + NXXX_LPI2C_MCFGR0_OFFSET)  /* Master Config Register 0  */
#define NXXX_LPI2C4_MCFGR1                 (NXXX_LPI2C4_BASE + NXXX_LPI2C_MCFGR1_OFFSET)  /* Master Config Register 1  */
#define NXXX_LPI2C4_MCFGR2                 (NXXX_LPI2C4_BASE + NXXX_LPI2C_MCFGR2_OFFSET)  /* Master Config Register 2  */
#define NXXX_LPI2C4_MCFGR3                 (NXXX_LPI2C4_BASE + NXXX_LPI2C_MCFGR3_OFFSET)  /* Master Config Register 3  */
#define NXXX_LPI2C4_MDMR                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_MDMR_OFFSET)    /* Master Data Match Register  */
#define NXXX_LPI2C4_MCCR0                  (NXXX_LPI2C4_BASE + NXXX_LPI2C_MCCR0_OFFSET)   /* Master Clock Configuration Register 0  */
#define NXXX_LPI2C4_MCCR1                  (NXXX_LPI2C4_BASE + NXXX_LPI2C_MCCR1_OFFSET)   /* Master Clock Configuration Register 1  */
#define NXXX_LPI2C4_MFCR                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_MFCR_OFFSET)    /* Master FIFO Control Register  */
#define NXXX_LPI2C4_MFSR                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_MFSR_OFFSET)    /* Master FIFO Status Register  */
#define NXXX_LPI2C4_MTDR                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_MTDR_OFFSET)    /* Master Transmit Data Register  */
#define NXXX_LPI2C4_MRDR                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_MRDR_OFFSET)    /* Master Receive Data Register  */
#define NXXX_LPI2C4_SCR                    (NXXX_LPI2C4_BASE + NXXX_LPI2C_SCR_OFFSET)     /* Slave Control Register  */
#define NXXX_LPI2C4_SSR                    (NXXX_LPI2C4_BASE + NXXX_LPI2C_SSR_OFFSET)     /* Slave Status Register  */
#define NXXX_LPI2C4_SIER                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_SIER_OFFSET)    /* Slave Interrupt Enable Register  */
#define NXXX_LPI2C4_SDER                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_SDER_OFFSET)    /* Slave DMA Enable Register  */
#define NXXX_LPI2C4_SCFGR1                 (NXXX_LPI2C4_BASE + NXXX_LPI2C_SCFGR1_OFFSET)  /* Slave Config Register 1  */
#define NXXX_LPI2C4_SCFGR2                 (NXXX_LPI2C4_BASE + NXXX_LPI2C_SCFGR2_OFFSET)  /* Slave Config Register 2  */
#define NXXX_LPI2C4_SAMR                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_SAMR_OFFSET)    /* Slave Address Match Register  */
#define NXXX_LPI2C4_SASR                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_SASR_OFFSET)    /* Slave Address Status Register  */
#define NXXX_LPI2C4_STAR                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_STAR_OFFSET)    /* Slave Transmit ACK Register  */
#define NXXX_LPI2C4_STDR                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_STDR_OFFSET)    /* Slave Transmit Data Register  */
#define NXXX_LPI2C4_SRDR                   (NXXX_LPI2C4_BASE + NXXX_LPI2C_SRDR_OFFSET)    /* Slave Receive Data Register  */
