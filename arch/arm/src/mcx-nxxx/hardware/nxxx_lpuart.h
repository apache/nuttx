/****************************************************************************
 * arch/arm/src/mcx-nxxx/hardware/nxxx_lpuart.h
 *
...
#ifndef __ARCH_ARM_SRC_MCX_NXXX_HARDWARE_NXXX_LPUART_H
#define __ARCH_ARM_SRC_MCX_NXXX_HARDWARE_NXXX_LPUART_H
...
#define NXXX_LPUART_VERID_OFFSET    (0x00) /* Version ID Register (VERID) */
#define NXXX_LPUART_PARAM_OFFSET    (0x04) /* Parameter Register (PARAM) */
#define NXXX_LPUART_GLOBAL_OFFSET   (0x08) /* LPUART Global Register (GLOBAL) */
#define NXXX_LPUART_PINCFG_OFFSET   (0x0c) /* LPUART Pin Configuration Register (PINCFG) */
#define NXXX_LPUART_BAUD_OFFSET     (0x10) /* LPUART Baud Rate Register (BAUD) */
#define NXXX_LPUART_STAT_OFFSET     (0x14) /* LPUART Status Register (STAT) */
#define NXXX_LPUART_CTRL_OFFSET     (0x18) /* LPUART Control Register (CTRL) */
#define NXXX_LPUART_DATA_OFFSET     (0x1c) /* LPUART Data Register (DATA) */
#define NXXX_LPUART_MATCH_OFFSET    (0x20) /* LPUART Match Address Register (MATCH) */
#define NXXX_LPUART_MODIR_OFFSET    (0x24) /* LPUART Modem IrDA Register (MODIR) */
#define NXXX_LPUART_FIFO_OFFSET     (0x28) /* LPUART FIFO Register (FIFO) */
#define NXXX_LPUART_WATER_OFFSET    (0x2c) /* LPUART Watermark Register (WATER) */
#define NXXX_LPUART_DATARO_OFFSET   (0x30) /* Data read-only Register (DATARO) */
...
#endif /* __ARCH_ARM_SRC_MCX_NXXX_HARDWARE_NXXX_LPUART_H */
