/****************************************************************************
 * arch/arm/src/mcx-nxxx/hardware/nxxx_lptmr.h
 *
...
#ifndef __ARCH_ARM_SRC_MCX_NXXX_HARDWARE_NXXX_LPTMR_H
#define __ARCH_ARM_SRC_MCX_NXXX_HARDWARE_NXXX_LPTMR_H
...
/* Clock sources
 * 0: FRO12 MHz clock source.
 * 1: FRO16 K clock source.
 * 2: OSC_32K or the FRO_32K.
 * 3: Crystal Oscillator
 */

#define LPTMR_PSR_PCS_SHIFT          (0) /* Bit[1:0]: Prescaler Clock Select */
#define LPTMR_PSR_PCS_MASK           (3 << LPTMR_PSR_PCS_SHIFT)
#define LPTMR_PSR_PCS_FRO_12M        (0 << LPTMR_PSR_PCS_SHIFT) /* FRO 12 MHz */
#define LPTMR_PSR_PCS_FRO_16K        (1 << LPTMR_PSR_PCS_SHIFT) /* FRO 16 KHz */
...
#endif /* __ARCH_ARM_SRC_MCX_NXXX_HARDWARE_NXXX_LPTMR_H */
