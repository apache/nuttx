/****************************************************************************
 * arch/arm/src/imx9/imx9_flexio.c
 *
...
static void imx9_flexio_reset(struct flexio_dev_s *dev);
static void imx9_flexio_enable(struct flexio_dev_s *dev, bool enable);
static uint32_t imx9_flexio_read_pin_input(struct flexio_dev_s *dev);
static uint8_t imx9_flexio_get_shifter_state(struct flexio_dev_s *dev);
static void imx9_flexio_set_shifter_config(struct flexio_dev_s *dev,
              uint8_t index,
              const struct flexio_shifter_config_s *shifter_config);
static void imx9_flexio_set_timer_config(struct flexio_dev_s *dev,
              uint8_t index,
              const struct flexio_timer_config_s *timer_config);
static void imx9_flexio_set_clock_mode(struct flexio_dev_s *dev,
              uint8_t index,
              enum flexio_timer_decrement_source_e clocksource);
static void imx9_flexio_enable_shifter_status_interrupts(
              struct flexio_dev_s *dev, uint32_t mask);
static void imx9_flexio_disable_shifter_status_interrupts(
              struct flexio_dev_s *dev, uint32_t mask);
static void imx9_flexio_enable_shifter_error_interrupts(
              struct flexio_dev_s *dev, uint32_t mask);
static void imx9_flexio_disable_shifter_error_interrupts(
              struct flexio_dev_s *dev, uint32_t mask);
static void imx9_flexio_enable_timer_status_interrupts(
              struct flexio_dev_s *dev, uint32_t mask);
static void imx9_flexio_disable_timer_status_interrupts(
              struct flexio_dev_s *dev, uint32_t mask);
static uint32_t imx9_flexio_get_shifter_status_flags(
              struct flexio_dev_s *dev);
static void imx9_flexio_clear_shifter_status_flags(
              struct flexio_dev_s *dev, uint32_t mask);
static uint32_t imx9_flexio_get_shifter_error_flags(
                  struct flexio_dev_s *dev);
static void imx9_flexio_clear_shifter_error_flags(
              struct flexio_dev_s *dev, uint32_t mask);
static uint32_t imx9_flexio_get_timer_status_flags(
                  struct flexio_dev_s *dev);
static void imx9_flexio_clear_timer_status_flags(
              struct flexio_dev_s *dev, uint32_t mask);
static void imx9_flexio_enable_shifter_status_dma(
              struct flexio_dev_s *dev, uint32_t mask, bool enable);
static uint32_t imx9_flexio_get_shifter_buffer_address(
                  struct flexio_dev_s *dev,
...
{
  .reset = imx9_flexio_reset,
  .enable = imx9_flexio_enable,
  .read_pin_input = imx9_flexio_read_pin_input,
  .get_shifter_state = imx9_flexio_get_shifter_state,
  .set_clock_mode = imx9_flexio_set_clock_mode,
  .enable_shifter_status_interrupts =
  imx9_flexio_enable_shifter_status_interrupts,
  .disable_shifter_status_interrupts =
  imx9_flexio_disable_shifter_status_interrupts,
  .enable_shifter_error_interrupts =
  imx9_flexio_enable_shifter_error_interrupts,
  .disable_shifter_error_interrupts =
  imx9_flexio_disable_shifter_error_interrupts,
  .enable_timer_status_interrupts =
  imx9_flexio_enable_timer_status_interrupts,
  .disable_timer_status_interrupts =
  imx9_flexio_disable_timer_status_interrupts,
  .get_shifter_status_flags = imx9_flexio_get_shifter_status_flags,
  .clear_shifter_status_flags = imx9_flexio_clear_shifter_status_flags,
  .get_shifter_error_flags = imx9_flexio_get_shifter_error_flags,
  .clear_shifter_error_flags = imx9_flexio_clear_shifter_error_flags,
  .get_timer_status_flags = imx9_flexio_get_timer_status_flags,
  .clear_timer_status_flags = imx9_flexio_clear_timer_status_flags,
  .enable_shifter_status_dma = imx9_flexio_enable_shifter_status_dma,
  .get_shifter_buffer_address = imx9_flexio_get_shifter_buffer_address,
  .set_shifter_config = imx9_flexio_set_shifter_config,
  .set_timer_config = imx9_flexio_set_timer_config,
};

#ifdef CONFIG_IMX9_FLEXIO1
static struct imx9_flexiodev_s g_flexio1_dev =
{
  .flexio =
  {
    .ops = &g_flexio_ops,
...
#ifdef CONFIG_IMX9_FLEXIO2
static struct imx9_flexiodev_s g_flexio2_dev =
{
  .flexio =
  {
    .ops = &g_flexio_ops,
...
static inline uint32_t imx9_flexio_getreg32(struct flexio_dev_s *dev,
                                             uint32_t offset);
static inline void imx9_flexio_putreg32(struct flexio_dev_s *dev,
                                         uint32_t value, uint32_t offset);

static inline void imx9_flexio_modifyreg32(struct flexio_dev_s *dev,
                                            unsigned int offset,
                                            uint32_t clearbits,
                                            uint32_t setbits);
...
static inline uint32_t imx9_flexio_getreg32(struct flexio_dev_s *dev,
                                             uint32_t offset)
{
  return getreg32(((struct imx9_flexiodev_s *)dev)->base + offset);
}

/****************************************************************************
 * Name: imx9_flexio_putreg32
 *
 * Description:
...
static inline void imx9_flexio_modifyreg32(struct flexio_dev_s *dev,
                                            ...
                                            uint32_t setbits)
{
  modifyreg32(((struct imx9_flexiodev_s *)dev)->base + offset, clearbits,
              setbits);
}
...
static inline void imx9_flexio_putreg32(struct flexio_dev_s *dev,
                                         uint32_t value, uint32_t offset)
{
  putreg32(value, ((struct imx9_flexiodev_s *)dev)->base + offset);
}
...
static void imx9_flexio_reset(struct flexio_dev_s *dev)
{
  ...
  imx9_flexio_modifyreg32(dev, IMX9_FLEXIO_CTRL_OFFSET, 0,
                           FLEXIO_CTRL_SWRST_MASK);
  imx9_flexio_putreg32(dev, 0, IMX9_FLEXIO_CTRL_OFFSET);
}
...
static void imx9_flexio_enable(struct flexio_dev_s *dev, bool enable)
{
  if (enable)
    ...
    {
      imx9_flexio_modifyreg32(dev, IMX9_FLEXIO_CTRL_OFFSET,
...
static uint32_t imx9_flexio_read_pin_input(struct flexio_dev_s *dev)
{
  ...
  regval = imx9_flexio_getreg32(dev, IMX9_FLEXIO_PIN_OFFSET);
...
static uint8_t imx9_flexio_get_shifter_state(struct flexio_dev_s *dev)
{
  ...
  regval = imx9_flexio_getreg32(dev, IMX9_FLEXIO_SHIFTSTATE_OFFSET);
 ...
 * };
 * imx9_flexio_set_shifter_config(dev, &config);
 * endcode
 *
              ...
              const struct flexio_shifter_config_s *shifter_config)
{
  ...
  imx9_flexio_putreg32(dev, regval,
                        IMX9_FLEXIO_SHIFTCFG0_OFFSET + index * 0x4);
  ...
  imx9_flexio_putreg32(dev, regval,
                        IMX9_FLEXIO_SHIFTCTL0_OFFSET + index * 0x4);
}
 ...
 * };
 * imx9_flexio_set_timer_config(dev, &config);
 * endcode
 *
              ...
              const struct flexio_timer_config_s *timer_config)
{
  ...
  imx9_flexio_putreg32(dev, regval,
                        IMX9_FLEXIO_TIMCFG0_OFFSET + index * 0x4);

  regval = FLEXIO_TIMCMP_CMP(timer_config->timer_compare);

  imx9_flexio_putreg32(dev, regval,
                        IMX9_FLEXIO_TIMCMP0_OFFSET + index * 0x4);
  ...
  imx9_flexio_putreg32(dev, regval,
                        IMX9_FLEXIO_TIMCTL0_OFFSET + index * 0x4);
}
...
static void imx9_flexio_set_clock_mode(struct flexio_dev_s *dev,
              ...
              enum flexio_timer_decrement_source_e clocksource)
{
  imx9_flexio_modifyreg32(dev, IMX9_FLEXIO_TIMCFG0_OFFSET + index * 0x4,
...
static void imx9_flexio_enable_shifter_status_interrupts(
              struct flexio_dev_s *dev, uint32_t mask)
{
  imx9_flexio_modifyreg32(dev, IMX9_FLEXIO_SHIFTSIEN_OFFSET, 0, mask);
}
...
static void imx9_flexio_disable_shifter_status_interrupts(
              struct flexio_dev_s *dev, uint32_t mask)
{
  imx9_flexio_modifyreg32(dev, IMX9_FLEXIO_SHIFTSIEN_OFFSET, mask, 0);
}
...
static void imx9_flexio_enable_shifter_error_interrupts(
              struct flexio_dev_s *dev, uint32_t mask)
{
  imx9_flexio_modifyreg32(dev, IMX9_FLEXIO_SHIFTEIEN_OFFSET, 0, mask);
}
...
static void imx9_flexio_disable_shifter_error_interrupts(
              struct flexio_dev_s *dev, uint32_t mask)
{
  imx9_flexio_modifyreg32(dev, IMX9_FLEXIO_SHIFTEIEN_OFFSET, mask, 0);
}
...
static void imx9_flexio_enable_timer_status_interrupts(
              struct flexio_dev_s *dev, uint32_t mask)
{
  imx9_flexio_modifyreg32(dev, IMX9_FLEXIO_TIMIEN_OFFSET, 0, mask);
}
...
static void imx9_flexio_disable_timer_status_interrupts(
              struct flexio_dev_s *dev, uint32_t mask)
{
  imx9_flexio_modifyreg32(dev, IMX9_FLEXIO_TIMIEN_OFFSET, mask, 0);
}
                  ...
                  struct flexio_dev_s *dev)
{
  ...
  regval = imx9_flexio_getreg32(dev, IMX9_FLEXIO_SHIFTSTAT_OFFSET);
...
static void imx9_flexio_clear_shifter_status_flags(
              struct flexio_dev_s *dev, uint32_t mask)
{
  imx9_flexio_putreg32(dev, mask, IMX9_FLEXIO_SHIFTSTAT_OFFSET);
}
                  ...
                  struct flexio_dev_s *dev)
{
  ...
  regval = imx9_flexio_getreg32(dev, IMX9_FLEXIO_SHIFTERR_OFFSET);
...
static void imx9_flexio_clear_shifter_error_flags(struct flexio_dev_s *dev,
                                                   uint32_t mask)
{
  imx9_flexio_putreg32(dev, mask, IMX9_FLEXIO_SHIFTERR_OFFSET);
}
...
static uint32_t imx9_flexio_get_timer_status_flags(struct flexio_dev_s *dev)
{
  uint32_t regval;
...
static void imx9_flexio_clear_timer_status_flags(struct flexio_dev_s *dev,
                                                  uint32_t mask)
{
  imx9_flexio_putreg32(dev, mask, IMX9_FLEXIO_TIMSTAT_OFFSET);
}
...
static void imx9_flexio_enable_shifter_status_dma(struct flexio_dev_s *dev,
                                                  uint32_t mask, bool enable)
{
  if (enable)
    {
      imx9_flexio_modifyreg32(dev, IMX9_FLEXIO_SHIFTSDEN_OFFSET, 0, mask);
    }
  else
    {
      imx9_flexio_modifyreg32(dev, IMX9_FLEXIO_SHIFTSDEN_OFFSET, mask, 0);
    }
}
 ...
 * imx9_flexio_get_default_config().
 *
 * Example
 * code
...
static void imx9_flexio_init(struct flexio_dev_s *dev,
                              const struct flexio_config_s *user_config)
{
  imx9_flexio_reset(dev);
 ...
 * code
 * struct flexio_config_s config;
 * imx9_flexio_get_default_config(&config);
 * endcode
 *
 * param user_config pointer to flexio_config_s structure
 */

static void imx9_flexio_get_default_config(
                  ...
                  enum flexio_shifter_buffer_type_e type, uint8_t index)
{
  ...
  switch (type)
    ...
    case FLEXIO_SHIFTER_BUFFER:
      address = (uint32_t)(((struct imx9_flexiodev_s *)dev)->base +
                           IMX9_FLEXIO_SHIFTBUF0_OFFSET + index * 0x4);
      break;

    case FLEXIO_SHIFTER_BUFFER_BIT_SWAPPED:
      address = (uint32_t)(((struct imx9_flexiodev_s *)dev)->base +
                           IMX9_FLEXIO_SHIFTBUFBIS0_OFFSET + index * 0x4);
      break;

    case FLEXIO_SHIFTER_BUFFER_BYTE_SWAPPED:
      address = (uint32_t)(((struct imx9_flexiodev_s *)dev)->base +
                           IMX9_FLEXIO_SHIFTBUFBYS0_OFFSET + index * 0x4);
      break;

    case FLEXIO_SHIFTER_BUFFER_BIT_BYTE_SWAPPED:
      address = (uint32_t)(((struct imx9_flexiodev_s *)dev)->base +
                           IMX9_FLEXIO_SHIFTBUFBBS0_OFFSET + index * 0x4);
      break;

    case FLEXIO_SHIFTER_BUFFER_NIBBLE_BYTE_SWAPPED:
      address = (uint32_t)(((struct imx9_flexiodev_s *)dev)->base +
                           IMX9_FLEXIO_SHIFTBUFNBS0_OFFSET + index * 0x4);
      break;

    case FLEXIO_SHIFTER_BUFFER_HALF_WORD_SWAPPED:
      address = (uint32_t)(((struct imx9_flexiodev_s *)dev)->base +
                           IMX9_FLEXIO_SHIFTBUFHWS0_OFFSET + index * 0x4);
      break;

    case FLEXIO_SHIFTER_BUFFER_NIBBLE_SWAPPED:
      address = (uint32_t)(((struct imx9_flexiodev_s *)dev)->base +
                           IMX9_FLEXIO_SHIFTBUFNIS0_OFFSET + index * 0x4);
      break;
...
struct flexio_dev_s *imx9_flexio_initialize(int intf)
{
  ...
  switch (intf)
    ...
    case 1:
      priv = &g_flexio1_dev;
      imx9_clockall_flexio1();
      break;
#endif
#ifdef CONFIG_IMX9_FLEXIO2
    case 2:
      priv = &g_flexio2_dev;
      imx9_clockall_flexio2();
      break;
#endif
#ifdef CONFIG_IMX9_FLEXIO3
    case 3:
      priv = &g_flexio3_dev;
      imx9_clockall_flexio2();
      break;
  ...
  if (!priv->initialized)
    {
      ...
      imx9_flexio_get_default_config(&flexio_config);
      imx9_flexio_init((struct flexio_dev_s *)priv, &flexio_config);
