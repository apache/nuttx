...
#define GPIO_FDCAN1_TX_3               (GPIO_ALT | GPIO_AF9 | GPIO_PUSHPULL | GPIO_PORTD | GPIO_PIN1)
...
#define GPIO_I2C4_SMBA_0               (GPIO_ALT | GPIO_AF3 | GPIO_PUSHPULL | GPIO_PORTA | GPIO_PIN14)
...
#define GPIO_QUADSPI1_BK1_IO0_0        (GPIO_ALT | GPIO_AF10 | GPIO_PORTB | GPIO_PIN1)
...
#define GPIO_QUADSPI1_BK2_IO0_0        (GPIO_ALT | GPIO_AF10 | GPIO_PORTC | GPIO_PIN1)
...
#define GPIO_QUADSPI1_BK2_IO2_0        (GPIO_ALT | GPIO_AF10 | GPIO_PORTC | GPIO_PIN3)
#define GPIO_QUADSPI1_BK2_IO3_0        (GPIO_ALT | GPIO_AF10 | GPIO_PORTC | GPIO_PIN4)
 ...
 * (for now). Granted, these are in the "additional function" column, not
 * the "alternate function" column.
 */
...
#define GPIO_SAI1_D2_0                 (GPIO_ALT | GPIO_AF3 | GPIO_PORTB | GPIO_PIN9)
#define GPIO_SAI1_D3_0                 (GPIO_ALT | GPIO_AF3 | GPIO_PORTC | GPIO_PIN5)
...
#define GPIO_TIM1_CH4NOUT_0            (GPIO_ALT | GPIO_AF6 | GPIO_PUSHPULL | GPIO_PORTC | GPIO_PIN5)
...
#define GPIO_TIM4_CH4IN_0              (GPIO_ALT | GPIO_AF2 | GPIO_FLOAT | GPIO_PORTB | GPIO_PIN9)
#define GPIO_TIM4_CH4OUT_0             (GPIO_ALT | GPIO_AF2 | GPIO_PUSHPULL | GPIO_PORTB | GPIO_PIN9)
...
#define GPIO_TIM5_CH3IN_0              (GPIO_ALT | GPIO_AF2 | GPIO_FLOAT | GPIO_PORTA | GPIO_PIN2)
#define GPIO_TIM5_CH3OUT_0             (GPIO_ALT | GPIO_AF2 | GPIO_PUSHPULL | GPIO_PORTA | GPIO_PIN2)
#define GPIO_TIM5_CH4IN_0              (GPIO_ALT | GPIO_AF2 | GPIO_FLOAT | GPIO_PORTA | GPIO_PIN3)
#define GPIO_TIM5_CH4OUT_0             (GPIO_ALT | GPIO_AF2 | GPIO_PUSHPULL | GPIO_PORTA | GPIO_PIN3)
#define GPIO_TIM5_ETR_0                (GPIO_ALT | GPIO_AF2 | GPIO_FLOAT | GPIO_PORTB | GPIO_PIN12)
...
#define GPIO_TIM8_CH4IN_0              (GPIO_ALT | GPIO_AF4 | GPIO_FLOAT | GPIO_PORTC | GPIO_PIN9)
#define GPIO_TIM8_CH4NIN_0             (GPIO_ALT | GPIO_AF6 | GPIO_FLOAT | GPIO_PORTC | GPIO_PIN13)
#define GPIO_TIM8_CH4NOUT_0            (GPIO_ALT | GPIO_AF6 | GPIO_PUSHPULL | GPIO_PORTC | GPIO_PIN13)
#define GPIO_TIM8_CH4OUT_0             (GPIO_ALT | GPIO_AF4 | GPIO_PUSHPULL | GPIO_PORTC | GPIO_PIN9)
...
#define GPIO_TIM20_CH1IN_0             (GPIO_ALT | GPIO_AF3 | GPIO_FLOAT | GPIO_PORTB | GPIO_PIN2)
#define GPIO_TIM20_CH1OUT_0            (GPIO_ALT | GPIO_AF3 | GPIO_PUSHPULL | GPIO_PORTB | GPIO_PIN2)
#define GPIO_TIM20_CH2IN_0             (GPIO_ALT | GPIO_AF6 | GPIO_FLOAT | GPIO_PORTC | GPIO_PIN2)
#define GPIO_TIM20_CH2OUT_0            (GPIO_ALT | GPIO_AF6 | GPIO_PUSHPULL | GPIO_PORTC | GPIO_PIN2)
#define GPIO_TIM20_CH3IN_0             (GPIO_ALT | GPIO_AF6 | GPIO_FLOAT | GPIO_PORTC | GPIO_PIN8)
#define GPIO_TIM20_CH3OUT_0            (GPIO_ALT | GPIO_AF6 | GPIO_PUSHPULL | GPIO_PORTC | GPIO_PIN8)
...
#define GPIO_USART3_DE_0               (GPIO_ALT | GPIO_AF7 | GPIO_PORTB | GPIO_PIN14)
...
#define GPIO_USART3_RTS_0              (GPIO_ALT | GPIO_AF7 | GPIO_PORTB | GPIO_PIN14)
