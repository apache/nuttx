...
#define GPIO_COMP5_OUT_0               (GPIO_ALT | GPIO_AF8 | GPIO_PORTA | GPIO_PIN9)
...
#define GPIO_COMP7_OUT_0               (GPIO_ALT | GPIO_AF8 | GPIO_PORTA | GPIO_PIN8)
...
#define GPIO_HRTIM1_FLT5_0             (GPIO_ALT | GPIO_AF13 | GPIO_PORTB | GPIO_PIN0)
...
#define GPIO_I2C3_SDA_2                (GPIO_ALT | GPIO_AF8 | GPIO_OPENDRAIN | GPIO_PORTC | GPIO_PIN11)
...
#define GPIO_I2C4_SDA_0                (GPIO_ALT | GPIO_AF3 | GPIO_OPENDRAIN | GPIO_PORTB | GPIO_PIN7)
...
#define GPIO_QUADSPI1_BK2_IO1_0        (GPIO_ALT | GPIO_AF10 | GPIO_PORTB | GPIO_PIN2)
...
#define GPIO_TIM1_CH1IN_0              (GPIO_ALT | GPIO_AF6 | GPIO_FLOAT | GPIO_PORTA | GPIO_PIN8)
...
#define GPIO_TIM1_CH1OUT_0             (GPIO_ALT | GPIO_AF6 | GPIO_PUSHPULL | GPIO_PORTA | GPIO_PIN8)
#define GPIO_TIM1_CH2IN_0              (GPIO_ALT | GPIO_AF6 | GPIO_FLOAT | GPIO_PORTA | GPIO_PIN9)
...
#define GPIO_TIM1_CH2OUT_0             (GPIO_ALT | GPIO_AF6 | GPIO_PUSHPULL | GPIO_PORTA | GPIO_PIN9)
#define GPIO_TIM1_CH3IN_0              (GPIO_ALT | GPIO_AF6 | GPIO_FLOAT | GPIO_PORTA | GPIO_PIN10)
...
#define GPIO_TIM1_CH3OUT_0             (GPIO_ALT | GPIO_AF6 | GPIO_PUSHPULL | GPIO_PORTA | GPIO_PIN10)
#define GPIO_TIM1_CH4IN_0              (GPIO_ALT | GPIO_AF11 | GPIO_FLOAT | GPIO_PORTA | GPIO_PIN11)
#define GPIO_TIM1_CH4NIN_0             (GPIO_ALT | GPIO_AF6 | GPIO_FLOAT | GPIO_PORTC | GPIO_PIN5)
#define GPIO_TIM1_CH4OUT_0             (GPIO_ALT | GPIO_AF11 | GPIO_PUSHPULL | GPIO_PORTA | GPIO_PIN11)
#define GPIO_TIM1_ETR_0                (GPIO_ALT | GPIO_AF11 | GPIO_FLOAT | GPIO_PORTA | GPIO_PIN12)
...
#define GPIO_TIM3_CH3IN_0              (GPIO_ALT | GPIO_AF2 | GPIO_FLOAT | GPIO_PORTB | GPIO_PIN0)
#define GPIO_TIM3_CH3OUT_0             (GPIO_ALT | GPIO_AF2 | GPIO_PUSHPULL | GPIO_PORTB | GPIO_PIN0)
...
#define GPIO_TIM3_ETR_0                (GPIO_ALT | GPIO_AF10 | GPIO_FLOAT | GPIO_PORTB | GPIO_PIN3)
...
#define GPIO_TIM5_CH2IN_0              (GPIO_ALT | GPIO_AF2 | GPIO_FLOAT | GPIO_PORTA | GPIO_PIN1)
#define GPIO_TIM5_CH2OUT_0             (GPIO_ALT | GPIO_AF2 | GPIO_PUSHPULL | GPIO_PORTA | GPIO_PIN1)
...
#define GPIO_TIM8_CH3IN_0              (GPIO_ALT | GPIO_AF10 | GPIO_FLOAT | GPIO_PORTB | GPIO_PIN9)
...
#define GPIO_TIM8_CH3OUT_0             (GPIO_ALT | GPIO_AF10 | GPIO_PUSHPULL | GPIO_PORTB | GPIO_PIN9)
...
#define GPIO_USART3_CK_0               (GPIO_ALT | GPIO_AF7 | GPIO_PORTB | GPIO_PIN12)
