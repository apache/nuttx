...
#ifdef SERIAL_HAVE_RXDMA
static unsigned int s32k3xx_dma_nextrx(struct s32k3xx_uart_s *priv)
{
  unsigned int dmaresidual = s32k3xx_dmach_getcount(priv->rxdma);
  ...
  if (priv->dma_rxreqsrc != 0)
    {
      ...
      /* Enable itnerrupt on Idle and errors */
