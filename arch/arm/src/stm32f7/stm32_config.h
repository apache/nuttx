...
#if STM32_NUART < 1
#  undef CONFIG_STM32_UART0
#  undef CONFIG_STM32_UART1
#  undef CONFIG_STM32_UART2
#  undef CONFIG_STM32_UART3
...
#if defined(CONFIG_STM32_UART0) || defined(CONFIG_STM32_UART1) || \
    defined(CONFIG_STM32_UART2) || defined(CONFIG_STM32_UART3) || \
...
#if defined(CONFIG_STM32_USART0) || defined(CONFIG_STM32_USART1) || \
...
#if defined(CONFIG_UART0_SERIAL_CONSOLE) && defined(CONFIG_STM32_UART0)
...
#elif defined(CONFIG_UART1_SERIAL_CONSOLE) && defined(CONFIG_STM32_UART1)
...
#  undef CONFIG_USART2_SERIAL_CONSOLE
#  define HAVE_SERIAL_CONSOLE 1
#elif defined(CONFIG_UART2_SERIAL_CONSOLE) && defined(CONFIG_STM32_UART2)
#  undef CONFIG_UART0_SERIAL_CONSOLE
#  undef CONFIG_UART1_SERIAL_CONSOLE
#  undef CONFIG_UART3_SERIAL_CONSOLE
#  undef CONFIG_UART4_SERIAL_CONSOLE
...
#  undef CONFIG_USART2_SERIAL_CONSOLE
#  define HAVE_SERIAL_CONSOLE 1
#elif defined(CONFIG_UART3_SERIAL_CONSOLE) && defined(CONFIG_STM32_UART3)
#  undef CONFIG_UART0_SERIAL_CONSOLE
#  undef CONFIG_UART1_SERIAL_CONSOLE
#  undef CONFIG_UART2_SERIAL_CONSOLE
#  undef CONFIG_UART4_SERIAL_CONSOLE
...
#  undef CONFIG_USART2_SERIAL_CONSOLE
#  define HAVE_SERIAL_CONSOLE 1
#elif defined(CONFIG_USART0_SERIAL_CONSOLE) && defined(CONFIG_STM32_USART0)
#  undef CONFIG_UART0_SERIAL_CONSOLE
#  undef CONFIG_UART1_SERIAL_CONSOLE
#  undef CONFIG_UART2_SERIAL_CONSOLE
#  undef CONFIG_UART3_SERIAL_CONSOLE
...
#if CHIP_NSPI < 1
#  undef CONFIG_STM32_SPI0
#  undef CONFIG_STM32_SPI1
#elif CHIP_NSPI < 2
#  undef CONFIG_STM32_SPI1
#endif

#ifndef CONFIG_STM32_HAVE_SPI
#  undef CONFIG_STM32_SPI0
#  undef CONFIG_STM32_SPI1
#endif
...
#if !defined(CONFIG_STM32_SPI0) && !defined(CONFIG_STM32_SPI0)
#  undef CONFIG_STM32_HAVE_SPI
#endif
