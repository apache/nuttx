...
/* If CONFIG_STM32_DSIHOST is defined in the board configuration, then
...
#  if defined(CONFIG_STM32_INTERNAL_ULPI) || \
      defined(CONFIG_STM32_EXTERNAL_ULPI)
...
#if defined(CONFIG_STM32_SPI2) || defined(CONFIG_STM32_I2S2)
  /* SPI2 clock enable */

  regval |= RCC_APB1ENR_SPI2EN;
#endif

#if defined(CONFIG_STM32_SPI3) || defined(CONFIG_STM32_I2S3)
  /* SPI3 clock enable */

  regval |= RCC_APB1ENR_SPI3EN;
#endif

#ifdef CONFIG_STM32_SPDIFRX
...
#ifdef CONFIG_STM32_FLASH_ART_ACCELERATOR
