...
#ifndef __ARCH_ARM_SRC_NRF53_HARDWARE_NRF53_GPIOTE_H
#define __ARCH_ARM_SRC_NRF53_HARDWARE_NRF53_GPIOTE_H
...
#define NRF53_GPIOTE_TASKS_OUT_OFFSET(x)    (0x0000 + (0x04 * x)) /* TASKS_OUT[x] */
#define NRF53_GPIOTE_TASKS_SET_OFFSET(x)    (0x0030 + (0x04 * x)) /* TASKS_SET[x] */
#define NRF53_GPIOTE_TASKS_CLR_OFFSET(x)    (0x0060 + (0x04 * x)) /* TASKS_CLR[x] */
                                                                  /* todo: subscribe */
#define NRF53_GPIOTE_EVENTS_IN_OFFSET(x)    (0x0100 + (0x04 * x)) /* EVENTS_IN[x] */
#define NRF53_GPIOTE_EVENTS_PORT_OFFSET     0x017c                /* EVENTS_PORT */
                                                                  /* todo: publish */
#define NRF53_GPIOTE_INTENSET_OFFSET        0x0304                /* INTENSET */
#define NRF53_GPIOTE_INTENCLR_OFFSET        0x0308                /* INTENCLR */
#define NRF53_GPIOTE_CONFIG_OFFSET(x)       (0x0510 + (0x04 * x)) /* CONFIG[x] */

/* Register addresses for GPIOTE ********************************************/

#define NRF53_GPIOTE_TASKS_OUT(x)           (NRF53_GPIOTE_BASE + NRF53_GPIOTE_TASKS_OUT_OFFSET(x))
#define NRF53_GPIOTE_TASKS_SET(x)           (NRF53_GPIOTE_BASE + NRF53_GPIOTE_TASKS_SET_OFFSET(x))
#define NRF53_GPIOTE_TASKS_CLR(x)           (NRF53_GPIOTE_BASE + NRF53_GPIOTE_TASKS_CLR_OFFSET(x))
#define NRF53_GPIOTE_EVENTS_IN(x)           (NRF53_GPIOTE_BASE + NRF53_GPIOTE_EVENTS_IN_OFFSET(x))
#define NRF53_GPIOTE_EVENTS_PORT            (NRF53_GPIOTE_BASE + NRF53_GPIOTE_EVENTS_PORT_OFFSET)
#define NRF53_GPIOTE_INTENSET               (NRF53_GPIOTE_BASE + NRF53_GPIOTE_INTENSET_OFFSET)
#define NRF53_GPIOTE_INTENCLR               (NRF53_GPIOTE_BASE + NRF53_GPIOTE_INTENCLR_OFFSET)
#define NRF53_GPIOTE_CONFIG(x)              (NRF53_GPIOTE_BASE + NRF53_GPIOTE_CONFIG_OFFSET(x))
...
#endif /* __ARCH_ARM_SRC_NRF53_HARDWARE_NRF53_GPIOTE_H */
