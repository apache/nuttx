 ...
 *   programming functions for read/write access to the region of on-chip
 *   QSPI flash that lies beyond the NuttX binary image.
 *
 * Returned Value:
 *   A pointer to the MTD device on success; NULL on failure (errno set).
 *
 ****************************************************************************/
