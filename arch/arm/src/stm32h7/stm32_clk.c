  ...
  for (i = 0;
       ...
       i++)
    {
      clk_register_gate(
        ...
        "cdppre1",
        CLK_NAME_IS_STATIC | CLK_PARENT_NAME_IS_STATIC,
        stm32h7_apb1_tim_gates[i].gate.reg,
        stm32h7_apb1_tim_gates[i].gate.bit_idx,
        stm32h7_apb1_tim_gates[i].gate.flags
      );
    }
  ...
  for (i = 0;
       ...
       i++)
    {
      clk_register_gate(
        ...
        "cdppre2",
        CLK_NAME_IS_STATIC | CLK_PARENT_NAME_IS_STATIC,
        stm32h7_apb2_tim_gates[i].gate.reg,
        stm32h7_apb2_tim_gates[i].gate.bit_idx,
        stm32h7_apb2_tim_gates[i].gate.flags
      );
    }
}
