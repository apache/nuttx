...
#  define STM32_GPIOM_MODER        (STM32_GPIOM_BASE+STM32_GPIO_MODER_OFFSET)
#  define STM32_GPIOM_OTYPER       (STM32_GPIOM_BASE+STM32_GPIO_OTYPER_OFFSET)
#  define STM32_GPIOM_OSPEED       (STM32_GPIOM_BASE+STM32_GPIO_OSPEED_OFFSET)
#  define STM32_GPIOM_PUPDR        (STM32_GPIOM_BASE+STM32_GPIO_PUPDR_OFFSET)
#  define STM32_GPIOM_IDR          (STM32_GPIOM_BASE+STM32_GPIO_IDR_OFFSET)
#  define STM32_GPIOM_ODR          (STM32_GPIOM_BASE+STM32_GPIO_ODR_OFFSET)
#  define STM32_GPIOM_BSRR         (STM32_GPIOM_BASE+STM32_GPIO_BSRR_OFFSET)
#  define STM32_GPIOM_LCKR         (STM32_GPIOM_BASE+STM32_GPIO_LCKR_OFFSET)
#  define STM32_GPIOM_AFRL         (STM32_GPIOM_BASE+STM32_GPIO_AFRL_OFFSET)
#  define STM32_GPIOM_AFRH         (STM32_GPIOM_BASE+STM32_GPIO_AFRH_OFFSET)
#endif
