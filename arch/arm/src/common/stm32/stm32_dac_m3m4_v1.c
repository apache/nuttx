/****************************************************************************
 * arch/arm/src/common/stm32/stm32_dac_m3m4_v1.c
 *
...
/* DMA stream/channel configuration.  The register layout depends on the DMA
 * IP version, not the DAC IP version: stream DMA (IPv2) uses the SCR
 * register fields, while channel DMA (IPv1) uses the CCR register fields.
 */
...
#if 0 /* defined(CONFIG_STM32_HAVE_IP_DAC_M3M4_V1) */
