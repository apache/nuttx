...
#ifndef __ARCH_ARM_SRC_COMMON_COMPAT_STM32_TIM_H
#define __ARCH_ARM_SRC_COMMON_COMPAT_STM32_TIM_H
...
#  include "stm32_tim_m3m4_v1v2v3.h"
#else
#  error "Unsupported STM32 TIM"
#endif

#endif /* __ARCH_ARM_SRC_COMMON_COMPAT_STM32_TIM_H */
