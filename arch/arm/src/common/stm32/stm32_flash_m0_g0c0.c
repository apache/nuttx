/****************************************************************************
 * arch/arm/src/common/stm32/stm32_flash_m0_g0c0.c
 *
...
#define FLASH_PAGE_SIZE     8
    ...
    !defined(CONFIG_STM32_FLASH_OVERRIDE)
#  error "No valid flash configuration was defined."
#endif

#ifdef CONFIG_STM32_FLASH_OVERRIDE
#  undef CONFIG_STM32_FLASH_CONFIG_4
#  undef CONFIG_STM32_FLASH_CONFIG_6
...
#  if defined(CONFIG_STM32_FLASH_OVERRIDE_4)
#    define CONFIG_STM32_FLASH_CONFIG_4
#  elif defined(CONFIG_STM32_FLASH_OVERRIDE_6)
#    define CONFIG_STM32_FLASH_CONFIG_6
#  elif defined(CONFIG_STM32_FLASH_OVERRIDE_8)
