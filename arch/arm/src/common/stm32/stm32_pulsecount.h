/****************************************************************************
 * arch/arm/src/common/stm32/stm32_pulsecount.h
 *
...
#ifndef __ARCH_ARM_SRC_COMMON_COMPAT_STM32_PULSECOUNT_H
#define __ARCH_ARM_SRC_COMMON_COMPAT_STM32_PULSECOUNT_H
