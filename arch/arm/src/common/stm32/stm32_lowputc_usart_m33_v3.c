/****************************************************************************
 * arch/arm/src/common/stm32/stm32_lowputc_usart_m33_v3.c
 *
...
#    define STM32_CONSOLE_IS_LPUART 1
...
#    define STM32_CONSOLE_IS_LPUART 0
#    define STM32_CONSOLE_BASE      STM32_USART1_BASE
#    define STM32_APBCLOCK          STM32_USART1_FREQUENCY
#    define STM32_CONSOLE_APBREG    STM32_USART1_RCC_REG
#    define STM32_CONSOLE_APBEN     STM32_USART1_RCC_EN
...
#    define STM32_CONSOLE_APBREG    STM32_USART2_RCC_REG
#    define STM32_CONSOLE_APBEN     STM32_USART2_RCC_EN
...
#    define STM32_CONSOLE_APBREG    STM32_USART3_RCC_REG
#    define STM32_CONSOLE_APBEN     STM32_USART3_RCC_EN
...
#    define STM32_CONSOLE_APBREG    STM32_UART4_RCC_REG
#    define STM32_CONSOLE_APBEN     STM32_UART4_RCC_EN
...
#    define STM32_CONSOLE_APBREG    STM32_UART5_RCC_REG
#    define STM32_CONSOLE_APBEN     STM32_UART5_RCC_EN
...
#  define USART_CR3_SETBITS 0
  ...
  /* Calculate all baud rate dividers, rounded to the nearest integer.
   * LPUART uses 256 * fCK / baud.  USART uses fCK / baud for oversampling
   * by 16, or 2 * fCK / baud for oversampling by 8.
   */

#  define STM32_LPUART_BRR_VALUE \
...
#  define STM32_USART_BRR_VALUE \
      (STM32_USARTDIV8 > 2000 ? STM32_USARTDIV16 : \
...
void stm32_lowsetup(void)
{
  ...
  if (STM32_CONSOLE_IS_LPUART)
    {
      putreg32(STM32_LPUART_BRR_VALUE,
               STM32_CONSOLE_BASE + STM32_USART_BRR_OFFSET);
    }
  else
    {
      putreg32(STM32_USART_BRR_VALUE,
               STM32_CONSOLE_BASE + STM32_USART_BRR_OFFSET);
    }

  /* Only USART uses oversampling by 8, and only for small divisors. */

  cr  = getreg32(STM32_CONSOLE_BASE + STM32_USART_CR1_OFFSET);

  if (!STM32_CONSOLE_IS_LPUART && STM32_USARTDIV8 <= 2000)
    {
      cr |= USART_CR1_OVER8;
    }
  else
