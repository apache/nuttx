/****************************************************************************
 * arch/arm/src/max326xx/hardware/max32690_gcr.h
 *
...
#ifndef __ARCH_ARM_SRC_MAX326XX_HARDWARE_MAX32690_GCR_H
#define __ARCH_ARM_SRC_MAX326XX_HARDWARE_MAX32690_GCR_H
...
#define GCR_PCLKDIS0_GPIO1D         (1 << 1)  /* Bit 1:  GPIO1 Port and Pad Logic Clock Disable */
#define GCR_PCLKDIS0_GPIO2D         (1 << 2)  /* Bit 2:  GPIO2 Port and Pad Logic Clock Disable */
#define GCR_PCLKDIS0_USBD           (1 << 3)  /* Bit 3:  UDB Clock Disable */
#define GCR_PCLKDIS0_DMAD           (1 << 5)  /* Bit 5:  Standard DMA Clock Disable */
#define GCR_PCLKDIS0_SPI0           (1 << 6)  /* Bit 6:  SPI0 Clock Disable */
#define GCR_PCLKDIS0_SPI1           (1 << 7)  /* Bit 7:  SPI1 Clock Disable */
#define GCR_PCLKDIS0_SPI2           (1 << 8)  /* Bit 8:  SPI2 Clock Disable */
#define GCR_PCLKDIS0_UART0D         (1 << 9)  /* Bit 9:  UART0 Clock Disable */
#define GCR_PCLKDIS0_UART1D         (1 << 10) /* Bit 10: UART1 Clock Disable */
#define GCR_PCLKDIS0_I2C0D          (1 << 13) /* Bit 13: I2C0 Clock Disable */
#define GCR_PCLKDIS0_CRYPTOD        (1 << 14) /* Bit 14: Crypto Clock Disable */
...
#define GCR_PCLKDIS0_TMR3D          (1 << 18) /* Bit 18: Timer3 Clock Disable */
#define GCR_PCLKDIS0_ADCD           (1 << 23) /* Bit 23: ADC Clock Disable */
#define GCR_PCLKDIS0_I2C1D          (1 << 28) /* Bit 28: I2C1 Clock Disable */
#define GCR_PCLKDIS0_PTD            (1 << 29) /* Bit 29: Pulse Train Clock Disable */
#define GCR_PCLKDIS0_SPIXiPD        (1 << 30) /* Bit 30: SPI XiP Clock Disable */
#define GCR_PCLKDIS0_SPIXiPMCD      (1 << 31) /* Bit 31: SPI XiP Master Controller Clock Disable */

#define GCR_PCLKDIS1_BTLE           (1 << 0)  /* Bit 0: Bluetooth Clock Disable */
#define GCR_PCLKDIS1_UART2D         (1 << 1)  /* Bit 1: UART2 Clock Disable */
#define GCR_PCLKDIS1_TRNG           (1 << 2)  /* Bit 2: TRNG Clock Disable */
#define GCR_PCLKDIS1_PUF            (1 << 3)  /* Bit 3: PUF Clock Disable */
#define GCR_PCLKDIS1_HPB            (1 << 4)  /* Bit 4: HyperBus Clock Disable */
#define GCR_PCLKDIS1_SYSCACHE       (1 << 7)  /* Bit 7: System Cache Clock Disable */
#define GCR_PCLKDIS1_SEM            (1 << 9)  /* Bit 9: Semaphore Block Clock Disable */
#define GCR_PCLKDIS1_CAN0           (1 << 11) /* Bit 11: CAN 0 Clock Disable */
#define GCR_PCLKDIS1_OW             (1 << 13) /* Bit 13: One-Wire Clock Disable */
#define GCR_PCLKDIS1_SPI3           (1 << 16) /* Bit 16: SPI3 Clock Disable */
#define GCR_PCLKDIS1_SPI4           (1 << 17) /* Bit 17: SPI4 Clock Disable */
#define GCR_PCLKDIS1_CAN1           (1 << 19) /* Bit 19: CAN 1 Clock Disable */
#define GCR_PCLKDIS1_SPIXiRAM       (1 << 20) /* Bit 20: SPI XiP RAM Clock Disable */
#define GCR_PCLKDIS1_I2S            (1 << 23) /* Bit 23: I2S Clock Disable */
#define GCR_PCLKDIS1_I2C2           (1 << 24) /* Bit 24: I2C 2 Clock Disable */
#define GCR_PCLKDIS1_WDT0           (1 << 27) /* Bit 27: Watchdog Timer 0 Clock Disable */
#define GCR_PCLKDIS1_CPU1           (1 << 31) /* Bit 31: CPU 1 Clock Disable */
...
#endif /* __ARCH_ARM_SRC_MAX326XX_HARDWARE_MAX32690_GCR_H */
