...
#if defined(CONFIG_ARCH_FAMILY_MAX32620) || defined(CONFIG_ARCH_FAMILY_MAX32630) || defined(CONFIG_ARCH_FAMILY_MAX32660)
#  include "hardware/max32660_gcr.h"
#elif defined(CONFIG_ARCH_FAMILY_MAX32690)
#  include "hardware/max32690_gcr.h"
#else
