/****************************************************************************
 * arch/arm/src/nrf91/nrf91_gpiote.h
 *
...
#ifndef __ARCH_ARM_SRC_NRF91_NRF91_GPIOTE_H
#define __ARCH_ARM_SRC_NRF91_NRF91_GPIOTE_H
...
enum nrf91_gpiote_outcfg_e
{
  NRF91_GPIOTE_SET    = 0,
  NRF91_GPIOTE_CLEAR  = 1,
  NRF91_GPIOTE_TOGGLE = 2,
};
...
void nrf91_gpiote_set_task(uint32_t pinset, int channel,
                        bool output_high, enum nrf91_gpiote_outcfg_e outcfg);
...
#endif /* __ARCH_ARM_SRC_NRF91_NRF91_GPIOTE_H */
