...
#define NRF91_PWM_TASKS_NEXTSTEP_OFFSET      0x0010 /* Steps by one value in the current sequence */
                                                    /* TODO: 0x084-0x090 */
#define NRF91_PWM_EVENTS_STOPPED_OFFSET      0x0104 /* STOP event */
#define NRF91_PWM_EVENTS_SEQSTARTED0_OFFSET  0x0108 /* Sequence 0 started event */
#define NRF91_PWM_EVENTS_SEQSTARTED1_OFFSET  0x010c /* Sequence 1 started event */
...
#define NRF91_PWM_INTEN_OFFSET               0x0300 /* Enable or disable interrupt */
...
#define NRF91_PWM_DECODER_OFFSET             0x0510 /* Configuration of the decoder */
#define NRF91_PWM_LOOP_OFFSET                0x0514 /* Amount of playback of a loop */
#define NRF91_PWM_SEQ0PTR_OFFSET             0x0520 /* Sequence 0 beginning address */
#define NRF91_PWM_SEQ0CNT_OFFSET             0x0524 /* Sequence 0 length */
#define NRF91_PWM_SEQ0REFRESH_OFFSET         0x0528 /* Sequence 0 additional periods */
#define NRF91_PWM_SEQ0ENDDELAY_OFFSET        0x052c /* Time added after sequence 0 */
#define NRF91_PWM_SEQ1PTR_OFFSET             0x0540 /* Sequence 1 beginning address */
#define NRF91_PWM_SEQ1CNT_OFFSET             0x0544 /* Sequence 1 length */
#define NRF91_PWM_SEQ1REFRESH_OFFSET         0x0548 /* Sequence 0 additional periods */
#define NRF91_PWM_SEQ1ENDDELAY_OFFSET        0x054c /* Time added after sequence 1 */
#define NRF91_PWM_PSEL0_OFFSET               0x0560 /* Output pin select for PWM chan 0 */
#define NRF91_PWM_PSEL1_OFFSET               0x0564 /* Output pin select for PWM chan 1 */
#define NRF91_PWM_PSEL2_OFFSET               0x0568 /* Output pin select for PWM chan 2 */
#define NRF91_PWM_PSEL3_OFFSET               0x056c /* Output pin select for PWM chan 3 */
