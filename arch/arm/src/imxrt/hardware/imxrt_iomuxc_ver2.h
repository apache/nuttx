...
#  define IOMUX_ENET_EN_DEFAULT           (IOMUX_PULL_UP | IOMUX_DRIVE_HIGHSTRENGTH | IOMUX_SLEW_FAST)
#  define IOMUX_ENET_RXERR_DEFAULT        (IOMUX_PULL_UP | IOMUX_DRIVE_HIGHSTRENGTH | IOMUX_SLEW_FAST)
#  define IOMUX_ENET_DATA_DEFAULT         (IOMUX_PULL_UP | IOMUX_DRIVE_HIGHSTRENGTH | IOMUX_SLEW_FAST)
