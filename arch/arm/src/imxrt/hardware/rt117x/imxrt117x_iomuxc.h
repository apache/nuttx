...
/* GPIO_SD_B1 Pad CTL Registers GPIO_DISP_B1 */
                                                    ...
                                                    /* Bit 0:      Reserved */
#define PADCTL_SD_B1_PDRV                 (1 << 1)  /* Bit 1:      PDRV Field (PDRV) */
#define PADCTL_SD_B1_PULL_SHIFT           (2)       /* Bits 2-3:   Pull Down / Pull Up Field (PULL) */
#define PADCTL_SD_B1_PULL_MASK            (0x03 << PADCTL_SD_B1_PULL_SHIFT)
#  define PADCTL_SD_B1_PULL_UP            (0x01 << PADCTL_SD_B1_PULL_SHIFT) /* Internal pullup resistor enabled */
#  define PADCTL_SD_B1_PULL_DOWN          (0x02 << PADCTL_SD_B1_PULL_SHIFT) /* Internal pulldown resistor enabled */
#  define PADCTL_SD_B1_PULL_NONE          (0x03 << PADCTL_SD_B1_PULL_SHIFT) /* No pull */

#define PADCTL_SD_B1_ODE                  (1 << 4)  /* Bit 4:      Open Drain Field (ODE) */
                                                    /* Bits 5-27:  Reserved */
#define PADCTL_SD_B1_DWP_SHIFT            (28)      /* Bits 28-29: Domain write protection (DWP) */
#define PADCTL_SD_B1_DWP_MASK             (0x03 << PADCTL_SD_B1_DWP_SHIFT)
#  define PADCTL_SD_B1_DWP_ALLOWBOTH      (0x00 << PADCTL_SD_B1_DWP_SHIFT) /* Both cores are allowed */
#  define PADCTL_SD_B1_DWP_DENYCM7        (0x01 << PADCTL_SD_B1_DWP_SHIFT) /* CM7 is forbidden */
#  define PADCTL_SD_B1_DWP_DENYCM4        (0x02 << PADCTL_SD_B1_DWP_SHIFT) /* CM4 is forbidden */
#  define PADCTL_SD_B1_DWP_DENYBOTH       (0x03 << PADCTL_SD_B1_DWP_SHIFT) /* Both cores are forbidden */

#define PADCTL_SD_B1_DWP_LOCK_SHIFT       (30)      /* Bits 30-31: Domain write protection lock (DWP_LOCK) */
#define PADCTL_SD_B1_DWP_LOCK_MASK        (0x03 << PADCTL_SD_B1_DWP_LOCK_SHIFT)
#  define PADCTL_SD_B1_DWP_LOCK_NOLCK     (0x00 << PADCTL_SD_B1_DWP_LOCK_SHIFT) /* Neither of DWP bits is locked */
#  define PADCTL_SD_B1_DWP_LOCK_LCKLO     (0x01 << PADCTL_SD_B1_DWP_LOCK_SHIFT) /* Lower DWP bit is locked */
#  define PADCTL_SD_B1_DWP_LOCK_LCKHI     (0x02 << PADCTL_SD_B1_DWP_LOCK_SHIFT) /* Higher DWP bit is locked */
#  define PADCTL_SD_B1_DWP_LOCK_LCKBOTH   (0x03 << PADCTL_SD_B1_DWP_LOCK_SHIFT) /* Both DWP bits are locked */
...
/* GPIO_DISP_B1 Pad CTL Registers */

                                                    /* Bit 0:      Reserved */
#define PADCTL_DISP_B1_PDRV               (1 << 1)  /* Bit 1:      PDRV Field (PDRV) */
#define PADCTL_DISP_B1_PULL_SHIFT         (2)       /* Bits 2-3:   Pull Down / Pull Up Field (PULL) */
#define PADCTL_DISP_B1_PULL_MASK          (0x03 << PADCTL_DISP_B1_PULL_SHIFT)
#  define PADCTL_DISP_B1_PULL_UP          (0x01 << PADCTL_DISP_B1_PULL_SHIFT) /* Internal pullup resistor enabled */
#  define PADCTL_DISP_B1_PULL_DOWN        (0x02 << PADCTL_DISP_B1_PULL_SHIFT) /* Internal pulldown resistor enabled */
#  define PADCTL_DISP_B1_PULL_NONE        (0x03 << PADCTL_DISP_B1_PULL_SHIFT) /* No pull */

#define PADCTL_DISP_B1_ODE                (1 << 4)  /* Bit 4:      Open Drain Field (ODE) */
                                                    /* Bits 5-27:  Reserved */
#define PADCTL_DISP_B1_DWP_SHIFT          (28)      /* Bits 28-29: Domain write protection (DWP) */
#define PADCTL_DISP_B1_DWP_MASK           (0x03 << PADCTL_DISP_B1_DWP_SHIFT)
#  define PADCTL_DISP_B1_DWP_ALLOWBOTH    (0x00 << PADCTL_DISP_B1_DWP_SHIFT) /* Both cores are allowed */
#  define PADCTL_DISP_B1_DWP_DENYCM7      (0x01 << PADCTL_DISP_B1_DWP_SHIFT) /* CM7 is forbidden */
#  define PADCTL_DISP_B1_DWP_DENYCM4      (0x02 << PADCTL_DISP_B1_DWP_SHIFT) /* CM4 is forbidden */
#  define PADCTL_DISP_B1_DWP_DENYBOTH     (0x03 << PADCTL_DISP_B1_DWP_SHIFT) /* Both cores are forbidden */

#define PADCTL_DISP_B1_DWP_LOCK_SHIFT     (30)      /* Bits 30-31: Domain write protection lock (DWP_LOCK) */
#define PADCTL_DISP_B1_DWP_LOCK_MASK      (0x03 << PADCTL_DISP_B1_DWP_LOCK_SHIFT)
#  define PADCTL_DISP_B1_DWP_LOCK_NOLCK   (0x00 << PADCTL_DISP_B1_DWP_LOCK_SHIFT) /* Neither of DWP bits is locked */
#  define PADCTL_DISP_B1_DWP_LOCK_LCKLO   (0x01 << PADCTL_DISP_B1_DWP_LOCK_SHIFT) /* Lower DWP bit is locked */
#  define PADCTL_DISP_B1_DWP_LOCK_LCKHI   (0x02 << PADCTL_DISP_B1_DWP_LOCK_SHIFT) /* Higher DWP bit is locked */
#  define PADCTL_DISP_B1_DWP_LOCK_LCKBOTH (0x03 << PADCTL_DISP_B1_DWP_LOCK_SHIFT) /* Both DWP bits are locked */
