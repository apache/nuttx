...
#define IMXRT_OCOTP_CHIP_ID       (IMXRT_OCOTP_SHADOW_BASE + 0x54)
#define IMXRT_OCOTP_CHIP_ID_SHIFT 9
#define IMXRT_OCOTP_CHIP_ID_MASK  0x7fffff
#define IMXRT_OCOTP_UNIQUE_ID_MSB (IMXRT_OCOTP_SHADOW_BASE + 0xc0)
#define IMXRT_OCOTP_UNIQUE_ID_LSB (IMXRT_OCOTP_SHADOW_BASE + 0xc4)
