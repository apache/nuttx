...
#define NRF52_RTC_GETCC(d, i, cc)         ((d)->ops->getcc(d, i, cc))
...
{
  NRF52_RTC_EVT_COMPARE0 = 0,
  NRF52_RTC_EVT_COMPARE1 = 1,
  NRF52_RTC_EVT_COMPARE2 = 2,
  NRF52_RTC_EVT_COMPARE3 = 3,
  NRF52_RTC_EVT_TICK     = 4,
  NRF52_RTC_EVT_OVRFLW   = 5,
};
