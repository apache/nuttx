/****************************************************************************
 * arch/arm/src/nrf52/hardware/nrf52_qspi.h
 *
...
#ifndef __ARCH_ARM_SRC_NRF52_HARDWARE_NRF52_QSPI_H
#define __ARCH_ARM_SRC_NRF52_HARDWARE_NRF52_QSPI_H
...
#define NRF52_QSPI_TASKS_ACTIVATE_OFFSET    0x0000 /* Activate QSPI interface */
#define NRF52_QSPI_TASKS_READSTART_OFFSET   0x0004 /* Start transfer from external flash memory to internal RAM */
#define NRF52_QSPI_TASKS_WRITESTART_OFFSET  0x0008 /* Start transfer from internal RAM to external flash memory */
#define NRF52_QSPI_TASKS_ERASESTART_OFFSET  0x000c /* Start external flash memory erase operation */
#define NRF52_QSPI_TASKS_DEACTIVATE_OFFSET  0x0010 /* Deactivate QSPI interface */
#define NRF52_QSPI_EVENTS_READY_OFFSET      0x0100 /* QSPI peripheral is ready */
#define NRF52_QSPI_INTEN_OFFSET             0x0300 /* Enable or disable interrupt */
#define NRF52_QSPI_INTENSET_OFFSET          0x0304 /* Enable interrupt */
#define NRF52_QSPI_INTENCLR_OFFSET          0x0308 /* Disable interrupt */
#define NRF52_QSPI_ENABLE_OFFSET            0x0500 /* Enable QSPI peripheral */
#define NRF52_QSPI_READ_SRC_OFFSET          0x0504 /* Flash memory source address */
#define NRF52_QSPI_READ_DST_OFFSET          0x0508 /* RAM destination address */
#define NRF52_QSPI_READ_CNT_OFFSET          0x050c /* Read transfer length */
#define NRF52_QSPI_WRITE_SRC_OFFSET         0x0510 /* Flash destination address */
#define NRF52_QSPI_WRITE_DST_OFFSET         0x0514 /* RAM source address */
#define NRF52_QSPI_WRITE_CNT_OFFSET         0x0518 /* Write transfer length */
#define NRF52_QSPI_ERASE_PTR_OFFSET         0x051c /* Start address of flash block to be erased */
#define NRF52_QSPI_ERASE_LEN_OFFSET         0x0520 /* Size of block to be erased */
#define NRF52_QSPI_PSEL_SCK_OFFSET          0x0524 /* Pin select for serial clock SCK */
#define NRF52_QSPI_PSEL_CSN_OFFSET          0x0528 /* Pin select for chip select signal CSN */
#define NRF52_QSPI_PSEL_IO0_OFFSET          0x0530 /* Pin select for serial data MOSI/IO0 */
#define NRF52_QSPI_PSEL_IO1_OFFSET          0x0534 /* Pin select for serial data MISO/IO1 */
#define NRF52_QSPI_PSEL_IO2_OFFSET          0x0538 /* Pin select for serial data IO2 */
#define NRF52_QSPI_PSEL_IO3_OFFSET          0x053c /* Pin select for serial data IO3 */
#define NRF52_QSPI_XIPOFFSET_OFFSET         0x0540 /* Address offset into the external memory for XIP */
#define NRF52_QSPI_IFCONFIG0_OFFSET         0x0544 /* Interface configuration */
#define NRF52_QSPI_IFCONFIG1_OFFSET         0x0600 /* Interface configuration */
#define NRF52_QSPI_STATUS_OFFSET            0x0604 /* Status register */
#define NRF52_QSPI_DPMDUR_OFFSET            0x0614 /* DPM duration */
#define NRF52_QSPI_ADDRCONF_OFFSET          0x0624 /* Extended address configuration. */
#define NRF52_QSPI_CINSTRCONF_OFFSET        0x0634 /* Custom instruction configuration register. */
#define NRF52_QSPI_CINSTRDAT0_OFFSET        0x0638 /* Custom instruction data register 0. */
#define NRF52_QSPI_CINSTRDAT1_OFFSET        0x063c /* Custom instruction data register 1. */
#define NRF52_QSPI_IFTIMING_OFFSET          0x0640 /* SPI interface timing. */
...
#endif /* __ARCH_ARM_SRC_NRF52_HARDWARE_NRF52_QSPI_H */
