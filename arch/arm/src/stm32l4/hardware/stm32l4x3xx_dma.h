...
/* DMA Channel mapping.
 * Each DMA channel has a mapping to one of several possible sources/sinks of
 * data. The requests from peripherals assigned to a channel are multiplexed
...
#define DMACHAN_DFSDM0          DMACHAN_SETTING(STM32_DMA1_CHAN5, 0)
#define DMACHAN_DFSDM1          DMACHAN_SETTING(STM32_DMA1_CHAN6, 0)
