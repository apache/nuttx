...
#define DMACHAN_DAC1_2          DMACHAN_SETTING(STM32_DMA2_CHAN4, 3)

#define DMACHAN_DAC2_1          DMACHAN_SETTING(STM32_DMA1_CHAN4, 5)
#define DMACHAN_DAC2_2          DMACHAN_SETTING(STM32_DMA2_CHAN5, 3)

/* DCMI */

#define DMACHAN_DCMI_1          DMACHAN_SETTING(STM32_DMA2_CHAN5, 4)
#define DMACHAN_DCMI_2          DMACHAN_SETTING(STM32_DMA2_CHAN6, 0)

/* DFSDM */

#define DMACHAN_DFSDM0          DMACHAN_SETTING(STM32_DMA1_CHAN4, 0)
#define DMACHAN_DFSDM1          DMACHAN_SETTING(STM32_DMA1_CHAN5, 0)
#define DMACHAN_DFSDM2          DMACHAN_SETTING(STM32_DMA1_CHAN6, 0)
#define DMACHAN_DFSDM3          DMACHAN_SETTING(STM32_DMA1_CHAN7, 0)

/* HASH */

#define DMACHAN_HASH_IN         DMACHAN_SETTING(STM32_DMA2_CHAN7, 6)
...
#define DMACHAN_I2C4_RX         DMACHAN_SETTING(STM32_DMA2_CHAN1, 0)
#define DMACHAN_I2C4_TX         DMACHAN_SETTING(STM32_DMA2_CHAN2, 0)
...
#define DMACHAN_SAI1_A_1        DMACHAN_SETTING(STM32_DMA2_CHAN1, 1)
#define DMACHAN_SAI1_A_2        DMACHAN_SETTING(STM32_DMA2_CHAN6, 1)
#define DMACHAN_SAI1_B_1        DMACHAN_SETTING(STM32_DMA2_CHAN2, 1)
#define DMACHAN_SAI1_B_2        DMACHAN_SETTING(STM32_DMA2_CHAN7, 1)

#define DMACHAN_SAI2_A_1        DMACHAN_SETTING(STM32_DMA1_CHAN6, 1)
#define DMACHAN_SAI2_A_2        DMACHAN_SETTING(STM32_DMA2_CHAN3, 1)
#define DMACHAN_SAI2_B_1        DMACHAN_SETTING(STM32_DMA1_CHAN7, 1)
#define DMACHAN_SAI2_B_2        DMACHAN_SETTING(STM32_DMA2_CHAN4, 1)

/* SDMMC */

#define DMACHAN_SDMMC_1         DMACHAN_SETTING(STM32_DMA2_CHAN4, 7)
#define DMACHAN_SDMMC_2         DMACHAN_SETTING(STM32_DMA2_CHAN5, 7)

/* SPI */

#define DMACHAN_SPI1_RX_1       DMACHAN_SETTING(STM32_DMA1_CHAN2, 1)
#define DMACHAN_SPI1_RX_2       DMACHAN_SETTING(STM32_DMA2_CHAN3, 4)
#define DMACHAN_SPI1_TX_1       DMACHAN_SETTING(STM32_DMA1_CHAN3, 1)
...
#define DMACHAN_SWPMI_RX        DMACHAN_SETTING(STM32_DMA2_CHAN1, 4)
#define DMACHAN_SWPMI_TX        DMACHAN_SETTING(STM32_DMA2_CHAN2, 4)
...
#define DMACHAN_USART3_RX       DMACHAN_SETTING(STM32_DMA1_CHAN3, 2)
#define DMACHAN_USART3_TX       DMACHAN_SETTING(STM32_DMA1_CHAN2, 2)

#define DMACHAN_UART5_RX        DMACHAN_SETTING(STM32_DMA2_CHAN2, 2)
#define DMACHAN_UART5_TX        DMACHAN_SETTING(STM32_DMA2_CHAN1, 2)

#define DMACHAN_UART4_RX        DMACHAN_SETTING(STM32_DMA2_CHAN5, 2)
#define DMACHAN_UART4_TX        DMACHAN_SETTING(STM32_DMA2_CHAN3, 2)

#define DMACHAN_LPUART_RX       DMACHAN_SETTING(STM32_DMA2_CHAN7, 4)
#define DMACHAN_LPUART_TX       DMACHAN_SETTING(STM32_DMA2_CHAN6, 4)
