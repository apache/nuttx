...
struct spi_dev_s *stm32l4_spibus_initialize(int bus);

/****************************************************************************
 * Name:  stm32l4_spi1/2/...select and stm32l4_spi1/2/...status
 *
 * Description:
 *   The external functions, stm32l4_spi1/2/...select,
 *   stm32l4_spi1/2/...status, and stm32l4_spi1/2/...cmddata must be
 ...
 *   (including stm32l4_spibus_initialize()) are provided by common
 *   STM32 logic.  To use this common SPI logic on your board:
 *
 *   1. Provide logic in stm32l4_board_initialize() to configure SPI chip
 *      select pins.
 *   2. Provide stm32l4_spi1/2/...select() and stm32l4_spi1/2/...status()
 *      functions in your board-specific logic.  These functions will perform
 *      chip selection and status operations using GPIOs in the way your
 *      board is configured.
 *   3. If CONFIG_SPI_CMDDATA is defined in your NuttX configuration file,
 *      then provide stm32l4_spi1/2/...cmddata() functions in your
 *      board-specific logic. These functions will perform cmd/data selection
 *      operations using GPIOs in the way your board is configured.
 *   4. Add a calls to stm32l4_spibus_initialize() in your low level
 *      application initialization logic
 *   5. The handle returned by stm32l4_spibus_initialize() may then be used
...
#ifdef CONFIG_STM32L4_SPI1
int stm32l4_spi1register(struct spi_dev_s *dev,
                         spi_mediachange_t callback,
                         void *arg);
#endif

#ifdef CONFIG_STM32L4_SPI2
int stm32l4_spi2register(struct spi_dev_s *dev,
                         spi_mediachange_t callback,
                         void *arg);
#endif

#ifdef CONFIG_STM32L4_SPI3
int stm32l4_spi3register(struct spi_dev_s *dev,
                         spi_mediachange_t callback,
                         void *arg);
#endif
#endif
