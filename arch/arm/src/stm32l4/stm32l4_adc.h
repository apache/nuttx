...
#if (defined(CONFIG_STM32_ADC1) && (CONFIG_STM32_ADC1_INJ_CHAN > 0)) || \
    (defined(CONFIG_STM32_ADC2) && (CONFIG_STM32_ADC2_INJ_CHAN > 0)) || \
    (defined(CONFIG_STM32_ADC3) && (CONFIG_STM32_ADC3_INJ_CHAN > 0))
...
#    define ADC1_TIMER_CHANNEL        CONFIG_STM32_TIM1_ADC_CHAN
...
#    define ADC1_TIMER_CHANNEL        CONFIG_STM32_TIM2_ADC_CHAN
...
#    define ADC1_TIMER_CHANNEL        CONFIG_STM32_TIM3_ADC_CHAN
...
#    define ADC1_TIMER_CHANNEL        CONFIG_STM32_TIM4_ADC_CHAN
...
#    define ADC1_TIMER_CHANNEL        CONFIG_STM32_TIM6_ADC_CHAN
...
#    define ADC1_TIMER_CHANNEL        CONFIG_STM32_TIM8_ADC_CHAN
...
#    define ADC1_TIMER_CHANNEL        CONFIG_STM32_TIM15_ADC_CHAN
#else
...
#  endif
#  if ((CONFIG_STM32_ADC1_EXTTRIG == 0) && \
       (CONFIG_STM32_ADC1_JEXTTRIG == 0))
...
#    define ADC2_TIMER_CHANNEL        CONFIG_STM32_TIM1_ADC_CHAN
...
#    define ADC2_TIMER_CHANNEL        CONFIG_STM32_TIM2_ADC_CHAN
...
#    define ADC2_TIMER_CHANNEL        CONFIG_STM32_TIM3_ADC_CHAN
...
#    define ADC2_TIMER_CHANNEL        CONFIG_STM32_TIM4_ADC_CHAN
...
#    define ADC2_TIMER_CHANNEL        CONFIG_STM32_TIM6_ADC_CHAN
...
#    define ADC2_TIMER_CHANNEL        CONFIG_STM32_TIM8_ADC_CHAN
...
#    define ADC2_TIMER_CHANNEL        CONFIG_STM32_TIM15_ADC_CHAN
#else
...
#  endif
#  if ((CONFIG_STM32_ADC2_EXTTRIG == 0) && \
       (CONFIG_STM32_ADC2_JEXTTRIG == 0))
...
#    define ADC3_TIMER_PCLK_FREQUENCY STM32_TIM1_CLKIN
...
#    define ADC3_TIMER_PCLK_FREQUENCY STM32_TIM2_CLKIN
#    define ADC3_TIMER_CHANNEL        CONFIG_STM32_TIM1_ADC_CHAN
#elif defined(CONFIG_STM32_TIM3_ADC3)
#    define ADC3_HAVE_TIMER           1
#    define ADC3_TIMER_BASE           STM32_TIM3_BASE
#    define ADC3_TIMER_PCLK_FREQUENCY STM32_TIM3_CLKIN
#    define ADC3_TIMER_CHANNEL        CONFIG_STM32_TIM3_ADC_CHAN
#elif defined(CONFIG_STM32_TIM4_ADC3)
#    define ADC3_HAVE_TIMER           1
#    define ADC3_TIMER_BASE           STM32_TIM4_BASE
#    define ADC3_TIMER_PCLK_FREQUENCY STM32_TIM4_CLKIN
#    define ADC3_TIMER_CHANNEL        CONFIG_STM32_TIM4_ADC_CHAN
#elif defined(CONFIG_STM32_TIM6_ADC3)
#    define ADC3_HAVE_TIMER           1
#    define ADC3_TIMER_BASE           STM32_TIM6_BASE
#    define ADC3_TIMER_PCLK_FREQUENCY STM32_TIM6_CLKIN
#    define ADC3_TIMER_CHANNEL        CONFIG_STM32_TIM6_ADC_CHAN
#elif defined(CONFIG_STM32_TIM8_ADC3)
#    define ADC3_HAVE_TIMER           1
#    define ADC3_TIMER_BASE           STM32_TIM8_BASE
#    define ADC3_TIMER_PCLK_FREQUENCY STM32_TIM8_CLKIN
#    define ADC3_TIMER_CHANNEL        CONFIG_STM32_TIM8_ADC_CHAN
#elif defined(CONFIG_STM32_TIM15_ADC3)
#    define ADC3_HAVE_TIMER           1
#    define ADC3_TIMER_BASE           STM32_TIM15_BASE
#    define ADC3_TIMER_PCLK_FREQUENCY STM32_TIM15_CLKIN
...
#  endif
#  if ((CONFIG_STM32_ADC3_EXTTRIG == 0) && \
       (CONFIG_STM32_ADC3_JEXTTRIG == 0))
...
/* If external trigger is enabled, (CONFIG_STM32_ADC1_EXTTRIG > 0),
...
#ifdef CONFIG_STM32_ADC1_EXTTRIG
#  if CONFIG_STM32_ADC1_EXTTRIG > 0
#    define ADC1_EXTCFG_VALUE \
            ADC_CFGR_EXTEN(CONFIG_STM32_ADC1_EXTTRIG)  | \
            ADC_CFGR_EXTSEL(CONFIG_STM32_ADC_L4_ADC1_EXTSEL)
#  endif
#endif /* CONFIG_STM32_ADC1_EXTTRIG */
...
#ifdef CONFIG_STM32_ADC2_EXTTRIG
#  if CONFIG_STM32_ADC2_EXTTRIG > 0
#    define ADC2_EXTCFG_VALUE \
            ADC_CFGR_EXTEN(CONFIG_STM32_ADC2_EXTTRIG)  | \
            ADC_CFGR_EXTSEL(CONFIG_STM32_ADC_L4_ADC2_EXTSEL)
#  endif
#endif /* CONFIG_STM32_ADC2_EXTTRIG */
...
#ifdef CONFIG_STM32_ADC3_EXTTRIG
#  if CONFIG_STM32_ADC3_EXTTRIG > 0
#    define ADC3_EXTCFG_VALUE \
            ADC_CFGR_EXTEN(CONFIG_STM32_ADC3_EXTTRIG)  | \
            ADC_CFGR_EXTSEL(CONFIG_STM32_ADC_L4_ADC3_EXTSEL)
#  endif
#endif /* CONFIG_STM32_ADC3_EXTTRIG */
...
#ifdef CONFIG_STM32_ADC1_JEXTTRIG
#  if CONFIG_STM32_ADC1_JEXTTRIG > 0
#    define ADC1_JEXTCFG_VALUE \
            ADC_JSQR_JEXTEN(CONFIG_STM32_ADC1_JEXTTRIG) | \
            ADC_JSQR_JEXTSEL(CONFIG_STM32_ADC_L4_ADC1_JEXTSEL)
#  endif
#endif /* CONFIG_STM32_ADC1_JEXTTRIG */

#ifdef ADC1_JEXTCFG_VALUE
#  define ADC1_HAVE_JEXTCFG  1
#endif

#ifdef CONFIG_STM32_ADC2_JEXTTRIG
#  if CONFIG_STM32_ADC2_JEXTTRIG > 0
#    define ADC2_JEXTCFG_VALUE \
            ADC_JSQR_JEXTEN(CONFIG_STM32_ADC2_JEXTTRIG) | \
            ADC_JSQR_JEXTSEL(CONFIG_STM32_ADC_L4_ADC2_JEXTSEL)
#  endif
#endif /* CONFIG_STM32_ADC2_JEXTTRIG */

#ifdef ADC2_JEXTCFG_VALUE
#  define ADC2_HAVE_JEXTCFG  1
#endif

#ifdef CONFIG_STM32_ADC3_JEXTTRIG
#  if CONFIG_STM32_ADC3_JEXTTRIG > 0
#    define ADC3_JEXTCFG_VALUE \
            ADC_JSQR_JEXTEN(CONFIG_STM32_ADC3_JEXTTRIG) | \
            ADC_JSQR_JEXTSEL(CONFIG_STM32_ADC_L4_ADC3_JEXTSEL)
#  endif
#endif /* CONFIG_STM32_ADC3_JEXTTRIG */
