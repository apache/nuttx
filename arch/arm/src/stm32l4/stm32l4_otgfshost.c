...
static void stm32_chan_configure(struct stm32_usbhost_s *priv,
                                   int chidx);
static void stm32_chan_halt(struct stm32_usbhost_s *priv,
                              int chidx, enum stm32_chreason_e chreason);
...
#endif
static inline void
stm32_gint_rxflvlisr(struct stm32_usbhost_s *priv);
static inline void
stm32_gint_nptxfeisr(struct stm32_usbhost_s *priv);
...
static void stm32_txfe_enable(struct stm32_usbhost_s *priv,
                                int chidx);
...
static int stm32_epalloc(struct usbhost_driver_s *drvr,
                           const struct usbhost_epdesc_s *epdesc,
                           usbhost_ep_t *ep);
static int stm32_epfree(struct usbhost_driver_s *drvr,
                          usbhost_ep_t ep);
...
static int stm32_iofree(struct usbhost_driver_s *drvr,
                          uint8_t *buffer);
static int stm32_ctrlin(struct usbhost_driver_s *drvr,
                          usbhost_ep_t ep0,
                          const struct usb_ctrlreq_s *req,
                          uint8_t *buffer);
static int stm32_ctrlout(struct usbhost_driver_s *drvr,
                           usbhost_ep_t ep0,
                           const struct usb_ctrlreq_s *req,
...
static int stm32_asynch(struct usbhost_driver_s *drvr, usbhost_ep_t ep,
                          ...
                          usbhost_asynch_t callback, void *arg);
#endif
static int stm32_cancel(struct usbhost_driver_s *drvr,
                          usbhost_ep_t ep);
#ifdef CONFIG_USBHOST_HUB
...
static void stm32_vbusdrive(struct stm32_usbhost_s *priv,
                              bool state);
                                ...
                                uint8_t speed, uint16_t maxpacketsize)
{
  ...
  struct stm32_ctrlinfo_s *ep0info =
    (struct stm32_ctrlinfo_s *)ep0;
  struct stm32_chan_s *chan;
  int ret;
...
static inline void stm32_sw_initialize(struct stm32_usbhost_s *priv)
{
  ...
  memset(priv->chan, 0,
         STM32_MAX_TX_FIFOS * sizeof(struct stm32_chan_s));
