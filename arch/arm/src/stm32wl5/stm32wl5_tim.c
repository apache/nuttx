...
static const struct stm32wl5_tim_ops_s stm32wl5_tim_ops =
{
  ...
  .setperiod  = stm32wl5_tim_setperiod,
  .getperiod  = stm32wl5_tim_getperiod,
  .getcounter = stm32wl5_tim_getcounter,
  .setchannel = stm32wl5_tim_setchannel,
  .setcompare = stm32wl5_tim_setcompare,
  .getcapture = stm32wl5_tim_getcapture,
  .setisr     = stm32wl5_tim_setisr,
  .enableint  = stm32wl5_tim_enableint,
  .disableint = stm32wl5_tim_disableint,
  .ackint     = stm32wl5_tim_ackint,
  .checkint   = stm32wl5_tim_checkint,
};
...
/****************************************************************************
 * Name: stm32wl5_getreg32
 *
 * Description:
 *   Get a 32-bit register value by offset.  This applies only for the
 *   STM32WL5 32-bit registers (CNT, ARR, CRR1-4) in the 32-bit timers TIM2-5
 *
 ****************************************************************************/
        ...
        switch (channel)
          {
            ...
            case 0:
              stm32wl5_tim_gpioconfig(GPIO_TIM1_CH1OUT, mode);
              break;
#endif

#if defined(GPIO_TIM1_CH2OUT)
            case 1:
              stm32wl5_tim_gpioconfig(GPIO_TIM1_CH2OUT, mode);
              break;
#endif

#if defined(GPIO_TIM1_CH3OUT)
            case 2:
              stm32wl5_tim_gpioconfig(GPIO_TIM1_CH3OUT, mode);
              break;
#endif

#if defined(GPIO_TIM1_CH4OUT)
            case 3:
              stm32wl5_tim_gpioconfig(GPIO_TIM1_CH4OUT, mode);
              break;
#endif
        ...
        switch (channel)
          {
            ...
            case 0:
              stm32wl5_tim_gpioconfig(GPIO_TIM2_CH1OUT, mode);
              break;
#endif

#if defined(GPIO_TIM2_CH2OUT)
            case 1:
              stm32wl5_tim_gpioconfig(GPIO_TIM2_CH2OUT, mode);
              break;
#endif

#if defined(GPIO_TIM2_CH3OUT)
            case 2:
              stm32wl5_tim_gpioconfig(GPIO_TIM2_CH3OUT, mode);
              break;
#endif

#if defined(GPIO_TIM2_CH4OUT)
            case 3:
              stm32wl5_tim_gpioconfig(GPIO_TIM2_CH4OUT, mode);
              break;
#endif
        ...
        switch (channel)
          {
            ...
            case 0:
              stm32wl5_tim_gpioconfig(GPIO_TIM3_CH1OUT, mode);
              break;
#endif

#if defined(GPIO_TIM3_CH2OUT)
            case 1:
              stm32wl5_tim_gpioconfig(GPIO_TIM3_CH2OUT, mode);
              break;
#endif

#if defined(GPIO_TIM3_CH3OUT)
            case 2:
              stm32wl5_tim_gpioconfig(GPIO_TIM3_CH3OUT, mode);
              break;
#endif

#if defined(GPIO_TIM3_CH4OUT)
            case 3:
              stm32wl5_tim_gpioconfig(GPIO_TIM3_CH4OUT, mode);
              break;
#endif
        ...
        switch (channel)
          {
            ...
            case 0:
              stm32wl5_tim_gpioconfig(GPIO_TIM4_CH1OUT, mode);
              break;
#endif

#if defined(GPIO_TIM4_CH2OUT)
            case 1:
              stm32wl5_tim_gpioconfig(GPIO_TIM4_CH2OUT, mode);
              break;
#endif
#if defined(GPIO_TIM4_CH3OUT)
            case 2:
              stm32wl5_tim_gpioconfig(GPIO_TIM4_CH3OUT, mode);
              break;
#endif

#if defined(GPIO_TIM4_CH4OUT)
            case 3:
              stm32wl5_tim_gpioconfig(GPIO_TIM4_CH4OUT, mode);
              break;
#endif
        ...
        switch (channel)
          {
            ...
            case 0:
              stm32wl5_tim_gpioconfig(GPIO_TIM5_CH1OUT, mode);
              break;
#endif

#if defined(GPIO_TIM5_CH2OUT)
            case 1:
              stm32wl5_tim_gpioconfig(GPIO_TIM5_CH2OUT, mode);
              break;
#endif

#if defined(GPIO_TIM5_CH3OUT)
            case 2:
              stm32wl5_tim_gpioconfig(GPIO_TIM5_CH3OUT, mode);
              break;
#endif

#if defined(GPIO_TIM5_CH4OUT)
            case 3:
              stm32wl5_tim_gpioconfig(GPIO_TIM5_CH4OUT, mode);
              break;
#endif
        ...
        switch (channel)
          {
            ...
            case 0:
              stm32wl5_tim_gpioconfig(GPIO_TIM8_CH1OUT, mode);
              break;
#endif

#if defined(GPIO_TIM8_CH2OUT)
            case 1:
              stm32wl5_tim_gpioconfig(GPIO_TIM8_CH2OUT, mode);
              break;
#endif

#if defined(GPIO_TIM8_CH3OUT)
            case 2:
              stm32wl5_tim_gpioconfig(GPIO_TIM8_CH3OUT, mode);
              break;
#endif

#if defined(GPIO_TIM8_CH4OUT)
            case 3:
              stm32wl5_tim_gpioconfig(GPIO_TIM8_CH4OUT, mode);
              break;
#endif
        ...
        switch (channel)
          {
            ...
            case 0:
              stm32wl5_tim_gpioconfig(GPIO_TIM15_CH1OUT, mode);
              break;
#endif

#if defined(GPIO_TIM15_CH2OUT)
            case 1:
              stm32wl5_tim_gpioconfig(GPIO_TIM15_CH2OUT, mode);
              break;
#endif

#if defined(GPIO_TIM15_CH3OUT)
            case 2:
              stm32wl5_tim_gpioconfig(GPIO_TIM15_CH3OUT, mode);
              break;
#endif

#if defined(GPIO_TIM15_CH4OUT)
            case 3:
              stm32wl5_tim_gpioconfig(GPIO_TIM15_CH4OUT, mode);
              break;
#endif
        ...
        switch (channel)
          {
            ...
            case 0:
              stm32wl5_tim_gpioconfig(GPIO_TIM16_CH1OUT, mode);
              break;
#endif

#if defined(GPIO_TIM16_CH2OUT)
            case 1:
              stm32wl5_tim_gpioconfig(GPIO_TIM16_CH2OUT, mode);
              break;
#endif

#if defined(GPIO_TIM16_CH3OUT)
            case 2:
              stm32wl5_tim_gpioconfig(GPIO_TIM16_CH3OUT, mode);
              break;
#endif

#if defined(GPIO_TIM16_CH4OUT)
            case 3:
              stm32wl5_tim_gpioconfig(GPIO_TIM16_CH4OUT, mode);
              break;
#endif
        ...
        switch (channel)
          {
            ...
            case 0:
              stm32wl5_tim_gpioconfig(GPIO_TIM17_CH1OUT, mode);
              break;
#endif

#if defined(GPIO_TIM17_CH2OUT)
            case 1:
              stm32wl5_tim_gpioconfig(GPIO_TIM17_CH2OUT, mode);
              break;
#endif

#if defined(GPIO_TIM17_CH3OUT)
            case 2:
              stm32wl5_tim_gpioconfig(GPIO_TIM17_CH3OUT, mode);
              break;
#endif

#if defined(GPIO_TIM17_CH4OUT)
            case 3:
              stm32wl5_tim_gpioconfig(GPIO_TIM17_CH4OUT, mode);
              break;
#endif
...
FAR struct stm32wl5_tim_dev_s *stm32wl5_tim_init(int timer)
{
  ...
  stm32wl5_tim_reset(dev);

  return dev;
}

/****************************************************************************
 * Name: stm32wl5_tim_deinit
 *
