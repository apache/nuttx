/****************************************************************************
 * arch/arm/src/nrf54l/nrf54l_lowputc.h
 *
...
#ifndef __ARCH_ARM_SRC_NRF54L_NRF54L_LOWPUTC_H
#define __ARCH_ARM_SRC_NRF54L_NRF54L_LOWPUTC_H
...
#endif
  nrf54l_pinset_t txpin;   /* TX pin */
  nrf54l_pinset_t rxpin;   /* RX pin */
};
#endif
...
#ifdef HAVE_UART_DEVICE
void nrf54l_usart_disable(uintptr_t base,
                          const struct uart_config_s *config);
#endif
...
#endif /* __ARCH_ARM_SRC_NRF54L_NRF54L_LOWPUTC_H */
