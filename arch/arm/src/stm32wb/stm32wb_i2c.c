...
#if defined(CONFIG_STM32_I2C1) || defined(CONFIG_STM32_I2C3)
...
struct stm32_trace_s
{
  ...
  enum stm32_intstate_e event;   /* Last event that occurred with status */
...
#endif /* CONFIG_STM32_I2C1 || CONFIG_STM32_I2C3 */
