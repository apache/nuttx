...
static void rtc_wprunlock(void)
{
  ...
  putreg32(RTC_WPR_KEY1, STM32_RTC_WPR);
  putreg32(RTC_WPR_KEY2, STM32_RTC_WPR);
}
      ...
      case RTC_ALARMA:
        {
          ...
          putreg32(0xffffffff, STM32_RTC_ALRMAR);
      ...
      case RTC_ALARMB:
        {
          ...
          putreg32(0xffffffff, STM32_RTC_ALRMBR);
