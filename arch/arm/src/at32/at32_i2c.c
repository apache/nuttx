...
#  define CONFIG_AT32_I2CTIMEOMS  500   /* Default is 500 milliseconds */
#  warning "Using Default 500 Ms Timeout"
#elif !defined(CONFIG_AT32_I2CTIMEOSEC)
#  define CONFIG_AT32_I2CTIMEOSEC 0     /* User provided milliseconds */
#elif !defined(CONFIG_AT32_I2CTIMEOMS)
#  define CONFIG_AT32_I2CTIMEOMS  0     /* User provided seconds */
#endif
...
struct at32_trace_s
{
  ...
  enum at32_intstate_e event;  /* Last event that occurred with this status */
...
#endif
  volatile uint8_t intstate;   /* Interrupt handshake (see enum at32_intstate_e) */
...
struct at32_i2c_inst_s
{
  ...
  struct at32_i2c_priv_s *priv;  /* Common driver private data structure */
};
...
#endif /* CONFIG_AT32_I2C_DYNTIMEO */
...
static inline int at32_i2c_sem_waitdone(struct at32_i2c_priv_s *priv)
{
  ...
  /* The TXIE and RXIE interrupts are enabled initially in at32_i2c_process.
...
{
  struct at32_i2c_priv_s *priv = NULL;  /* private data of device with multiple instances */
  struct at32_i2c_inst_s *inst = NULL;  /* device, single instance */
#if 0
...
#endif /* CONFIG_AT32_I2C1 || CONFIG_AT32_I2C2 || \
