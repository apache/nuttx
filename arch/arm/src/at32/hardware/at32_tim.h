...
#ifndef __ARCH_ARM_SRC_AT32_HARDWARE_AT32_TIM_V1V2_H
#define __ARCH_ARM_SRC_AT32_HARDWARE_AT32_TIM_V1V2_H
...
#define AT32_BTIM_CR1_OFFSET     0x0000  /* Control register 1 (16-bit) */
#define AT32_BTIM_CR2_OFFSET     0x0004  /* Control register 2 (16-bit) */
#define AT32_BTIM_DIER_OFFSET    0x000c  /* DMA/Interrupt enable register (16-bit) */
#define AT32_BTIM_SR_OFFSET      0x0010  /* Status register (16-bit) */
#define AT32_BTIM_EGR_OFFSET     0x0014  /* Event generation register (16-bit) */
#define AT32_BTIM_CNT_OFFSET     0x0024  /* Counter (16-bit) */
#define AT32_BTIM_PSC_OFFSET     0x0028  /* Prescaler (16-bit) */
#define AT32_BTIM_ARR_OFFSET     0x002c  /* Auto-reload register (16-bit) */
...
#define AT32_GTIM_CR1_OFFSET      0x0000  /* Control register 1 (16-bit) */
#define AT32_GTIM_CR2_OFFSET      0x0004  /* Control register 2 (16-bit, TIM2-5 only) */
#define AT32_GTIM_SMCR_OFFSET     0x0008  /* Slave mode control register (16-bit, TIM2-5 only) */
#define AT32_GTIM_DIER_OFFSET     0x000c  /* DMA/Interrupt enable register (16-bit) */
#define AT32_GTIM_SR_OFFSET       0x0010  /* Status register (16-bit) */
#define AT32_GTIM_EGR_OFFSET      0x0014  /* Event generation register (16-bit) */
#define AT32_GTIM_CCMR1_OFFSET    0x0018  /* Capture/compare mode register 1 (16-bit) */
#define AT32_GTIM_CCMR2_OFFSET    0x001c  /* Capture/compare mode register 2 (16-bit, TIM2-5 only) */
#define AT32_GTIM_CCER_OFFSET     0x0020  /* Capture/compare enable register (16-bit) */
#define AT32_GTIM_CNT_OFFSET      0x0024  /* Counter (16-bit* or 32-bit AT32F43 TIM2 and 5 only) */
#define AT32_GTIM_PSC_OFFSET      0x0028  /* Prescaler (16-bit) */
#define AT32_GTIM_ARR_OFFSET      0x002c  /* Auto-reload register (16-bit) */
#define AT32_GTIM_CCR1_OFFSET     0x0034  /* Capture/compare register 1 (16-bit or 32-bit AT32F43 TIM2/5 only) */
#define AT32_GTIM_CCR2_OFFSET     0x0038  /* Capture/compare register 2 (16-bit TIM2-5 only or 32-bit AT32 F4 TIM2/5 or STM2 F3 TIM15 only) */
#define AT32_GTIM_CCR3_OFFSET     0x003c  /* Capture/compare register 3 (16-bit TIM2-5 only or 32-bit AT32 F4 TIM2/5 only) */
#define AT32_GTIM_CCR4_OFFSET     0x0040  /* Capture/compare register 4 (16-bit TIM2-5 only or 32-bit AT32 F4 TIM2/5 only) */
#define AT32_GTIM_DCR_OFFSET      0x0048  /* DMA control register (16-bit, TIM2-5 only) */
#define AT32_GTIM_DMAR_OFFSET     0x004c  /* DMA address for burst mode (16-bit, TIM2-5 only) */

#define AT32_GTIM_OR_OFFSET       0x0050  /* Timer 2/5/11/16 option register */

/* Advanced Timers - TIM1, TIM8 and TIM20 */

#define AT32_ATIM_CR1_OFFSET      0x0000  /* Control register 1 (16-bit) */
#define AT32_ATIM_CR2_OFFSET      0x0004  /* Control register 2 (16-bit*) */
#define AT32_ATIM_SMCR_OFFSET     0x0008  /* Slave mode control register (16-bit) */
#define AT32_ATIM_DIER_OFFSET     0x000c  /* DMA/Interrupt enable register (16-bit) */
#define AT32_ATIM_SR_OFFSET       0x0010  /* Status register (16-bit*) */
#define AT32_ATIM_EGR_OFFSET      0x0014  /* Event generation register (16-bit) */
#define AT32_ATIM_CCMR1_OFFSET    0x0018  /* Capture/compare mode register 1 (16-bit*) */
#define AT32_ATIM_CCMR2_OFFSET    0x001c  /* Capture/compare mode register 2 (16-bit*) */
#define AT32_ATIM_CCER_OFFSET     0x0020  /* Capture/compare enable register (16-bit*) */
#define AT32_ATIM_CNT_OFFSET      0x0024  /* Counter (16-bit) */
#define AT32_ATIM_PSC_OFFSET      0x0028  /* Prescaler (16-bit) */
#define AT32_ATIM_ARR_OFFSET      0x002c  /* Auto-reload register (16-bit) */
#define AT32_ATIM_RCR_OFFSET      0x0030  /* Repetition counter register (16-bit) */
#define AT32_ATIM_CCR1_OFFSET     0x0034  /* Capture/compare register 1 (16-bit) */
#define AT32_ATIM_CCR2_OFFSET     0x0038  /* Capture/compare register 2 (16-bit) */
#define AT32_ATIM_CCR3_OFFSET     0x003c  /* Capture/compare register 3 (16-bit) */
#define AT32_ATIM_CCR4_OFFSET     0x0040  /* Capture/compare register 4 (16-bit) */
#define AT32_ATIM_BDTR_OFFSET     0x0044  /* Break and dead-time register (16-bit*) */
#define AT32_ATIM_DCR_OFFSET      0x0048  /* DMA control register (16-bit) */
#define AT32_ATIM_DMAR_OFFSET     0x004c  /* DMA address for burst mode (16-bit) */

/* Note that many of the above registers are 32-bits wide on the F3 */

#define AT32_ATIM_CCMR3_OFFSET    0x0070  /* Capture/compare mode register 3 (32-bit) */
#define AT32_ATIM_CCR5_OFFSET     0x0074  /* Capture/compare register 5 (32-bit) */

/* Register Addresses *******************************************************/

/* Advanced Timers - TIM1 and TIM8 TIM20 */

#if AT32_NATIM > 0
#  define AT32_TIM1_CR1          (AT32_TMR1_BASE+AT32_ATIM_CR1_OFFSET)
#  define AT32_TIM1_CR2          (AT32_TMR1_BASE+AT32_ATIM_CR2_OFFSET)
#  define AT32_TIM1_SMCR         (AT32_TMR1_BASE+AT32_ATIM_SMCR_OFFSET)
#  define AT32_TIM1_DIER         (AT32_TMR1_BASE+AT32_ATIM_DIER_OFFSET)
#  define AT32_TIM1_SR           (AT32_TMR1_BASE+AT32_ATIM_SR_OFFSET)
#  define AT32_TIM1_EGR          (AT32_TMR1_BASE+AT32_ATIM_EGR_OFFSET)
#  define AT32_TIM1_CCMR1        (AT32_TMR1_BASE+AT32_ATIM_CCMR1_OFFSET)
#  define AT32_TIM1_CCMR2        (AT32_TMR1_BASE+AT32_ATIM_CCMR2_OFFSET)
#  define AT32_TIM1_CCER         (AT32_TMR1_BASE+AT32_ATIM_CCER_OFFSET)
#  define AT32_TIM1_CNT          (AT32_TMR1_BASE+AT32_ATIM_CNT_OFFSET)
#  define AT32_TIM1_PSC          (AT32_TMR1_BASE+AT32_ATIM_PSC_OFFSET)
#  define AT32_TIM1_ARR          (AT32_TMR1_BASE+AT32_ATIM_ARR_OFFSET)
#  define AT32_TIM1_RCR          (AT32_TMR1_BASE+AT32_ATIM_RCR_OFFSET)
#  define AT32_TIM1_CCR1         (AT32_TMR1_BASE+AT32_ATIM_CCR1_OFFSET)
#  define AT32_TIM1_CCR2         (AT32_TMR1_BASE+AT32_ATIM_CCR2_OFFSET)
#  define AT32_TIM1_CCR3         (AT32_TMR1_BASE+AT32_ATIM_CCR3_OFFSET)
#  define AT32_TIM1_CCR4         (AT32_TMR1_BASE+AT32_ATIM_CCR4_OFFSET)
#  define AT32_TIM1_BDTR         (AT32_TMR1_BASE+AT32_ATIM_BDTR_OFFSET)
#  define AT32_TIM1_DCR          (AT32_TMR1_BASE+AT32_ATIM_DCR_OFFSET)
#  define AT32_TIM1_DMAR         (AT32_TMR1_BASE+AT32_ATIM_DMAR_OFFSET)
#  define AT32_TIM1_CCMR3        (AT32_TMR1_BASE+AT32_ATIM_CCMR3_OFFSET)
#  define AT32_TIM1_CCR5         (AT32_TMR1_BASE+AT32_ATIM_CCR5_OFFSET)
#endif

#if AT32_NATIM > 1
#  define AT32_TIM8_CR1          (AT32_TMR8_BASE+AT32_ATIM_CR1_OFFSET)
#  define AT32_TIM8_CR2          (AT32_TMR8_BASE+AT32_ATIM_CR2_OFFSET)
#  define AT32_TIM8_SMCR         (AT32_TMR8_BASE+AT32_ATIM_SMCR_OFFSET)
#  define AT32_TIM8_DIER         (AT32_TMR8_BASE+AT32_ATIM_DIER_OFFSET)
#  define AT32_TIM8_SR           (AT32_TMR8_BASE+AT32_ATIM_SR_OFFSET)
#  define AT32_TIM8_EGR          (AT32_TMR8_BASE+AT32_ATIM_EGR_OFFSET)
#  define AT32_TIM8_CCMR1        (AT32_TMR8_BASE+AT32_ATIM_CCMR1_OFFSET)
#  define AT32_TIM8_CCMR2        (AT32_TMR8_BASE+AT32_ATIM_CCMR2_OFFSET)
#  define AT32_TIM8_CCER         (AT32_TMR8_BASE+AT32_ATIM_CCER_OFFSET)
#  define AT32_TIM8_CNT          (AT32_TMR8_BASE+AT32_ATIM_CNT_OFFSET)
#  define AT32_TIM8_PSC          (AT32_TMR8_BASE+AT32_ATIM_PSC_OFFSET)
#  define AT32_TIM8_ARR          (AT32_TMR8_BASE+AT32_ATIM_ARR_OFFSET)
#  define AT32_TIM8_RCR          (AT32_TMR8_BASE+AT32_ATIM_RCR_OFFSET)
#  define AT32_TIM8_CCR1         (AT32_TMR8_BASE+AT32_ATIM_CCR1_OFFSET)
#  define AT32_TIM8_CCR2         (AT32_TMR8_BASE+AT32_ATIM_CCR2_OFFSET)
#  define AT32_TIM8_CCR3         (AT32_TMR8_BASE+AT32_ATIM_CCR3_OFFSET)
#  define AT32_TIM8_CCR4         (AT32_TMR8_BASE+AT32_ATIM_CCR4_OFFSET)
#  define AT32_TIM8_BDTR         (AT32_TMR8_BASE+AT32_ATIM_BDTR_OFFSET)
#  define AT32_TIM8_DCR          (AT32_TMR8_BASE+AT32_ATIM_DCR_OFFSET)
#  define AT32_TIM8_DMAR         (AT32_TMR8_BASE+AT32_ATIM_DMAR_OFFSET)
#  define AT32_TIM8_CCMR3        (AT32_TMR8_BASE+AT32_ATIM_CCMR3_OFFSET)
#  define AT32_TIM8_CCR5         (AT32_TMR8_BASE+AT32_ATIM_CCR5_OFFSET)
#endif

#if AT32_NATIM > 2
#  define AT32_TIM20_CR1          (AT32_TMR20_BASE+AT32_ATIM_CR1_OFFSET)
#  define AT32_TIM20_CR2          (AT32_TMR20_BASE+AT32_ATIM_CR2_OFFSET)
#  define AT32_TIM20_SMCR         (AT32_TMR20_BASE+AT32_ATIM_SMCR_OFFSET)
#  define AT32_TIM20_DIER         (AT32_TMR20_BASE+AT32_ATIM_DIER_OFFSET)
#  define AT32_TIM20_SR           (AT32_TMR20_BASE+AT32_ATIM_SR_OFFSET)
#  define AT32_TIM20_EGR          (AT32_TMR20_BASE+AT32_ATIM_EGR_OFFSET)
#  define AT32_TIM20_CCMR1        (AT32_TMR20_BASE+AT32_ATIM_CCMR1_OFFSET)
#  define AT32_TIM20_CCMR2        (AT32_TMR20_BASE+AT32_ATIM_CCMR2_OFFSET)
#  define AT32_TIM20_CCER         (AT32_TMR20_BASE+AT32_ATIM_CCER_OFFSET)
#  define AT32_TIM20_CNT          (AT32_TMR20_BASE+AT32_ATIM_CNT_OFFSET)
#  define AT32_TIM20_PSC          (AT32_TMR20_BASE+AT32_ATIM_PSC_OFFSET)
#  define AT32_TIM20_ARR          (AT32_TMR20_BASE+AT32_ATIM_ARR_OFFSET)
#  define AT32_TIM20_RCR          (AT32_TMR20_BASE+AT32_ATIM_RCR_OFFSET)
#  define AT32_TIM20_CCR1         (AT32_TMR20_BASE+AT32_ATIM_CCR1_OFFSET)
#  define AT32_TIM20_CCR2         (AT32_TMR20_BASE+AT32_ATIM_CCR2_OFFSET)
#  define AT32_TIM20_CCR3         (AT32_TMR20_BASE+AT32_ATIM_CCR3_OFFSET)
#  define AT32_TIM20_CCR4         (AT32_TMR20_BASE+AT32_ATIM_CCR4_OFFSET)
#  define AT32_TIM20_BDTR         (AT32_TMR20_BASE+AT32_ATIM_BDTR_OFFSET)
#  define AT32_TIM20_DCR          (AT32_TMR20_BASE+AT32_ATIM_DCR_OFFSET)
#  define AT32_TIM20_DMAR         (AT32_TMR20_BASE+AT32_ATIM_DMAR_OFFSET)
#  define AT32_TIM20_CCMR3        (AT32_TMR20_BASE+AT32_ATIM_CCMR3_OFFSET)
#  define AT32_TIM20_CCR5         (AT32_TMR20_BASE+AT32_ATIM_CCR5_OFFSET)
#endif

/* 16-/32-bit General Timers - TIM2, TIM3, TIM4, and TIM5 with DMA. */

#if AT32_NGTIM > 0
#  define AT32_TIM2_CR1          (AT32_TMR2_BASE+AT32_GTIM_CR1_OFFSET)
#  define AT32_TIM2_CR2          (AT32_TMR2_BASE+AT32_GTIM_CR2_OFFSET)
#  define AT32_TIM2_SMCR         (AT32_TMR2_BASE+AT32_GTIM_SMCR_OFFSET)
#  define AT32_TIM2_DIER         (AT32_TMR2_BASE+AT32_GTIM_DIER_OFFSET)
#  define AT32_TIM2_SR           (AT32_TMR2_BASE+AT32_GTIM_SR_OFFSET)
#  define AT32_TIM2_EGR          (AT32_TMR2_BASE+AT32_GTIM_EGR_OFFSET)
#  define AT32_TIM2_CCMR1        (AT32_TMR2_BASE+AT32_GTIM_CCMR1_OFFSET)
#  define AT32_TIM2_CCMR2        (AT32_TMR2_BASE+AT32_GTIM_CCMR2_OFFSET)
#  define AT32_TIM2_CCER         (AT32_TMR2_BASE+AT32_GTIM_CCER_OFFSET)
#  define AT32_TIM2_CNT          (AT32_TMR2_BASE+AT32_GTIM_CNT_OFFSET)
#  define AT32_TIM2_PSC          (AT32_TMR2_BASE+AT32_GTIM_PSC_OFFSET)
#  define AT32_TIM2_ARR          (AT32_TMR2_BASE+AT32_GTIM_ARR_OFFSET)
#  define AT32_TIM2_CCR1         (AT32_TMR2_BASE+AT32_GTIM_CCR1_OFFSET)
#  define AT32_TIM2_CCR2         (AT32_TMR2_BASE+AT32_GTIM_CCR2_OFFSET)
#  define AT32_TIM2_CCR3         (AT32_TMR2_BASE+AT32_GTIM_CCR3_OFFSET)
#  define AT32_TIM2_CCR4         (AT32_TMR2_BASE+AT32_GTIM_CCR4_OFFSET)
#  define AT32_TIM2_DCR          (AT32_TMR2_BASE+AT32_GTIM_DCR_OFFSET)
#  define AT32_TIM2_DMAR         (AT32_TMR2_BASE+AT32_GTIM_DMAR_OFFSET)
#  if defined(CONFIG_AT32_AT32F43XX)
#    define AT32_TIM2_OR         (AT32_TMR2_BASE+AT32_GTIM_OR_OFFSET)
#  endif
#endif

#if AT32_NGTIM > 1
#  define AT32_TIM3_CR1          (AT32_TMR3_BASE+AT32_GTIM_CR1_OFFSET)
#  define AT32_TIM3_CR2          (AT32_TMR3_BASE+AT32_GTIM_CR2_OFFSET)
#  define AT32_TIM3_SMCR         (AT32_TMR3_BASE+AT32_GTIM_SMCR_OFFSET)
#  define AT32_TIM3_DIER         (AT32_TMR3_BASE+AT32_GTIM_DIER_OFFSET)
#  define AT32_TIM3_SR           (AT32_TMR3_BASE+AT32_GTIM_SR_OFFSET)
#  define AT32_TIM3_EGR          (AT32_TMR3_BASE+AT32_GTIM_EGR_OFFSET)
#  define AT32_TIM3_CCMR1        (AT32_TMR3_BASE+AT32_GTIM_CCMR1_OFFSET)
#  define AT32_TIM3_CCMR2        (AT32_TMR3_BASE+AT32_GTIM_CCMR2_OFFSET)
#  define AT32_TIM3_CCER         (AT32_TMR3_BASE+AT32_GTIM_CCER_OFFSET)
#  define AT32_TIM3_CNT          (AT32_TMR3_BASE+AT32_GTIM_CNT_OFFSET)
#  define AT32_TIM3_PSC          (AT32_TMR3_BASE+AT32_GTIM_PSC_OFFSET)
#  define AT32_TIM3_ARR          (AT32_TMR3_BASE+AT32_GTIM_ARR_OFFSET)
#  define AT32_TIM3_CCR1         (AT32_TMR3_BASE+AT32_GTIM_CCR1_OFFSET)
#  define AT32_TIM3_CCR2         (AT32_TMR3_BASE+AT32_GTIM_CCR2_OFFSET)
#  define AT32_TIM3_CCR3         (AT32_TMR3_BASE+AT32_GTIM_CCR3_OFFSET)
#  define AT32_TIM3_CCR4         (AT32_TMR3_BASE+AT32_GTIM_CCR4_OFFSET)
#  define AT32_TIM3_DCR          (AT32_TMR3_BASE+AT32_GTIM_DCR_OFFSET)
#  define AT32_TIM3_DMAR         (AT32_TMR3_BASE+AT32_GTIM_DMAR_OFFSET)
#endif

#if AT32_NGTIM > 2
#  define AT32_TIM4_CR1          (AT32_TMR4_BASE+AT32_GTIM_CR1_OFFSET)
#  define AT32_TIM4_CR2          (AT32_TMR4_BASE+AT32_GTIM_CR2_OFFSET)
#  define AT32_TIM4_SMCR         (AT32_TMR4_BASE+AT32_GTIM_SMCR_OFFSET)
#  define AT32_TIM4_DIER         (AT32_TMR4_BASE+AT32_GTIM_DIER_OFFSET)
#  define AT32_TIM4_SR           (AT32_TMR4_BASE+AT32_GTIM_SR_OFFSET)
#  define AT32_TIM4_EGR          (AT32_TMR4_BASE+AT32_GTIM_EGR_OFFSET)
#  define AT32_TIM4_CCMR1        (AT32_TMR4_BASE+AT32_GTIM_CCMR1_OFFSET)
#  define AT32_TIM4_CCMR2        (AT32_TMR4_BASE+AT32_GTIM_CCMR2_OFFSET)
#  define AT32_TIM4_CCER         (AT32_TMR4_BASE+AT32_GTIM_CCER_OFFSET)
#  define AT32_TIM4_CNT          (AT32_TMR4_BASE+AT32_GTIM_CNT_OFFSET)
#  define AT32_TIM4_PSC          (AT32_TMR4_BASE+AT32_GTIM_PSC_OFFSET)
#  define AT32_TIM4_ARR          (AT32_TMR4_BASE+AT32_GTIM_ARR_OFFSET)
#  define AT32_TIM4_CCR1         (AT32_TMR4_BASE+AT32_GTIM_CCR1_OFFSET)
#  define AT32_TIM4_CCR2         (AT32_TMR4_BASE+AT32_GTIM_CCR2_OFFSET)
#  define AT32_TIM4_CCR3         (AT32_TMR4_BASE+AT32_GTIM_CCR3_OFFSET)
#  define AT32_TIM4_CCR4         (AT32_TMR4_BASE+AT32_GTIM_CCR4_OFFSET)
#  define AT32_TIM4_DCR          (AT32_TMR4_BASE+AT32_GTIM_DCR_OFFSET)
#  define AT32_TIM4_DMAR         (AT32_TMR4_BASE+AT32_GTIM_DMAR_OFFSET)
#endif

#if AT32_NGTIM > 3
#  define AT32_TIM5_CR1          (AT32_TMR5_BASE+AT32_GTIM_CR1_OFFSET)
#  define AT32_TIM5_CR2          (AT32_TMR5_BASE+AT32_GTIM_CR2_OFFSET)
#  define AT32_TIM5_SMCR         (AT32_TMR5_BASE+AT32_GTIM_SMCR_OFFSET)
#  define AT32_TIM5_DIER         (AT32_TMR5_BASE+AT32_GTIM_DIER_OFFSET)
#  define AT32_TIM5_SR           (AT32_TMR5_BASE+AT32_GTIM_SR_OFFSET)
#  define AT32_TIM5_EGR          (AT32_TMR5_BASE+AT32_GTIM_EGR_OFFSET)
#  define AT32_TIM5_CCMR1        (AT32_TMR5_BASE+AT32_GTIM_CCMR1_OFFSET)
#  define AT32_TIM5_CCMR2        (AT32_TMR5_BASE+AT32_GTIM_CCMR2_OFFSET)
#  define AT32_TIM5_CCER         (AT32_TMR5_BASE+AT32_GTIM_CCER_OFFSET)
#  define AT32_TIM5_CNT          (AT32_TMR5_BASE+AT32_GTIM_CNT_OFFSET)
#  define AT32_TIM5_PSC          (AT32_TMR5_BASE+AT32_GTIM_PSC_OFFSET)
#  define AT32_TIM5_ARR          (AT32_TMR5_BASE+AT32_GTIM_ARR_OFFSET)
#  define AT32_TIM5_CCR1         (AT32_TMR5_BASE+AT32_GTIM_CCR1_OFFSET)
#  define AT32_TIM5_CCR2         (AT32_TMR5_BASE+AT32_GTIM_CCR2_OFFSET)
#  define AT32_TIM5_CCR3         (AT32_TMR5_BASE+AT32_GTIM_CCR3_OFFSET)
#  define AT32_TIM5_CCR4         (AT32_TMR5_BASE+AT32_GTIM_CCR4_OFFSET)
#  define AT32_TIM5_DCR          (AT32_TMR5_BASE+AT32_GTIM_DCR_OFFSET)
#  define AT32_TIM5_DMAR         (AT32_TMR5_BASE+AT32_GTIM_DMAR_OFFSET)
#  if defined(CONFIG_AT32_AT32F43XX)
#    define AT32_TIM5_OR         (AT32_TMR5_BASE+AT32_GTIM_OR_OFFSET)
#  endif
#endif
...
#if AT32_NGTIMNDMA > 0
#  define AT32_TIM9_CR1          (AT32_TMR9_BASE+AT32_GTIM_CR1_OFFSET)
#  define AT32_TIM9_CR2          (AT32_TMR9_BASE+AT32_GTIM_CR2_OFFSET)
#  define AT32_TIM9_DIER         (AT32_TMR9_BASE+AT32_GTIM_DIER_OFFSET)
#  define AT32_TIM9_SR           (AT32_TMR9_BASE+AT32_GTIM_SR_OFFSET)
#  define AT32_TIM9_EGR          (AT32_TMR9_BASE+AT32_GTIM_EGR_OFFSET)
#  define AT32_TIM9_CCMR1        (AT32_TMR9_BASE+AT32_GTIM_CCMR1_OFFSET)
#  define AT32_TIM9_CCER         (AT32_TMR9_BASE+AT32_GTIM_CCER_OFFSET)
#  define AT32_TIM9_CNT          (AT32_TMR9_BASE+AT32_GTIM_CNT_OFFSET)
#  define AT32_TIM9_PSC          (AT32_TMR9_BASE+AT32_GTIM_PSC_OFFSET)
#  define AT32_TIM9_ARR          (AT32_TMR9_BASE+AT32_GTIM_ARR_OFFSET)
#  define AT32_TIM9_CCR1         (AT32_TMR9_BASE+AT32_GTIM_CCR1_OFFSET)
#  define AT32_TIM9_CCR2         (AT32_TMR9_BASE+AT32_GTIM_CCR2_OFFSET)
#endif

#if AT32_NGTIMNDMA > 1
#  define AT32_TIM10_CR1         (AT32_TMR10_BASE+AT32_GTIM_CR1_OFFSET)
#  define AT32_TIM10_DIER        (AT32_TMR10_BASE+AT32_GTIM_DIER_OFFSET)
#  define AT32_TIM10_SR          (AT32_TMR10_BASE+AT32_GTIM_SR_OFFSET)
#  define AT32_TIM10_EGR         (AT32_TMR10_BASE+AT32_GTIM_EGR_OFFSET)
#  define AT32_TIM10_CCMR1       (AT32_TMR10_BASE+AT32_GTIM_CCMR1_OFFSET)
#  define AT32_TIM10_CCER        (AT32_TMR10_BASE+AT32_GTIM_CCER_OFFSET)
#  define AT32_TIM10_CNT         (AT32_TMR10_BASE+AT32_GTIM_CNT_OFFSET)
#  define AT32_TIM10_PSC         (AT32_TMR10_BASE+AT32_GTIM_PSC_OFFSET)
#  define AT32_TIM10_ARR         (AT32_TMR10_BASE+AT32_GTIM_ARR_OFFSET)
#  define AT32_TIM10_CCR1        (AT32_TMR10_BASE+AT32_GTIM_CCR1_OFFSET)
#endif

#if AT32_NGTIMNDMA > 2
#  define AT32_TIM11_CR1         (AT32_TMR11_BASE+AT32_GTIM_CR1_OFFSET)
#  define AT32_TIM11_DIER        (AT32_TMR11_BASE+AT32_GTIM_DIER_OFFSET)
#  define AT32_TIM11_SR          (AT32_TMR11_BASE+AT32_GTIM_SR_OFFSET)
#  define AT32_TIM11_EGR         (AT32_TMR11_BASE+AT32_GTIM_EGR_OFFSET)
#  define AT32_TIM11_CCMR1       (AT32_TMR11_BASE+AT32_GTIM_CCMR1_OFFSET)
#  define AT32_TIM11_CCER        (AT32_TMR11_BASE+AT32_GTIM_CCER_OFFSET)
#  define AT32_TIM11_CNT         (AT32_TMR11_BASE+AT32_GTIM_CNT_OFFSET)
#  define AT32_TIM11_PSC         (AT32_TMR11_BASE+AT32_GTIM_PSC_OFFSET)
#  define AT32_TIM11_ARR         (AT32_TMR11_BASE+AT32_GTIM_ARR_OFFSET)
#  define AT32_TIM11_CCR1        (AT32_TMR11_BASE+AT32_GTIM_CCR1_OFFSET)
#  define AT32_TIM11_OR          (AT32_TMR11_BASE+AT32_GTIM_OR_OFFSET)
#endif

#if AT32_NGTIMNDMA > 3
#  define AT32_TIM12_CR1         (AT32_TMR12_BASE+AT32_GTIM_CR1_OFFSET)
#  define AT32_TIM12_CR2         (AT32_TMR12_BASE+AT32_GTIM_CR2_OFFSET)
#  define AT32_TIM12_DIER        (AT32_TMR12_BASE+AT32_GTIM_DIER_OFFSET)
#  define AT32_TIM12_SR          (AT32_TMR12_BASE+AT32_GTIM_SR_OFFSET)
#  define AT32_TIM12_EGR         (AT32_TMR12_BASE+AT32_GTIM_EGR_OFFSET)
#  define AT32_TIM12_CCMR1       (AT32_TMR12_BASE+AT32_GTIM_CCMR1_OFFSET)
#  define AT32_TIM12_CCER        (AT32_TMR12_BASE+AT32_GTIM_CCER_OFFSET)
#  define AT32_TIM12_CNT         (AT32_TMR12_BASE+AT32_GTIM_CNT_OFFSET)
#  define AT32_TIM12_PSC         (AT32_TMR12_BASE+AT32_GTIM_PSC_OFFSET)
#  define AT32_TIM12_ARR         (AT32_TMR12_BASE+AT32_GTIM_ARR_OFFSET)
#  define AT32_TIM12_CCR1        (AT32_TMR12_BASE+AT32_GTIM_CCR1_OFFSET)
#  define AT32_TIM12_CCR2        (AT32_TMR12_BASE+AT32_GTIM_CCR2_OFFSET)
#endif

#if AT32_NGTIMNDMA > 4
#  define AT32_TIM13_CR1         (AT32_TMR13_BASE+AT32_GTIM_CR1_OFFSET)
#  define AT32_TIM13_DIER        (AT32_TMR13_BASE+AT32_GTIM_DIER_OFFSET)
#  define AT32_TIM13_SR          (AT32_TMR13_BASE+AT32_GTIM_SR_OFFSET)
#  define AT32_TIM13_EGR         (AT32_TMR13_BASE+AT32_GTIM_EGR_OFFSET)
#  define AT32_TIM13_CCMR1       (AT32_TMR13_BASE+AT32_GTIM_CCMR1_OFFSET)
#  define AT32_TIM13_CCER        (AT32_TMR13_BASE+AT32_GTIM_CCER_OFFSET)
#  define AT32_TIM13_CNT         (AT32_TMR13_BASE+AT32_GTIM_CNT_OFFSET)
#  define AT32_TIM13_PSC         (AT32_TMR13_BASE+AT32_GTIM_PSC_OFFSET)
#  define AT32_TIM13_ARR         (AT32_TMR13_BASE+AT32_GTIM_ARR_OFFSET)
#  define AT32_TIM13_CCR1        (AT32_TMR13_BASE+AT32_GTIM_CCR1_OFFSET)
#endif

#if AT32_NGTIMNDMA > 5
#  define AT32_TIM14_CR1         (AT32_TMR14_BASE+AT32_GTIM_CR1_OFFSET)
#  define AT32_TIM14_DIER        (AT32_TMR14_BASE+AT32_GTIM_DIER_OFFSET)
#  define AT32_TIM14_SR          (AT32_TMR14_BASE+AT32_GTIM_SR_OFFSET)
#  define AT32_TIM14_EGR         (AT32_TMR14_BASE+AT32_GTIM_EGR_OFFSET)
#  define AT32_TIM14_CCMR1       (AT32_TMR14_BASE+AT32_GTIM_CCMR1_OFFSET)
#  define AT32_TIM14_CCER        (AT32_TMR14_BASE+AT32_GTIM_CCER_OFFSET)
#  define AT32_TIM14_CNT         (AT32_TMR14_BASE+AT32_GTIM_CNT_OFFSET)
#  define AT32_TIM14_PSC         (AT32_TMR14_BASE+AT32_GTIM_PSC_OFFSET)
#  define AT32_TIM14_ARR         (AT32_TMR14_BASE+AT32_GTIM_ARR_OFFSET)
#  define AT32_TIM14_CCR1        (AT32_TMR14_BASE+AT32_GTIM_CCR1_OFFSET)
#endif

/* Basic Timers - TIM6 and TIM7 */

#if AT32_NBTIM > 0
#  define AT32_TIM6_CR1          (AT32_TMR6_BASE+AT32_BTIM_CR1_OFFSET)
#  define AT32_TIM6_CR2          (AT32_TMR6_BASE+AT32_BTIM_CR2_OFFSET)
#  define AT32_TIM6_DIER         (AT32_TMR6_BASE+AT32_BTIM_DIER_OFFSET)
#  define AT32_TIM6_SR           (AT32_TMR6_BASE+AT32_BTIM_SR_OFFSET)
#  define AT32_TIM6_EGR          (AT32_TMR6_BASE+AT32_BTIM_EGR_OFFSET)
#  define AT32_TIM6_CNT          (AT32_TMR6_BASE+AT32_BTIM_CNT_OFFSET)
#  define AT32_TIM6_PSC          (AT32_TMR6_BASE+AT32_BTIM_PSC_OFFSET)
#  define AT32_TIM6_ARR          (AT32_TMR6_BASE+AT32_BTIM_ARR_OFFSET)
#endif

#if AT32_NBTIM > 1
#  define AT32_TIM7_CR1          (AT32_TMR7_BASE+AT32_BTIM_CR1_OFFSET)
#  define AT32_TIM7_CR2          (AT32_TMR7_BASE+AT32_BTIM_CR2_OFFSET)
#  define AT32_TIM7_DIER         (AT32_TMR7_BASE+AT32_BTIM_DIER_OFFSET)
#  define AT32_TIM7_SR           (AT32_TMR7_BASE+AT32_BTIM_SR_OFFSET)
#  define AT32_TIM7_EGR          (AT32_TMR7_BASE+AT32_BTIM_EGR_OFFSET)
#  define AT32_TIM7_CNT          (AT32_TMR7_BASE+AT32_BTIM_CNT_OFFSET)
#  define AT32_TIM7_PSC          (AT32_TMR7_BASE+AT32_BTIM_PSC_OFFSET)
#  define AT32_TIM7_ARR          (AT32_TMR7_BASE+AT32_BTIM_ARR_OFFSET)
#endif
...
#define ATIM_CR2_TRGOUT2EN           (1 << 31)  /* TRGOUT2 enable */
...
#    define TIM2_OR_ITR1_OTGFS1SOF (2 << TIM2_OR_ITR1_RMP_SHIFT)   /* 10: TIM2_ITR1 input connected to OTG FS SOF */
#    define TIM2_OR_ITR1_OTGFS2SOF (3 << TIM2_OR_ITR1_RMP_SHIFT)   /* 11: TIM2_ITR1 input connected to OTG HS SOF */
...
#endif /* __ARCH_ARM_SRC_AT32_HARDWARE_AT32_TIM_V1V2_H */
