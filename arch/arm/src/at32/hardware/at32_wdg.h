/****************************************************************************
 * arch/arm/src/at32/hardware/at32_wdg.h
 *
...
#ifndef __ARCH_ARM_SRC_AT32_HARDWARE_AT32_WDG_H
#define __ARCH_ARM_SRC_AT32_HARDWARE_AT32_WDG_H
...
#define AT32_IWDG_KR_OFFSET     0x0000  /* Key register (32-bit) */
#define AT32_IWDG_PR_OFFSET     0x0004  /* Prescaler register (32-bit) */
#define AT32_IWDG_RLR_OFFSET    0x0008  /* Reload register (32-bit) */
#define AT32_IWDG_SR_OFFSET     0x000c  /* Status register (32-bit) */
#define AT32_IWDG_WINR_OFFSET   0x000c  /* Window register (32-bit) */

#define AT32_WWDG_CR_OFFSET     0x0000  /* Control Register (32-bit) */
#define AT32_WWDG_CFR_OFFSET    0x0004  /* Configuration register (32-bit) */
#define AT32_WWDG_SR_OFFSET     0x0008  /* Status register (32-bit) */

/* Register Addresses *******************************************************/

#define AT32_IWDG_KR            (AT32_WDT_BASE+AT32_IWDG_KR_OFFSET)
#define AT32_IWDG_PR            (AT32_WDT_BASE+AT32_IWDG_PR_OFFSET)
#define AT32_IWDG_RLR           (AT32_WDT_BASE+AT32_IWDG_RLR_OFFSET)
#define AT32_IWDG_SR            (AT32_WDT_BASE+AT32_IWDG_SR_OFFSET)
#define AT32_IWDG_WINR          (AT32_WDT_BASE+AT32_IWDG_WINR_OFFSET)

#define AT32_WWDG_CR            (AT32_WWDT_BASE+AT32_WWDG_CR_OFFSET)
#define AT32_WWDG_CFR           (AT32_WWDT_BASE+AT32_WWDG_CFR_OFFSET)
#define AT32_WWDG_SR            (AT32_WWDT_BASE+AT32_WWDG_SR_OFFSET)
...
#endif /* __ARCH_ARM_SRC_AT32_HARDWARE_AT32_WDG_H */
