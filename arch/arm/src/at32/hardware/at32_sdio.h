/****************************************************************************
 * arch/arm/src/at32/hardware/at32_sdio.h
 *
...
#ifndef __ARCH_ARM_SRC_AT32_HARDWARE_AT32_SDIO_H
#define __ARCH_ARM_SRC_AT32_HARDWARE_AT32_SDIO_H
...
#define AT32_SDIO_POWER_OFFSET   0x0000 /* SDIO power control register */
#define AT32_SDIO_CLKCR_OFFSET   0x0004 /* SDI clock control register */
#define AT32_SDIO_ARG_OFFSET     0x0008 /* SDIO argument register */
#define AT32_SDIO_CMD_OFFSET     0x000c /* SDIO command register */
#define AT32_SDIO_RESPCMD_OFFSET 0x0010 /* SDIO command response register */
#define AT32_SDIO_RESP_OFFSET(n) (0x0010+4*(n))
#define AT32_SDIO_RESP1_OFFSET   0x0014 /* SDIO response 1 register */
#define AT32_SDIO_RESP2_OFFSET   0x0018 /* SDIO response 2 register */
#define AT32_SDIO_RESP3_OFFSET   0x001c /* SDIO response 3 register */
#define AT32_SDIO_RESP4_OFFSET   0x0020 /* SDIO response 4 register */
#define AT32_SDIO_DTIMER_OFFSET  0x0024 /* SDIO data timer register */
#define AT32_SDIO_DLEN_OFFSET    0x0028 /* SDIO data length register */
#define AT32_SDIO_DCTRL_OFFSET   0x002c /* SDIO data control register */
#define AT32_SDIO_DCOUNT_OFFSET  0x0030 /* SDIO data counter register */
#define AT32_SDIO_STA_OFFSET     0x0034 /* SDIO status register */
#define AT32_SDIO_ICR_OFFSET     0x0038 /* SDIO interrupt clear register */
#define AT32_SDIO_MASK_OFFSET    0x003c /* SDIO mask register */
#define AT32_SDIO_FIFOCNT_OFFSET 0x0048 /* SDIO FIFO counter register */
#define AT32_SDIO_FIFO_OFFSET    0x0080 /* SDIO data FIFO register */

/* Register Addresses *******************************************************/

#define AT32_SDIO_POWER          (AT32_SDIO1_BASE+AT32_SDIO_POWER_OFFSET)
#define AT32_SDIO_CLKCR          (AT32_SDIO1_BASE+AT32_SDIO_CLKCR_OFFSET)
#define AT32_SDIO_ARG            (AT32_SDIO1_BASE+AT32_SDIO_ARG_OFFSET)
#define AT32_SDIO_CMD            (AT32_SDIO1_BASE+AT32_SDIO_CMD_OFFSET)
#define AT32_SDIO_RESPCMD        (AT32_SDIO1_BASE+AT32_SDIO_RESPCMD_OFFSET)
#define AT32_SDIO_RESP(n)        (AT32_SDIO1_BASE+AT32_SDIO_RESP_OFFSET(n))
#define AT32_SDIO_RESP1          (AT32_SDIO1_BASE+AT32_SDIO_RESP1_OFFSET)
#define AT32_SDIO_RESP2          (AT32_SDIO1_BASE+AT32_SDIO_RESP2_OFFSET)
#define AT32_SDIO_RESP3          (AT32_SDIO1_BASE+AT32_SDIO_RESP3_OFFSET)
#define AT32_SDIO_RESP4          (AT32_SDIO1_BASE+AT32_SDIO_RESP4_OFFSET)
#define AT32_SDIO_DTIMER         (AT32_SDIO1_BASE+AT32_SDIO_DTIMER_OFFSET)
#define AT32_SDIO_DLEN           (AT32_SDIO1_BASE+AT32_SDIO_DLEN_OFFSET)
#define AT32_SDIO_DCTRL          (AT32_SDIO1_BASE+AT32_SDIO_DCTRL_OFFSET)
#define AT32_SDIO_DCOUNT         (AT32_SDIO1_BASE+AT32_SDIO_DCOUNT_OFFSET)
#define AT32_SDIO_STA            (AT32_SDIO1_BASE+AT32_SDIO_STA_OFFSET)
#define AT32_SDIO_ICR            (AT32_SDIO1_BASE+AT32_SDIO_ICR_OFFSET)
#define AT32_SDIO_MASK           (AT32_SDIO1_BASE+AT32_SDIO_MASK_OFFSET)
#define AT32_SDIO_FIFOCNT        (AT32_SDIO1_BASE+AT32_SDIO_FIFOCNT_OFFSET)
#define AT32_SDIO_FIFO           (AT32_SDIO1_BASE+AT32_SDIO_FIFO_OFFSET)

/* Bit-band (BB) base addresses *********************************************/

#define AT32_SDIO_OFFSET         (AT32_SDIO1_BASE-AT32_PERIPH_BASE)

#define AT32_SDIO_POWER_BB       (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_POWER_OFFSET)<<5))
#define AT32_SDIO_CLKCR_BB       (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_CLKCR_OFFSET)<<5))
#define AT32_SDIO_ARG_BB         (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_ARG_OFFSET)<<5))
#define AT32_SDIO_CMD_BB         (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_CMD_OFFSET)<<5))
#define AT32_SDIO_RESPCMD_BB     (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_RESPCMD_OFFSET)<<5))
#define AT32_SDIO_RESP_BB(n)     (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_RESP_OFFSET(n))<<5))
#define AT32_SDIO_RESP1_BB       (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_RESP1_OFFSET)<<5))
#define AT32_SDIO_RESP2_BB       (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_RESP2_OFFSET)<<5))
#define AT32_SDIO_RESP3_BB       (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_RESP3_OFFSET)<<5))
#define AT32_SDIO_RESP4_BB       (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_RESP4_OFFSET)<<5))
#define AT32_SDIO_DTIMER_BB      (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_DTIMER_OFFSET)<<5))
#define AT32_SDIO_DLEN_BB        (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_DLEN_OFFSET)<<5))
#define AT32_SDIO_DCTRL_BB       (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_DCTRL_OFFSET)<<5))
#define AT32_SDIO_DCOUNT_BB      (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_DCOUNT_OFFSET)<<5))
#define AT32_SDIO_STA_BB         (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_STA_OFFSET)<<5))
#define AT32_SDIO_ICR_BB         (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_ICR_OFFSET)<<5))
#define AT32_SDIO_MASK_BB        (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_MASK_OFFSET)<<5))
#define AT32_SDIO_FIFOCNT_BB     (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_FIFOCNT_OFFSET)<<5))
#define AT32_SDIO_FIFO_BB        (AT32_PERIPHBB_BASE+((AT32_SDIO_OFFSET+AT32_SDIO_FIFO_OFFSET)<<5))
...
#define SDIO_CLKCR_CLKDIV89_SHIFT      (15) /* Clock division bit8 ~ bit9 */
#define SDIO_CLKCR_CLKDIV89_MASK       (3 << SDIO_CLKCR_CLKDIV89_SHIFT)

#define SDIO_CLKCR_RESET               (0)       /* Reset value */
#define SDIO_ARG_RESET                 (0)       /* Reset value */

#define SDIO_CLKCR_CLKEN_BB            (AT32_SDIO_CLKCR_BB + (8 * 4))
#define SDIO_CLKCR_PWRSAV_BB           (AT32_SDIO_CLKCR_BB + (9 * 4))
#define SDIO_CLKCR_BYPASS_BB           (AT32_SDIO_CLKCR_BB + (10 * 4))
#define SDIO_CLKCR_NEGEDGE_BB          (AT32_SDIO_CLKCR_BB + (13 * 4))
#define SDIO_CLKCR_HWFC_EN_BB          (AT32_SDIO_CLKCR_BB + (14 * 4))
...
#define SDIO_CMD_WAITINT_BB            (AT32_SDIO_CMD_BB + (8 * 4))
#define SDIO_CMD_WAITPEND_BB           (AT32_SDIO_CMD_BB + (9 * 4))
#define SDIO_CMD_CPSMEN_BB             (AT32_SDIO_CMD_BB + (10 * 4))
#define SDIO_CMD_SUSPEND_BB            (AT32_SDIO_CMD_BB + (11 * 4))
#define SDIO_CMD_ENCMD_BB              (AT32_SDIO_CMD_BB + (12 * 4))
#define SDIO_CMD_NIEN_BB               (AT32_SDIO_CMD_BB + (13 * 4))
#define SDIO_CMD_ATACMD_BB             (AT32_SDIO_CMD_BB + (14 * 4))
...
#define SDIO_DCTRL_DTEN_BB             (AT32_SDIO_DCTRL_BB + (0 * 4))
#define SDIO_DCTRL_DTDIR_BB            (AT32_SDIO_DCTRL_BB + (1 * 4))
#define SDIO_DCTRL_DTMODE_BB           (AT32_SDIO_DCTRL_BB + (2 * 4))
#define SDIO_DCTRL_DMAEN_BB            (AT32_SDIO_DCTRL_BB + (3 * 4))
#define SDIO_DCTRL_RWSTART_BB          (AT32_SDIO_DCTRL_BB + (8 * 4))
#define SDIO_DCTRL_RWSTOP_BB           (AT32_SDIO_DCTRL_BB + (9 * 4))
#define SDIO_DCTRL_RWMOD_BB            (AT32_SDIO_DCTRL_BB + (10 * 4))
#define SDIO_DCTRL_SDIOEN_BB           (AT32_SDIO_DCTRL_BB + (11 * 4))
...
#define SDIO_ICR_RESET                 0x004007ff
...
#endif /* __ARCH_ARM_SRC_AT32_HARDWARE_AT32_SDIO_H */
