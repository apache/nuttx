...
static void stm32l5_tim_reload_counter(struct stm32l5_tim_dev_s *dev)
{
  uint16_t val = stm32l5_getreg16(dev, STM32_GTIM_EGR_OFFSET);
  val |= GTIM_EGR_UG;
  stm32l5_putreg16(dev, STM32_GTIM_EGR_OFFSET, val);
}
...
static void stm32l5_tim_enable(struct stm32l5_tim_dev_s *dev)
{
  uint16_t val = stm32l5_getreg16(dev, STM32_GTIM_CR1_OFFSET);
  val |= GTIM_CR1_CEN;
  stm32l5_tim_reload_counter(dev);
  stm32l5_putreg16(dev, STM32_GTIM_CR1_OFFSET, val);
}
...
static void stm32l5_tim_reset(struct stm32l5_tim_dev_s *dev)
{
  ((struct stm32l5_tim_priv_s *)dev)->mode = STM32_TIM_MODE_DISABLED;
                               ...
                               enum stm32l5_tim_mode_e mode)
{
...
#if STM32_NBTIM > 0
  if (((struct stm32l5_tim_priv_s *)dev)->base == STM32_TIM6_BASE
#endif
#if STM32_NBTIM > 1
      ||  ((struct stm32l5_tim_priv_s *)dev)->base == STM32_TIM7_BASE
#endif
#if STM32_NBTIM > 0
  )
    {
  ...
  /* Advanced registers require Main Output Enable */
    ...
    if (((struct stm32l5_tim_priv_s *)dev)->base == STM32_TIM1_BASE ||
        ((struct stm32l5_tim_priv_s *)dev)->base == STM32_TIM8_BASE)
      {
        stm32l5_modifyreg16(dev, STM32_ATIM_BDTR_OFFSET, 0, ATIM_BDTR_MOE);
      }
#endif
                                ...
                                uint32_t freq)
{
  ...
  stm32l5_putreg16(dev, STM32_GTIM_PSC_OFFSET, prescaler);
...
static uint32_t stm32l5_tim_getclock(struct stm32l5_tim_dev_s *dev)
{
  ...
  clock = freqin / (stm32l5_getreg16(dev, STM32_GTIM_PSC_OFFSET) + 1);
  return clock;
}
...
{
  DEBUGASSERT(dev != NULL);
  stm32l5_putreg32(dev, STM32_GTIM_ARR_OFFSET, period);
}
...
{
  DEBUGASSERT(dev != NULL);
  return stm32l5_getreg32 (dev, STM32_GTIM_ARR_OFFSET);
}
...
{
  DEBUGASSERT(dev != NULL);
  uint32_t counter = stm32l5_getreg32(dev, STM32_GTIM_CNT_OFFSET);
                                  ...
                                  enum stm32l5_tim_channel_e mode)
{
  ...
  ccer_val = stm32l5_getreg16(dev, STM32_GTIM_CCER_OFFSET);
  ...
  stm32l5_putreg16(dev, STM32_GTIM_CCER_OFFSET, ccer_val);
                                  ...
                                  uint8_t channel, uint32_t compare)
{
  ...
  switch (channel)
    {
      case 1:
        stm32l5_putreg32(dev, STM32_GTIM_CCR1_OFFSET, compare);
        break;

      case 2:
        stm32l5_putreg32(dev, STM32_GTIM_CCR2_OFFSET, compare);
        break;

      case 3:
        stm32l5_putreg32(dev, STM32_GTIM_CCR3_OFFSET, compare);
        break;

      case 4:
        stm32l5_putreg32(dev, STM32_GTIM_CCR4_OFFSET, compare);
        break;
                                  ...
                                  uint8_t channel)
{
  ...
  switch (channel)
    {
      case 1:
        return stm32l5_getreg32(dev, STM32_GTIM_CCR1_OFFSET);

      case 2:
        return stm32l5_getreg32(dev, STM32_GTIM_CCR2_OFFSET);

      case 3:
        return stm32l5_getreg32(dev, STM32_GTIM_CCR3_OFFSET);

      case 4:
        return stm32l5_getreg32(dev, STM32_GTIM_CCR4_OFFSET);
    }
...
{
  DEBUGASSERT(dev != NULL);
  stm32l5_modifyreg16(dev, STM32_GTIM_DIER_OFFSET, 0, GTIM_DIER_UIE);
}
...
{
  DEBUGASSERT(dev != NULL);
  stm32l5_modifyreg16(dev, STM32_GTIM_DIER_OFFSET, GTIM_DIER_UIE, 0);
}
...
{
  stm32l5_putreg16(dev, STM32_GTIM_SR_OFFSET, ~GTIM_SR_UIF);
}
...
static int stm32l5_tim_checkint(struct stm32l5_tim_dev_s *dev,
                                int source)
{
  uint16_t regval = stm32l5_getreg16(dev, STM32_GTIM_SR_OFFSET);
...
struct stm32l5_tim_dev_s *stm32l5_tim_init(int timer)
{
  ...
  if (((struct stm32l5_tim_priv_s *)dev)->mode != STM32_TIM_MODE_UNUSED)
    {
      return NULL;
    }
...
int stm32l5_tim_deinit(struct stm32l5_tim_dev_s *dev)
{
  ...
  ((struct stm32l5_tim_priv_s *)dev)->mode = STM32_TIM_MODE_UNUSED;
