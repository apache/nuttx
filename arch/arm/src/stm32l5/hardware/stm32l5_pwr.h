...
#define STM32_PWR_SECCFGR_OFFSET  0x0078  /* Power secure configuration register */
#define STM32_PWR_PRIVCFGR_OFFSET 0x0078  /* Power privilege configuration register */
