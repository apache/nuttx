 ...
 ****************************************************************************/
 ...
 #ifndef __ARCH_ARM_SRC_N32H7_N32_GPIO_H
 #define __ARCH_ARM_SRC_N32H7_N32_GPIO_H
...
/* Bit-encoded input to n32_configgpio() */
 ...
 * Outputs:               MMUU .... DDOS PPPP BBBB
 * Alternate Functions:   MMUU AAAA DDOS PPPP BBBB
 * Analog:                MM.. .... .... PPPP BBBB
 */
...
/* Output/Alt function drive current selection:
 *
 * 1111 1111 1100 0000 0000
 * 9876 5432 1098 7654 3210
 * ---- ---- ---- ---- ----
...
#define GPIO_DRIVE_SHIFT              (10)                       /* Bits 10-11: GPIO drive current selection */
#define GPIO_DRIVE_MASK               (3 << GPIO_DRIVE_SHIFT)
#  define GPIO_DRIVE_2mA              (0 << GPIO_DRIVE_SHIFT)     /* 2  mA Low drive current output */
#  define GPIO_DRIVE_4mA              (2 << GPIO_DRIVE_SHIFT)     /* 4  mA Medium drive current output */
#  define GPIO_DRIVE_8mA              (1 << GPIO_DRIVE_SHIFT)     /* 8  mA Fast drive current output  */
#  define GPIO_DRIVE_12mA             (3 << GPIO_DRIVE_SHIFT)     /* 12 mA High drive current output */
...
/* Output/Alt function slew rate selection:
 *
 * 1111 1111 1100 0000 0000
 * 9876 5432 1098 7654 3210
 * ---- ---- ---- ---- ----
...
#define GPIO_SLEW_RATE_SLOW           (1 << 8)                   /* Bit 8: If output, initial value of output */
...
EXTERN const uint32_t g_gpiobase[N32H7_NGPIO];
...
int n32_dumpgpio(uint32_t pinset, const char *msg);
#else
#  define n32_dumpgpio(p,m)
#endif
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_ARM_SRC_N32H7_N32_GPIO_H */
