...
#if defined(CONFIG_STM32H5_QSPI1) && !defined(STM32_QSPI_FREQUENCY)
#  error your board.h needs to defined STM32_QSPI_FREQUENCY
#else
#  define QSPI_CLK_FREQUENCY STM32_QSPI_FREQUENCY
#endif
