...
#if defined(CONFIG_STM32_QSPI1) && !defined(STM32_RCC_CCIPR4_OCTOSPI1SEL)
#  error your board.h needs to define STM32_RCC_CCIPR4_OCTOSPI1SEL
#endif

#if defined(CONFIG_STM32_QSPI1) && !defined(STM32_QSPI_FREQUENCY)
...
static int qspi_hw_initialize(struct stm32_qspidev_s *priv)
{
  ...
  regval |= ((CONFIG_STM32_QSPI_CSHT - 1) << QSPI_DCR1_CSHT_SHIFT);
