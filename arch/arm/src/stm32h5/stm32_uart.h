...
#if !defined(CONFIG_STM32_HAVE_UART12)
#  undef CONFIG_STM32_UART12
#endif
#if !defined(CONFIG_STM32_HAVE_USART11)
#  undef CONFIG_STM32_USART11
#endif
#if !defined(CONFIG_STM32_HAVE_USART10)
#  undef CONFIG_STM32_USART10
#endif
#if !defined(CONFIG_STM32_HAVE_UART9)
#  undef CONFIG_STM32_UART9
#endif
#if !defined(CONFIG_STM32_HAVE_UART8)
#  undef CONFIG_STM32_UART8
#endif
#if !defined(CONFIG_STM32_HAVE_UART7)
#  undef CONFIG_STM32_UART7
#endif
#if !defined(CONFIG_STM32_HAVE_USART6)
...
#  define HAVE_CONSOLE 1
#elif defined(CONFIG_USART11_SERIAL_CONSOLE) && defined(CONFIG_STM32_USART11_SERIALDRIVER)
#  undef CONFIG_LPUART1_SERIAL_CONSOLE
#  undef CONFIG_USART1_SERIAL_CONSOLE
#  undef CONFIG_USART2_SERIAL_CONSOLE
#  undef CONFIG_USART3_SERIAL_CONSOLE
...
#  define HAVE_CONSOLE 1
#elif defined(CONFIG_UART12_SERIAL_CONSOLE) && defined(CONFIG_STM32_UART12_SERIALDRIVER)
#  undef CONFIG_LPUART1_SERIAL_CONSOLE
#  undef CONFIG_USART1_SERIAL_CONSOLE
#  undef CONFIG_USART2_SERIAL_CONSOLE
#  undef CONFIG_USART3_SERIAL_CONSOLE
...
#  undef SERIAL_HAVE_ONLY_DMA
#elif defined(CONFIG_STM32_USART10_SERIALDRIVER) && !defined(CONFIG_USART10_RXDMA)
#  undef SERIAL_HAVE_ONLY_DMA
#elif defined(CONFIG_STM32_USART11_SERIALDRIVER) && !defined(CONFIG_USART11_RXDMA)
#  undef SERIAL_HAVE_ONLY_DMA
#elif defined(CONFIG_STM32_UART12_SERIALDRIVER) && !defined(CONFIG_UART12_RXDMA)
#  undef SERIAL_HAVE_ONLY_DMA
#endif
