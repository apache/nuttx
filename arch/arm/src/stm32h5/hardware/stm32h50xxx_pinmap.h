...
#define GPIO_TIM1_CH1OUT_2        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN13)   /* PA13 */
#define GPIO_TIM1_CH1OUT_3        (GPIO_ALT|GPIO_AF14|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN7)   /* PB7  */
#define GPIO_TIM1_CH1OUT_4        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN6)    /* PC6  */

#define GPIO_TIM1_CH1NOUT_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTA|GPIO_PIN3)                 /* PA3  */
#define GPIO_TIM1_CH1NOUT_2       (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN7)                  /* PA7  */
#define GPIO_TIM1_CH1NOUT_3       (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN13)                 /* PB13 */

#define GPIO_TIM1_CH2OUT_1        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN9)    /* PA9  */
#define GPIO_TIM1_CH2OUT_2        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN14)   /* PA14 */
#define GPIO_TIM1_CH2OUT_3        (GPIO_ALT|GPIO_AF14|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN4)   /* PB4  */
#define GPIO_TIM1_CH2OUT_4        (GPIO_ALT|GPIO_AF14|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN6)   /* PB6  */

#define GPIO_TIM1_CH2NOUT_1       (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN4)                  /* PA4  */
#define GPIO_TIM1_CH2NOUT_2       (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN0)                  /* PB0  */
#define GPIO_TIM1_CH2NOUT_3       (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN2)                  /* PB2  */
#define GPIO_TIM1_CH2NOUT_4       (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN7)                  /* PB7  */
#define GPIO_TIM1_CH2NOUT_5       (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN14)                 /* PB14 */

#define GPIO_TIM1_CH3OUT_1        (GPIO_ALT|GPIO_AF14|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN1)   /* PA1  */
#define GPIO_TIM1_CH3OUT_2        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN10)   /* PA10 */
#define GPIO_TIM1_CH3OUT_3        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN5)    /* PB5  */
#define GPIO_TIM1_CH3OUT_4        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN8)    /* PC8  */

#define GPIO_TIM1_CH3NOUT_1       (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN1)                  /* PB1  */
#define GPIO_TIM1_CH3NOUT_2       (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN6)                  /* PB6  */
#define GPIO_TIM1_CH3NOUT_3       (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN15)                 /* PB15 */

#define GPIO_TIM1_CH4OUT_1        (GPIO_ALT|GPIO_AF14|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN2)   /* PA2  */
#define GPIO_TIM1_CH4OUT_2        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN11)   /* PA11 */
#define GPIO_TIM1_CH4OUT_3        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN9)    /* PC9  */
#define GPIO_TIM1_CH4OUT_4        (GPIO_ALT|GPIO_AF14|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN12)  /* PC12 */

#define GPIO_TIM1_CH4NOUT_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTA|GPIO_PIN8)                 /* PA8  */
#define GPIO_TIM1_CH4NOUT_2       (GPIO_ALT|GPIO_AF14|GPIO_PORTA|GPIO_PIN14)                /* PA14 */
#define GPIO_TIM1_CH4NOUT_3       (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN4)                  /* PB4  */
#define GPIO_TIM1_CH4NOUT_4       (GPIO_ALT|GPIO_AF1|GPIO_PORTC|GPIO_PIN5)                  /* PC5  */
...
#define GPIO_TIM2_CH1OUT_4        (GPIO_ALT|GPIO_AF14|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN2)   /* PB2  */
...
#define GPIO_TIM2_CH2OUT_3        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN11)   /* PC11 */

#define GPIO_TIM2_CH3OUT_1        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN2)    /* PA2  */
#define GPIO_TIM2_CH3OUT_2        (GPIO_ALT|GPIO_AF14|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN7)   /* PA7  */
#define GPIO_TIM2_CH3OUT_3        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN10)   /* PB10 */
#define GPIO_TIM2_CH3OUT_4        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTD|GPIO_PIN2)    /* PD2  */

#define GPIO_TIM2_CH4OUT_1        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN3)    /* PA3  */
#define GPIO_TIM2_CH4OUT_2        (GPIO_ALT|GPIO_AF14|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN12)  /* PA12 */
#define GPIO_TIM2_CH4OUT_3        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN4)    /* PC4  */
#define GPIO_TIM2_CH4OUT_4        (GPIO_ALT|GPIO_AF1|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN12)   /* PC12 */

#define GPIO_TIM3_CH1OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN0)    /* PA0  */
#define GPIO_TIM3_CH1OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN6)    /* PA6  */
#define GPIO_TIM3_CH1OUT_3        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN14)   /* PA14 */
#define GPIO_TIM3_CH1OUT_4        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN4)    /* PB4  */
#define GPIO_TIM3_CH1OUT_5        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN6)    /* PC6  */

#define GPIO_TIM3_CH2OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN7)    /* PA7  */
#define GPIO_TIM3_CH2OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN11)   /* PA11 */
#define GPIO_TIM3_CH2OUT_3        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN5)    /* PB5  */
#define GPIO_TIM3_CH2OUT_4        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN7)    /* PC7  */

#define GPIO_TIM3_CH3OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN8)    /* PA8  */
#define GPIO_TIM3_CH3OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN0)    /* PB0  */
#define GPIO_TIM3_CH3OUT_3        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN6)    /* PB6  */
#define GPIO_TIM3_CH3OUT_4        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN8)    /* PC8  */

#define GPIO_TIM3_CH4OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN12)   /* PA12 */
#define GPIO_TIM3_CH4OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN1)    /* PB1  */
#define GPIO_TIM3_CH4OUT_3        (GPIO_ALT|GPIO_AF14|GPIO_PUSHPULL|GPIO_PORTB|GPIO_PIN15)  /* PB15 */
#define GPIO_TIM3_CH4OUT_4        (GPIO_ALT|GPIO_AF2|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN9)    /* PC9  */
