...
#ifdef CONFIG_STM32_CORDIC
  /* CORDIC clock enable */

  regval |= RCC_AHB1ENR_CORDICEN;
#endif

#ifdef CONFIG_STM32_FMAC
  /* FMAC clock enable */

  regval |= RCC_AHB1ENR_FMACEN;
#endif

#ifdef CONFIG_STM32_RAMCFG
  /* RAMCFG clock enable */
...
#if defined(CONFIG_STM32_USBFS) || defined(CONFIG_STM32_USBFS_HOST)
  /* USB clock enable */
