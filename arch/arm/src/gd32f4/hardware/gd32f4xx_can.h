/****************************************************************************
 * arch/arm/src/gd32f4/hardware/gd32f4xx_can.h
 *
...
#ifndef __ARCH_ARM_SRC_GD32F4_HARDWARE_GD32F4XX_CAN_H
#define __ARCH_ARM_SRC_GD32F4_HARDWARE_GD32F4XX_CAN_H
...
/* GD32F4 bxCAN has 28 filter banks (shared by CAN0/CAN1) */
...
#define GD32_CAN_MCR_OFFSET      0x0000  /* CAN master control register */
#define GD32_CAN_MSR_OFFSET      0x0004  /* CAN master status register */
#define GD32_CAN_TSR_OFFSET      0x0008  /* CAN transmit status register */

#define GD32_CAN_RFR_OFFSET(m)   (0x000c+((m)<<2))
#define GD32_CAN_RF0R_OFFSET     0x000c  /* CAN receive FIFO 0 register */
#define GD32_CAN_RF1R_OFFSET     0x0010  /* CAN receive FIFO 1 register */

#define GD32_CAN_IER_OFFSET      0x0014  /* CAN interrupt enable register */
#define GD32_CAN_ESR_OFFSET      0x0018  /* CAN error status register */
#define GD32_CAN_BTR_OFFSET      0x001c  /* CAN bit timing register */

/* CAN mailbox registers (3 TX and 2 RX) */

#define GD32_CAN_TIR_OFFSET(m)   (0x0180+((m)<<4))
#define GD32_CAN_TI0R_OFFSET     0x0180  /* TX mailbox identifier register 0 */
#define GD32_CAN_TI1R_OFFSET     0x0190  /* TX mailbox identifier register 1 */
#define GD32_CAN_TI2R_OFFSET     0x01a0  /* TX mailbox identifier register 2 */

#define GD32_CAN_TDTR_OFFSET(m)  (0x0184+((m)<<4))
#define GD32_CAN_TDT0R_OFFSET    0x0184  /* Mailbox data length control and time stamp register 0 */
#define GD32_CAN_TDT1R_OFFSET    0x0194  /* Mailbox data length control and time stamp register 1 */
#define GD32_CAN_TDT2R_OFFSET    0x01a4  /* Mailbox data length control and time stamp register 2 */

#define GD32_CAN_TDLR_OFFSET(m)  (0x0188+((m)<<4))
#define GD32_CAN_TDL0R_OFFSET    0x0188  /* Mailbox data low register 0 */
#define GD32_CAN_TDL1R_OFFSET    0x0198  /* Mailbox data low register 1 */
#define GD32_CAN_TDL2R_OFFSET    0x01a8  /* Mailbox data low register 2 */

#define GD32_CAN_TDHR_OFFSET(m)  (0x018c+((m)<<4))
#define GD32_CAN_TDH0R_OFFSET    0x018c  /* Mailbox data high register 0 */
#define GD32_CAN_TDH1R_OFFSET    0x019c  /* Mailbox data high register 1 */
#define GD32_CAN_TDH2R_OFFSET    0x01ac  /* Mailbox data high register 2 */

#define GD32_CAN_RIR_OFFSET(m)   (0x01b0+((m)<<4))
#define GD32_CAN_RI0R_OFFSET     0x01b0  /* Rx FIFO mailbox identifier register 0 */
#define GD32_CAN_RI1R_OFFSET     0x01c0  /* Rx FIFO mailbox identifier register 1 */

#define GD32_CAN_RDTR_OFFSET(m)  (0x01b4+((m)<<4))
#define GD32_CAN_RDT0R_OFFSET    0x01b4  /* Rx FIFO mailbox data length control and time stamp register 0 */
#define GD32_CAN_RDT1R_OFFSET    0x01c4  /* Rx FIFO mailbox data length control and time stamp register 1 */

#define GD32_CAN_RDLR_OFFSET(m)  (0x01b8+((m)<<4))
#define GD32_CAN_RDL0R_OFFSET    0x01b8  /* Receive FIFO mailbox data low register 0 */
#define GD32_CAN_RDL1R_OFFSET    0x01c8  /* Receive FIFO mailbox data low register 1 */

#define GD32_CAN_RDHR_OFFSET(m)  (0x01bc+((m)<<4))
#define GD32_CAN_RDH0R_OFFSET    0x01bc  /* Receive FIFO mailbox data high register 0 */
#define GD32_CAN_RDH1R_OFFSET    0x01cc  /* Receive FIFO mailbox data high register 1 */

/* CAN filter registers */

#define GD32_CAN_FMR_OFFSET      0x0200  /* CAN filter master register */
#define GD32_CAN_FM1R_OFFSET     0x0204  /* CAN filter mode register */
#define GD32_CAN_FS1R_OFFSET     0x020c  /* CAN filter scale register */
#define GD32_CAN_FFA1R_OFFSET    0x0214  /* CAN filter FIFO assignment register */
#define GD32_CAN_FA1R_OFFSET     0x021c  /* CAN filter activation register */
...
#define GD32_CAN_FIR_OFFSET(f,i) (0x240+((f)<<3)+(((i)-1)<<2))

/* Register Addresses *******************************************************/

#if GD32_NCAN > 0
#  define GD32_CAN0_MCR          (GD32_CAN0_BASE+GD32_CAN_MCR_OFFSET)
#  define GD32_CAN0_MSR          (GD32_CAN0_BASE+GD32_CAN_MSR_OFFSET)
#  define GD32_CAN0_TSR          (GD32_CAN0_BASE+GD32_CAN_TSR_OFFSET)
#  define GD32_CAN0_RF0R         (GD32_CAN0_BASE+GD32_CAN_RF0R_OFFSET)
#  define GD32_CAN0_RF1R         (GD32_CAN0_BASE+GD32_CAN_RF1R_OFFSET)
#  define GD32_CAN0_IER          (GD32_CAN0_BASE+GD32_CAN_IER_OFFSET)
#  define GD32_CAN0_ESR          (GD32_CAN0_BASE+GD32_CAN_ESR_OFFSET)
#  define GD32_CAN0_BTR          (GD32_CAN0_BASE+GD32_CAN_BTR_OFFSET)

#  define GD32_CAN0_TIR(m)       (GD32_CAN0_BASE+GD32_CAN_TIR_OFFSET(m))
#  define GD32_CAN0_TI0R         (GD32_CAN0_BASE+GD32_CAN_TI0R_OFFSET)
#  define GD32_CAN0_TI1R         (GD32_CAN0_BASE+GD32_CAN_TI1R_OFFSET)
#  define GD32_CAN0_TI2R         (GD32_CAN0_BASE+GD32_CAN_TI2R_OFFSET)

#  define GD32_CAN0_TDTR(m)      (GD32_CAN0_BASE+GD32_CAN_TDTR_OFFSET(m))
#  define GD32_CAN0_TDT0R        (GD32_CAN0_BASE+GD32_CAN_TDT0R_OFFSET)
#  define GD32_CAN0_TDT1R        (GD32_CAN0_BASE+GD32_CAN_TDT1R_OFFSET)
#  define GD32_CAN0_TDT2R        (GD32_CAN0_BASE+GD32_CAN_TDT2R_OFFSET)

#  define GD32_CAN0_TDLR(m)      (GD32_CAN0_BASE+GD32_CAN_TDLR_OFFSET(m))
#  define GD32_CAN0_TDL0R        (GD32_CAN0_BASE+GD32_CAN_TDL0R_OFFSET)
#  define GD32_CAN0_TDL1R        (GD32_CAN0_BASE+GD32_CAN_TDL1R_OFFSET)
#  define GD32_CAN0_TDL2R        (GD32_CAN0_BASE+GD32_CAN_TDL2R_OFFSET)

#  define GD32_CAN0_TDHR(m)      (GD32_CAN0_BASE+GD32_CAN_TDHR_OFFSET(m))
#  define GD32_CAN0_TDH0R        (GD32_CAN0_BASE+GD32_CAN_TDH0R_OFFSET)
#  define GD32_CAN0_TDH1R        (GD32_CAN0_BASE+GD32_CAN_TDH1R_OFFSET)
#  define GD32_CAN0_TDH2R        (GD32_CAN0_BASE+GD32_CAN_TDH2R_OFFSET)

#  define GD32_CAN0_RIR(m)       (GD32_CAN0_BASE+GD32_CAN_RIR_OFFSET(m))
#  define GD32_CAN0_RI0R         (GD32_CAN0_BASE+GD32_CAN_RI0R_OFFSET)
#  define GD32_CAN0_RI1R         (GD32_CAN0_BASE+GD32_CAN_RI1R_OFFSET)

#  define GD32_CAN0_RDTR(m)      (GD32_CAN0_BASE+GD32_CAN_RDTR_OFFSET(m))
#  define GD32_CAN0_RDT0R        (GD32_CAN0_BASE+GD32_CAN_RDT0R_OFFSET)
#  define GD32_CAN0_RDT1R        (GD32_CAN0_BASE+GD32_CAN_RDT1R_OFFSET)

#  define GD32_CAN0_RDLR(m)      (GD32_CAN0_BASE+GD32_CAN_RDLR_OFFSET(m))
#  define GD32_CAN0_RDL0R        (GD32_CAN0_BASE+GD32_CAN_RDL0R_OFFSET)
#  define GD32_CAN0_RDL1R        (GD32_CAN0_BASE+GD32_CAN_RDL1R_OFFSET)

#  define GD32_CAN0_RDHR(m)      (GD32_CAN0_BASE+GD32_CAN_RDHR_OFFSET(m))
#  define GD32_CAN0_RDH0R        (GD32_CAN0_BASE+GD32_CAN_RDH0R_OFFSET)
#  define GD32_CAN0_RDH1R        (GD32_CAN0_BASE+GD32_CAN_RDH1R_OFFSET)

#  define GD32_CAN0_FMR          (GD32_CAN0_BASE+GD32_CAN_FMR_OFFSET)
#  define GD32_CAN0_FM1R         (GD32_CAN0_BASE+GD32_CAN_FM1R_OFFSET)
#  define GD32_CAN0_FS1R         (GD32_CAN0_BASE+GD32_CAN_FS1R_OFFSET)
#  define GD32_CAN0_FFA1R        (GD32_CAN0_BASE+GD32_CAN_FFA1R_OFFSET)
#  define GD32_CAN0_FA1R         (GD32_CAN0_BASE+GD32_CAN_FA1R_OFFSET)
#  define GD32_CAN0_FIR(b,i)     (GD32_CAN0_BASE+GD32_CAN_FIR_OFFSET(b,i))
#endif

#if GD32_NCAN > 1
#  define GD32_CAN1_MCR          (GD32_CAN1_BASE+GD32_CAN_MCR_OFFSET)
#  define GD32_CAN1_MSR          (GD32_CAN1_BASE+GD32_CAN_MSR_OFFSET)
#  define GD32_CAN1_TSR          (GD32_CAN1_BASE+GD32_CAN_TSR_OFFSET)
#  define GD32_CAN1_RF0R         (GD32_CAN1_BASE+GD32_CAN_RF0R_OFFSET)
#  define GD32_CAN1_RF1R         (GD32_CAN1_BASE+GD32_CAN_RF1R_OFFSET)
#  define GD32_CAN1_IER          (GD32_CAN1_BASE+GD32_CAN_IER_OFFSET)
#  define GD32_CAN1_ESR          (GD32_CAN1_BASE+GD32_CAN_ESR_OFFSET)
#  define GD32_CAN1_BTR          (GD32_CAN1_BASE+GD32_CAN_BTR_OFFSET)

#  define GD32_CAN1_TIR(m)       (GD32_CAN1_BASE+GD32_CAN_TIR_OFFSET(m))
#  define GD32_CAN1_TI0R         (GD32_CAN1_BASE+GD32_CAN_TI0R_OFFSET)
#  define GD32_CAN1_TI1R         (GD32_CAN1_BASE+GD32_CAN_TI1R_OFFSET)
#  define GD32_CAN1_TI2R         (GD32_CAN1_BASE+GD32_CAN_TI2R_OFFSET)

#  define GD32_CAN1_TDTR(m)      (GD32_CAN1_BASE+GD32_CAN_TDTR_OFFSET(m))
#  define GD32_CAN1_TDT0R        (GD32_CAN1_BASE+GD32_CAN_TDT0R_OFFSET)
#  define GD32_CAN1_TDT1R        (GD32_CAN1_BASE+GD32_CAN_TDT1R_OFFSET)
#  define GD32_CAN1_TDT2R        (GD32_CAN1_BASE+GD32_CAN_TDT2R_OFFSET)

#  define GD32_CAN1_TDLR(m)      (GD32_CAN1_BASE+GD32_CAN_TDLR_OFFSET(m))
#  define GD32_CAN1_TDL0R        (GD32_CAN1_BASE+GD32_CAN_TDL0R_OFFSET)
#  define GD32_CAN1_TDL1R        (GD32_CAN1_BASE+GD32_CAN_TDL1R_OFFSET)
#  define GD32_CAN1_TDL2R        (GD32_CAN1_BASE+GD32_CAN_TDL2R_OFFSET)

#  define GD32_CAN1_TDHR(m)      (GD32_CAN1_BASE+GD32_CAN_TDHR_OFFSET(m))
#  define GD32_CAN1_TDH0R        (GD32_CAN1_BASE+GD32_CAN_TDH0R_OFFSET)
#  define GD32_CAN1_TDH1R        (GD32_CAN1_BASE+GD32_CAN_TDH1R_OFFSET)
#  define GD32_CAN1_TDH2R        (GD32_CAN1_BASE+GD32_CAN_TDH2R_OFFSET)

#  define GD32_CAN1_RIR(m)       (GD32_CAN1_BASE+GD32_CAN_RIR_OFFSET(m))
#  define GD32_CAN1_RI0R         (GD32_CAN1_BASE+GD32_CAN_RI0R_OFFSET)
#  define GD32_CAN1_RI1R         (GD32_CAN1_BASE+GD32_CAN_RI1R_OFFSET)

#  define GD32_CAN1_RDTR(m)      (GD32_CAN1_BASE+GD32_CAN_RDTR_OFFSET(m))
#  define GD32_CAN1_RDT0R        (GD32_CAN1_BASE+GD32_CAN_RDT0R_OFFSET)
#  define GD32_CAN1_RDT1R        (GD32_CAN1_BASE+GD32_CAN_RDT1R_OFFSET)

#  define GD32_CAN1_RDLR(m)      (GD32_CAN1_BASE+GD32_CAN_RDLR_OFFSET(m))
#  define GD32_CAN1_RDL0R        (GD32_CAN1_BASE+GD32_CAN_RDL0R_OFFSET)
#  define GD32_CAN1_RDL1R        (GD32_CAN1_BASE+GD32_CAN_RDL1R_OFFSET)

#  define GD32_CAN1_RDHR(m)      (GD32_CAN1_BASE+GD32_CAN_RDHR_OFFSET(m))
#  define GD32_CAN1_RDH0R        (GD32_CAN1_BASE+GD32_CAN_RDH0R_OFFSET)
#  define GD32_CAN1_RDH1R        (GD32_CAN1_BASE+GD32_CAN_RDH1R_OFFSET)

#  define GD32_CAN1_FMR          (GD32_CAN1_BASE+GD32_CAN_FMR_OFFSET)
#  define GD32_CAN1_FM1R         (GD32_CAN1_BASE+GD32_CAN_FM1R_OFFSET)
#  define GD32_CAN1_FS1R         (GD32_CAN1_BASE+GD32_CAN_FS1R_OFFSET)
#  define GD32_CAN1_FFA1R        (GD32_CAN1_BASE+GD32_CAN_FFA1R_OFFSET)
#  define GD32_CAN1_FA1R         (GD32_CAN1_BASE+GD32_CAN_FA1R_OFFSET)
#  define GD32_CAN1_FIR(b,i)     (GD32_CAN1_BASE+GD32_CAN_FIR_OFFSET(b,i))
#endif
...
#define CAN_ESR_TEC_MASK          (0xff << CAN_ESR_TEC_SHIFT)
...
#define CAN_FMR_CAN1SB_SHIFT      (8)       /* Bits 13-8: CAN1 start bank */
#define CAN_FMR_CAN1SB_MASK       (0x3f << CAN_FMR_CAN1SB_SHIFT)
...
#endif /* __ARCH_ARM_SRC_GD32F4_HARDWARE_GD32F4XX_CAN_H */
