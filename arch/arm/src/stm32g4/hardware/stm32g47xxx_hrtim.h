...
#ifndef __ARCH_ARM_SRC_STM32_HARDWARE_STM32G47XXX_HRTIM_H
#define __ARCH_ARM_SRC_STM32_HARDWARE_STM32G47XXX_HRTIM_H
...
#define STM32_HRTIM_TIMERF_OFFSET       0x0300      /* HRTIM Timer F base address offset */
...
#define STM32_HRTIM1_TIMERF_BASE        (STM32_HRTIM_TIMERF_OFFSET+STM32_HRTIM1_BASE)
...
/* Register offsets Specific for Timer A-F */
...
#define STM32_HRTIM_TIM_CR2_OFFSET     0x006C /* HRTIM Timer Control Register 2 */
#define STM32_HRTIM_TIM_EEFR3_OFFSET   0x0070 /* HRTIM timer External Event Filtering Register 3 */
...
#define STM32_HRTIM_CMN_BDTFUPR_OFFSET  0x0074 /* HRTIM Timer F Update Register */
#define STM32_HRTIM_CMN_ADCER_OFFSET    0x0078 /* HRTIM ADC extended trigger register */
#define STM32_HRTIM_CMN_ADCUR_OFFSET    0x007C /* HRTIM ADC trigger update register */
#define STM32_HRTIM_CMN_ADCPS1_OFFSET   0x0080 /* HRTIM ADC post scaler register 1 */
#define STM32_HRTIM_CMN_ADCPS2_OFFSET   0x0084 /* HRTIM ADC post scaler register 2 */
#define STM32_HRTIM_CMN_FLTINR3_OFFSET  0x0088 /* HRTIM fault input register 3 */
#define STM32_HRTIM_CMN_FLTINR4_OFFSET  0x008C /* HRTIM fault input register 4 */

/* Register Bitfield Definitions ********************************************/

/* Control Register Bits Common to Master Timer and Timer A-F */
...
#  define HRTIM_CMNCR_DACSYNC_00     (0 << HRTIM_CMNCR_DACSYNC_SHIFT) /* 00: No DAC trigger generated */
#  define HRTIM_CMNCR_DACSYNC_01     (1 << HRTIM_CMNCR_DACSYNC_SHIFT) /* 01: Trigger generated on hrtim_dac_trg1 */
#  define HRTIM_CMNCR_DACSYNC_10     (2 << HRTIM_CMNCR_DACSYNC_SHIFT) /* 10: Trigger generated on hrtim_dac_trg2 */
#  define HRTIM_CMNCR_DACSYNC_11     (3 << HRTIM_CMNCR_DACSYNC_SHIFT) /* 11: Trigger generated on hrtim_dac_trg3 */
#define HRTIM_CMNCR_PREEN            (1 << 27)                        /* Bit 27: Preload enable */
                                                                      /* Bits 28-31 differs */

/* Control Register Bits specific to Master Timer */

#define HRTIM_MCR_INTLVD_SHIFT     6                             /* Bits 6-7: Interleaved mode */
#define HRTIM_MCR_INTLVD_MASK      (4 << HRTIM_MCR_INTLVD_SHIFT)
#  define HRTIM_MCR_INTLVD_DIS     (0 << HRTIM_MCR_INTLVD_SHIFT) /* 00: Interleaved mode disabled */
#  define HRTIM_MCR_INTLVD_TRIPLE  (1 << HRTIM_MCR_INTLVD_SHIFT) /* 01: Triple interleaved mode */
#  define HRTIM_MCR_INTLVD_QUAD    (2 << HRTIM_MCR_INTLVD_SHIFT) /* 10: Quad interleaved mode*/
...
#define HRTIM_MCR_TFCEN            (1 << 22) /* Bit 22: Timer F counter enable */
                                             /* Bits 23-24: Reserved */
                                             /* Bit 28: Reserved */
...
#define HRTIM_MDIER_MCMP1DE        (1 << 16) /* Bit 16: Master compare 1 DMA request enable */
#define HRTIM_MDIER_MCMP2DE        (1 << 17) /* Bit 17:  Master compare 2 DMA request enable */
#define HRTIM_MDIER_MCMP3DE        (1 << 18) /* Bit 18: Master compare 3 DMA request enable */
#define HRTIM_MDIER_MCMP4DE        (1 << 19) /* Bit 19: Master compare 4 DMA request enable */
#define HRTIM_MDIER_MREPDE         (1 << 20) /* Bit 20: Master repetition DMA request enable */
#define HRTIM_MDIER_SYNCDE         (1 << 21) /* Bit 21: Sync input DMA request enable */
#define HRTIM_MDIER_MUPDDE         (1 << 22) /* Bit 22: Master update DMA request enable */
...
#define HRTIM_TIMCR_INTLVD_SHIFT    7                                /* Bits 7-8: Interleaved mode */
#define HRTIM_TIMCR_INTLVD_MASK     (3 << HRTIM_TIMCR_INTLVD_SHIFT)
#  define HRTIM_TIMCR_INTLVD_DIS    (0 << HRTIM_TIMCR_INTLVD_SHIFT)  /* 00: Interleaved mode disabled */
#  define HRTIM_TIMCR_INTLVD_TRI    (1 << HRTIM_TIMCR_INTLVD_SHIFT)  /* 01: Triple interleaved mode */
#  define HRTIM_TIMCR_INTLVD_QUAD   (2 << HRTIM_TIMCR_INTLVD_SHIFT)  /* 10: Quad interleaved mode */
                                                                     /* 11: Interleaved mode disabled */
#define HRTIM_TIMCR_RSYNCU          (1 << 9)                         /* Bit 9: Re-synchronized update */
#define HRTIM_TIMCR_SYNCRST         (1 << 10)                        /* Bit 10: Synchronization resets timer x */
#define HRTIM_TIMCR_SYNCSTRT        (1 << 11)                        /* Bit 11: Synchronization starts timer x */
...
#  define HRTIM_TIMCR_DELCMP2_00    (0 << HRTIM_TIMCR_DELCMP2_SHIFT) /* 00: CMP2 register is always active */
#  define HRTIM_TIMCR_DELCMP2_01    (1 << HRTIM_TIMCR_DELCMP2_SHIFT) /* 01: CMP2 value is recomputed and is active following a capture 1 event */
#  define HRTIM_TIMCR_DELCMP2_10    (2 << HRTIM_TIMCR_DELCMP2_SHIFT) /* 10: CMP2 value is recomputed and is active following a capture 1 event, or is recomputed and active after compare 1 match */
#  define HRTIM_TIMCR_DELCMP2_11    (3 << HRTIM_TIMCR_DELCMP2_SHIFT) /* 11: CMP2 value is recomputed and is active following a capture 1 event, or is recomputed and active after compare 3 match */
...
#  define HRTIM_TIMCR_DELCMP4_00    (0 << HRTIM_TIMCR_DELCMP4_SHIFT) /* 00: CMP4 register is always active */
#  define HRTIM_TIMCR_DELCMP4_01    (1 << HRTIM_TIMCR_DELCMP4_SHIFT) /* 01: CMP4 value is recomputed and is active following a capture 2 event */
#  define HRTIM_TIMCR_DELCMP4_10    (2 << HRTIM_TIMCR_DELCMP4_SHIFT) /* 10: CMP4 value is recomputed and is active following a capture 2 event, or is recomputed and active after Compare 1 match */
#  define HRTIM_TIMCR_DELCMP4_11    (3 << HRTIM_TIMCR_DELCMP4_SHIFT) /* 11: CMP4 value is recomputed and is active following a capture 2 event, or is recomputed and active after Compare 3 match */
#define HRTIM_TIMCR_TAU             (1 << 19)                        /* Bit 16: Timer F Update */
...
#define HRTIM_TIMCR_DACSYNC_MASK    (1 << HRTIM_TIMCR_DACSYNC_SHIFT)
#  define HRTIM_TIMCR_DACSYNC_NOTRG                                  /* 00: No DAC trigger generated */
#  define HRTIM_TIMCR_DACSYNC_TRG1                                   /* 01: Trigger generated on hrtim_dac_trg1 */
#  define HRTIM_TIMCR_DACSYNC_TRG2                                   /* 10: Trigger generated on hrtim_dac_trg2 */
#  define HRTIM_TIMCR_DACSYNC_TRG3                                   /* 11: Trigger generated on hrtim_dac_trg3 */
...
#  define HRTIM_TIMCR_UPDGAT_0000   (0 << HRTIM_TIMCR_UPDGAT_SHIFT)  /* 0000: The update occurs independently from the DMA burst transfer */
#  define HRTIM_TIMCR_UPDGAT_0001   (1 << HRTIM_TIMCR_UPDGAT_SHIFT)  /* 0001: The update occurs when the DMA burst transfer is completed */
#  define HRTIM_TIMCR_UPDGAT_0010   (2 << HRTIM_TIMCR_UPDGAT_SHIFT)  /* 0010: The update occurs on the update event following the DMA burst transfer completion */
#  define HRTIM_TIMCR_UPDGAT_0011   (3 << HRTIM_TIMCR_UPDGAT_SHIFT)  /* 0011: The update occurs on a rising edge on hrtim_upd_en1 */
#  define HRTIM_TIMCR_UPDGAT_0100   (4 << HRTIM_TIMCR_UPDGAT_SHIFT)  /* 0100: The update occurs on a rising edge on hrtim_upd_en2 */
#  define HRTIM_TIMCR_UPDGAT_0101   (5 << HRTIM_TIMCR_UPDGAT_SHIFT)  /* 0101: The update occurs on a rising edge on hrtim_upd_en3 */
#  define HRTIM_TIMCR_UPDGAT_0110   (6 << HRTIM_TIMCR_UPDGAT_SHIFT)  /* 0110: The update occurs on the update event following a rising edge on hrtim_upd_en1 */
#  define HRTIM_TIMCR_UPDGAT_0111   (7 << HRTIM_TIMCR_UPDGAT_SHIFT)  /* 0111: The update occurs on the update event following a rising edge on hrtim_upd_en2 */
#  define HRTIM_TIMCR_UPDGAT_1000   (8 << HRTIM_TIMCR_UPDGAT_SHIFT)  /* 1000: The update occurs on the update event following a rising edge on hrtim_upd_en3 */
...
#define HRTIM_TIMARST_TIMFCMP1        (1 << 0)  /* Bit 0: Timer F compare 1 */
#define HRTIM_TIMARST_UPDT            (1 << 1)  /* Bit 1: Timer A update reset */
#define HRTIM_TIMARST_CMP2            (1 << 2)  /* Bit 2: Timer A compare 2 reset */
#define HRTIM_TIMARST_CMP4            (1 << 3)  /* Bit 3: Timer A compare 4 reset */
#define HRTIM_TIMARST_MSTPER          (1 << 4)  /* Bit 4: Master timer period */
#define HRTIM_TIMARST_MSTCMP1         (1 << 5)  /* Bit 5: Master compare 1 */
#define HRTIM_TIMARST_MSTCMP2         (1 << 6)  /* Bit 6: Master compare 2 */
#define HRTIM_TIMARST_MSTCMP3         (1 << 7)  /* Bit 7: Master compare 3 */
#define HRTIM_TIMARST_MSTCMP4         (1 << 8)  /* Bit 8: Master compare 4 */
#define HRTIM_TIMARST_EXTEVNT1        (1 << 9)  /* Bit 9: External event 1 */
#define HRTIM_TIMARST_EXTEVNT2        (1 << 10) /* Bit 10: External event 2 */
#define HRTIM_TIMARST_EXTEVNT3        (1 << 11) /* Bit 11: External event 3 */
#define HRTIM_TIMARST_EXTEVNT4        (1 << 12) /* Bit 12: External event 4 */
#define HRTIM_TIMARST_EXTEVNT5        (1 << 13) /* Bit 13: External event 5 */
#define HRTIM_TIMARST_EXTEVNT6        (1 << 14) /* Bit 14: External event 6 */
#define HRTIM_TIMARST_EXTEVNT7        (1 << 15) /* Bit 15: External event 7 */
#define HRTIM_TIMARST_EXTEVNT8        (1 << 16) /* Bit 16: External event 8 */
#define HRTIM_TIMARST_EXTEVNT9        (1 << 17) /* Bit 17: External event 9 */
#define HRTIM_TIMARST_EXTEVNT10       (1 << 18) /* Bit 18: External event 10 */
#define HRTIM_TIMARST_TIMBCMP1        (1 << 19) /* Bit 19: Timer B compare 1 */
#define HRTIM_TIMARST_TIMBCMP2        (1 << 20) /* Bit 20: Timer B compare 2 */
#define HRTIM_TIMARST_TIMBCMP4        (1 << 21) /* Bit 21: Timer B compare 4 */
#define HRTIM_TIMARST_TIMCCMP1        (1 << 22) /* Bit 22: Timer C compare 1 */
#define HRTIM_TIMARST_TIMCCMP2        (1 << 23) /* Bit 23: Timer C compare 2 */
#define HRTIM_TIMARST_TIMCCMP4        (1 << 24) /* Bit 24: Timer C compare 4 */
#define HRTIM_TIMARST_TIMDCMP1        (1 << 25) /* Bit 25: Timer D compare 1 */
#define HRTIM_TIMARST_TIMDCMP2        (1 << 26) /* Bit 26: Timer D compare 2 */
#define HRTIM_TIMARST_TIMDCMP4        (1 << 27) /* Bit 27: Timer D compare 4 */
#define HRTIM_TIMARST_TIMECMP1        (1 << 28) /* Bit 28: Timer E compare 1 */
#define HRTIM_TIMARST_TIMECMP2        (1 << 29) /* Bit 29: Timer E compare 2 */
#define HRTIM_TIMARST_TIMECMP4        (1 << 30) /* Bit 30: Timer E compare 4 */
#define HRTIM_TIMARST_TIMFCMP2        (1 << 31) /* Bit 31: Timer F compare 2 */

#define HRTIM_TIMBRST_TIMFCMP1        (1 << 0)  /* Bit 0: Timer F compare 1 */
#define HRTIM_TIMBRST_UPDT            (1 << 1)  /* Bit 1: Timer B update reset */
#define HRTIM_TIMBRST_CMP2            (1 << 2)  /* Bit 2: Timer B compare 2 reset */
#define HRTIM_TIMBRST_CMP4            (1 << 3)  /* Bit 3: Timer B compare 4 reset */
#define HRTIM_TIMBRST_MSTPER          (1 << 4)  /* Bit 4: Master timer period */
#define HRTIM_TIMBRST_MSTCMP1         (1 << 5)  /* Bit 5: Master compare 1 */
#define HRTIM_TIMBRST_MSTCMP2         (1 << 6)  /* Bit 6: Master compare 2 */
#define HRTIM_TIMBRST_MSTCMP3         (1 << 7)  /* Bit 7: Master compare 3 */
#define HRTIM_TIMBRST_MSTCMP4         (1 << 8)  /* Bit 8: Master compare 4 */
#define HRTIM_TIMBRST_EXTEVNT1        (1 << 9)  /* Bit 9: External event 1 */
#define HRTIM_TIMBRST_EXTEVNT2        (1 << 10) /* Bit 10: External event 2 */
#define HRTIM_TIMBRST_EXTEVNT3        (1 << 11) /* Bit 11: External event 3 */
#define HRTIM_TIMBRST_EXTEVNT4        (1 << 12) /* Bit 12: External event 4 */
#define HRTIM_TIMBRST_EXTEVNT5        (1 << 13) /* Bit 13: External event 5 */
#define HRTIM_TIMBRST_EXTEVNT6        (1 << 14) /* Bit 14: External event 6 */
#define HRTIM_TIMBRST_EXTEVNT7        (1 << 15) /* Bit 15: External event 7 */
#define HRTIM_TIMBRST_EXTEVNT8        (1 << 16) /* Bit 16: External event 8 */
#define HRTIM_TIMBRST_EXTEVNT9        (1 << 17) /* Bit 17: External event 9 */
#define HRTIM_TIMBRST_EXTEVNT10       (1 << 18) /* Bit 18: External event 10 */
#define HRTIM_TIMBRST_TIMACMP1        (1 << 19) /* Bit 19: Timer A compare 1 */
#define HRTIM_TIMBRST_TIMACMP2        (1 << 20) /* Bit 20: Timer A compare 2 */
#define HRTIM_TIMBRST_TIMACMP4        (1 << 21) /* Bit 21: Timer A compare 4 */
#define HRTIM_TIMBRST_TIMCCMP1        (1 << 22) /* Bit 22: Timer C compare 1 */
#define HRTIM_TIMBRST_TIMCCMP2        (1 << 23) /* Bit 23: Timer C compare 2 */
#define HRTIM_TIMBRST_TIMCCMP4        (1 << 24) /* Bit 24: Timer C compare 4 */
#define HRTIM_TIMBRST_TIMDCMP1        (1 << 25) /* Bit 25: Timer D compare 1 */
#define HRTIM_TIMBRST_TIMDCMP2        (1 << 26) /* Bit 26: Timer D compare 2 */
#define HRTIM_TIMBRST_TIMDCMP4        (1 << 27) /* Bit 27: Timer D compare 4 */
#define HRTIM_TIMBRST_TIMECMP1        (1 << 28) /* Bit 28: Timer E compare 1 */
#define HRTIM_TIMBRST_TIMECMP2        (1 << 29) /* Bit 29: Timer E compare 2 */
#define HRTIM_TIMBRST_TIMECMP4        (1 << 30) /* Bit 30: Timer D compare 4 */
#define HRTIM_TIMBRST_TIMFCMP2        (1 << 31) /* Bit 30: Timer F compare 2 */

#define HRTIM_TIMCRST_TIMFCMP1        (1 << 0)  /* Bit 0: Timer F compare 1 */
#define HRTIM_TIMCRST_UPDT            (1 << 1)  /* Bit 1: Timer C update reset */
#define HRTIM_TIMCRST_CMP2            (1 << 2)  /* Bit 2: Timer C compare 2 reset */
#define HRTIM_TIMCRST_CMP4            (1 << 3)  /* Bit 3: Timer C compare 4 reset */
#define HRTIM_TIMCRST_MSTPER          (1 << 4)  /* Bit 4: Master timer period */
#define HRTIM_TIMCRST_MSTCMP1         (1 << 5)  /* Bit 5: Master compare 1 */
#define HRTIM_TIMCRST_MSTCMP2         (1 << 6)  /* Bit 6: Master compare 2 */
#define HRTIM_TIMCRST_MSTCMP3         (1 << 7)  /* Bit 7: Master compare 3 */
#define HRTIM_TIMCRST_MSTCMP4         (1 << 8)  /* Bit 8: Master compare 4 */
#define HRTIM_TIMCRST_EXTEVNT1        (1 << 9)  /* Bit 9: External event 1 */
#define HRTIM_TIMCRST_EXTEVNT2        (1 << 10) /* Bit 10: External event 2 */
#define HRTIM_TIMCRST_EXTEVNT3        (1 << 11) /* Bit 11: External event 3 */
#define HRTIM_TIMCRST_EXTEVNT4        (1 << 12) /* Bit 12: External event 4 */
#define HRTIM_TIMCRST_EXTEVNT5        (1 << 13) /* Bit 13: External event 5 */
#define HRTIM_TIMCRST_EXTEVNT6        (1 << 14) /* Bit 14: External event 6 */
#define HRTIM_TIMCRST_EXTEVNT7        (1 << 15) /* Bit 15: External event 7 */
#define HRTIM_TIMCRST_EXTEVNT8        (1 << 16) /* Bit 16: External event 8 */
#define HRTIM_TIMCRST_EXTEVNT9        (1 << 17) /* Bit 17: External event 9 */
#define HRTIM_TIMCRST_EXTEVNT10       (1 << 18) /* Bit 18: External event 10 */
#define HRTIM_TIMCRST_TIMACMP1        (1 << 19) /* Bit 19: Timer A compare 1 */
#define HRTIM_TIMCRST_TIMACMP2        (1 << 20) /* Bit 20: Timer A compare 2 */
#define HRTIM_TIMCRST_TIMACMP4        (1 << 21) /* Bit 21: Timer A compare 4 */
#define HRTIM_TIMCRST_TIMBCMP1        (1 << 22) /* Bit 22: Timer B compare 1 */
#define HRTIM_TIMCRST_TIMBCMP2        (1 << 23) /* Bit 23: Timer B compare 2 */
#define HRTIM_TIMCRST_TIMBCMP4        (1 << 24) /* Bit 24: Timer B compare 4 */
#define HRTIM_TIMCRST_TIMDCMP1        (1 << 25) /* Bit 25: Timer D compare 1 */
#define HRTIM_TIMCRST_TIMDCMP2        (1 << 26) /* Bit 26: Timer D compare 2 */
#define HRTIM_TIMCRST_TIMDCMP4        (1 << 27) /* Bit 27: Timer D compare 4 */
#define HRTIM_TIMCRST_TIMECMP1        (1 << 28) /* Bit 28: Timer E compare 1 */
#define HRTIM_TIMCRST_TIMECMP2        (1 << 29) /* Bit 29: Timer E compare 2 */
#define HRTIM_TIMCRST_TIMECMP4        (1 << 30) /* Bit 30: Timer E compare 4 */
#define HRTIM_TIMCRST_TIMFCMP2        (1 << 31) /* Bit 31: Timer F compare 2 */

#define HRTIM_TIMDRST_TIMFCMP1        (1 << 0)  /* Bit 0: Timer F compare 1 */
#define HRTIM_TIMDRST_UPDT            (1 << 1)  /* Bit 1: Timer D update reset */
#define HRTIM_TIMDRST_CMP2            (1 << 2)  /* Bit 2: Timer D compare 2 reset */
#define HRTIM_TIMDRST_CMP4            (1 << 3)  /* Bit 3: Timer D compare 4 reset */
#define HRTIM_TIMDRST_MSTPER          (1 << 4)  /* Bit 4: Master timer period */
#define HRTIM_TIMDRST_MSTCMP1         (1 << 5)  /* Bit 5: Master compare 1 */
#define HRTIM_TIMDRST_MSTCMP2         (1 << 6)  /* Bit 6: Master compare 2 */
#define HRTIM_TIMDRST_MSTCMP3         (1 << 7)  /* Bit 7: Master compare 3 */
#define HRTIM_TIMDRST_MSTCMP4         (1 << 8)  /* Bit 8: Master compare 4 */
#define HRTIM_TIMDRST_EXTEVNT1        (1 << 9)  /* Bit 9: External event 1 */
#define HRTIM_TIMDRST_EXTEVNT2        (1 << 10) /* Bit 10: External event 2 */
#define HRTIM_TIMDRST_EXTEVNT3        (1 << 11) /* Bit 11: External event 3 */
#define HRTIM_TIMDRST_EXTEVNT4        (1 << 12) /* Bit 12: External event 4 */
#define HRTIM_TIMDRST_EXTEVNT5        (1 << 13) /* Bit 13: External event 5 */
#define HRTIM_TIMDRST_EXTEVNT6        (1 << 14) /* Bit 14: External event 6 */
#define HRTIM_TIMDRST_EXTEVNT7        (1 << 15) /* Bit 15: External event 7 */
#define HRTIM_TIMDRST_EXTEVNT8        (1 << 16) /* Bit 16: External event 8 */
#define HRTIM_TIMDRST_EXTEVNT9        (1 << 17) /* Bit 17: External event 9 */
#define HRTIM_TIMDRST_EXTEVNT10       (1 << 18) /* Bit 18: External event 10 */
#define HRTIM_TIMDRST_TIMACMP1        (1 << 19) /* Bit 19: Timer A compare 1 */
#define HRTIM_TIMDRST_TIMACMP2        (1 << 20) /* Bit 20: Timer A compare 2 */
#define HRTIM_TIMDRST_TIMACMP4        (1 << 21) /* Bit 21: Timer A compare 1 */
#define HRTIM_TIMDRST_TIMBCMP1        (1 << 22) /* Bit 22: Timer B compare 1 */
#define HRTIM_TIMDRST_TIMBCMP2        (1 << 23) /* Bit 23: Timer B compare 2 */
#define HRTIM_TIMDRST_TIMBCMP4        (1 << 24) /* Bit 24: Timer B compare 4 */
#define HRTIM_TIMDRST_TIMCCMP1        (1 << 25) /* Bit 25: Timer C compare 1 */
#define HRTIM_TIMDRST_TIMCCMP2        (1 << 26) /* Bit 26: Timer C compare 2 */
#define HRTIM_TIMDRST_TIMCCMP4        (1 << 27) /* Bit 27: Timer C compare 4 */
#define HRTIM_TIMDRST_TIMECMP1        (1 << 28) /* Bit 28: Timer E compare 1 */
#define HRTIM_TIMDRST_TIMECMP2        (1 << 29) /* Bit 29: Timer E compare 2 */
#define HRTIM_TIMDRST_TIMECMP4        (1 << 30) /* Bit 30: Timer E compare 4 */
#define HRTIM_TIMDRST_TIMFCMP2        (1 << 31) /* Bit 31: Timer F compare 2 */

#define HRTIM_TIMERST_TIMFCMP1        (1 << 0)  /* Bit 0: Timer F compare 1 */
#define HRTIM_TIMERST_UPDT            (1 << 1)  /* Bit 1: Timer E update reset */
#define HRTIM_TIMERST_CMP2            (1 << 2)  /* Bit 2: Timer E compare 2 reset */
#define HRTIM_TIMERST_CMP4            (1 << 3)  /* Bit 3: Timer E compare 4 reset */
#define HRTIM_TIMERST_MSTPER          (1 << 4)  /* Bit 4: Master timer period */
#define HRTIM_TIMERST_MSTCMP1         (1 << 5)  /* Bit 5: Master compare 1 */
#define HRTIM_TIMERST_MSTCMP2         (1 << 6)  /* Bit 6: Master compare 2 */
#define HRTIM_TIMERST_MSTCMP3         (1 << 7)  /* Bit 7: Master compare 3 */
#define HRTIM_TIMERST_MSTCMP4         (1 << 8)  /* Bit 8: Master compare 4 */
#define HRTIM_TIMERST_EXTEVNT1        (1 << 9)  /* Bit 9: External event 1 */
#define HRTIM_TIMERST_EXTEVNT2        (1 << 10) /* Bit 10: External event 2 */
#define HRTIM_TIMERST_EXTEVNT3        (1 << 11) /* Bit 11: External event 3 */
#define HRTIM_TIMERST_EXTEVNT4        (1 << 12) /* Bit 12: External event 4 */
#define HRTIM_TIMERST_EXTEVNT5        (1 << 13) /* Bit 13: External event 5 */
#define HRTIM_TIMERST_EXTEVNT6        (1 << 14) /* Bit 14: External event 6 */
#define HRTIM_TIMERST_EXTEVNT7        (1 << 15) /* Bit 15: External event 7 */
#define HRTIM_TIMERST_EXTEVNT8        (1 << 16) /* Bit 16: External event 8 */
#define HRTIM_TIMERST_EXTEVNT9        (1 << 17) /* Bit 17: External event 9 */
#define HRTIM_TIMERST_EXTEVNT10       (1 << 18) /* Bit 18: External event 10 */
#define HRTIM_TIMERST_TIMACMP1        (1 << 19) /* Bit 19: Timer A compare 1 */
#define HRTIM_TIMERST_TIMACMP2        (1 << 20) /* Bit 20: Timer A compare 2 */
#define HRTIM_TIMERST_TIMACMP4        (1 << 21) /* Bit 21: Timer A compare 4 */
#define HRTIM_TIMERST_TIMBCMP1        (1 << 22) /* Bit 22: Timer B compare 1 */
#define HRTIM_TIMERST_TIMBCMP2        (1 << 23) /* Bit 23: Timer B compare 2 */
#define HRTIM_TIMERST_TIMBCMP4        (1 << 24) /* Bit 24: Timer B compare 4 */
#define HRTIM_TIMERST_TIMCCMP1        (1 << 25) /* Bit 25: Timer C compare 1 */
#define HRTIM_TIMERST_TIMCCMP2        (1 << 26) /* Bit 26: Timer C compare 2 */
#define HRTIM_TIMERST_TIMCCMP4        (1 << 27) /* Bit 27: Timer C compare 4 */
#define HRTIM_TIMERST_TIMDCMP1        (1 << 28) /* Bit 28: Timer D compare 1 */
#define HRTIM_TIMERST_TIMDCMP2        (1 << 29) /* Bit 29: Timer D compare 2 */
#define HRTIM_TIMERST_TIMDCMP4        (1 << 30) /* Bit 30: Timer D compare 4 */
#define HRTIM_TIMERST_TIMFCMP2        (1 << 31) /* Bit 0: Timer F compare 2 */

#define HRTIM_TIMFRST_TIMECMP1        (1 << 0)  /* Bit 0: Timer E compare 1 */
#define HRTIM_TIMFRST_UPDT            (1 << 1)  /* Bit 1: Timer F update reset */
#define HRTIM_TIMFRST_CMP2            (1 << 2)  /* Bit 2: Timer F compare 2 reset */
#define HRTIM_TIMFRST_CMP4            (1 << 3)  /* Bit 3: Timer F compare 4 reset */
#define HRTIM_TIMFRST_MSTPER          (1 << 4)  /* Bit 4: Master timer period */
#define HRTIM_TIMFRST_MSTCMP1         (1 << 5)  /* Bit 5: Master compare 1 */
#define HRTIM_TIMFRST_MSTCMP2         (1 << 6)  /* Bit 6: Master compare 2 */
#define HRTIM_TIMFRST_MSTCMP3         (1 << 7)  /* Bit 7: Master compare 3 */
#define HRTIM_TIMFRST_MSTCMP4         (1 << 8)  /* Bit 8: Master compare 4 */
#define HRTIM_TIMFRST_EXTEVNT1        (1 << 9)  /* Bit 9: External event 1 */
#define HRTIM_TIMFRST_EXTEVNT2        (1 << 10) /* Bit 10: External event 2 */
#define HRTIM_TIMFRST_EXTEVNT3        (1 << 11) /* Bit 11: External event 3 */
#define HRTIM_TIMFRST_EXTEVNT4        (1 << 12) /* Bit 12: External event 4 */
#define HRTIM_TIMFRST_EXTEVNT5        (1 << 13) /* Bit 13: External event 5 */
#define HRTIM_TIMFRST_EXTEVNT6        (1 << 14) /* Bit 14: External event 6 */
#define HRTIM_TIMFRST_EXTEVNT7        (1 << 15) /* Bit 15: External event 7 */
#define HRTIM_TIMFRST_EXTEVNT8        (1 << 16) /* Bit 16: External event 8 */
#define HRTIM_TIMFRST_EXTEVNT9        (1 << 17) /* Bit 17: External event 9 */
#define HRTIM_TIMFRST_EXTEVNT10       (1 << 18) /* Bit 18: External event 10 */
#define HRTIM_TIMFRST_TIMACMP1        (1 << 19) /* Bit 19: Timer A compare 1 */
#define HRTIM_TIMFRST_TIMACMP2        (1 << 20) /* Bit 20: Timer A compare 2 */
#define HRTIM_TIMFRST_TIMACMP4        (1 << 21) /* Bit 21: Timer A compare 4 */
#define HRTIM_TIMFRST_TIMBCMP1        (1 << 22) /* Bit 22: Timer B compare 1 */
#define HRTIM_TIMFRST_TIMBCMP2        (1 << 23) /* Bit 23: Timer B compare 2 */
#define HRTIM_TIMFRST_TIMBCMP4        (1 << 24) /* Bit 24: Timer B compare 4 */
#define HRTIM_TIMFRST_TIMCCMP1        (1 << 25) /* Bit 25: Timer C compare 1 */
#define HRTIM_TIMFRST_TIMCCMP2        (1 << 26) /* Bit 26: Timer C compare 2 */
#define HRTIM_TIMFRST_TIMCCMP4        (1 << 27) /* Bit 27: Timer C compare 4 */
#define HRTIM_TIMFRST_TIMDCMP1        (1 << 28) /* Bit 28: Timer D compare 1 */
#define HRTIM_TIMFRST_TIMDCMP2        (1 << 29) /* Bit 29: Timer D compare 2 */
#define HRTIM_TIMFRST_TIMDCMP4        (1 << 30) /* Bit 30: Timer D compare 4 */
#define HRTIM_TIMFRST_TIMECMP2        (1 << 31) /* Bit 0: Timer E compare 2 */
...
#define HRTIM_TIMACPT12CR_SWCPT       (1 << 0)  /* Bit 0: Software capture */
#define HRTIM_TIMACPT12CR_UPDCPT      (1 << 1)  /* Bit 1: Update capture */
#define HRTIM_TIMACPT12CR_EXEV1CPT    (1 << 2)  /* Bit 2: External event 1 capture */
#define HRTIM_TIMACPT12CR_EXEV2CPT    (1 << 3)  /* Bit 3: External event 2 capture */
#define HRTIM_TIMACPT12CR_EXEV3CPT    (1 << 4)  /* Bit 4: External event 3 capture */
#define HRTIM_TIMACPT12CR_EXEV4CPT    (1 << 5)  /* Bit 5: External event 4 capture */
#define HRTIM_TIMACPT12CR_EXEV5CPT    (1 << 6)  /* Bit 6: External event 5 capture */
#define HRTIM_TIMACPT12CR_EXEV6CPT    (1 << 7)  /* Bit 7: External event 6 capture */
#define HRTIM_TIMACPT12CR_EXEV7CPT    (1 << 8)  /* Bit 8: External event 7 capture */
#define HRTIM_TIMACPT12CR_EXEV8CPT    (1 << 9)  /* Bit 9: External event 8 capture */
#define HRTIM_TIMACPT12CR_EXEV9CPT    (1 << 10) /* Bit 10: External event 9 capture */
#define HRTIM_TIMACPT12CR_EXEV10CPT   (1 << 11) /* Bit 11: External event 10 capture */
#define HRTIM_TIMACPT12CR_TF1SET      (1 << 12) /* Bit 12: Timer F output 1 set */
#define HRTIM_TIMACPT12CR_TF1RST      (1 << 13) /* Bit 13: Timer F output 1 reset */
#define HRTIM_TIMACPT12CR_TFCMP1      (1 << 14) /* Bit 14: Timer F compare 1 */
#define HRTIM_TIMACPT12CR_TFCMP2      (1 << 15) /* Bit 15: Timer F compare 2 */
#define HRTIM_TIMACPT12CR_TB1SET      (1 << 16) /* Bit 16: Timer B output 1 set */
#define HRTIM_TIMACPT12CR_TB1RST      (1 << 17) /* Bit 17: Timer B output 1 reset */
#define HRTIM_TIMACPT12CR_TBCMP1      (1 << 18) /* Bit 18: Timer B compare 1 */
#define HRTIM_TIMACPT12CR_TBCMP2      (1 << 19) /* Bit 19: Timer B compare 2 */
#define HRTIM_TIMACPT12CR_TC1SET      (1 << 20) /* Bit 20: Timer C output 1 set */
#define HRTIM_TIMACPT12CR_TC1RST      (1 << 21) /* Bit 21: Timer C output 1 reset */
#define HRTIM_TIMACPT12CR_TCCMP1      (1 << 22) /* Bit 22: Timer C compare 1 */
#define HRTIM_TIMACPT12CR_TCCMP2      (1 << 23) /* Bit 23: Timer C compare 2 */
#define HRTIM_TIMACPT12CR_TD1SET      (1 << 24) /* Bit 24: Timer D output 1 set */
#define HRTIM_TIMACPT12CR_TD1RST      (1 << 25) /* Bit 25: Timer D output 1 reset */
#define HRTIM_TIMACPT12CR_TDCMP1      (1 << 26) /* Bit 26: Timer D compare 1 */
#define HRTIM_TIMACPT12CR_TDCMP2      (1 << 27) /* Bit 27: Timer D compare 2 */
#define HRTIM_TIMACPT12CR_TE1SET      (1 << 28) /* Bit 28: Timer E output 1 set */
#define HRTIM_TIMACPT12CR_TE1RST      (1 << 29) /* Bit 29: Timer E output 1 reset */
#define HRTIM_TIMACPT12CR_TECMP1      (1 << 30) /* Bit 30: Timer E compare 1 */
#define HRTIM_TIMACPT12CR_TECMP2      (1 << 31) /* Bit 31: Timer E compare 2 */

#define HRTIM_TIMBCPT12CR_SWCPT       (1 << 0)  /* Bit 0: Software capture */
#define HRTIM_TIMBCPT12CR_UPDCPT      (1 << 1)  /* Bit 1: Update capture */
#define HRTIM_TIMBCPT12CR_EXEV1CPT    (1 << 2)  /* Bit 2: External event 1 capture */
#define HRTIM_TIMBCPT12CR_EXEV2CPT    (1 << 3)  /* Bit 3: External event 2 capture */
#define HRTIM_TIMBCPT12CR_EXEV3CPT    (1 << 4)  /* Bit 4: External event 3 capture */
#define HRTIM_TIMBCPT12CR_EXEV4CPT    (1 << 5)  /* Bit 5: External event 4 capture */
#define HRTIM_TIMBCPT12CR_EXEV5CPT    (1 << 6)  /* Bit 6: External event 5 capture */
#define HRTIM_TIMBCPT12CR_EXEV6CPT    (1 << 7)  /* Bit 7: External event 6 capture */
#define HRTIM_TIMBCPT12CR_EXEV7CPT    (1 << 8)  /* Bit 8: External event 7 capture */
#define HRTIM_TIMBCPT12CR_EXEV8CPT    (1 << 9)  /* Bit 9: External event 8 capture */
#define HRTIM_TIMBCPT12CR_EXEV9CPT    (1 << 10) /* Bit 10: External event 9 capture */
#define HRTIM_TIMBCPT12CR_EXEV10CPT   (1 << 11) /* Bit 11: External event 10 capture */
#define HRTIM_TIMBCPT12CR_TA1SET      (1 << 12) /* Bit 12: Timer A output 1 set */
#define HRTIM_TIMBCPT12CR_TA1RST      (1 << 13) /* Bit 13: Timer A output 1 reset */
#define HRTIM_TIMBCPT12CR_TACMP1      (1 << 14) /* Bit 14: Timer A compare 1 */
#define HRTIM_TIMBCPT12CR_TACMP2      (1 << 15) /* Bit 15: Timer A compare 2 */
#define HRTIM_TIMBCPT12CR_TF1SET      (1 << 16) /* Bit 16: Timer F output 1 set */
#define HRTIM_TIMBCPT12CR_TF1RST      (1 << 17) /* Bit 17: Timer F output 1 reset */
#define HRTIM_TIMBCPT12CR_TFCMP1      (1 << 18) /* Bit 18: Timer F compare 1 */
#define HRTIM_TIMBCPT12CR_TFCMP2      (1 << 19) /* Bit 19: Timer F compare 2 */
#define HRTIM_TIMBCPT12CR_TC1SET      (1 << 20) /* Bit 20: Timer C output 1 set */
#define HRTIM_TIMBCPT12CR_TC1RST      (1 << 21) /* Bit 21: Timer C output 1 reset */
#define HRTIM_TIMBCPT12CR_TCCMP1      (1 << 22) /* Bit 22: Timer C compare 1 */
#define HRTIM_TIMBCPT12CR_TCCMP2      (1 << 23) /* Bit 23: Timer C compare 2 */
#define HRTIM_TIMBCPT12CR_TD1SET      (1 << 24) /* Bit 24: Timer D output 1 set */
#define HRTIM_TIMBCPT12CR_TD1RST      (1 << 25) /* Bit 25: Timer D output 1 reset */
#define HRTIM_TIMBCPT12CR_TDCMP1      (1 << 26) /* Bit 26: Timer D compare 1 */
#define HRTIM_TIMBCPT12CR_TDCMP2      (1 << 27) /* Bit 27: Timer D compare 2 */
#define HRTIM_TIMBCPT12CR_TE1SET      (1 << 28) /* Bit 28: Timer E output 1 set */
#define HRTIM_TIMBCPT12CR_TE1RST      (1 << 29) /* Bit 29: Timer E output 1 reset */
#define HRTIM_TIMBCPT12CR_TECMP1      (1 << 30) /* Bit 30: Timer E compare 1 */
#define HRTIM_TIMBCPT12CR_TECMP2      (1 << 31) /* Bit 31: Timer E compare 2 */

#define HRTIM_TIMCCPT12CR_SWCPT       (1 << 0)  /* Bit 0: Software capture */
#define HRTIM_TIMCCPT12CR_UPDCPT      (1 << 1)  /* Bit 1: Update capture */
#define HRTIM_TIMCCPT12CR_EXEV1CPT    (1 << 2)  /* Bit 2: External event 1 capture */
#define HRTIM_TIMCCPT12CR_EXEV2CPT    (1 << 3)  /* Bit 3: External event 2 capture */
#define HRTIM_TIMCCPT12CR_EXEV3CPT    (1 << 4)  /* Bit 4: External event 3 capture */
#define HRTIM_TIMCCPT12CR_EXEV4CPT    (1 << 5)  /* Bit 5: External event 4 capture */
#define HRTIM_TIMCCPT12CR_EXEV5CPT    (1 << 6)  /* Bit 6: External event 5 capture */
#define HRTIM_TIMCCPT12CR_EXEV6CPT    (1 << 7)  /* Bit 7: External event 6 capture */
#define HRTIM_TIMCCPT12CR_EXEV7CPT    (1 << 8)  /* Bit 8: External event 7 capture */
#define HRTIM_TIMCCPT12CR_EXEV8CPT    (1 << 9)  /* Bit 9: External event 8 capture */
#define HRTIM_TIMCCPT12CR_EXEV9CPT    (1 << 10) /* Bit 10: External event 9 capture */
#define HRTIM_TIMCCPT12CR_EXEV10CPT   (1 << 11) /* Bit 11: External event 10 capture */
#define HRTIM_TIMCCPT12CR_TA1SET      (1 << 12) /* Bit 12: Timer A output 1 set */
#define HRTIM_TIMCCPT12CR_TA1RST      (1 << 13) /* Bit 13: Timer A output 1 reset */
#define HRTIM_TIMCCPT12CR_TACMP1      (1 << 14) /* Bit 14: Timer A compare 1 */
#define HRTIM_TIMCCPT12CR_TACMP2      (1 << 15) /* Bit 15: Timer A compare 2 */
#define HRTIM_TIMCCPT12CR_TB1SET      (1 << 16) /* Bit 16: Timer B output 1 set */
#define HRTIM_TIMCCPT12CR_TB1RST      (1 << 17) /* Bit 17: Timer B output 1 reset */
#define HRTIM_TIMCCPT12CR_TBCMP1      (1 << 18) /* Bit 18: Timer B compare 1 */
#define HRTIM_TIMCCPT12CR_TBCMP2      (1 << 19) /* Bit 19: Timer B compare 2 */
#define HRTIM_TIMCCPT12CR_TF1SET      (1 << 20) /* Bit 20: Timer F output 1 set */
#define HRTIM_TIMCCPT12CR_TF1RST      (1 << 21) /* Bit 21: Timer F output 1 reset */
#define HRTIM_TIMCCPT12CR_TFCMP1      (1 << 22) /* Bit 22: Timer F compare 1 */
#define HRTIM_TIMCCPT12CR_TFCMP2      (1 << 23) /* Bit 23: Timer F compare 2 */
#define HRTIM_TIMCCPT12CR_TD1SET      (1 << 24) /* Bit 24: Timer D output 1 set */
#define HRTIM_TIMCCPT12CR_TD1RST      (1 << 25) /* Bit 25: Timer D output 1 reset */
#define HRTIM_TIMCCPT12CR_TDCMP1      (1 << 26) /* Bit 26: Timer D compare 1 */
#define HRTIM_TIMCCPT12CR_TDCMP2      (1 << 27) /* Bit 27: Timer D compare 2 */
#define HRTIM_TIMCCPT12CR_TE1SET      (1 << 28) /* Bit 28: Timer E output 1 set */
#define HRTIM_TIMCCPT12CR_TE1RST      (1 << 29) /* Bit 29: Timer E output 1 reset */
#define HRTIM_TIMCCPT12CR_TECMP1      (1 << 30) /* Bit 30: Timer E compare 1 */
#define HRTIM_TIMCCPT12CR_TECMP2      (1 << 31) /* Bit 31: Timer E compare 2 */

#define HRTIM_TIMDCPT12CR_SWCPT       (1 << 0)  /* Bit 0: Software capture */
#define HRTIM_TIMDCPT12CR_UPDCPT      (1 << 1)  /* Bit 1: Update capture */
#define HRTIM_TIMDCPT12CR_EXEV1CPT    (1 << 2)  /* Bit 2: External event 1 capture */
#define HRTIM_TIMDCPT12CR_EXEV2CPT    (1 << 3)  /* Bit 3: External event 2 capture */
#define HRTIM_TIMDCPT12CR_EXEV3CPT    (1 << 4)  /* Bit 4: External event 3 capture */
#define HRTIM_TIMDCPT12CR_EXEV4CPT    (1 << 5)  /* Bit 5: External event 4 capture */
#define HRTIM_TIMDCPT12CR_EXEV5CPT    (1 << 6)  /* Bit 6: External event 5 capture */
#define HRTIM_TIMDCPT12CR_EXEV6CPT    (1 << 7)  /* Bit 7: External event 6 capture */
#define HRTIM_TIMDCPT12CR_EXEV7CPT    (1 << 8)  /* Bit 8: External event 7 capture */
#define HRTIM_TIMDCPT12CR_EXEV8CPT    (1 << 9)  /* Bit 9: External event 8 capture */
#define HRTIM_TIMDCPT12CR_EXEV9CPT    (1 << 10) /* Bit 10: External event 9 capture */
#define HRTIM_TIMDCPT12CR_EXEV10CPT   (1 << 11) /* Bit 11: External event 10 capture */
#define HRTIM_TIMDCPT12CR_TA1SET      (1 << 12) /* Bit 12: Timer A output 1 set */
#define HRTIM_TIMDCPT12CR_TA1RST      (1 << 13) /* Bit 13: Timer A output 1 reset */
#define HRTIM_TIMDCPT12CR_TACMP1      (1 << 14) /* Bit 14: Timer A compare 1 */
#define HRTIM_TIMDCPT12CR_TACMP2      (1 << 15) /* Bit 15: Timer A compare 2 */
#define HRTIM_TIMDCPT12CR_TB1SET      (1 << 16) /* Bit 16: Timer B output 1 set */
#define HRTIM_TIMDCPT12CR_TB1RST      (1 << 17) /* Bit 17: Timer B output 1 reset */
#define HRTIM_TIMDCPT12CR_TBCMP1      (1 << 18) /* Bit 18: Timer B compare 1 */
#define HRTIM_TIMDCPT12CR_TBCMP2      (1 << 19) /* Bit 19: Timer B compare 2 */
#define HRTIM_TIMDCPT12CR_TC1SET      (1 << 20) /* Bit 20: Timer C output 1 set */
#define HRTIM_TIMDCPT12CR_TC1RST      (1 << 21) /* Bit 21: Timer C output 1 reset */
#define HRTIM_TIMDCPT12CR_TCCMP1      (1 << 22) /* Bit 22: Timer C compare 1 */
#define HRTIM_TIMDCPT12CR_TCCMP2      (1 << 23) /* Bit 23: Timer C compare 2 */
#define HRTIM_TIMDCPT12CR_TF1SET      (1 << 24) /* Bit 24: Timer F output 1 set */
#define HRTIM_TIMDCPT12CR_TF1RST      (1 << 25) /* Bit 25: Timer F output 1 reset */
#define HRTIM_TIMDCPT12CR_TFCMP1      (1 << 26) /* Bit 26: Timer F compare 1 */
#define HRTIM_TIMDCPT12CR_TFCMP2      (1 << 27) /* Bit 27: Timer F compare 2 */
#define HRTIM_TIMDCPT12CR_TE1SET      (1 << 28) /* Bit 28: Timer E output 1 set */
#define HRTIM_TIMDCPT12CR_TE1RST      (1 << 29) /* Bit 29: Timer E output 1 reset */
#define HRTIM_TIMDCPT12CR_TECMP1      (1 << 30) /* Bit 30: Timer E compare 1 */
#define HRTIM_TIMDCPT12CR_TECMP2      (1 << 31) /* Bit 31: Timer E compare 2 */

#define HRTIM_TIMECPT12CR_SWCPT       (1 << 0)  /* Bit 0: Software capture */
#define HRTIM_TIMECPT12CR_UPDCPT      (1 << 1)  /* Bit 1: Update capture */
#define HRTIM_TIMECPT12CR_EXEV1CPT    (1 << 2)  /* Bit 2: External event 1 capture */
#define HRTIM_TIMECPT12CR_EXEV2CPT    (1 << 3)  /* Bit 3: External event 2 capture */
#define HRTIM_TIMECPT12CR_EXEV3CPT    (1 << 4)  /* Bit 4: External event 3 capture */
#define HRTIM_TIMECPT12CR_EXEV4CPT    (1 << 5)  /* Bit 5: External event 4 capture */
#define HRTIM_TIMECPT12CR_EXEV5CPT    (1 << 6)  /* Bit 6: External event 5 capture */
#define HRTIM_TIMECPT12CR_EXEV6CPT    (1 << 7)  /* Bit 7: External event 6 capture */
#define HRTIM_TIMECPT12CR_EXEV7CPT    (1 << 8)  /* Bit 8: External event 7 capture */
#define HRTIM_TIMECPT12CR_EXEV8CPT    (1 << 9)  /* Bit 9: External event 8 capture */
#define HRTIM_TIMECPT12CR_EXEV9CPT    (1 << 10) /* Bit 10: External event 9 capture */
#define HRTIM_TIMECPT12CR_EXEV10CPT   (1 << 11) /* Bit 11: External event 10 capture */
#define HRTIM_TIMECPT12CR_TA1SET      (1 << 12) /* Bit 12: Timer A output 1 set */
#define HRTIM_TIMECPT12CR_TA1RST      (1 << 13) /* Bit 13: Timer A output 1 reset */
#define HRTIM_TIMECPT12CR_TACMP1      (1 << 14) /* Bit 14: Timer A compare 1 */
#define HRTIM_TIMECPT12CR_TACMP2      (1 << 15) /* Bit 15: Timer A compare 2 */
#define HRTIM_TIMECPT12CR_TB1SET      (1 << 16) /* Bit 16: Timer B output 1 set */
#define HRTIM_TIMECPT12CR_TB1RST      (1 << 17) /* Bit 17: Timer B output 1 reset */
#define HRTIM_TIMECPT12CR_TBCMP1      (1 << 18) /* Bit 18: Timer B compare 1 */
#define HRTIM_TIMECPT12CR_TBCMP2      (1 << 19) /* Bit 19: Timer B compare 2 */
#define HRTIM_TIMECPT12CR_TC1SET      (1 << 20) /* Bit 20: Timer C output 1 set */
#define HRTIM_TIMECPT12CR_TC1RST      (1 << 21) /* Bit 21: Timer C output 1 reset */
#define HRTIM_TIMECPT12CR_TCCMP1      (1 << 22) /* Bit 22: Timer C compare 1 */
#define HRTIM_TIMECPT12CR_TCCMP2      (1 << 23) /* Bit 23: Timer C compare 2 */
#define HRTIM_TIMECPT12CR_TD1SET      (1 << 24) /* Bit 24: Timer D output 1 set */
#define HRTIM_TIMECPT12CR_TD1RST      (1 << 25) /* Bit 25: Timer D output 1 reset */
#define HRTIM_TIMECPT12CR_TDCMP1      (1 << 26) /* Bit 26: Timer D compare 1 */
#define HRTIM_TIMECPT12CR_TDCMP2      (1 << 27) /* Bit 27: Timer D compare 2 */
#define HRTIM_TIMECPT12CR_TF1SET      (1 << 28) /* Bit 28: Timer F output 1 set */
#define HRTIM_TIMECPT12CR_TF1RST      (1 << 29) /* Bit 29: Timer F output 1 reset */
#define HRTIM_TIMECPT12CR_TFCMP1      (1 << 30) /* Bit 30: Timer F compare 1 */
#define HRTIM_TIMECPT12CR_TFCMP2      (1 << 31) /* Bit 31: Timer F compare 2 */

#define HRTIM_TIMFCPT12CR_SWCPT       (1 << 0)  /* Bit 0: Software capture */
#define HRTIM_TIMFCPT12CR_UPDCPT      (1 << 1)  /* Bit 1: Update capture */
#define HRTIM_TIMFCPT12CR_EXEV1CPT    (1 << 2)  /* Bit 2: External event 1 capture */
#define HRTIM_TIMFCPT12CR_EXEV2CPT    (1 << 3)  /* Bit 3: External event 2 capture */
#define HRTIM_TIMFCPT12CR_EXEV3CPT    (1 << 4)  /* Bit 4: External event 3 capture */
#define HRTIM_TIMFCPT12CR_EXEV4CPT    (1 << 5)  /* Bit 5: External event 4 capture */
#define HRTIM_TIMFCPT12CR_EXEV5CPT    (1 << 6)  /* Bit 6: External event 5 capture */
#define HRTIM_TIMFCPT12CR_EXEV6CPT    (1 << 7)  /* Bit 7: External event 6 capture */
#define HRTIM_TIMFCPT12CR_EXEV7CPT    (1 << 8)  /* Bit 8: External event 7 capture */
#define HRTIM_TIMFCPT12CR_EXEV8CPT    (1 << 9)  /* Bit 9: External event 8 capture */
#define HRTIM_TIMFCPT12CR_EXEV9CPT    (1 << 10) /* Bit 10: External event 9 capture */
#define HRTIM_TIMFCPT12CR_EXEV10CPT   (1 << 11) /* Bit 11: External event 10 capture */
#define HRTIM_TIMFCPT12CR_TA1SET      (1 << 12) /* Bit 12: Timer A output 1 set */
#define HRTIM_TIMFCPT12CR_TA1RST      (1 << 13) /* Bit 13: Timer A output 1 reset */
#define HRTIM_TIMFCPT12CR_TACMP1      (1 << 14) /* Bit 14: Timer A compare 1 */
#define HRTIM_TIMFCPT12CR_TACMP2      (1 << 15) /* Bit 15: Timer A compare 2 */
#define HRTIM_TIMFCPT12CR_TB1SET      (1 << 16) /* Bit 16: Timer B output 1 set */
#define HRTIM_TIMFCPT12CR_TB1RST      (1 << 17) /* Bit 17: Timer B output 1 reset */
#define HRTIM_TIMFCPT12CR_TBCMP1      (1 << 18) /* Bit 18: Timer B compare 1 */
#define HRTIM_TIMFCPT12CR_TBCMP2      (1 << 19) /* Bit 19: Timer B compare 2 */
#define HRTIM_TIMFCPT12CR_TC1SET      (1 << 20) /* Bit 20: Timer C output 1 set */
#define HRTIM_TIMFCPT12CR_TC1RST      (1 << 21) /* Bit 21: Timer C output 1 reset */
#define HRTIM_TIMFCPT12CR_TCCMP1      (1 << 22) /* Bit 22: Timer C compare 1 */
#define HRTIM_TIMFCPT12CR_TCCMP2      (1 << 23) /* Bit 23: Timer C compare 2 */
#define HRTIM_TIMFCPT12CR_TD1SET      (1 << 24) /* Bit 24: Timer D output 1 set */
#define HRTIM_TIMFCPT12CR_TD1RST      (1 << 25) /* Bit 25: Timer D output 1 reset */
#define HRTIM_TIMFCPT12CR_TDCMP1      (1 << 26) /* Bit 26: Timer D compare 1 */
#define HRTIM_TIMFCPT12CR_TDCMP2      (1 << 27) /* Bit 27: Timer D compare 2 */
#define HRTIM_TIMFCPT12CR_TE1SET      (1 << 28) /* Bit 28: Timer E output 1 set */
#define HRTIM_TIMFCPT12CR_TE1RST      (1 << 29) /* Bit 29: Timer E output 1 reset */
#define HRTIM_TIMFCPT12CR_TECMP1      (1 << 30) /* Bit 30: Timer E compare 1 */
#define HRTIM_TIMFCPT12CR_TECMP2      (1 << 31) /* Bit 31: Timer E compare 2 */
...
#define HRTIM_TIMFLT_FLT6EN           (1 << 5)  /* Bit 5: Fault 6 enable */
#define HRTIM_TIMFLT_FLTLCK           (1 << 31) /* Bit 31: Fault sources lock*/

/* Timer X Control Register 2 */

#define HRTIM_TIMCR2_DCDE             (1 << 0)  /* Bit 0: Dual channel DAC trigger enable */
#define HRTIM_TIMCR2_DCDS             (1 << 1)  /* Bit 1: Dual channel DAC Step trigger */
#define HRTIM_TIMCR2_DCDR             (1 << 2)  /* Bit 2: Dual channel DAC reset trigger */
#define HRTIM_TIMCR2_UDM              (1 << 4)  /* Bit 4: Up-Down mode */
#define HRTIM_TIMCR2_ROM_SHIFT        6         /* Bits 6-7: Roll-over mode */
#define HRTIM_TIMCR2_ROM_MASK         (3 << HRTIM_TIMCR2_ROM_SHIFT)
#  define HRTIM_TIMCR2_ROM_00         (0 << HRTIM_TIMCR2_ROM_SHIFT)  /* 00: */
#  define HRTIM_TIMCR2_ROM_01         (1 << HRTIM_TIMCR2_ROM_SHIFT)  /* 01: */
#  define HRTIM_TIMCR2_ROM_10         (2 << HRTIM_TIMCR2_ROM_SHIFT)  /* 10: */
#define HRTIM_TIMCR2_OUTROM_SHIFT     8                              /* Bits 8-9: Output roll-over mode */
#define HRTIM_TIMCR2_OUTROM_MASK      (3 << HRTIM_TIMCR2_OUTROM_SHIFT)
#  define HRTIM_TIMCR2_OUTROM_00      (0 << HRTIM_TIMCR2_OUTROM_SHIFT)  /* 00: */
#  define HRTIM_TIMCR2_OUTROM_01      (1 << HRTIM_TIMCR2_OUTROM_SHIFT)  /* 01: */
#  define HRTIM_TIMCR2_OUTROM_10      (2 << HRTIM_TIMCR2_OUTROM_SHIFT)  /* 10: */
#define HRTIM_TIMCR2_ADROM_SHIFT      10                                /* Bits 10-11: ADC roll-over mode */
#define HRTIM_TIMCR2_ADROM_MASK       (3 << HRTIM_TIMCR2_ADROM_SHIFT)
#  define HRTIM_TIMCR2_ADROM_00       (0 << HRTIM_TIMCR2_ADROM_SHIFT)  /* 00: */
#  define HRTIM_TIMCR2_ADROM_01       (1 << HRTIM_TIMCR2_ADROM_SHIFT)  /* 01: */
#  define HRTIM_TIMCR2_ADROM_10       (2 << HRTIM_TIMCR2_ADROM_SHIFT)  /* 10: */
#define HRTIM_TIMCR2_BMROM_SHIFT      12                               /* Bits 12-13: Burst mode roll-over mode */
#define HRTIM_TIMCR2_BMROM_MASK       (3 << HRTIM_TIMCR2_BMROM_SHIFT)
#  define HRTIM_TIMCR2_BMROM_00       (0 << HRTIM_TIMCR2_BMROM_SHIFT)  /* 00: */
#  define HRTIM_TIMCR2_BMROM_01       (1 << HRTIM_TIMCR2_BMROM_SHIFT)  /* 01: */
#  define HRTIM_TIMCR2_BMROM_10       (2 << HRTIM_TIMCR2_BMROM_SHIFT)  /* 10: */
#define HRTIM_TIMCR2_FEROM_SHIFT      14                               /* Bits 14-15: Fault and event roll-over mode */
#define HRTIM_TIMCR2_FEROM_MASK       (3 << HRTIM_TIMCR2_FEROM_SHIFT)
#  define HRTIM_TIMCR2_FEROM_00       (0 << HRTIM_TIMCR2_FEROM_SHIFT)  /* 00: */
#  define HRTIM_TIMCR2_FEROM_01       (1 << HRTIM_TIMCR2_FEROM_SHIFT)  /* 01: */
#  define HRTIM_TIMCR2_FEROM_10       (2 << HRTIM_TIMCR2_FEROM_SHIFT)  /* 10: */
#define HRTIM_TIMCR2_GTCMP1           (1 << 16)                        /* Bit 16: Greater than compare 1 PWM mode */
#define HRTIM_TIMCR2_GTCMP3           (1 << 17)                        /* Bit 17: Greater than compare 3 PWM mode */
#define HRTIM_TIMCR2_TRGHLF           (1 << 20)                        /* Bit 20: Triggered-half mode */

/* Timer X external event filtering register 3 */

#define HRTIM_TIMEEFR3_EEVACE         (1 << 0)                             /* Bit 0: External event A counter enable */
#define HRTIM_TIMEEFR3_EEVARSTM       (1 << 1)                             /* Bit 1: External event A counter reset */
#define HRTIM_TIMEEFR3_EEVACRES       (1 << 2)                             /* Bit 2: External event A reset mode */
#define HRTIM_TIMEEFR3_EEVASEL_SHIFT  4                                    /* Bits 4-7: External event A Selection */
#define HRTIM_TIMEEFR3_EEVASEL_MASK   (0xf << HRTIM_TIMEEFR3_EEVASEL_SHIFT)
#  define HRTIM_TIMEEFR3_EEVASEL_1    (0 << HRTIM_TIMEEFR3_EEVASEL_SHIFT)  /* External event 1 is used as external event A source */
#  define HRTIM_TIMEEFR3_EEVASEL_2    (1 << HRTIM_TIMEEFR3_EEVASEL_SHIFT)  /* External event 2 is used as external event A source */
#  define HRTIM_TIMEEFR3_EEVASEL_3    (2 << HRTIM_TIMEEFR3_EEVASEL_SHIFT)  /* External event 3 is used as external event A source */
#  define HRTIM_TIMEEFR3_EEVASEL_4    (3 << HRTIM_TIMEEFR3_EEVASEL_SHIFT)  /* External event 4 is used as external event A source */
#  define HRTIM_TIMEEFR3_EEVASEL_5    (4 << HRTIM_TIMEEFR3_EEVASEL_SHIFT)  /* External event 5 is used as external event A source */
#  define HRTIM_TIMEEFR3_EEVASEL_6    (5 << HRTIM_TIMEEFR3_EEVASEL_SHIFT)  /* External event 6 is used as external event A source */
#  define HRTIM_TIMEEFR3_EEVASEL_7    (6 << HRTIM_TIMEEFR3_EEVASEL_SHIFT)  /* External event 7 is used as external event A source */
#  define HRTIM_TIMEEFR3_EEVASEL_8    (7 << HRTIM_TIMEEFR3_EEVASEL_SHIFT)  /* External event 8 is used as external event A source */
#  define HRTIM_TIMEEFR3_EEVASEL_9    (8 << HRTIM_TIMEEFR3_EEVASEL_SHIFT)  /* External event 9 is used as external event A source */
#  define HRTIM_TIMEEFR3_EEVASEL_10   (9 << HRTIM_TIMEEFR3_EEVASEL_SHIFT)  /* External event 10 is used as external event A source */
#define HRTIM_TIMEEFR3_EEVACNT_SHIFT  8                                    /* Bits 8-13: External event A counter */
#define HRTIM_TIMEEFR3_EEVACNT_MASK   (0x3f << HRTIM_TIMEEFR3_EEVACNT_SHIFT)
...
#define HRTIM_CR1_TFUDIS              (1 << 6) /* Bit 6: Timer F Update Disable */
...
#  define HRTIM_CR1_AD1USRC_TE        (5 << HRTIM_CR1_AD1USRC_SHIFT) /* 101: Timer E */
#  define HRTIM_CR1_AD1USRC_TF        (6 << HRTIM_CR1_AD1USRC_SHIFT) /* 110: Timer F */
...
#  define HRTIM_CR1_AD2USRC_TE        (5 << HRTIM_CR1_AD2USRC_SHIFT) /* 101: Timer E */
#  define HRTIM_CR1_AD2USRC_TF        (6 << HRTIM_CR1_AD2USRC_SHIFT) /* 110: Timer F */
...
#  define HRTIM_CR1_AD3USRC_TE        (5 << HRTIM_CR1_AD3USRC_SHIFT) /* 101: Timer E */
#  define HRTIM_CR1_AD3USRC_TF        (6 << HRTIM_CR1_AD3USRC_SHIFT) /* 110: Timer F */
...
#  define HRTIM_CR1_AD4USRC_TE        (5 << HRTIM_CR1_AD4USRC_SHIFT) /* 101: Timer E */
#  define HRTIM_CR1_AD4USRC_TF        (6 << HRTIM_CR1_AD4USRC_SHIFT) /* 110: Timer F */
...
#define HRTIM_CR2_TFSWU               (1 << 6)  /* Bit 6: Timer F Software Update */
...
#define HRTIM_CR2_TFRST               (1 << 14) /* Bit 14: Timer F Counter Software Reset */
#define HRTIM_CR2_SWPA                (1 << 16) /* Bit 16: Swap timer A outputs */
#define HRTIM_CR2_SWPB                (1 << 17) /* Bit 17: Swap timer B outputs */
#define HRTIM_CR2_SWPC                (1 << 18) /* Bit 18: Swap timer C outputs */
#define HRTIM_CR2_SWPD                (1 << 19) /* Bit 19: Swap timer D outputs */
#define HRTIM_CR2_SWPE                (1 << 20) /* Bit 20: Swap timer E outputs */
#define HRTIM_CR2_SWPF                (1 << 21) /* Bit 21: Swap timer F outputs */
...
#define HRTIM_ISR_FLT6                (1 << 6)  /* Bit 6: Fault 6 Interrupt Flag */
...
#define HRTIM_ICR_FLT6C                (1 << 6)  /* Bit 6: Fault 6 Interrupt Flag Clear */
...
#define HRTIM_IER_FLT6IE               (1 << 6)  /* Bit 6: Fault 6 Interrupt Enable */
...
#define HRTIM_OENR_TF1OE                (1 << 10) /* Bit 10: Timer F Output 1 Enable */
#define HRTIM_OENR_TF2OE                (1 << 11) /* Bit 11: Timer F Output 2 Enable */
...
#define HRTIM_ODISR_TF1ODIS             (1 << 10) /* Bit 10: Timer F Output 1 Disable */
#define HRTIM_ODISR_TF2ODIS             (1 << 11) /* Bit 11: Timer F Output 2 Disable */
...
#define HRTIM_ODSR_TF1ODS               (1 << 10) /* Bit 10: Timer F Output 1 Disable Status */
#define HRTIM_ODSR_TF2ODS               (1 << 11) /* Bit 11: Timer F Output 2 Disable Status */
...
#define HRTIM_BMCR_TFBM                 (1 << 22)                       /* Bit 22: Timer F Burst Mode */
...
#define HRTIM_EECR1_EE3SRC_SHIFT      12                              /* Bits 12-13: External Event 3 Source */
...
#define HRTIM_EECR2_EE6POL              (1 << 3)                        /* Bit 2: External Event 6 Polarity */
...
#define HRTIM_ADC1R_AD1TFC2            (1 << 10) /* Bit 10: ADC trigger 1 on Timer F Compare 2 */
...
#define HRTIM_ADC1R_AD1TFC3            (1 << 15) /* Bit 15: ADC trigger 1 on Timer F Compare 3 */
...
#define HRTIM_ADC1R_AD1TFC4            (1 << 20) /* Bit 20: ADC trigger 1 on Timer F Compare 4 */
...
#define HRTIM_ADC1R_AD1TFRST           (1 << 28) /* Bit 28: ADC trigger 1 on Timer F Reset and counter roll-over */
...
#define HRTIM_ADC2R_AD2TFC2            (1 << 11) /* Bit 11: ADC trigger 2 on Timer F Compare 2 */
...
#define HRTIM_ADC2R_AD2TBPER           (1 << 17) /* Bit 17: ADC trigger 2 on Timer B Period */
#define HRTIM_ADC2R_AD2TCC2            (1 << 18) /* Bit 18: ADC trigger 2 on Timer C Compare 2 */
#define HRTIM_ADC2R_AD2TCC3            (1 << 19) /* Bit 19: ADC trigger 2 on Timer C Compare 3 */
#define HRTIM_ADC2R_AD2TFC3            (1 << 20) /* Bit 20: ADC trigger 2 on Timer F Compare 4 */
#define HRTIM_ADC2R_AD2TCPER           (1 << 21) /* Bit 21: ADC trigger 2 on Timer C Period*/
...
#define HRTIM_ADC2R_AD2TFPER           (1 << 24) /* Bit 24: ADC trigger 2 on Timer F Period*/
...
#define HRTIM_ADC3R_AD3TFC2            (1 << 10) /* Bit 10: ADC trigger 3 on Timer F Compare 2 */
...
#define HRTIM_ADC3R_AD3TFC3            (1 << 15) /* Bit 15: ADC trigger 3 on Timer F Compare 3 */
...
#define HRTIM_ADC3R_AD3TFC4            (1 << 20) /* Bit 20: ADC trigger 3 on Timer F Compare 4 */
...
#define HRTIM_ADC3R_AD3TFPER           (1 << 24) /* Bit 24: ADC trigger 3 on Timer F Period*/
...
#define HRTIM_ADC3R_AD3TFRST           (1 << 28) /* Bit 28: ADC trigger 3 on Timer F Reset and counter roll-over */
...
#define HRTIM_ADC4R_AD4TFC2            (1 << 11) /* Bit 11: ADC trigger 4 on Timer F Compare 2 */
...
#define HRTIM_ADC4R_AD4TFC3            (1 << 15) /* Bit 15: ADC trigger 4 on Timer F Compare 3 */
...
#define HRTIM_ADC4R_AD4TFC4            (1 << 19) /* Bit 20: ADC trigger 4 on Timer F Compare 4 */
...
#define HRTIM_ADC4R_AD4TFPER           (1 << 24) /* Bit 24: ADC trigger 4 on Timer F Period*/
...
#define HRTIM_FLTINR1_FLT1SRC0         (1 << 2)                          /* Bit 2: Fault 1 source bit 0 */
#define HRTIM_FLTINR1_FLT1F_SHIFT      3                                 /* Bits 3-6: Fault 1 filter */
...
#define HRTIM_FLTINR1_FLT2SRC0         (1 << 10)                         /* Bit 10: Fault 2 source bit 0 */
#define HRTIM_FLTINR1_FLT2F_SHIFT      11                                /* Bits 11-14: Fault 2 filter */
...
#define HRTIM_FLTINR1_FLT3SRC0         (1 << 18)                         /* Bit 18: Fault 3 source bit 0 */
#define HRTIM_FLTINR1_FLT3F_SHIFT      19                                /* Bits 19-22: Fault 3 filter */
...
#define HRTIM_FLTINR1_FLT4SRC0         (1 << 26)                         /* Bit 26: Fault 4 source bit 0 */
#define HRTIM_FLTINR1_FLT4F_SHIFT      27                                /* Bits 27-30: Fault 4 filter */
...
#define HRTIM_FLTINR2_FLT5SRC0         (1 << 2)                          /* Bit 2: Fault 5 source bit 0 */
#define HRTIM_FLTINR2_FLT5F_SHIFT      3                                 /* Bits 3-6: Fault 5 filter */
...
#define HRTIM_FLTINR2_FLT6E            (1 << 8)                          /* Bit 8: Fault 6 enable */
#define HRTIM_FLTINR2_FLT6P            (1 << 9)                          /* Bit 9: Fault 6 polarity */
#define HRTIM_FLTINR2_FLT6SRC0         (1 << 10)                         /* Bit 10: Fault 6 source bit 0 */
#define HRTIM_FLTINR2_FLT6F_SHIFT      11                                /* Bits 11-14: Fault 6 filter */
#define HRTIM_FLTINR2_FLT6F_MASK       (15 << HRTIM_FLTINR2_FLT6F_SHIFT)
#  define HRTIM_FLTINR2_FLT6F_NOFLT    (0 << HRTIM_FLTINR2_FLT6F_SHIFT)  /* 0000: No filter, FLT6 acts asynchronously */
#  define HRTIM_FLTINR2_FLT6F_HRTN2    (1 << HRTIM_FLTINR2_FLT6F_SHIFT)  /* 0001: fSAMPLING = fHRTIM, N=2 */
#  define HRTIM_FLTINR2_FLT6F_HRTN4    (2 << HRTIM_FLTINR2_FLT6F_SHIFT)  /* 0010: fSAMPLING = fHRTIM, N=4 */
#  define HRTIM_FLTINR2_FLT6F_HRTN8    (3 << HRTIM_FLTINR2_FLT6F_SHIFT)  /* 0011: fSAMPLING = fHRTIM, N=8 */
#  define HRTIM_FLTINR2_FLT6F_FLTS2N6  (4 << HRTIM_FLTINR2_FLT6F_SHIFT)  /* 0100: fSAMPLING = fFLTS/2, N=6 */
#  define HRTIM_FLTINR2_FLT6F_FLTS2N8  (5 << HRTIM_FLTINR2_FLT6F_SHIFT)  /* 0101: fSAMPLING = fFLTS/2, N=8 */
#  define HRTIM_FLTINR2_FLT6F_FLTS4N6  (6 << HRTIM_FLTINR2_FLT6F_SHIFT)  /* 0110: fSAMPLING = fFLTS/4, N=6 */
#  define HRTIM_FLTINR2_FLT6F_FLTS4N8  (7 << HRTIM_FLTINR2_FLT6F_SHIFT)  /* 0111: fSAMPLING = fFLTS/4, N=8 */
#  define HRTIM_FLTINR2_FLT6F_FLTS8N6  (8 << HRTIM_FLTINR2_FLT6F_SHIFT)  /* 1000: fSAMPLING = fFLTS/8, N=6 */
#  define HRTIM_FLTINR2_FLT6F_FLTS8N8  (9 << HRTIM_FLTINR2_FLT6F_SHIFT)  /* 1001: fSAMPLING = fFLTS/8, N=8 */
#  define HRTIM_FLTINR2_FLT6F_FLTS16N5 (10 << HRTIM_FLTINR2_FLT6F_SHIFT) /* 1010: fSAMPLING = fFLTS/16, N=5 */
#  define HRTIM_FLTINR2_FLT6F_FLTS16N6 (11 << HRTIM_FLTINR2_FLT6F_SHIFT) /* 1011: fSAMPLING = fFLTS/16, N=6 */
#  define HRTIM_FLTINR2_FLT6F_FLTS16N8 (12 << HRTIM_FLTINR2_FLT6F_SHIFT) /* 1100: fSAMPLING = fFLTS/16, N=8 */
#  define HRTIM_FLTINR2_FLT6F_FLTS32N5 (13 << HRTIM_FLTINR2_FLT6F_SHIFT) /* 1101: fSAMPLING = fFLTS/32, N=5 */
#  define HRTIM_FLTINR2_FLT6F_FLTS32N6 (14 << HRTIM_FLTINR2_FLT6F_SHIFT) /* 1110: fSAMPLING = fFLTS/32, N=6 */
#  define HRTIM_FLTINR2_FLT6F_FLTS32N8 (15 << HRTIM_FLTINR2_FLT6F_SHIFT) /* 1111: fSAMPLING = fFLTS/32, N=8 */
#define HRTIM_FLTINR2_FLT6LCK          (1 << 7)                          /* Bit 15: Fault 6 lock */
#define HRTIM_FLTINR2_FLT1SRC1         (1 << 16)                         /* Bit 16: Fault 1 source bit 1 */
#define HRTIM_FLTINR2_FLT2SRC1         (1 << 17)                         /* Bit 17: Fault 2 source bit 1 */
#define HRTIM_FLTINR2_FLT3SRC1         (1 << 18)                         /* Bit 18: Fault 3 source bit 1 */
#define HRTIM_FLTINR2_FLT4SRC1         (1 << 19)                         /* Bit 19: Fault 4 source bit 1 */
#define HRTIM_FLTINR2_FLT5SRC1         (1 << 20)                         /* Bit 20: Fault 5 source bit 1 */
#define HRTIM_FLTINR2_FLT6SRC1         (1 << 21)                         /* Bit 21: Fault 6 source bit 1 */
...
/* Common Burst DMA Timer X Update Register (Timer A-F) */

#define HRTIM_BDTxUPR_CR               (1 << 0)  /* Bit 0: HRTIM_TIMxCR register update enable */
#define HRTIM_BDTxUPR_ICR              (1 << 1)  /* Bit 1: HRTIM_TIMxICR register update enable */
#define HRTIM_BDTxUPR_DIER             (1 << 2)  /* Bit 2: HRTIM_TIMxDIER register update enable */
#define HRTIM_BDTxUPR_CNT              (1 << 3)  /* Bit 3: HRTIM_CNTxR register update enable */
#define HRTIM_BDTxUPR_PER              (1 << 4)  /* Bit 4: HRTIM_PERxR register update enable */
#define HRTIM_BDTxUPR_REP              (1 << 5)  /* Bit 5: HRTIM_REPxR register update enable */
#define HRTIM_BDTxUPR_CMP1             (1 << 6)  /* Bit 6: HRTIM_CMP1xR register update enable */
#define HRTIM_BDTxUPR_CMP2             (1 << 7)  /* Bit 7: HRTIM_CMP2xR register update enable */
#define HRTIM_BDTxUPR_CMP3             (1 << 8)  /* Bit 8: HRTIM_CMP3xR register update enable */
#define HRTIM_BDTxUPR_CMP4             (1 << 9)  /* Bit 9: HRTIM_CMP4xR register update enable */
#define HRTIM_BDTxUPR_DTR              (1 << 10) /* Bit 10: HRTIM_DTxR register update enable */
#define HRTIM_BDTxUPR_SET1R            (1 << 11) /* Bit 11: HRTIM_SET1xR register update enable */
#define HRTIM_BDTxUPR_RST1R            (1 << 12) /* Bit 12: HRTIM_RST1xR register update enable */
#define HRTIM_BDTxUPR_SET2R            (1 << 13) /* Bit 13: HRTIM_SET2xR register update enable */
#define HRTIM_BDTxUPR_RST2R            (1 << 14) /* Bit 14: HRTIM_RST2xR register update enable */
#define HRTIM_BDTxUPR_EEFR1            (1 << 15) /* Bit 15: HRTIM_EEFxR1 register update enable */
#define HRTIM_BDTxUPR_EEFR2            (1 << 16) /* Bit 16: HRTIM_EEFxR2 register update enable */
#define HRTIM_BDTxUPR_RSTR             (1 << 17) /* Bit 17: HRTIM_RSTxR register update enable */
#define HRTIM_BDTxUPR_CHPR             (1 << 18) /* Bit 18: HRTIM_CHRxR register update enable */
#define HRTIM_BDTxUPR_OUTR             (1 << 19) /* Bit 19: HRTIM_OUTxR register update enable */
#define HRTIM_BDTxUPR_FLTR             (1 << 20) /* Bit 20: HRTIM_FLTxR register update enable */
#define HRTIM_BDTxUPR_CR2              (1 << 21) /* Bit 21: HRTIM_TIMxCR2 register update enable */
#define HRTIM_BDTxUPR_EEFR3            (1 << 22) /* Bit 22: HRTIM_EEFxR3 register update enable */
...
/* Common ADC extended trigger register */

#define HRTIM_ADCER_ADC5TRG_SHIFT      0                                 /* Bits 0-4: ADC trigger 5 selection */
#define HRTIM_ADCER_ADC5TRG_MASK       (0x1f << HRTIM_ADCER_ADC5TRG_SHIFT)
#  define HRTIM_ADCER_ADC5TRG_MC1      (0 << HRTIM_ADCER_ADC5TRG_SHIFT)  /* 0: Trigger on master compare 1 */
#  define HRTIM_ADCER_ADC5TRG_MC2      (1 << HRTIM_ADCER_ADC5TRG_SHIFT)  /* 1: Trigger on master compare 2 */
#  define HRTIM_ADCER_ADC5TRG_MC3      (2 << HRTIM_ADCER_ADC5TRG_SHIFT)  /* 2: Trigger on master compare 3 */
#  define HRTIM_ADCER_ADC5TRG_MC4      (3 << HRTIM_ADCER_ADC5TRG_SHIFT)  /* 3: Trigger on master compare 4 */
#  define HRTIM_ADCER_ADC5TRG_MPER     (4 << HRTIM_ADCER_ADC5TRG_SHIFT)  /* 4: Trigger on  master period */
#  define HRTIM_ADCER_ADC5TRG_EE1      (5 << HRTIM_ADCER_ADC5TRG_SHIFT)  /* 5: Trigger on external event 1 */
#  define HRTIM_ADCER_ADC5TRG_EE2      (6 << HRTIM_ADCER_ADC5TRG_SHIFT)  /* 6: Trigger on external event 2 */
#  define HRTIM_ADCER_ADC5TRG_EE3      (7 << HRTIM_ADCER_ADC5TRG_SHIFT)  /* 7: Trigger on external event 3 */
#  define HRTIM_ADCER_ADC5TRG_EE4      (8 << HRTIM_ADCER_ADC5TRG_SHIFT)  /* 8: Trigger on external event 4 */
#  define HRTIM_ADCER_ADC5TRG_EE5      (9 << HRTIM_ADCER_ADC5TRG_SHIFT)  /* 9: Trigger on external event 5 */
#  define HRTIM_ADCER_ADC5TRG_TAC3     (10 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 10: Trigger on timer A compare 3 */
#  define HRTIM_ADCER_ADC5TRG_TAC4     (11 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 11: Trigger on timer A compare 4 */
#  define HRTIM_ADCER_ADC5TRG_TAPER    (12 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 12: Trigger on timer A period */
#  define HRTIM_ADCER_ADC5TRG_TARST    (13 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 13: Trigger on timer A reset and counter roll-over */
#  define HRTIM_ADCER_ADC5TRG_TBC3     (14 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 14: Trigger on timer B compare 3 */
#  define HRTIM_ADCER_ADC5TRG_TBC4     (15 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 15: Trigger on timer B compare 4 */
#  define HRTIM_ADCER_ADC5TRG_TBPER    (16 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 16: Trigger on timer B period */
#  define HRTIM_ADCER_ADC5TRG_TBRST    (17 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 17: Trigger on timer B reset and counter roll-over */
#  define HRTIM_ADCER_ADC5TRG_TCC3     (18 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 18: Trigger on timer C compare 3 */
#  define HRTIM_ADCER_ADC5TRG_TCC4     (19 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 19: Trigger on timer C compare 4 */
#  define HRTIM_ADCER_ADC5TRG_TCPER    (20 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 20: Trigger on timer C period */
#  define HRTIM_ADCER_ADC5TRG_TDC3     (21 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 21: Trigger on timer D compare 3 */
#  define HRTIM_ADCER_ADC5TRG_TDC4     (22 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 22: Trigger on timer D compare 4 */
#  define HRTIM_ADCER_ADC5TRG_TDPER    (23 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 23: Trigger on timer D period */
#  define HRTIM_ADCER_ADC5TRG_TEC3     (24 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 24: Trigger on timer E compare 3 */
#  define HRTIM_ADCER_ADC5TRG_TEC4     (25 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 25: Trigger on timer E compare 4 */
#  define HRTIM_ADCER_ADC5TRG_TEPER    (26 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 26: Trigger on timer E period */
#  define HRTIM_ADCER_ADC5TRG_TFC2     (27 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 27: Trigger on timer F compare 2 */
#  define HRTIM_ADCER_ADC5TRG_TFC3     (28 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 28: Trigger on timer F compare 3 */
#  define HRTIM_ADCER_ADC5TRG_TFC4     (29 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 29: Trigger on timer F compare 4 */
#  define HRTIM_ADCER_ADC5TRG_TFPER    (30 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 30: Trigger on timer F period */
#  define HRTIM_ADCER_ADC5TRG_TFRST    (31 << HRTIM_ADCER_ADC5TRG_SHIFT) /* 31: Trigger on timer F reset and counter roll-over */
#define HRTIM_ADCER_ADC6TRG_SHIFT      5                                 /* Bits 5-9: ADC trigger 6 selection */
#define HRTIM_ADCER_ADC6TRG_MASK       (0x1f << HRTIM_ADCER_ADC6TRG_SHIFT)
#  define HRTIM_ADCER_ADC6TRG_MC1      (0 << HRTIM_ADCER_ADC6TRG_SHIFT)  /* 0: Trigger on master compare 1 */
#  define HRTIM_ADCER_ADC6TRG_MC2      (1 << HRTIM_ADCER_ADC6TRG_SHIFT)  /* 1: Trigger on master compare 2 */
#  define HRTIM_ADCER_ADC6TRG_MC3      (2 << HRTIM_ADCER_ADC6TRG_SHIFT)  /* 2: Trigger on master compare 3 */
#  define HRTIM_ADCER_ADC6TRG_MC4      (3 << HRTIM_ADCER_ADC6TRG_SHIFT)  /* 3: Trigger on master compare 4 */
#  define HRTIM_ADCER_ADC6TRG_MPER     (4 << HRTIM_ADCER_ADC6TRG_SHIFT)  /* 4: Trigger on  master period */
#  define HRTIM_ADCER_ADC6TRG_EE6      (5 << HRTIM_ADCER_ADC6TRG_SHIFT)  /* 5: Trigger on external event 6 */
#  define HRTIM_ADCER_ADC6TRG_EE7      (6 << HRTIM_ADCER_ADC6TRG_SHIFT)  /* 6: Trigger on external event 7 */
#  define HRTIM_ADCER_ADC6TRG_EE8      (7 << HRTIM_ADCER_ADC6TRG_SHIFT)  /* 7: Trigger on external event 8 */
#  define HRTIM_ADCER_ADC6TRG_EE9      (8 << HRTIM_ADCER_ADC6TRG_SHIFT)  /* 8: Trigger on external event 9 */
#  define HRTIM_ADCER_ADC6TRG_EE10     (9 << HRTIM_ADCER_ADC6TRG_SHIFT)  /* 9: Trigger on external event 10 */
#  define HRTIM_ADCER_ADC6TRG_TAC2     (10 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 10: Trigger on timer A compare 2 */
#  define HRTIM_ADCER_ADC6TRG_TAC4     (11 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 11: Trigger on timer A compare 4 */
#  define HRTIM_ADCER_ADC6TRG_TAPER    (12 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 12: Trigger on timer A period */
#  define HRTIM_ADCER_ADC6TRG_TBC2     (13 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 13: Trigger on timer B compare 2 */
#  define HRTIM_ADCER_ADC6TRG_TBC4     (14 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 14: Trigger on timer B compare 4 */
#  define HRTIM_ADCER_ADC6TRG_TBPER    (15 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 15: Trigger on timer B period */
#  define HRTIM_ADCER_ADC6TRG_TCC2     (16 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 16: Trigger on timer C compare 2 */
#  define HRTIM_ADCER_ADC6TRG_TCC4     (17 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 17: Trigger on timer C compare 4 */
#  define HRTIM_ADCER_ADC6TRG_TCPER    (18 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 18: Trigger on timer C period */
#  define HRTIM_ADCER_ADC6TRG_TCRST    (19 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 19: Trigger on timer C reset and counter roll-over */
#  define HRTIM_ADCER_ADC6TRG_TDC2     (20 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 20: Trigger on timer D compare 2 */
#  define HRTIM_ADCER_ADC6TRG_TDC4     (21 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 21: Trigger on timer D compare 4 */
#  define HRTIM_ADCER_ADC6TRG_TDPER    (22 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 22: Trigger on timer D period */
#  define HRTIM_ADCER_ADC6TRG_TDRST    (23 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 23: Trigger on timer D reset and counter roll-over */
#  define HRTIM_ADCER_ADC6TRG_TEC2     (24 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 24: Trigger on timer E compare 2 */
#  define HRTIM_ADCER_ADC6TRG_TEC3     (25 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 25: Trigger on timer E compare 3 */
#  define HRTIM_ADCER_ADC6TRG_TEC4     (26 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 26: Trigger on timer E compare 4 */
#  define HRTIM_ADCER_ADC6TRG_TERST    (27 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 27: Trigger on timer E reset and counter roll-over */
#  define HRTIM_ADCER_ADC6TRG_TFC2     (28 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 28: Trigger on timer F compare 2 */
#  define HRTIM_ADCER_ADC6TRG_TFC3     (29 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 29: Trigger on timer F compare 3 */
#  define HRTIM_ADCER_ADC6TRG_TFC4     (30 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 30: Trigger on timer F compare 4 */
#  define HRTIM_ADCER_ADC6TRG_TFPER    (31 << HRTIM_ADCER_ADC6TRG_SHIFT) /* 31: Trigger on timer F period */
#define HRTIM_ADCER_ADC7TRG_SHIFT      10                                /* Bits 10-14: ADC trigger 7 selection */
#define HRTIM_ADCER_ADC7TRG_MASK       (0x1f << HRTIM_ADCER_ADC7TRG_SHIFT)
#  define HRTIM_ADCER_ADC7TRG_MC1      (0 << HRTIM_ADCER_ADC7TRG_SHIFT)  /* 0: Trigger on master compare 1 */
#  define HRTIM_ADCER_ADC7TRG_MC2      (1 << HRTIM_ADCER_ADC7TRG_SHIFT)  /* 1: Trigger on master compare 2 */
#  define HRTIM_ADCER_ADC7TRG_MC3      (2 << HRTIM_ADCER_ADC7TRG_SHIFT)  /* 2: Trigger on master compare 3 */
#  define HRTIM_ADCER_ADC7TRG_MC4      (3 << HRTIM_ADCER_ADC7TRG_SHIFT)  /* 3: Trigger on master compare 4 */
#  define HRTIM_ADCER_ADC7TRG_MPER     (4 << HRTIM_ADCER_ADC7TRG_SHIFT)  /* 4: Trigger on  master period */
#  define HRTIM_ADCER_ADC7TRG_EE1      (5 << HRTIM_ADCER_ADC7TRG_SHIFT)  /* 5: Trigger on external event 1 */
#  define HRTIM_ADCER_ADC7TRG_EE2      (6 << HRTIM_ADCER_ADC7TRG_SHIFT)  /* 6: Trigger on external event 2 */
#  define HRTIM_ADCER_ADC7TRG_EE3      (7 << HRTIM_ADCER_ADC7TRG_SHIFT)  /* 7: Trigger on external event 3 */
#  define HRTIM_ADCER_ADC7TRG_EE4      (8 << HRTIM_ADCER_ADC7TRG_SHIFT)  /* 8: Trigger on external event 4 */
#  define HRTIM_ADCER_ADC7TRG_EE5      (9 << HRTIM_ADCER_ADC7TRG_SHIFT)  /* 9: Trigger on external event 5 */
#  define HRTIM_ADCER_ADC7TRG_TAC3     (10 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 10: Trigger on timer A compare 3 */
#  define HRTIM_ADCER_ADC7TRG_TAC4     (11 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 11: Trigger on timer A compare 4 */
#  define HRTIM_ADCER_ADC7TRG_TAPER    (12 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 12: Trigger on timer A period */
#  define HRTIM_ADCER_ADC7TRG_TARST    (13 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 13: Trigger on timer A reset and counter roll-over */
#  define HRTIM_ADCER_ADC7TRG_TBC3     (14 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 14: Trigger on timer B compare 3 */
#  define HRTIM_ADCER_ADC7TRG_TBC4     (15 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 15: Trigger on timer B compare 4 */
#  define HRTIM_ADCER_ADC7TRG_TBPER    (16 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 16: Trigger on timer B period */
#  define HRTIM_ADCER_ADC7TRG_TBRST    (17 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 17: Trigger on timer B reset and counter roll-over */
#  define HRTIM_ADCER_ADC7TRG_TCC3     (18 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 18: Trigger on timer C compare 3 */
#  define HRTIM_ADCER_ADC7TRG_TCC4     (19 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 19: Trigger on timer C compare 4 */
#  define HRTIM_ADCER_ADC7TRG_TCPER    (20 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 20: Trigger on timer C period */
#  define HRTIM_ADCER_ADC7TRG_TDC3     (21 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 21: Trigger on timer D compare 3 */
#  define HRTIM_ADCER_ADC7TRG_TDC4     (22 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 22: Trigger on timer D compare 4 */
#  define HRTIM_ADCER_ADC7TRG_TDPER    (23 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 23: Trigger on timer D period */
#  define HRTIM_ADCER_ADC7TRG_TEC3     (24 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 24: Trigger on timer E compare 3 */
#  define HRTIM_ADCER_ADC7TRG_TEC4     (25 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 25: Trigger on timer E compare 4 */
#  define HRTIM_ADCER_ADC7TRG_TEPER    (26 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 26: Trigger on timer E period */
#  define HRTIM_ADCER_ADC7TRG_TFC2     (27 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 27: Trigger on timer F compare 2 */
#  define HRTIM_ADCER_ADC7TRG_TFC3     (28 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 28: Trigger on timer F compare 3 */
#  define HRTIM_ADCER_ADC7TRG_TFC4     (29 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 29: Trigger on timer F compare 4 */
#  define HRTIM_ADCER_ADC7TRG_TFPER    (30 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 30: Trigger on timer F period */
#  define HRTIM_ADCER_ADC7TRG_TFRST    (31 << HRTIM_ADCER_ADC7TRG_SHIFT) /* 31: Trigger on timer F reset and counter roll-over */
#define HRTIM_ADCER_ADC8TRG_SHIFT      16                                /* Bits 16-20: ADC trigger 8 selection */
#define HRTIM_ADCER_ADC8TRG_MASK       (0x1f << HRTIM_ADCER_ADC8TRG_SHIFT)
#  define HRTIM_ADCER_ADC8TRG_MC1      (0 << HRTIM_ADCER_ADC8TRG_SHIFT)  /* 0: Trigger on master compare 1 */
#  define HRTIM_ADCER_ADC8TRG_MC2      (1 << HRTIM_ADCER_ADC8TRG_SHIFT)  /* 1: Trigger on master compare 2 */
#  define HRTIM_ADCER_ADC8TRG_MC3      (2 << HRTIM_ADCER_ADC8TRG_SHIFT)  /* 2: Trigger on master compare 3 */
#  define HRTIM_ADCER_ADC8TRG_MC4      (3 << HRTIM_ADCER_ADC8TRG_SHIFT)  /* 3: Trigger on master compare 4 */
#  define HRTIM_ADCER_ADC8TRG_MPER     (4 << HRTIM_ADCER_ADC8TRG_SHIFT)  /* 4: Trigger on  master period */
#  define HRTIM_ADCER_ADC8TRG_EE6      (5 << HRTIM_ADCER_ADC8TRG_SHIFT)  /* 5: Trigger on external event 6 */
#  define HRTIM_ADCER_ADC8TRG_EE7      (6 << HRTIM_ADCER_ADC8TRG_SHIFT)  /* 6: Trigger on external event 7 */
#  define HRTIM_ADCER_ADC8TRG_EE8      (7 << HRTIM_ADCER_ADC8TRG_SHIFT)  /* 7: Trigger on external event 8 */
#  define HRTIM_ADCER_ADC8TRG_EE9      (8 << HRTIM_ADCER_ADC8TRG_SHIFT)  /* 8: Trigger on external event 9 */
#  define HRTIM_ADCER_ADC8TRG_EE10     (9 << HRTIM_ADCER_ADC8TRG_SHIFT)  /* 9: Trigger on external event 10 */
#  define HRTIM_ADCER_ADC8TRG_TAC2     (10 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 10: Trigger on timer A compare 2 */
#  define HRTIM_ADCER_ADC8TRG_TAC4     (11 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 11: Trigger on timer A compare 4 */
#  define HRTIM_ADCER_ADC8TRG_TAPER    (12 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 12: Trigger on timer A period */
#  define HRTIM_ADCER_ADC8TRG_TBC2     (13 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 13: Trigger on timer B compare 2 */
#  define HRTIM_ADCER_ADC8TRG_TBC4     (14 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 14: Trigger on timer B compare 4 */
#  define HRTIM_ADCER_ADC8TRG_TBPER    (15 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 15: Trigger on timer B period */
#  define HRTIM_ADCER_ADC8TRG_TCC2     (16 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 16: Trigger on timer C compare 2 */
#  define HRTIM_ADCER_ADC8TRG_TCC4     (17 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 17: Trigger on timer C compare 4 */
#  define HRTIM_ADCER_ADC8TRG_TCPER    (18 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 18: Trigger on timer C period */
#  define HRTIM_ADCER_ADC8TRG_TCRST    (19 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 19: Trigger on timer C reset and counter roll-over */
#  define HRTIM_ADCER_ADC8TRG_TDC2     (20 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 20: Trigger on timer D compare 2 */
#  define HRTIM_ADCER_ADC8TRG_TDC4     (21 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 21: Trigger on timer D compare 4 */
#  define HRTIM_ADCER_ADC8TRG_TDPER    (22 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 22: Trigger on timer D period */
#  define HRTIM_ADCER_ADC8TRG_TDRST    (23 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 23: Trigger on timer D reset and counter roll-over */
#  define HRTIM_ADCER_ADC8TRG_TEC2     (24 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 24: Trigger on timer E compare 2 */
#  define HRTIM_ADCER_ADC8TRG_TEC3     (25 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 25: Trigger on timer E compare 3 */
#  define HRTIM_ADCER_ADC8TRG_TEC4     (26 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 26: Trigger on timer E compare 4 */
#  define HRTIM_ADCER_ADC8TRG_TERST    (27 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 27: Trigger on timer E reset and counter roll-over */
#  define HRTIM_ADCER_ADC8TRG_TFC2     (28 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 28: Trigger on timer F compare 2 */
#  define HRTIM_ADCER_ADC8TRG_TFC3     (29 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 29: Trigger on timer F compare 3 */
#  define HRTIM_ADCER_ADC8TRG_TFC4     (30 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 30: Trigger on timer F compare 4 */
#  define HRTIM_ADCER_ADC8TRG_TFPER    (31 << HRTIM_ADCER_ADC8TRG_SHIFT) /* 31: Trigger on timer F period */
#define HRTIM_ADCER_ADC9TRG_SHIFT      21                                /* Bits 21-25: ADC trigger 9 selection */
#define HRTIM_ADCER_ADC9TRG_MASK       (0x1f << HRTIM_ADCER_ADC9TRG_SHIFT)
#  define HRTIM_ADCER_ADC9TRG_MC1      (0 << HRTIM_ADCER_ADC9TRG_SHIFT)  /* 0: Trigger on master compare 1 */
#  define HRTIM_ADCER_ADC9TRG_MC2      (1 << HRTIM_ADCER_ADC9TRG_SHIFT)  /* 1: Trigger on master compare 2 */
#  define HRTIM_ADCER_ADC9TRG_MC3      (2 << HRTIM_ADCER_ADC9TRG_SHIFT)  /* 2: Trigger on master compare 3 */
#  define HRTIM_ADCER_ADC9TRG_MC4      (3 << HRTIM_ADCER_ADC9TRG_SHIFT)  /* 3: Trigger on master compare 4 */
#  define HRTIM_ADCER_ADC9TRG_MPER     (4 << HRTIM_ADCER_ADC9TRG_SHIFT)  /* 4: Trigger on  master period */
#  define HRTIM_ADCER_ADC9TRG_EE1      (5 << HRTIM_ADCER_ADC9TRG_SHIFT)  /* 5: Trigger on external event 1 */
#  define HRTIM_ADCER_ADC9TRG_EE2      (6 << HRTIM_ADCER_ADC9TRG_SHIFT)  /* 6: Trigger on external event 2 */
#  define HRTIM_ADCER_ADC9TRG_EE3      (7 << HRTIM_ADCER_ADC9TRG_SHIFT)  /* 7: Trigger on external event 3 */
#  define HRTIM_ADCER_ADC9TRG_EE4      (8 << HRTIM_ADCER_ADC9TRG_SHIFT)  /* 8: Trigger on external event 4 */
#  define HRTIM_ADCER_ADC9TRG_EE5      (9 << HRTIM_ADCER_ADC9TRG_SHIFT)  /* 9: Trigger on external event 5 */
#  define HRTIM_ADCER_ADC9TRG_TAC3     (10 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 10: Trigger on timer A compare 3 */
#  define HRTIM_ADCER_ADC9TRG_TAC4     (11 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 11: Trigger on timer A compare 4 */
#  define HRTIM_ADCER_ADC9TRG_TAPER    (12 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 12: Trigger on timer A period */
#  define HRTIM_ADCER_ADC9TRG_TARST    (13 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 13: Trigger on timer A reset and counter roll-over */
#  define HRTIM_ADCER_ADC9TRG_TBC3     (14 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 14: Trigger on timer B compare 3 */
#  define HRTIM_ADCER_ADC9TRG_TBC4     (15 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 15: Trigger on timer B compare 4 */
#  define HRTIM_ADCER_ADC9TRG_TBPER    (16 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 16: Trigger on timer B period */
#  define HRTIM_ADCER_ADC9TRG_TBRST    (17 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 17: Trigger on timer B reset and counter roll-over */
#  define HRTIM_ADCER_ADC9TRG_TCC3     (18 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 18: Trigger on timer C compare 3 */
#  define HRTIM_ADCER_ADC9TRG_TCC4     (19 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 19: Trigger on timer C compare 4 */
#  define HRTIM_ADCER_ADC9TRG_TCPER    (20 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 20: Trigger on timer C period */
#  define HRTIM_ADCER_ADC9TRG_TDC3     (21 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 21: Trigger on timer D compare 3 */
#  define HRTIM_ADCER_ADC9TRG_TDC4     (22 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 22: Trigger on timer D compare 4 */
#  define HRTIM_ADCER_ADC9TRG_TDPER    (23 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 23: Trigger on timer D period */
#  define HRTIM_ADCER_ADC9TRG_TEC3     (24 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 24: Trigger on timer E compare 3 */
#  define HRTIM_ADCER_ADC9TRG_TEC4     (25 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 25: Trigger on timer E compare 4 */
#  define HRTIM_ADCER_ADC9TRG_TEPER    (26 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 26: Trigger on timer E period */
#  define HRTIM_ADCER_ADC9TRG_TFC2     (27 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 27: Trigger on timer F compare 2 */
#  define HRTIM_ADCER_ADC9TRG_TFC3     (28 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 28: Trigger on timer F compare 3 */
#  define HRTIM_ADCER_ADC9TRG_TFC4     (29 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 29: Trigger on timer F compare 4 */
#  define HRTIM_ADCER_ADC9TRG_TFPER    (30 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 30: Trigger on timer F period */
#  define HRTIM_ADCER_ADC9TRG_TFRST    (31 << HRTIM_ADCER_ADC9TRG_SHIFT) /* 31: Trigger on timer F reset and counter roll-over */
#define HRTIM_ADCER_ADC10TRG_SHIFT     26                                /* Bits 26-30: ADC trigger 10 selection */
#define HRTIM_ADCER_ADC10TRG_MASK      (0x1f << HRTIM_ADCER_ADC10TRG_SHIFT)
#  define HRTIM_ADCER_ADC10TRG_MC1     (0 << HRTIM_ADCER_ADC10TRG_SHIFT)  /* 0: Trigger on master compare 1 */
#  define HRTIM_ADCER_ADC10TRG_MC2     (1 << HRTIM_ADCER_ADC10TRG_SHIFT)  /* 1: Trigger on master compare 2 */
#  define HRTIM_ADCER_ADC10TRG_MC3     (2 << HRTIM_ADCER_ADC10TRG_SHIFT)  /* 2: Trigger on master compare 3 */
#  define HRTIM_ADCER_ADC10TRG_MC4     (3 << HRTIM_ADCER_ADC10TRG_SHIFT)  /* 3: Trigger on master compare 4 */
#  define HRTIM_ADCER_ADC10TRG_MPER    (4 << HRTIM_ADCER_ADC10TRG_SHIFT)  /* 4: Trigger on  master period */
#  define HRTIM_ADCER_ADC10TRG_EE6     (5 << HRTIM_ADCER_ADC10TRG_SHIFT)  /* 5: Trigger on external event 6 */
#  define HRTIM_ADCER_ADC10TRG_EE7     (6 << HRTIM_ADCER_ADC10TRG_SHIFT)  /* 6: Trigger on external event 7 */
#  define HRTIM_ADCER_ADC10TRG_EE8     (7 << HRTIM_ADCER_ADC10TRG_SHIFT)  /* 7: Trigger on external event 8 */
#  define HRTIM_ADCER_ADC10TRG_EE9     (8 << HRTIM_ADCER_ADC10TRG_SHIFT)  /* 8: Trigger on external event 9 */
#  define HRTIM_ADCER_ADC10TRG_EE10    (9 << HRTIM_ADCER_ADC10TRG_SHIFT)  /* 9: Trigger on external event 10 */
#  define HRTIM_ADCER_ADC10TRG_TAC2    (10 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 10: Trigger on timer A compare 2 */
#  define HRTIM_ADCER_ADC10TRG_TAC4    (11 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 11: Trigger on timer A compare 4 */
#  define HRTIM_ADCER_ADC10TRG_TAPER   (12 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 12: Trigger on timer A period */
#  define HRTIM_ADCER_ADC10TRG_TBC2    (13 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 13: Trigger on timer B compare 2 */
#  define HRTIM_ADCER_ADC10TRG_TBC4    (14 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 14: Trigger on timer B compare 4 */
#  define HRTIM_ADCER_ADC10TRG_TBPER   (15 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 15: Trigger on timer B period */
#  define HRTIM_ADCER_ADC10TRG_TCC2    (16 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 16: Trigger on timer C compare 2 */
#  define HRTIM_ADCER_ADC10TRG_TCC4    (17 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 17: Trigger on timer C compare 4 */
#  define HRTIM_ADCER_ADC10TRG_TCPER   (18 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 18: Trigger on timer C period */
#  define HRTIM_ADCER_ADC10TRG_TCRST   (19 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 19: Trigger on timer C reset and counter roll-over */
#  define HRTIM_ADCER_ADC10TRG_TDC2    (20 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 20: Trigger on timer D compare 2 */
#  define HRTIM_ADCER_ADC10TRG_TDC4    (21 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 21: Trigger on timer D compare 4 */
#  define HRTIM_ADCER_ADC10TRG_TDPER   (22 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 22: Trigger on timer D period */
#  define HRTIM_ADCER_ADC10TRG_TDRST   (23 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 23: Trigger on timer D reset and counter roll-over */
#  define HRTIM_ADCER_ADC10TRG_TEC2    (24 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 24: Trigger on timer E compare 2 */
#  define HRTIM_ADCER_ADC10TRG_TEC3    (25 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 25: Trigger on timer E compare 3 */
#  define HRTIM_ADCER_ADC10TRG_TEC4    (26 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 26: Trigger on timer E compare 4 */
#  define HRTIM_ADCER_ADC10TRG_TERST   (27 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 27: Trigger on timer E reset and counter roll-over */
#  define HRTIM_ADCER_ADC10TRG_TFC2    (28 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 28: Trigger on timer F compare 2 */
#  define HRTIM_ADCER_ADC10TRG_TFC3    (29 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 29: Trigger on timer F compare 3 */
#  define HRTIM_ADCER_ADC10TRG_TFC4    (30 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 30: Trigger on timer F compare 4 */
#  define HRTIM_ADCER_ADC10TRG_TFPER   (31 << HRTIM_ADCER_ADC10TRG_SHIFT) /* 31: Trigger on timer F period */

/* Common ADC trigger update register */

#define HRTIM_ADCUR_AD5USRC_SHIFT      0                                 /* Bits 0-2: ADC trigger 5 update source */
#define HRTIM_ADCUR_AD5USRC_MASK       (7 << HRTIM_ADCUR_AD5USRC_SHIFT)
#  define HRTIM_ADCUR_AD5USRC_MT       (0 << HRTIM_ADCUR_AD5USRC_SHIFT)  /* 0: Master timer */
#  define HRTIM_ADCUR_AD5USRC_TA       (1 << HRTIM_ADCUR_AD5USRC_SHIFT)  /* 1: Timer A */
#  define HRTIM_ADCUR_AD5USRC_TB       (2 << HRTIM_ADCUR_AD5USRC_SHIFT)  /* 2: Timer B */
#  define HRTIM_ADCUR_AD5USRC_TC       (3 << HRTIM_ADCUR_AD5USRC_SHIFT)  /* 3: Timer C */
#  define HRTIM_ADCUR_AD5USRC_TD       (4 << HRTIM_ADCUR_AD5USRC_SHIFT)  /* 4: Timer D */
#  define HRTIM_ADCUR_AD5USRC_TE       (5 << HRTIM_ADCUR_AD5USRC_SHIFT)  /* 5: Timer E */
#  define HRTIM_ADCUR_AD5USRC_TF       (6 << HRTIM_ADCUR_AD5USRC_SHIFT)  /* 6: Timer F */
#define HRTIM_ADCUR_AD6USRC_SHIFT      4                                 /* Bits 4-6: ADC trigger 6 update source */
#define HRTIM_ADCUR_AD6USRC_MASK       (7 << HRTIM_ADCUR_AD6USRC_SHIFT)
#  define HRTIM_ADCUR_AD6USRC_MT       (0 << HRTIM_ADCUR_AD6USRC_SHIFT)  /* 0: Master timer */
#  define HRTIM_ADCUR_AD6USRC_TA       (1 << HRTIM_ADCUR_AD6USRC_SHIFT)  /* 1: Timer A */
#  define HRTIM_ADCUR_AD6USRC_TB       (2 << HRTIM_ADCUR_AD6USRC_SHIFT)  /* 2: Timer B */
#  define HRTIM_ADCUR_AD6USRC_TC       (3 << HRTIM_ADCUR_AD6USRC_SHIFT)  /* 3: Timer C */
#  define HRTIM_ADCUR_AD6USRC_TD       (4 << HRTIM_ADCUR_AD6USRC_SHIFT)  /* 4: Timer D */
#  define HRTIM_ADCUR_AD6USRC_TE       (5 << HRTIM_ADCUR_AD6USRC_SHIFT)  /* 5: Timer E */
#  define HRTIM_ADCUR_AD6USRC_TF       (6 << HRTIM_ADCUR_AD6USRC_SHIFT)  /* 6: Timer F */
#define HRTIM_ADCUR_AD7USRC_SHIFT      8                                 /* Bits 8-10: ADC trigger 7 update source */
#define HRTIM_ADCUR_AD7USRC_MASK       (7 << HRTIM_ADCUR_AD7USRC_SHIFT)
#  define HRTIM_ADCUR_AD7USRC_MT       (0 << HRTIM_ADCUR_AD7USRC_SHIFT)  /* 0: Master timer */
#  define HRTIM_ADCUR_AD7USRC_TA       (1 << HRTIM_ADCUR_AD7USRC_SHIFT)  /* 1: Timer A */
#  define HRTIM_ADCUR_AD7USRC_TB       (2 << HRTIM_ADCUR_AD7USRC_SHIFT)  /* 2: Timer B */
#  define HRTIM_ADCUR_AD7USRC_TC       (3 << HRTIM_ADCUR_AD7USRC_SHIFT)  /* 3: Timer C */
#  define HRTIM_ADCUR_AD7USRC_TD       (4 << HRTIM_ADCUR_AD7USRC_SHIFT)  /* 4: Timer D */
#  define HRTIM_ADCUR_AD7USRC_TE       (5 << HRTIM_ADCUR_AD7USRC_SHIFT)  /* 5: Timer E */
#  define HRTIM_ADCUR_AD7USRC_TF       (6 << HRTIM_ADCUR_AD7USRC_SHIFT)  /* 6: Timer F */
#define HRTIM_ADCUR_AD8USRC_SHIFT      12                                /* Bits 12-14: ADC trigger 8 update source */
#define HRTIM_ADCUR_AD8USRC_MASK       (7 << HRTIM_ADCUR_AD8USRC_SHIFT)
#  define HRTIM_ADCUR_AD8USRC_MT       (0 << HRTIM_ADCUR_AD8USRC_SHIFT)  /* 0: Master timer */
#  define HRTIM_ADCUR_AD8USRC_TA       (1 << HRTIM_ADCUR_AD8USRC_SHIFT)  /* 1: Timer A */
#  define HRTIM_ADCUR_AD8USRC_TB       (2 << HRTIM_ADCUR_AD8USRC_SHIFT)  /* 2: Timer B */
#  define HRTIM_ADCUR_AD8USRC_TC       (3 << HRTIM_ADCUR_AD8USRC_SHIFT)  /* 3: Timer C */
#  define HRTIM_ADCUR_AD8USRC_TD       (4 << HRTIM_ADCUR_AD8USRC_SHIFT)  /* 4: Timer D */
#  define HRTIM_ADCUR_AD8USRC_TE       (5 << HRTIM_ADCUR_AD8USRC_SHIFT)  /* 5: Timer E */
#  define HRTIM_ADCUR_AD8USRC_TF       (6 << HRTIM_ADCUR_AD8USRC_SHIFT)  /* 6: Timer F */
#define HRTIM_ADCUR_AD9USRC_SHIFT      16                                /* Bits 16-18: ADC trigger 9 update source */
#define HRTIM_ADCUR_AD9USRC_MASK       (7 << HRTIM_ADCUR_AD9USRC_SHIFT)
#  define HRTIM_ADCUR_AD9USRC_MT       (0 << HRTIM_ADCUR_AD9USRC_SHIFT)  /* 0: Master timer */
#  define HRTIM_ADCUR_AD9USRC_TA       (1 << HRTIM_ADCUR_AD9USRC_SHIFT)  /* 1: Timer A */
#  define HRTIM_ADCUR_AD9USRC_TB       (2 << HRTIM_ADCUR_AD9USRC_SHIFT)  /* 2: Timer B */
#  define HRTIM_ADCUR_AD9USRC_TC       (3 << HRTIM_ADCUR_AD9USRC_SHIFT)  /* 3: Timer C */
#  define HRTIM_ADCUR_AD9USRC_TD       (4 << HRTIM_ADCUR_AD9USRC_SHIFT)  /* 4: Timer D */
#  define HRTIM_ADCUR_AD9USRC_TE       (5 << HRTIM_ADCUR_AD9USRC_SHIFT)  /* 5: Timer E */
#  define HRTIM_ADCUR_AD9USRC_TF       (6 << HRTIM_ADCUR_AD9USRC_SHIFT)  /* 6: Timer F */
#define HRTIM_ADCUR_AD10USRC_SHIFT     20                                /* Bits 20-22: ADC trigger 10 update source */
#define HRTIM_ADCUR_AD10USRC_MASK      (7 << HRTIM_ADCUR_AD10USRC_SHIFT)
#  define HRTIM_ADCUR_AD10USRC_MT      (0 << HRTIM_ADCUR_AD10USRC_SHIFT) /* 0: Master timer */
#  define HRTIM_ADCUR_AD10USRC_TA      (1 << HRTIM_ADCUR_AD10USRC_SHIFT) /* 1: Timer A */
#  define HRTIM_ADCUR_AD10USRC_TB      (2 << HRTIM_ADCUR_AD10USRC_SHIFT) /* 2: Timer B */
#  define HRTIM_ADCUR_AD10USRC_TC      (3 << HRTIM_ADCUR_AD10USRC_SHIFT) /* 3: Timer C */
#  define HRTIM_ADCUR_AD10USRC_TD      (4 << HRTIM_ADCUR_AD10USRC_SHIFT) /* 4: Timer D */
#  define HRTIM_ADCUR_AD10USRC_TE      (5 << HRTIM_ADCUR_AD10USRC_SHIFT) /* 5: Timer E */
#  define HRTIM_ADCUR_AD10USRC_TF      (6 << HRTIM_ADCUR_AD10USRC_SHIFT) /* 6: Timer F */

/* Common ADC post scaler register 1 */

#define HRTIM_ADCPS1_ADC1PSC_SHIFT     0                                 /* Bits 0-4: ADC 1 post scaler */
#define HRTIM_ADCPS1_ADC1PSC_MASK      (0x1f << HRTIM_ADCPS1_ADC1PSC_SHIFT)
#define HRTIM_ADCPS1_ADC2PSC_SHIFT     6                                 /* Bits 6-10: ADC 2 post scaler */
#define HRTIM_ADCPS1_ADC2PSC_MASK      (0x1f << HRTIM_ADCPS1_ADC2PSC_SHIFT)
#define HRTIM_ADCPS1_ADC3PSC_SHIFT     12                                /* Bits 12-16: ADC 3 post scaler */
#define HRTIM_ADCPS1_ADC3PSC_MASK      (0x1f << HRTIM_ADCPS1_ADC3PSC_SHIFT)
#define HRTIM_ADCPS1_ADC4PSC_SHIFT     18                                /* Bits 18-22: ADC 4 post scaler */
#define HRTIM_ADCPS1_ADC4PSC_MASK      (0x1f << HRTIM_ADCPS1_ADC4PSC_SHIFT)
#define HRTIM_ADCPS1_ADC5PSC_SHIFT     24                                /* Bits 24-28: ADC 5 post scaler */
#define HRTIM_ADCPS1_ADC5PSC_MASK      (0x1f << HRTIM_ADCPS1_ADC5PSC_SHIFT)

/* Common ADC post scaler register 2 */

#define HRTIM_ADCPS2_ADC6PSC_SHIFT     0                                 /* Bits 0-4: ADC 6 post scaler */
#define HRTIM_ADCPS2_ADC6PSC_MASK      (0x1f << HRTIM_ADCPS2_ADC6PSC_SHIFT)
#define HRTIM_ADCPS2_ADC7PSC_SHIFT     6                                 /* Bits 6-10: ADC 7 post scaler */
#define HRTIM_ADCPS2_ADC7PSC_MASK      (0x1f << HRTIM_ADCPS2_ADC7PSC_SHIFT)
#define HRTIM_ADCPS2_ADC8PSC_SHIFT     12                                /* Bits 12-16: ADC 8 post scaler */
#define HRTIM_ADCPS2_ADC8PSC_MASK      (0x1f << HRTIM_ADCPS2_ADC8PSC_SHIFT)
#define HRTIM_ADCPS2_ADC9PSC_SHIFT     18                                /* Bits 18-22: ADC 9 post scaler */
#define HRTIM_ADCPS2_ADC9PSC_MASK      (0x1f << HRTIM_ADCPS2_ADC9PSC_SHIFT)
#define HRTIM_ADCPS2_ADC10PSC_SHIFT    24                                /* Bits :24-28 ADC 10 post scaler */
#define HRTIM_ADCPS2_ADC10PSC_MASK     (0x1f << HRTIM_ADCPS2_ADC10PSC_SHIFT)

/* Common HRTIM fault input register 3 */

#define HRTIM_FLTINR3_FLT1BLKE         (1 << 0)                          /* Bit 0: Fault 1 blanking enable */
#define HRTIM_FLTINR3_FLT1BLKS         (1 << 1)                          /* Bit 1: Fault 1 blanking source */
#define HRTIM_FLTINR3_FLT1CNT_SHIFT    2                                 /* Bits 2-5: Fault 1 counter */
#define HRTIM_FLTINR3_FLT1CNT_MASK     (0xf << HRTIM_FLTINR3_FLT1CNT_SHIFT)
#define HRTIM_FLTINR3_FLT1CRES         (1 << 6)                          /* Bit 6: Fault 1 counter reset */
#define HRTIM_FLTINR3_FLT1RSTM         (1 << 7)                          /* Bit 7: Fault 1 reset mode */
#define HRTIM_FLTINR3_FLT2BLKE         (1 << 8)                          /* Bit 8: Fault 2 blanking enable */
#define HRTIM_FLTINR3_FLT2BLKS         (1 << 9)                          /* Bit 9: Fault 2 blanking source */
#define HRTIM_FLTINR3_FLT2CNT_SHIFT    10                                /* Bits 10-13: Fault 2 counter */
#define HRTIM_FLTINR3_FLT2CNT_MASK     (0xf << HRTIM_FLTINR3_FLT2CNT_SHIFT)
#define HRTIM_FLTINR3_FLT2CRES         (1 << 14)                         /* Bit 14: Fault 2 counter reset */
#define HRTIM_FLTINR3_FLT2RSTM         (1 << 15)                         /* Bit 15: Fault 2 reset mode */
#define HRTIM_FLTINR3_FLT3BLKE         (1 << 16)                         /* Bit 16: Fault 3 blanking enable */
#define HRTIM_FLTINR3_FLT3BLKS         (1 << 17)                         /* Bit 17: Fault 3 blanking source */
#define HRTIM_FLTINR3_FLT3CNT_SHIFT    18                                /* Bits 18-21: Fault 3 counter */
#define HRTIM_FLTINR3_FLT3CNT_MASK     (0xf << HRTIM_FLTINR3_FLT3CNT_SHIFT)
#define HRTIM_FLTINR3_FLT3CRES         (1 << 22)                         /* Bit 22: Fault 3 counter reset */
#define HRTIM_FLTINR3_FLT3RSTM         (1 << 23)                         /* Bit 23: Fault 3 reset mode */
#define HRTIM_FLTINR3_FLT4BLKE         (1 << 24)                         /* Bit 24: Fault 4 blanking enable */
#define HRTIM_FLTINR3_FLT4BLKS         (1 << 25)                         /* Bit 25: Fault 4 blanking source */
#define HRTIM_FLTINR3_FLT4CNT_SHIFT    26                                /* Bits 26-29: Fault 4 counter */
#define HRTIM_FLTINR3_FLT4CNT_MASK     (0xf << HRTIM_FLTINR3_FLT4CNT_SHIFT)
#define HRTIM_FLTINR3_FLT4CRES         (1 << 30)                         /* Bit 30: Fault 4 counter reset */
#define HRTIM_FLTINR3_FLT4RSTM         (1 << 31)                         /* Bit 31: Fault 4 reset mode */

/* Common HRTIM fault input register 4 */

#define HRTIM_FLTINR3_FLT5BLKE         (1 << 0)                          /* Bit 0: Fault 5 blanking enable */
#define HRTIM_FLTINR3_FLT5BLKS         (1 << 1)                          /* Bit 1: Fault 5 blanking source */
#define HRTIM_FLTINR3_FLT5CNT_SHIFT    2                                 /* Bits 2-5: Fault 5 counter */
#define HRTIM_FLTINR3_FLT5CNT_MASK     (0xf << HRTIM_FLTINR3_FLT5CNT_SHIFT)
#define HRTIM_FLTINR3_FLT5CRES         (1 << 6)                          /* Bit 6: Fault 5 counter reset */
#define HRTIM_FLTINR3_FLT5RSTM         (1 << 7)                          /* Bit 7: Fault 5 reset mode */
#define HRTIM_FLTINR3_FLT6BLKE         (1 << 8)                          /* Bit 8: Fault 6 blanking enable */
#define HRTIM_FLTINR3_FLT6BLKS         (1 << 9)                          /* Bit 9: Fault 6 blanking source */
#define HRTIM_FLTINR3_FLT6CNT_SHIFT    10                                /* Bits 10-13: Fault 6 counter */
#define HRTIM_FLTINR3_FLT6CNT_MASK     (0xf << HRTIM_FLTINR3_FLT6CNT_SHIFT)
#define HRTIM_FLTINR3_FLT6CRES         (1 << 14)                         /* Bit 14: Fault 6 counter reset */
#define HRTIM_FLTINR3_FLT6RSTM         (1 << 15)                         /* Bit 15: Fault 6 reset mode */

#endif /* __ARCH_ARM_SRC_STM32_HARDWARE_STM32G47XXX_HRTIM_H */
