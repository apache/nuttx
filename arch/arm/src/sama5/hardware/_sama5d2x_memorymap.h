...
#  define SAM_MCAN0_OFFSET       0x00054000 /* 0x00054000-0x00057fff: CAN0 */
...
#  define SAM_MCAN1_OFFSET       0x00050000 /* 0x00050000-0x00053fff: CAN1 */
...
#define SAM_PIOA_VBASE           (SAM_PERIPHC_VSECTION+SAM_PIO_OFFSET)
#define SAM_PIOB_VBASE           (SAM_PERIPHC_VSECTION+SAM_PIO_OFFSET)
#define SAM_PIOC_VBASE           (SAM_PERIPHC_VSECTION+SAM_PIO_OFFSET)
#define SAM_PIOD_VBASE           (SAM_PERIPHC_VSECTION+SAM_PIO_OFFSET)
