...
#define FLEXCOM_SPI_MR_PCS_MASK           (3 << FLEXCOM_SPI_MR_PCS_SHIFT) /* Only 2 chip selects */
#define FLEXCOM_SPI_MR_PCS0               (0 << FLEXCOM_SPI_MR_PCS_SHIFT) /* NPCS[1:0] = 10 */
#define FLEXCOM_SPI_MR_PCS1               (1 << FLEXCOM_SPI_MR_PCS_SHIFT) /* NPCS[1:0] = 01 */
