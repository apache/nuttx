...
GU32 *g_punGh3x2xAlgoMemBufferPointer;
GU16 GH3X2X_ReadAlgorithmConfigWithVirtualReg(GU16 usVirtualRegAddr){return 0;}
void GH3X2X_WriteAlgorithmConfigWithVirtualReg(GU16 usVirtualRegAddr, GU16 usVirtualRegValue){}
GS8 GH3X2X_AlgoMemConfig(GU32 unMemSize){ return GH3X2X_RET_OK;}
void GH3X2X_AlgoMemDeinit(void){}
GS8 GH3X2X_AlgoMemInit(void){ return GH3X2X_RET_OK;}
GS8 GH3X2X_GetRawdataForAlgorithm(GU8 *puchPackageDataBuffer ,GU16 usReadByteNum){return GH3X2X_RET_OK;}


void GH3x2xAlgoVersion(GU32 unFunctionID, GCHAR version[100]){}

void GH3X2X_CacheIncompleteRawdataForAlgorithm(GU32 *punIncompleteMark, GU32 *punIncompleteRawdataArr,
                                        GU8 *puchRawdataFifo, GU16 usRawdataFifoCnt,
                                        GU16 *pusRawdataByteIndexArr, GU8 uchChannelCnt, GU8 *puchChannelMapArray){}
GS8 GH3X2X_GetRawdataInfo(GF32 *pfGsFloatIncVal, GU16 *pusChannelDataCnt, GU16 *pusDataCntMax,
                                 GU32 unIncompleteMark, GU16 usFifoLength, GU8 *puchDataBuffer,
                                 GU8 uchChannelCnt, GU8 *puchChannelMapArray, GU16 usReadGsensorArrCnt){return GH3X2X_RET_OK;}


void GH3X2X_MemFree(void* mem_addr){}
void* GH3X2X_MemMalloc(GS32 nSize){return 0;}


void Gh3x2xSleepFlagSet(GU8 uchSleepFlag){}
GU8 GH3x2xSleepFlagGet(void){return 0;}
...
void GH3x2xBpAlgoInitSetting(GU8 *puchRespondBuffer){}
#endif
