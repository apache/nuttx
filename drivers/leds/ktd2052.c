...
static int ktd2052_write_regs(FAR struct ktd2052_dev_s *priv,
                              uint8_t reg_addr, const uint8_t *reg_vals,
                              uint8_t count);
...
static int ktd2052_setup_pattern(FAR struct ktd2052_dev_s *priv,
                                 uint8_t slots, uint8_t duration,
                                     ...
                                     uint8_t slots)
{
  ...
  return ktd2052_write_regs(priv,
                            KTD2052_PG_RGB1_REG + (module - 1), &slots, 1);
}
      ...
      case KTDIOSETPATTERN:
        {
          ...
          ret = ktd2052_setup_pattern(priv,
                                      pattern->slots,
                                      pattern->duration,
                                      pattern->fade_rate1,
                                      pattern->watchdog);
