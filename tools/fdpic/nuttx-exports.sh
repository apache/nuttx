...
if [ -z "$CC" ]; then
    echo "nuttx-exports: no compiler found; set CC." >&2
    exit 1
fi
...
then
    echo "nuttx-exports: failed to preprocess $SYMTAB with $CC:" >&2
