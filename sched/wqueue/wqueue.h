...
{
  struct list_node q;         /* The queue of pending periodical work. */
  ...
  int16_t          wait_count;
  struct wdog_s    timer;     /* The timer used for requeued */
...
void work_insert_queue(FAR struct kwork_wqueue_s *wqueue,
