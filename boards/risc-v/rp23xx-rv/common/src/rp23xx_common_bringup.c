/****************************************************************************
 * boards/risc-v/rp23xx-rv/common/src/rp23xx_common_bringup.c
 *
...
#if defined(CONFIG_ADC) && defined(CONFIG_RP23XX_RV_ADC)
...
#if defined(CONFIG_RP23XX_RV_ROMFS_ROMDISK_DEVNAME)
#  include <rp23xx_romfsimg.h>
#endif

#if defined(CONFIG_RP23XX_RV_BOARD_HAS_WS2812) && defined(CONFIG_WS2812)
...
#ifdef CONFIG_RP23XX_RV_SPI_DRIVER
...
#ifdef CONFIG_RP23XX_RV_PWM
#  ifdef CONFIG_RP23XX_RV_PWM0
#    if defined(CONFIG_PWM_NCHANNELS) && CONFIG_PWM_NCHANNELS == 2
  ret = rp23xx_pwmdev_initialize(0,
                                 CONFIG_RP23XX_RV_PWM0A_GPIO,
                                 CONFIG_RP23XX_RV_PWM0B_GPIO,
                                 (0
#      ifdef CONFIG_RP23XX_RV_PWM0A_INVERT
                                  | RP23XX_RV_PWM_CSR_A_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM0B_INVERT
                                  | RP23XX_RV_PWM_CSR_B_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM0_PHASE_CORRECT
...
#  ifdef CONFIG_RP23XX_RV_PWM1
#    if defined(CONFIG_PWM_NCHANNELS) && CONFIG_PWM_NCHANNELS == 2
  ret = rp23xx_pwmdev_initialize(1,
                                 CONFIG_RP23XX_RV_PWM1A_GPIO,
                                 CONFIG_RP23XX_RV_PWM1B_GPIO,
                                 (0
#      ifdef CONFIG_RP23XX_RV_PWM1A_INVERT
                                  | RP23XX_RV_PWM_CSR_A_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM1B_INVERT
                                  | RP23XX_RV_PWM_CSR_B_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM1_PHASE_CORRECT
                                  | RP23XX_RV_PWM_CSR_PH_CORRECT
#      endif
                                 ));
#    else
...
#  ifdef CONFIG_RP23XX_RV_PWM2
#    if defined(CONFIG_PWM_NCHANNELS) && CONFIG_PWM_NCHANNELS == 2
  ret = rp23xx_pwmdev_initialize(2,
                                 CONFIG_RP23XX_RV_PWM2A_GPIO,
                                 CONFIG_RP23XX_RV_PWM2B_GPIO,
                                 (0
#      ifdef CONFIG_RP23XX_RV_PWM2A_INVERT
                                  | RP23XX_RV_PWM_CSR_A_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM2B_INVERT
                                  | RP23XX_RV_PWM_CSR_B_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM2_PHASE_CORRECT
                                  | RP23XX_RV_PWM_CSR_PH_CORRECT
#      endif
                                 ));
#    else
...
#  ifdef CONFIG_RP23XX_RV_PWM3
#    if defined(CONFIG_PWM_NCHANNELS) && CONFIG_PWM_NCHANNELS == 2
  ret = rp23xx_pwmdev_initialize(3,
                                 CONFIG_RP23XX_RV_PWM3A_GPIO,
                                 CONFIG_RP23XX_RV_PWM3B_GPIO,
                                 (0
#      ifdef CONFIG_RP23XX_RV_PWM3A_INVERT
                                  | RP23XX_RV_PWM_CSR_A_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM3B_INVERT
                                  | RP23XX_RV_PWM_CSR_B_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM3_PHASE_CORRECT
                                  | RP23XX_RV_PWM_CSR_PH_CORRECT
#      endif
                                 ));
#    else
...
#  ifdef CONFIG_RP23XX_RV_PWM4
#    if defined(CONFIG_PWM_NCHANNELS) && CONFIG_PWM_NCHANNELS == 2
  ret = rp23xx_pwmdev_initialize(4,
                                 CONFIG_RP23XX_RV_PWM4A_GPIO,
                                 CONFIG_RP23XX_RV_PWM4B_GPIO,
                                 (0
#      ifdef CONFIG_RP23XX_RV_PWM4A_INVERT
                                  | RP23XX_RV_PWM_CSR_A_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM4B_INVERT
                                  | RP23XX_RV_PWM_CSR_B_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM4_PHASE_CORRECT
                                  | RP23XX_RV_PWM_CSR_PH_CORRECT
#      endif
                                 ));
#    else
...
#  ifdef CONFIG_RP23XX_RV_PWM5
#    if defined(CONFIG_PWM_NCHANNELS) && CONFIG_PWM_NCHANNELS == 2
  ret = rp23xx_pwmdev_initialize(5,
                                 CONFIG_RP23XX_RV_PWM5A_GPIO,
                                 CONFIG_RP23XX_RV_PWM5B_GPIO,
                                 (0
#      ifdef CONFIG_RP23XX_RV_PWM5A_INVERT
                                  | RP23XX_RV_PWM_CSR_A_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM5B_INVERT
                                  | RP23XX_RV_PWM_CSR_B_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM5_PHASE_CORRECT
                                  | RP23XX_RV_PWM_CSR_PH_CORRECT
#      endif
                                 ));
#  else
...
#  ifdef CONFIG_RP23XX_RV_PWM6
#    if defined(CONFIG_PWM_NCHANNELS) && CONFIG_PWM_NCHANNELS == 2
  ret = rp23xx_pwmdev_initialize(6,
                                 CONFIG_RP23XX_RV_PWM6A_GPIO,
                                 CONFIG_RP23XX_RV_PWM6B_GPIO,
                                 (0
#      ifdef CONFIG_RP23XX_RV_PWM6A_INVERT
                                  | RP23XX_RV_PWM_CSR_A_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM6B_INVERT
                                  | RP23XX_RV_PWM_CSR_B_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM6_PHASE_CORRECT
                                  | RP23XX_RV_PWM_CSR_PH_CORRECT
#      endif
                                 ));
#    else
...
#  ifdef CONFIG_RP23XX_RV_PWM7
#    if defined(CONFIG_PWM_NCHANNELS) && CONFIG_PWM_NCHANNELS == 2
  ret = rp23xx_pwmdev_initialize(7,
                                 CONFIG_RP23XX_RV_PWM7A_GPIO,
                                 CONFIG_RP23XX_RV_PWM7B_GPIO,
                                 (0
#      ifdef CONFIG_RP23XX_RV_PWM7A_INVERT
                                  | RP23XX_RV_PWM_CSR_A_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM7B_INVERT
                                  | RP23XX_RV_PWM_CSR_B_INV
#      endif
#      ifdef CONFIG_RP23XX_RV_PWM7_PHASE_CORRECT
                                  | RP23XX_RV_PWM_CSR_PH_CORRECT
#      endif
                                 ));
#    else
...
#  endif
  ...
  ret = board_spisd_initialize(0, CONFIG_RP23XX_RV_SPISD_SPI_CH);
  if (ret < 0)
    {
...
#  ifdef CONFIG_RP23XX_RV_ADC_CHANNEL0
#    define ADC_0 true
#  else
#    define ADC_0 false
#  endif

#  ifdef CONFIG_RP23XX_RV_ADC_CHANNEL1
#    define ADC_1 true
#  else
#    define ADC_1 false
#  endif

#  ifdef CONFIG_RP23XX_RV_ADC_CHANNEL2
#    define ADC_2 true
#  else
#    define ADC_2 false
#  endif

#  ifdef CONFIG_RP23XX_RV_ADC_CHANNEL3
#    define ADC_3 true
#  else
#    define ADC_3 false
#  endif

#  ifdef CONFIG_RP23XX_RV_ADC_TEMPERATURE
...
#  endif
...
#endif /* defined(CONFIG_ADC) && defined(CONFIG_RP23XX_RV_ADC) */
  ...
  if (rp23xx_ws2812_setup("/dev/leds0",
                          CONFIG_RP23XX_RV_WS2812_GPIO_PIN,
                          CONFIG_RP23XX_RV_WS2812_PWR_GPIO,
