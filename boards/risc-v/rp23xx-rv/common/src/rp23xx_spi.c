/****************************************************************************
 * boards/risc-v/rp23xx-rv/common/src/rp23xx_spi.c
 *
                       ...
                       bool selected)
{
  ...
  rp23xx_gpio_put(CONFIG_RP23XX_RV_SPI0_CS_GPIO, !selected);
}
...
#  if defined(CONFIG_RP23XX_RV_SPISD) && (CONFIG_RP23XX_RV_SPISD_SPI_CH == 0)
  ...
  if (devid == SPIDEV_DISPLAY(0))
    {
      ...
      rp23xx_gpio_put(CONFIG_RP23XX_RV_SPI0_RX_GPIO, !cmd);
                       ...
                       bool selected)
{
  ...
  rp23xx_gpio_put(CONFIG_RP23XX_RV_SPI1_CS_GPIO, !selected);
}
...
#  if defined(CONFIG_RP23XX_RV_SPISD) && (CONFIG_RP23XX_RV_SPISD_SPI_CH == 1)
  ret = board_spisd_status(dev, devid);
#  endif
  return ret;
}
  ...
  if (devid == SPIDEV_DISPLAY(0))
    {
      ...
      rp23xx_gpio_put(CONFIG_RP23XX_RV_SPI1_RX_GPIO, !cmd);
