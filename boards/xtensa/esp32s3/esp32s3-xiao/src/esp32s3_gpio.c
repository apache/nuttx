/****************************************************************************
 * boards/xtensa/esp32s3/esp32s3-xiao/src/esp32s3_gpio.c
 *
...
/* Output pins. GPIO02 is used as an example, any other outputs could be
 * used.
 */

#define GPIO_OUT1    2

/* Input pins. GPIO01 is used as an example, any other inputs could be
 * used.
 */

#define GPIO_IN1     1

/* Interrupt pins. GPIO03 is used as an example, any other inputs could be
 * used.
 */

#define GPIO_IRQPIN1 3
