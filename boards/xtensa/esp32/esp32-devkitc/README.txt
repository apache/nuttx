README for the Espressif ESP32 DevkitC board (V4)
=================================================
...
==========
  ...
  NOTE 2: Heap ends at the top of dram_0_seg
...
=====================
  ...
  source tree at nuttx/boards/xtensa/esp32/esp32-devkitc/scripts/esp32.cfg .  It has these
  modifications:
...
==============
  ...
  can be selected as follow:
    ...
    tools/configure.sh esp32-devkitc:<subdir>
    make oldconfig
  ...
  instead of configure.sh:
    ...
    configure.bat esp32-devkitc\<subdir>
...
NOTES:
  ...
  3. By default, these configurations assume a 40MHz crystal on-
     ...
     CONFIG_ESP32_DEVKITC_XTAL_40MZ=y
     # CONFIG_ESP32_DEVKITC_XTAL_26MHz is not set

  4. Default configurations are set to run from FLASH.  You will need
     to set CONFIG_ESP32_DEVKITC_RUN_IRAM=y for now (see the " Executing
