...
#    define CONFIG_STM32_SPI1_TEST_MODE SPIDEV_MODE0
#  elif defined(CONFIG_STM32_SPI1_TEST_MODE1)
#    define CONFIG_STM32_SPI1_TEST_MODE SPIDEV_MODE1
#  elif defined(CONFIG_STM32_SPI1_TEST_MODE2)
#    define CONFIG_STM32_SPI1_TEST_MODE SPIDEV_MODE2
#  elif defined(CONFIG_STM32_SPI1_TEST_MODE3)
#    define CONFIG_STM32_SPI1_TEST_MODE SPIDEV_MODE3
#  else
#    error "No CONFIG_STM32_SPI1_TEST_MODEx defined"
#  endif
#endif

#if defined(CONFIG_STM32_SPI2_TEST)
#  if defined(CONFIG_STM32_SPI2_TEST_MODE0)
#    define CONFIG_STM32_SPI2_TEST_MODE SPIDEV_MODE0
#  elif defined(CONFIG_STM32_SPI2_TEST_MODE1)
#    define CONFIG_STM32_SPI2_TEST_MODE SPIDEV_MODE1
#  elif defined(CONFIG_STM32_SPI2_TEST_MODE2)
#    define CONFIG_STM32_SPI2_TEST_MODE SPIDEV_MODE2
#  elif defined(CONFIG_STM32_SPI2_TEST_MODE3)
#    define CONFIG_STM32_SPI2_TEST_MODE SPIDEV_MODE3
#  else
#    error "No CONFIG_STM32_SPI2_TEST_MODEx defined"
#  endif
#endif

#if defined(CONFIG_STM32_SPI3_TEST)
#  if defined(CONFIG_STM32_SPI3_TEST_MODE0)
#    define CONFIG_STM32_SPI3_TEST_MODE SPIDEV_MODE0
#  elif defined(CONFIG_STM32_SPI3_TEST_MODE1)
#    define CONFIG_STM32_SPI3_TEST_MODE SPIDEV_MODE1
#  elif defined(CONFIG_STM32_SPI3_TEST_MODE2)
#    define CONFIG_STM32_SPI3_TEST_MODE SPIDEV_MODE2
#  elif defined(CONFIG_STM32_SPI3_TEST_MODE3)
#    define CONFIG_STM32_SPI3_TEST_MODE SPIDEV_MODE3
#  else
#    error "No CONFIG_STM32_SPI3_TEST_MODEx defined"
#  endif
#endif
...
int stm32_spidev_bus_test(void)
{
  ...
  SPI_SETMODE(g_spi1, CONFIG_STM32_SPI1_TEST_MODE);
  ...
  SPI_SETMODE(g_spi2, CONFIG_STM32_SPI2_TEST_MODE);
  ...
  SPI_SETMODE(g_spi3, CONFIG_STM32_SPI3_TEST_MODE);
