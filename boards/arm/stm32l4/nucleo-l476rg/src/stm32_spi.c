 ...
 *
 * Description:
 *   Called to configure SPI chip select GPIO pins for the Nucleo-L476RG
 *   board.
 *
 ****************************************************************************/
...
void weak_function stm32_spiinitialize(void)
{
  ...
  stm32_configgpio(STM32_LCD_CS);       /* PCD8544 chip select */
#endif
#endif
  ...
  stm32_configgpio(GPIO_CC1101_PWR);
  stm32_configgpio(GPIO_CC1101_CS);
  stm32_configgpio(GPIO_CC1101_GDO2);
#endif
 ...
 *   stm32_spi1/2/3status must be provided by board-specific logic.  They
 ...
 *   STM32 logic.  To use this common SPI logic on your
 *   board:
 *
