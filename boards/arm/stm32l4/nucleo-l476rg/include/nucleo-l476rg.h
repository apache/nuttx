...
/* The NUCLEOL476RG supports both HSE and LSE crystals (X2 and X3).  However,
 * as shipped, the X3 crystal is not populated.  Therefore the Nucleo-L476RG
...
#define STM32_LPTIM1_FREQUENCY  (STM32_HCLK_FREQUENCY / 2)
#define STM32_LPTIM2_FREQUENCY  (STM32_HCLK_FREQUENCY / 2)
