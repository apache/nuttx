/****************************************************************************
 * boards/arm/stm32h7/h747ai/include/board_vos_scale_3.h
 *
...
#ifndef __BOARDS_ARM_STM32H7_H747AI_INCLUDE_BOARD_VOS_SCALE_3_H
#define __BOARDS_ARM_STM32H7_H747AI_INCLUDE_BOARD_VOS_SCALE_3_H
 ...
 *
 *   PLL1_VCO = (48,000,000 / 3) * 25 = 400 MHz
 *
 *   PLL1P = PLL1_VCO/2  = 400 MHz / 2   = 200 MHz
 *   PLL1Q = PLL1_VCO/4  = 400 MHz / 4   = 100 MHz
 *   PLL1R = PLL1_VCO/2  = 400 MHz / 2   = 200 MHz
 */
...
#define STM32_PLLCFG_PLL1N       RCC_PLL1DIVR_N1(25)
#define STM32_PLLCFG_PLL1P       RCC_PLL1DIVR_P1(2)
#define STM32_PLLCFG_PLL1Q       RCC_PLL1DIVR_Q1(4)
#define STM32_PLLCFG_PLL1R       RCC_PLL1DIVR_R1(2)

#define STM32_VCO1_FREQUENCY     ((STM32_HSE_FREQUENCY / 3) * 25)
...
#define STM32_RCC_D1CFGR_HPRE   RCC_D1CFGR_HPRE_SYSCLK          /* HCLK  = SYSCLK */
#define STM32_ACLK_FREQUENCY    (STM32_SYSCLK_FREQUENCY / 1)    /* ACLK in D1, HCLK3 in D1 */
#define STM32_HCLK_FREQUENCY    (STM32_SYSCLK_FREQUENCY / 1)    /* HCLK in D2, HCLK4 in D3 */
...
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_ARM_STM32H7_H747AI_INCLUDE_BOARD_VOS_SCALE_3_H */
