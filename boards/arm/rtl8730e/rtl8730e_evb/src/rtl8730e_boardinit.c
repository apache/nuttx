...
/****************************************************************************
 * Name: rtl8730e_memory_initialize
 *
 * Description:
 *   All rtl8730e architectures must provide the following entry point.  This
 ...
 *
 *   Logic in rtl8730e_memory_initialize must be careful to avoid using any
...
void rtl8730e_memory_initialize(void)
{
  /* SDRAM was initialized by a bootloader in the supported configurations. */
}

/****************************************************************************
 * Name: rtl8730e_board_initialize
 *
 * Description:
 *   All rtl8730e architectures must provide the following entry point.  This
 *   entry point is called in the initialization phase -- after
 *   rtl8730e_memory_initialize and after all memory has been configured and
...
void rtl8730e_board_initialize(void)
{
