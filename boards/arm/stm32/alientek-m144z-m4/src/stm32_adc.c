/****************************************************************************
 * boards/arm/stm32/alientek-m144z-m4/src/stm32_adc.c
 *
...
/* ALIENTEK M144Z-M4 exposes ADC1_IN1 (PA1) on the JP1 analog header.
 * Only that single channel is enabled by default; extend g_chanlist and
 * g_pinlist below to add more.
 */
