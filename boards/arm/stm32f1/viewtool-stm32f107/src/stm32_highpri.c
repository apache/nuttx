/****************************************************************************
 * boards/arm/stm32f1/viewtool-stm32f107/src/stm32_highpri.c
 *
...
#  warning CONFIG_VIEWTOOL_TIM6_FREQUENCY defaulting to STM32_TIM6_CLKIN
#  define CONFIG_VIEWTOOL_TIM6_FREQUENCY STM32_TIM6_CLKIN
#endif
...
int highpri_main(int argc, char *argv[])
{
  ...
  printf("TIM6 CLKIN=%jd Hz, Frequency=%d Hz, prescaler=%d\n",
         (uintmax_t)STM32_TIM6_CLKIN, CONFIG_VIEWTOOL_TIM6_FREQUENCY,
         prescaler);
