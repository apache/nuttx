...
int rtl8720f_bringup(void)
{
  ...
  ret = rtl8720f_gpio_initialize();
  if (ret < 0)
    {
      syslog(LOG_ERR, "ERROR: rtl8720f_gpio_initialize failed: %d\n", ret);
    }
#endif
  ...
  ret = rtl8720f_spi_initialize();
  if (ret < 0)
    {
      syslog(LOG_ERR, "ERROR: rtl8720f_spi_initialize failed: %d\n", ret);
    }
#endif
  ...
  ret = rtl8720f_pwm_initialize();
  if (ret < 0)
    {
      syslog(LOG_ERR, "ERROR: rtl8720f_pwm_initialize failed: %d\n", ret);
    }
#endif
  ...
  ret = rtl8720f_adc_initialize();
  if (ret < 0)
    {
      syslog(LOG_ERR, "ERROR: rtl8720f_adc_initialize failed: %d\n", ret);
    }
#endif
  ...
  ret = rtl8720f_wdg_initialize();
  if (ret < 0)
    {
      syslog(LOG_ERR, "ERROR: rtl8720f_wdg_initialize failed: %d\n", ret);
    }
#endif
  ...
  ret = rtl8720f_timer_initialize();
  if (ret < 0)
    {
      syslog(LOG_ERR, "ERROR: rtl8720f_timer_initialize failed: %d\n", ret);
    }
#endif
