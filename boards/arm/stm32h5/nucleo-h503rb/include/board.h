/****************************************************************************
 * boards/arm/stm32h5/nucleo-h503rb/include/board.h
 *
...
#ifndef __BOARDS_ARM_STM32H5_NUCLEO_H503RB_INCLUDE_BOARD_H
#define __BOARDS_ARM_STM32H5_NUCLEO_H503RB_INCLUDE_BOARD_H
...
/* The Nucleo-H503RB supports using a HSE crystal (X3), but it is not
...
/* The Nucleo-H503RB has one user controllable LED, LD2 a Green LED
 * connected to PA5.
 *
...
/* The Nucleo-H503RB supports one button:  Pushbutton B1, labeled "User", is
...
#define GPIO_USART3_RX   GPIO_USART3_RX_1    /* PA3 */
#define GPIO_USART3_TX   GPIO_USART3_TX_1    /* PA4 */
...
#endif /* __ASSEMBLY__ */
#endif  /* __BOARDS_ARM_STM32H5_NUCLEO_H503RB_INCLUDE_BOARD_H */
