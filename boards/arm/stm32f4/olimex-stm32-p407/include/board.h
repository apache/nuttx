...
#  undef  GPIO_USART3_RX    (GPIO_USART3_RX_3|GPIO_SPEED_100MHz)
#  undef  GPIO_USART3_TX    (GPIO_USART3_TX_3|GPIO_SPEED_100MHz)
...
/* ETH MII/RMII inputs and MDC/MDIO (referenced by arch driver) */
