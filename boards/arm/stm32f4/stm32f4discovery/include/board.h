...
#  define GPIO_CAN2_RX (GPIO_CAN2_RX_1|GPIO_SPEED_50MHz)
...
#  define GPIO_USART2_RX  (GPIO_USART2_RX_1|GPIO_SPEED_100MHz)     /* PA3, P1 pin 13 */
#  define GPIO_USART2_TX  (GPIO_USART2_TX_1|GPIO_SPEED_100MHz)     /* PA2, P1 pin 14 */
...
#define GPIO_USART3_TX    (GPIO_USART3_TX_1|GPIO_SPEED_100MHz)     /* PB10, P1 pin 34 (also MP45DT02 CLK_IN) */
#define GPIO_USART3_RX    (GPIO_USART3_RX_1|GPIO_SPEED_100MHz)     /* PB11, P1 pin 35 */
...
#define GPIO_USART6_RX    (GPIO_USART6_RX_1|GPIO_SPEED_100MHz)     /* PC7 (also I2S3_MCK and P2 pin 48) */
#define GPIO_USART6_TX    (GPIO_USART6_TX_1|GPIO_SPEED_100MHz)     /* PC6 (also P2 pin 47) */
...
#define GPIO_TIM3_CH1IN  (GPIO_TIM3_CH2IN_2|GPIO_SPEED_50MHz)
...
#define GPIO_TIM3_CH3OUT  (GPIO_TIM3_CH3OUT_1|GPIO_SPEED_50MHz)
...
/* MCO and ETH inputs (referenced by arch/eth driver) */
...
/* I2S3 MCK (referenced by audio driver) */

#define GPIO_I2S3_MCK    GPIO_I2S3_MCK_0
...
#define GPIO_FSMC_NE1       (GPIO_FSMC_NE1_0|GPIO_SPEED_100MHz)
#define GPIO_FSMC_NE2       (GPIO_FSMC_NE2_0|GPIO_SPEED_100MHz)
#define GPIO_FSMC_NE3       (GPIO_FSMC_NE3_0|GPIO_SPEED_100MHz)
#define GPIO_FSMC_NE4       (GPIO_FSMC_NE4_0|GPIO_SPEED_100MHz)
