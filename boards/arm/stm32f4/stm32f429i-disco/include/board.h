...
#define STM32_TIM2_CLKIN    (STM32_HCLK_FREQUENCY/2)
#define STM32_TIM3_CLKIN    (STM32_HCLK_FREQUENCY/2)
#define STM32_TIM4_CLKIN    (STM32_HCLK_FREQUENCY/2)
#define STM32_TIM5_CLKIN    (STM32_HCLK_FREQUENCY/2)
#define STM32_TIM6_CLKIN    (STM32_HCLK_FREQUENCY/2)
#define STM32_TIM7_CLKIN    (STM32_HCLK_FREQUENCY/2)
...
#define GPIO_LTDC_R2                    (GPIO_LTDC_R2_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_R3                    (GPIO_LTDC_R3_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_R4                    (GPIO_LTDC_R4_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_R5                    (GPIO_LTDC_R5_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_R6                    (GPIO_LTDC_R6_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_R7                    (GPIO_LTDC_R7_1|GPIO_SPEED_100MHz)

#define GPIO_LTDC_G2                    (GPIO_LTDC_G2_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_G3                    (GPIO_LTDC_G3_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_G4                    (GPIO_LTDC_G4_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_G5                    (GPIO_LTDC_G5_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_G6                    (GPIO_LTDC_G6_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_G7                    (GPIO_LTDC_G7_1|GPIO_SPEED_100MHz)

#define GPIO_LTDC_B2                    (GPIO_LTDC_B2_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_B3                    (GPIO_LTDC_B3_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_B4                    (GPIO_LTDC_B4_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_B5                    (GPIO_LTDC_B5_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_B6                    (GPIO_LTDC_B6_1|GPIO_SPEED_100MHz)
#define GPIO_LTDC_B7                    (GPIO_LTDC_B7_1|GPIO_SPEED_100MHz)

#define GPIO_LTDC_VSYNC                 GPIO_LTDC_VSYNC_1
#define GPIO_LTDC_HSYNC                 GPIO_LTDC_HSYNC_1
#define GPIO_LTDC_DE                    (GPIO_LTDC_DE_1|GPIO_SPEED_100MHz)
...
/* FMC SDRAM pins (referenced by board src) */
