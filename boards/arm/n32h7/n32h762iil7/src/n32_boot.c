/****************************************************************************
 * boards/arm/n32h7/n32h762iil7/src/n32_boot.c
 *
...
/****************************************************************************
 * Name: n32_boardinitialize
 *
 * Description:
 *   All N32 architectures must provide the following entry point.
...
void n32_boardinitialize(void)
{
#ifdef CONFIG_ARCH_LEDS
  board_autoled_initialize();
#endif
#ifdef CONFIG_N32H7_DMA
  modifyreg32(N32_DMA1_CFG, 0, DMA_CFG_EN);
  modifyreg32(N32_DMA2_CFG, 0, DMA_CFG_EN);
  modifyreg32(N32_DMA3_CFG, 0, DMA_CFG_EN);
#endif
