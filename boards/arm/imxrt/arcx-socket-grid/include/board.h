/****************************************************************************
 * boards/arm/imxrt/arcx-socket-grid/include/board.h
 *
...
#ifndef __BOARDS_ARM_IMXRT_IMXRT1052_SOCKET_GRID_INCLUDE_BOARD_H
#define __BOARDS_ARM_IMXRT_IMXRT1052_SOCKET_GRID_INCLUDE_BOARD_H
...
/* There are three LED status indicators located on the Board.
 *  The functions of these LEDs include:
 *
 *   - Main Power Supply(LED1: green)
 *   - 5V Power Supply(LED3: green)
 *   - USER LED(LED2: red)
 *
 * Only a single LED, LED2, is under software control (GPIO_B0_08).
 */
...
/* The Socket_Grid board doesn't have external user button */
...
/* LPUARTs
 *
 * Serial console port is provided on UART1 using the pins
 * 4 and 6 of JTAG 20 pins connector.
 */
...
/* LPI2Cs
 *
 * There are three LPI2C ports and an I2C expansor (PCA9645APW):
 *   - LPI2C1: Coil sensor PCB
 *   - LPI2C2: Coil sensor PCB
 *   - LPI2C3: 2 devices (EEPROM M24128 and IO/Expander PCA9645)
 *             and Coil sensor PCB
 *
 * IO Expansor I2C ports:
 *   - I2C4: not used
 *   - I2C5: V, I, Temp Measurements:
 *             0x48 - ADS7830
 *             0x49 - LM75B
 *             0x4A - LM75B
 *   - I2C6: USB2 HUB Controller (USB2517)
 *   - I2C7: Coil sensor connector
 */
...
#define GPIO_LPI2C2_SDA   (GPIO_LPI2C2_SDA_1|IOMUX_LPI2C_DEFAULT) /* GPIO_B0_04 */
#define GPIO_LPI2C2_SCL   (GPIO_LPI2C2_SCL_1|IOMUX_LPI2C_DEFAULT) /* GPIO_B0_03 */
#define GPIO_LPI2C3_SDA   (GPIO_LPI2C3_SDA_3|IOMUX_LPI2C_DEFAULT) /* GPIO_AD_B0_01 */
#define GPIO_LPI2C3_SCL   (GPIO_LPI2C3_SCL_3|IOMUX_LPI2C_DEFAULT) /* GPIO_AD_B0_00 */

/* LPSPI
 *
 * The Socket Grid board uses 3 SPI ports
 *
 *   - FlexSPI: Serial NOR
 *   - LPSPI3: Gigabit Switch KSZ8795
 *   - LPSPI4: IO-Link MAX14819 transceiver
 */

/* FLEXSPI */

#define GPIO_FLEXSPI_DQS     (GPIO_FLEXSPIA_DQS_2|IOMUX_FLEXSPI_DEFAULT)    /* GPIO_SD_B1_05 */
#define GPIO_FLEXSPI_CS      (GPIO_FLEXSPIA_SS0_2|IOMUX_FLEXSPI_DEFAULT)    /* GPIO_SD_B1_06 */
#define GPIO_FLEXSPI_IO0     (GPIO_FLEXSPIA_DATA00_2|IOMUX_FLEXSPI_DEFAULT) /* GPIO_SD_B1_08 */
#define GPIO_FLEXSPI_IO1     (GPIO_FLEXSPIA_DATA01_2|IOMUX_FLEXSPI_DEFAULT) /* GPIO_SD_B1_09 */
#define GPIO_FLEXSPI_IO2     (GPIO_FLEXSPIA_DATA02_2|IOMUX_FLEXSPI_DEFAULT) /* GPIO_SD_B1_10 */
#define GPIO_FLEXSPI_IO3     (GPIO_FLEXSPIA_DATA03_2|IOMUX_FLEXSPI_DEFAULT) /* GPIO_SD_B1_11 */
#define GPIO_FLEXSPI_IO4     (GPIO_FLEXSPIB_DATA00_2|IOMUX_FLEXSPI_DEFAULT) /* GPIO_SD_B1_03 */
#define GPIO_FLEXSPI_IO5     (GPIO_FLEXSPIB_DATA01_2|IOMUX_FLEXSPI_DEFAULT) /* GPIO_SD_B1_02 */
#define GPIO_FLEXSPI_IO6     (GPIO_FLEXSPIB_DATA02_2|IOMUX_FLEXSPI_DEFAULT) /* GPIO_SD_B1_01 */
#define GPIO_FLEXSPI_IO7     (GPIO_FLEXSPIB_DATA03_2|IOMUX_FLEXSPI_DEFAULT) /* GPIO_SD_B1_00 */
#define GPIO_FLEXSPI_SCK     (GPIO_FLEXSPIA_SCLK_2|IOMUX_FLEXSPI_DEFAULT)   /* GPIO_SD_B1_07 */

/* LPSPI3 */

#define GPIO_LPSPI3_SCK   (GPIO_LPSPI3_SCK_1|IOMUX_LPSPI_DEFAULT) /* GPIO_AD_B1_15 */
#define GPIO_LPSPI3_MISO  (GPIO_LPSPI3_SDI_1|IOMUX_LPSPI_DEFAULT) /* GPIO_AD_B1_13 */
#define GPIO_LPSPI3_MOSI  (GPIO_LPSPI3_SDO_1|IOMUX_LPSPI_DEFAULT) /* GPIO_AD_B1_14 */

/* LPSPI4 */

#define GPIO_LPSPI4_SCK   (GPIO_LPSPI4_SCK_2|IOMUX_LPSPI_DEFAULT) /* GPIO_B0_03 */
#define GPIO_LPSPI4_MISO  (GPIO_LPSPI4_SDI_2|IOMUX_LPSPI_DEFAULT) /* GPIO_B0_01 */
#define GPIO_LPSPI4_MOSI  (GPIO_LPSPI4_SDO_2|IOMUX_LPSPI_DEFAULT) /* GPIO_B0_02 */
...
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_ARM_IMXRT_IMXRT1052_SOCKET_GRID_INCLUDE_BOARD_H */
