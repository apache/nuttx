/****************************************************************************
 * boards/arm/imxrt/fmu-v6xrt/src/imxrt_flexspi_nor_boot.h
 *
...
/* The part holds 64M, but programming all of it costs more time than the
 * image needs.
 */

#define FLASH_END                   FLASH_BASE + (3 * (1024 * 1024))

/* This has to account for the memory configuration the bootloader
 * leaves behind.
 */
