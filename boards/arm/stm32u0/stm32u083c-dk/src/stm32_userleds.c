/****************************************************************************
 * boards/arm/stm32u0/stm32u083c-dk/src/stm32_userleds.c
 *
...
{
  /* Configure LD3, LD4 and LD5 GPIO for output */
...
void board_userled(int led, bool ledon)
{
  ...
  if (led == BOARD_LED3)
    {
      stm32_gpiowrite(GPIO_LD5, ledon);
    }
}
...
{
  stm32_gpiowrite(GPIO_LD3, (ledset & BOARD_LED1_BIT) != 0);
  stm32_gpiowrite(GPIO_LD4, (ledset & BOARD_LED2_BIT) != 0);
  stm32_gpiowrite(GPIO_LD5, (ledset & BOARD_LED3_BIT) != 0);
}
