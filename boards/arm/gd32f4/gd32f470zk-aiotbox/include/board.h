/****************************************************************************
 * boards/arm/gd32f4/gd32f470zk-aiotbox/include/board.h
 *
...
#ifndef __BOARDS_ARM_GD32F470ZK_AIOTBOX_INCLUDE_BOARD_H
#define __BOARDS_ARM_GD32F470ZK_AIOTBOX_INCLUDE_BOARD_H
...
#if defined(CONFIG_GD32F470_200MHZ_AIOTBOX)
...
#elif defined(CONFIG_GD32F470_168MHZ_AIOTBOX)
...
#elif defined(CONFIG_GD32F470_240MHZ_AIOTBOX)
...
#if defined(CONFIG_GD32F470ZK_AIOTBOX_CONSOLE_BOARD)
...
#if defined(GD32F470ZK_AIOTBOX_CONSOLE_VIRTUAL)
 ...
 *   TX    USART2_TX PD8
 */
#  define GPIO_USART2_RX GPIO_USART2_RX_4
 ...
 *   TX    USART5_TX PC6
 */
#  define GPIO_USART5_RX GPIO_USART5_RX_2
#  define GPIO_USART5_TX GPIO_USART5_TX_2
 ...
 *   TX    UART6_TX PE7
 */
#  define GPIO_UART6_RX GPIO_UART6_RX_1
#  define GPIO_UART6_TX GPIO_UART6_TX_1
...
#define GPIO_SPI4_CSPIN (GPIO_CFG_PORT_F | GPIO_PIN6_OUTPUT)
#define GPIO_SPI4_MISO_PIN  ((GPIO_SPI4_MISO_3& ~GPIO_CFG_SPEED_MASK) | GPIO_CFG_SPEED_25MHZ)
#define GPIO_SPI4_MOSI_PIN  ((GPIO_SPI4_MOSI_4 & ~GPIO_CFG_SPEED_MASK) | GPIO_CFG_SPEED_25MHZ)
#define GPIO_SPI4_SCK_PIN   ((GPIO_SPI4_SCK_3 & ~GPIO_CFG_SPEED_MASK) | GPIO_CFG_SPEED_25MHZ)
...
#endif /* __BOARDS_ARM_GD32F470ZK_AIOTBOX_INCLUDE_BOARD_H */
