...
#define STM32_TIM2_CLKIN     (1 * STM32_PCLK1_FREQUENCY)

/* Timers driven from APB2 will be the same frequency as PCLK2 */

#define STM32_TIM1_CLKIN     (1 * STM32_PCLK2_FREQUENCY)
#define STM32_TIM16_CLKIN    (1 * STM32_PCLK2_FREQUENCY)
#define STM32_TIM17_CLKIN    (1 * STM32_PCLK2_FREQUENCY)
