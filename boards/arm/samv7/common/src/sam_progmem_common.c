...
#if defined(CONFIG_SAMV7_PROGMEM_MCUBOOT_PARTITION)

static const struct mcuboot_partition_s g_mcuboot_partition_table[] =
{
  {
    .offset  = CONFIG_SAMV7_MCUBOOT_PRIMARY_SLOT_OFFSET,
    .size    = CONFIG_SAMV7_MCUBOOT_SLOT_SIZE,
    .devpath = CONFIG_SAMV7_MCUBOOT_PRIMARY_SLOT_DEVPATH
  },
  {
    .offset  = CONFIG_SAMV7_MCUBOOT_SECONDARY_SLOT_OFFSET,
    .size    = CONFIG_SAMV7_MCUBOOT_SLOT_SIZE,
    .devpath = CONFIG_SAMV7_MCUBOOT_SECONDARY_SLOT_DEVPATH
  },
  {
    .offset  = CONFIG_SAMV7_MCUBOOT_SCRATCH_OFFSET,
    .size    = CONFIG_SAMV7_MCUBOOT_SCRATCH_SIZE,
    .devpath = CONFIG_SAMV7_MCUBOOT_SCRATCH_DEVPATH
  }
};
