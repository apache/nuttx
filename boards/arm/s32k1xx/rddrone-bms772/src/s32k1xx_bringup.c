...
#  endif /* CONFIG_S32K1XX_NRSTCHECK_PROCFS */
...
#if defined(CONFIG_SMBUS_SBD) && defined(CONFIG_S32K1XX_LPI2C0)
  ...
  ret = smbus_sbd_initialize(0, i2c_slave);
  if (ret < 0)
    {
      syslog(LOG_ERR, "ERROR: smbus_sbd_initialize() failed: %d\n", ret);
    }
#endif /* CONFIG_SMBUS_SBD && CONFIG_S32K1XX_LPI2C0 */
...
#if defined(CONFIG_NETDEV_LATEINIT) && defined(CONFIG_S32K1XX_FLEXCAN0)
...
#endif /* CONFIG_NETDEV_LATEINIT && CONFIG_S32K1XX_FLEXCAN0 */
