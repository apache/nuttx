...
static int s32k1xx_nrstcheck_procfs_open(FAR struct file *filep,
                                         FAR const char *relpath, int oflags,
                                         mode_t mode);
static int s32k1xx_nrstcheck_procfs_close(FAR struct file *filep);
static ssize_t s32k1xx_nrstcheck_procfs_read(FAR struct file *filep,
                                             FAR char *buffer,
                                             size_t buflen);
static int s32k1xx_nrstcheck_procfs_dup(FAR const struct file *oldp,
                                        FAR struct file *newp);
static int s32k1xx_nrstcheck_procfs_stat(FAR const char *relpath,
                                         FAR struct stat *buf);
...
static int s32k1xx_nrstcheck_procfs_open(FAR struct file *filep,
                                         ...
                                         mode_t mode)
{
  FAR struct s32k1xx_nrstcheck_procfs_file_s *attr;
...
static int s32k1xx_nrstcheck_procfs_close(FAR struct file *filep)
{
  ...
  attr = (FAR struct s32k1xx_nrstcheck_procfs_file_s *)filep->f_priv;
  DEBUGASSERT(attr);
...
static int s32k1xx_nrstcheck_procfs_dup(FAR const struct file *oldp,
                                        FAR struct file *newp)
{
  FAR struct s32k1xx_nrstcheck_procfs_file_s *oldattr;
  FAR struct s32k1xx_nrstcheck_procfs_file_s *newattr;

  finfo("Dup %p->%p\n", oldp, newp);

  /* Recover our private data from the old struct file instance */

  oldattr = (FAR struct s32k1xx_nrstcheck_procfs_file_s *)oldp->f_priv;
  DEBUGASSERT(oldattr);
