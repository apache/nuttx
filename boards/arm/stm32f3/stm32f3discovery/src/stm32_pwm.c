/****************************************************************************
 * boards/arm/stm32f3/stm32f3discovery/src/stm32_pwm.c
 *
...
/* PWM
 *
 * The stm32f3discovery has no real on-board PWM devices, but the board can
 * be configured to output a pulse train using TIM4 CH2.  This pin is used
 * by FSMC is connected to CN5 just for this purpose:
 *
