 ...
 *     P1.25/MCOA1/MAT1.1          |  LCD-RST      | LCD Reset (RSTB) -
 *                                 |               | Resets Everything in LCD
 *     ----------------------------+---------------+-------------------------
 */
 ...
 *
 * Description:
 *   Called to configure SSP chip select GPIO pins for the ZKit-ARM-1769
 *   board.
 *
 ****************************************************************************/
 ...
 *
 * Description:
 *   Called to configure SPI chip select GPIO pins for the ZKit-ARM-1769
 *   board.
 *
 ****************************************************************************/
