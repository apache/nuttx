...
#if defined(CONFIG_AT32_ETHMAC)

/****************************************************************************
 * Pre-processor Definitions
 ****************************************************************************/

#define AT32_ETHMAC_DEVNAME "eth0"
...
/****************************************************************************
 * Name: at32_emac0_phy_enable
 ****************************************************************************/

#ifdef HAVE_NETMONITOR
static void at32_emac0_phy_enable(bool enable)
{
  phyinfo("enable=%d\n", enable);
  if (enable && g_ethmac_handler != NULL)
    {
      ...
      at32_gpiosetevent(GPIO_EMAC_NINT, false, true, true,
  ...
  else
    {
      ...
      at32_gpiosetevent(GPIO_EMAC_NINT, false, false, false,
                         NULL, NULL);
    }
}
#endif
...
void  at32_netinitialize(void)
{
  ...
  at32_configgpio(GPIO_EMAC_NINT);
#endif

  /* Configure PHY /RESET output */

  at32_configgpio(GPIO_EMAC_NRST);
}
