...
#define STM32_TIM1_CLKIN    (AT32_HCLK_FREQUENCY)
#define STM32_TIM2_CLKIN    (AT32_HCLK_FREQUENCY)
#define STM32_TIM3_CLKIN    (AT32_HCLK_FREQUENCY)
#define STM32_TIM4_CLKIN    (AT32_HCLK_FREQUENCY)
#define STM32_TIM5_CLKIN    (AT32_HCLK_FREQUENCY)
#define STM32_TIM6_CLKIN    (AT32_HCLK_FREQUENCY)
#define STM32_TIM7_CLKIN    (AT32_HCLK_FREQUENCY)
#define STM32_TIM8_CLKIN    (AT32_HCLK_FREQUENCY)
