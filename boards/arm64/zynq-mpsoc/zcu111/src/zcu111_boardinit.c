...
/****************************************************************************
 * Name: zynq_memory_initialize
 *
 * Description:
 *   All ZYNQ MPSOC architectures must provide the following entry point.
 *   This entry point is called early in the initialization before memory has
 *   been configured.  This board-specific function is responsible for
 *   configuring any on-board memories.
 *
 *   Logic in zynq_memory_initialize must be careful to avoid using any
...
void zynq_memory_initialize(void)
{
 ...
 *   zynq_memory_initialize and after all memory has been configured and
