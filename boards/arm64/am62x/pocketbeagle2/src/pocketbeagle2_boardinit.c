/****************************************************************************
 * boards/arm64/am62x/pocketbeagle2/src/pocketbeagle2_boardinit.c
 *
 ...
 *   DRAM training.
 *
 *   On PocketBeagle 2, U-Boot trains and initialises the 512 MB DDR4
