/****************************************************************************
 * boards/tricore/tc4da/triboard_tc4x9_com/src/tc4da_boardinit.c
 *
 ...
 *
 *   Logic in tc4da_memory_initialize must be careful to avoid using any
...
void tc4da_memory_initialize(void)
{
  /* SDRAM was initialized by a bootloader in the supported configurations. */
}

/****************************************************************************
 * Name: tc4da_board_initialize
 *
 * Description:
 *   All i.MX6 architectures must provide the following entry point.  This
 *   entry point is called in the initialization phase -- after
 *   tc4da_memory_initialize and after all memory has been configured and
...
void tc4da_board_initialize(void)
{
